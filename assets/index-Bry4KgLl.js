...
`,Pt="/assets/contact-CNdl1USL.jpg",Ft="/assets/donate-alipay-BSmrWLPt.jpg",It="/assets/donate-wx-Dn3cqFoe.jpg",Lt="/assets/mp-CqDGcv-x.png",Mt="/assets/public-rtsp-e2e-SF2azekD.png",Wt="/assets/rtsp-player-latest-architecture-DXNX5NGC.png",Nt="/assets/rtsp-player-latest-architecture-DHNnpsnF.svg",Ot="/assets/rtsp-player-latest-cover-bg-DdSb4E2y.png",Ht="/assets/rtsp-player-latest-cover-B7Gc5T4f.png",zt="/assets/rtsp-player-wechat-cover-BddK3DxA.png",tn="rtsp-player",Bt="640px",qt="360px",J={extensionId:"",tagName:tn,runtime:"extension"},Ue=new WeakMap,Ve=6,Gt=700,jt=8e3;function Ut(){return typeof document>"u"?"":document.currentScript?.dataset?.extensionId||""}function cn(e){return String(e||"").trim().replace(/^chrome-extension:\/\//,"").replace(/\/.*$/,"")}function Vt(e){const n=cn(e);return n?`chrome-extension://${n}`:""}function Sn(e,n){if(e==null||e==="")return n;const u=String(e);return/^\d+$/.test(u)?`${u}px`:u}function ru(e){const n=String(e||"").trim().toLowerCase();return n==="desktop"||n==="auto"||n==="extension"?n:"extension"}function $t(e){const n=String(e).trim().toLowerCase();return n==="webrtc"||n==="ws-annexb"||n==="auto"?n:"auto"}function ou(e){const n=String(e||"").trim().toLowerCase();return n==="h265"||n==="hevc"?"h265":n==="h264"||n==="avc"?"h264":"auto"}function de(){return typeof window>"u"?null:window.rtspNative||window.__RTSP_DESKTOP__||null}function iu(){return!!de()?.startStream}function L(e,n,u={}){e.dispatchEvent(new CustomEvent(n,{detail:u,bubbles:!0,composed:!0}))}function Zt(e={}){return e.extensionId!==void 0&&(J.extensionId=cn(e.extensionId)),e.tagName&&(J.tagName=String(e.tagName)),e.runtime&&(J.runtime=ru(e.runtime)),{...J}}async function Tn(e="auto"){const n=ou(e),u={desktopRuntime:iu(),webcodecs:"VideoDecoder"in globalThis,webrtc:"RTCPeerConnection"in globalThis,h264WebRTC:!1,h265WebRTC:!1,h264WebCodecs:!1,h265WebCodecs:!1};try{const r=(globalThis.RTCRtpReceiver?.getCapabilities?.("video")?.codecs||[]).map(o=>String(o.mimeType||"").toLowerCase());u.h264WebRTC=r.includes("video/h264"),u.h265WebRTC=r.includes("video/h265")||r.includes("video/hevc")}catch{}if(u.webcodecs){try{u.h264WebCodecs=!!(await VideoDecoder.isConfigSupported({codec:"avc1.42E01E",hardwareAcceleration:"prefer-hardware",optimizeForLatency:!0})).supported}catch{}try{u.h265WebCodecs=!!(await VideoDecoder.isConfigSupported({codec:"hvc1.1.6.L93.B0",hardwareAcceleration:"prefer-hardware",optimizeForLatency:!0})).supported}catch{}}return u.requestedCodec=n,u}function Kt(e=J.tagName||tn,n={}){if(typeof window>"u"||typeof customElements>"u")return;Zt(n);const u=String(e||tn),t=customElements.get(u);if(t)return t;class r extends HTMLElement{static get observedAttributes(){return["url","src","width","height","autoplay","controls","muted","transport","media-transport","rtsp-transport","codec","runtime","extension-id"]}constructor(){super(),this._iframe=null,this._loaded=!1,this._player=null,this._pc=null,this._video=null,this._mode="",this._streamId="",this._streamToken="",this._playGeneration=0,this._recoveryAttempts=0,this._recoveryTimer=0,this._userStopped=!1,this.attachShadow({mode:"open"})}connectedCallback(){this._render()}disconnectedCallback(){this.stop(),this._iframe?.contentWindow&&Ue.delete(this._iframe.contentWindow)}attributeChangedCallback(i){if(i==="runtime"||i==="extension-id"){this.stop(),this._iframe=null,this._loaded=!1,this.shadowRoot&&(this.shadowRoot.innerHTML=""),this._render();return}this._resize(),this._mode==="extension"?this._sendInit():this.hasAttribute("autoplay")&&(i==="url"||i==="src")&&this.play()}play(i){i&&this.setAttribute("url",i),this._mode==="extension"?this._sendInit():this._startDesktop()}stop(){this._userStopped=!0,this._playGeneration+=1,this._clearRecoveryTimer(),this._recoveryAttempts=0;const i=this._streamId;if(this._streamId="",this._streamToken="",this._iframe?.contentWindow&&this._iframe.contentWindow.postMessage({type:"RTSP_PLAYER_STOP"},this._origin()),this._player&&(this._player.close(),this._player=null),this._pc){try{this._pc.close()}catch{}this._pc=null}if(this._video){try{this._video.srcObject=null}catch{}this._video.remove(),this._video=null}const a=de();i&&a?.stopStream&&a.stopStream({streamId:i}).catch?.(()=>{})}async capabilities(){return Tn(this._codec())}_runtime(){const i=ru(this.getAttribute("runtime")||J.runtime);return i==="auto"?iu()?"desktop":"extension":i}_extensionId(){return cn(this.getAttribute("extension-id")||J.extensionId||window.RTSP_EXTENSION_ID||window.RTSP_WEB_PLAYER_EXTENSION_ID||Ut())}_origin(){return Vt(this._extensionId())}_url(){return this.getAttribute("url")||this.getAttribute("src")||""}_rtspTransport(){const i=this.getAttribute("rtsp-transport"),a=this.getAttribute("transport");return i||(a==="tcp"||a==="udp"?a:"tcp")}_mediaTransport(){return $t(this.getAttribute("media-transport")||this.getAttribute("transport")||"auto")}_codec(){return ou(this.getAttribute("codec")||"auto")}_render(){if(!this.shadowRoot||this.shadowRoot.innerHTML)return;this._resize(),this._runtime()==="desktop"?this._renderDesktop():this._renderExtension()}_renderExtension(){this._mode="extension",this.shadowRoot.innerHTML=`
        <style>
...
`;break}return t};ce.prototype.render=function(e,n,u){let t="";const r=this.rules;for(let o=0,i=e.length;o<i;o++){const a=e[o].type;a==="inline"?t+=this.renderInline(e[o].children,n,u):typeof r[a]<"u"?t+=r[a](e,o,n,u,this):t+=this.renderToken(e,o,n,u)}return t};function E(){this.__rules__=[],this.__cache__=null}E.prototype.__find__=function(e){for(let n=0;n<this.__rules__.length;n++)if(this.__rules__[n].name===e)return n;return-1};E.prototype.__compile__=function(){const e=this,n=[""];e.__rules__.forEach(function(u){u.enabled&&u.alt.forEach(function(t){n.indexOf(t)<0&&n.push(t)})}),e.__cache__={},n.forEach(function(u){e.__cache__[u]=[],e.__rules__.forEach(function(t){t.enabled&&(u&&t.alt.indexOf(u)<0||e.__cache__[u].push(t.fn))})})};E.prototype.at=function(e,n,u){const t=this.__find__(e),r=u||{};if(t===-1)throw new Error("Parser rule not found: "+e);this.__rules__[t].fn=n,this.__rules__[t].alt=r.alt||[],this.__cache__=null};E.prototype.before=function(e,n,u,t){const r=this.__find__(e),o=t||{};if(r===-1)throw new Error("Parser rule not found: "+e);this.__rules__.splice(r,0,{name:n,enabled:!0,fn:u,alt:o.alt||[]}),this.__cache__=null};E.prototype.after=function(e,n,u,t){const r=this.__find__(e),o=t||{};if(r===-1)throw new Error("Parser rule not found: "+e);this.__rules__.splice(r+1,0,{name:n,enabled:!0,fn:u,alt:o.alt||[]}),this.__cache__=null};E.prototype.push=function(e,n,u){const t=u||{};this.__rules__.push({name:e,enabled:!0,fn:n,alt:t.alt||[]}),this.__cache__=null};E.prototype.enable=function(e,n){Array.isArray(e)||(e=[e]);const u=[];return e.forEach(function(t){const r=this.__find__(t);if(r<0){if(n)return;throw new Error("Rules manager: invalid rule name "+t)}this.__rules__[r].enabled=!0,u.push(t)},this),this.__cache__=null,u};E.prototype.enableOnly=function(e,n){Array.isArray(e)||(e=[e]),this.__rules__.forEach(function(u){u.enabled=!1}),this.enable(e,n)};E.prototype.disable=function(e,n){Array.isArray(e)||(e=[e]);const u=[];return e.forEach(function(t){const r=this.__find__(t);if(r<0){if(n)return;throw new Error("Rules manager: invalid rule name "+t)}this.__rules__[r].enabled=!1,u.push(t)},this),this.__cache__=null,u};E.prototype.getRules=function(e){return this.__cache__===null&&this.__compile__(),this.__cache__[e]||[]};function I(e,n,u){this.type=e,this.tag=n,this.attrs=null,this.map=null,this.nesting=u,this.level=0,this.children=null,this.content="",this.markup="",this.info="",this.meta=null,this.block=!1,this.hidden=!1}I.prototype.attrIndex=function(n){if(!this.attrs)return-1;const u=this.attrs;for(let t=0,r=u.length;t<r;t++)if(u[t][0]===n)return t;return-1};I.prototype.attrPush=function(n){this.attrs?this.attrs.push(n):this.attrs=[n]};I.prototype.attrSet=function(n,u){const t=this.attrIndex(n),r=[n,u];t<0?this.attrPush(r):this.attrs[t]=r};I.prototype.attrGet=function(n){const u=this.attrIndex(n);let t=null;return u>=0&&(t=this.attrs[u][1]),t};I.prototype.attrJoin=function(n,u){const t=this.attrIndex(n);t<0?this.attrPush([n,u]):this.attrs[t][1]=this.attrs[t][1]+" "+u};function mu(e,n,u){this.src=e,this.env=u,this.tokens=[],this.inlineMode=!1,this.md=n}mu.prototype.Token=I;const Ur=/\r\n?|\n/g,Vr=/\0/g;function $r(e){let n;n=e.src.replace(Ur,`
`),n=n.replace(Vr,"�"),e.src=n}function Zr(e){let n;e.inlineMode?(n=new e.Token("inline","",0),n.content=e.src,n.map=[0,1],n.children=[],e.tokens.push(n)):e.md.block.parse(e.src,e.md,e.env,e.tokens)}function Kr(e){const n=e.tokens;for(let u=0,t=n.length;u<t;u++){const r=n[u];r.type==="inline"&&e.md.inline.parse(r.content,e.md,e.env,r.children)}}function Jr(e){return/^<a[>\s]/i.test(e)}function Xr(e){return/^<\/a\s*>/i.test(e)}function Yr(e){const n=e.tokens;if(e.md.options.linkify)for(let u=0,t=n.length;u<t;u++){if(n[u].type!=="inline"||!e.md.linkify.pretest(n[u].content))continue;let r=n[u].children,o=0;for(let i=r.length-1;i>=0;i--){const a=r[i];if(a.type==="link_close"){for(i--;r[i].level!==a.level&&r[i].type!=="link_open";)i--;continue}if(a.type==="html_inline"&&(Jr(a.content)&&o>0&&o--,Xr(a.content)&&o++),!(o>0)&&a.type==="text"&&e.md.linkify.test(a.content)){const s=a.content;let c=e.md.linkify.match(s);const l=[];let d=a.level,h=0;c.length>0&&c[0].index===0&&i>0&&r[i-1].type==="text_special"&&(c=c.slice(1));for(let p=0;p<c.length;p++){const f=c[p].url,m=e.md.normalizeLink(f);if(!e.md.validateLink(m))continue;let g=c[p].text;c[p].schema?c[p].schema==="mailto:"&&!/^mailto:/i.test(g)?g=e.md.normalizeLinkText("mailto:"+g).replace(/^mailto:/,""):g=e.md.normalizeLinkText(g):g=e.md.normalizeLinkText("http://"+g).replace(/^http:\/\//,"");const C=c[p].index;if(C>h){const y=new e.Token("text","",0);y.content=s.slice(h,C),y.level=d,l.push(y)}const _=new e.Token("link_open","a",1);_.attrs=[["href",m]],_.level=d++,_.markup="linkify",_.info="auto",l.push(_);const b=new e.Token("text","",0);b.content=g,b.level=d,l.push(b);const x=new e.Token("link_close","a",-1);x.level=--d,x.markup="linkify",x.info="auto",l.push(x),h=c[p].lastIndex}if(h<s.length){const p=new e.Token("text","",0);p.content=s.slice(h),p.level=d,l.push(p)}n[u].children=r=pu(r,i,l)}}}}const gu=/\+-|\.\.|\?\?\?\?|!!!!|,,|--/,Qr=/\((c|tm|r)\)/i,eo=/\((c|tm|r)\)/ig,no={c:"©",r:"®",tm:"™"};function uo(e,n){return no[n.toLowerCase()]}function to(e){let n=0;for(let u=e.length-1;u>=0;u--){const t=e[u];t.type==="text"&&!n&&(t.content=t.content.replace(eo,uo)),t.type==="link_open"&&t.info==="auto"&&n--,t.type==="link_close"&&t.info==="auto"&&n++}}function ro(e){let n=0;for(let u=e.length-1;u>=0;u--){const t=e[u];t.type==="text"&&!n&&gu.test(t.content)&&(t.content=t.content.replace(/\+-/g,"±").replace(/\.{2,}/g,"…").replace(/([?!])…/g,"$1..").replace(/([?!]){4,}/g,"$1$1$1").replace(/,{2,}/g,",").replace(/(^|[^-])---(?=[^-]|$)/mg,"$1—").replace(/(^|\s)--(?=\s|$)/mg,"$1–").replace(/(^|[^-\s])--(?=[^-\s]|$)/mg,"$1–")),t.type==="link_open"&&t.info==="auto"&&n--,t.type==="link_close"&&t.info==="auto"&&n++}}function oo(e){let n;if(e.md.options.typographer)for(n=e.tokens.length-1;n>=0;n--)e.tokens[n].type==="inline"&&(Qr.test(e.tokens[n].content)&&to(e.tokens[n].children),gu.test(e.tokens[n].content)&&ro(e.tokens[n].children))}const io=/['"]/,Wn=/['"]/g,Nn="’";function Te(e,n,u,t){e[n]||(e[n]=[]),e[n].push({pos:u,ch:t})}function ao(e,n){let u="",t=0;n.sort((r,o)=>r.pos-o.pos);for(let r=0;r<n.length;r++){const o=n[r];u+=e.slice(t,o.pos)+o.ch,t=o.pos+1}return u+e.slice(t)}function so(e,n){let u;const t=[],r={};for(let o=0;o<e.length;o++){const i=e[o],a=e[o].level;for(u=t.length-1;u>=0&&!(t[u].level<=a);u--);if(t.length=u+1,i.type!=="text")continue;const s=i.content;let c=0;const l=s.length;e:for(;c<l;){Wn.lastIndex=c;const d=Wn.exec(s);if(!d)break;let h=!0,p=!0;c=d.index+1;const f=d[0]==="'";let m=32;if(d.index-1>=0)m=s.charCodeAt(d.index-1);else for(u=o-1;u>=0&&!(e[u].type==="softbreak"||e[u].type==="hardbreak");u--)if(e[u].content){m=e[u].content.charCodeAt(e[u].content.length-1);break}let g=32;if(c<l)g=s.charCodeAt(c);else for(u=o+1;u<e.length&&!(e[u].type==="softbreak"||e[u].type==="hardbreak");u++)if(e[u].content){g=e[u].content.charCodeAt(0);break}const C=ge(m)||me(m),_=ge(g)||me(g),b=be(m),x=be(g);if(x?h=!1:_&&(b||C||(h=!1)),b?p=!1:C&&(x||_||(p=!1)),g===34&&d[0]==='"'&&m>=48&&m<=57&&(p=h=!1),h&&p&&(h=C,p=_),!h&&!p){f&&Te(r,o,d.index,Nn);continue}if(p)for(u=t.length-1;u>=0;u--){let y=t[u];if(t[u].level<a)break;if(y.single===f&&t[u].level===a){y=t[u];let k,S;f?(k=n.md.options.quotes[2],S=n.md.options.quotes[3]):(k=n.md.options.quotes[0],S=n.md.options.quotes[1]),Te(r,o,d.index,S),Te(r,y.token,y.pos,k),t.length=u;continue e}}h?t.push({token:o,pos:d.index,single:f,level:a}):p&&f&&Te(r,o,d.index,Nn)}}Object.keys(r).forEach(function(o){e[o].content=ao(e[o].content,r[o])})}function co(e){if(e.md.options.typographer)for(let n=e.tokens.length-1;n>=0;n--)e.tokens[n].type!=="inline"||!io.test(e.tokens[n].content)||so(e.tokens[n].children,e)}function lo(e){let n,u;const t=e.tokens,r=t.length;for(let o=0;o<r;o++){if(t[o].type!=="inline")continue;const i=t[o].children,a=i.length;for(n=0;n<a;n++)i[n].type==="text_special"&&(i[n].type="text");for(n=u=0;n<a;n++)i[n].type==="text"&&n+1<a&&i[n+1].type==="text"?i[n+1].content=i[n].content+i[n+1].content:(n!==u&&(i[u]=i[n]),u++);n!==u&&(i.length=u)}}const Ze=[["normalize",$r],["block",Zr],["inline",Kr],["linkify",Yr],["replacements",oo],["smartquotes",co],["text_join",lo]];function bn(){this.ruler=new E;for(let e=0;e<Ze.length;e++)this.ruler.push(Ze[e][0],Ze[e][1])}bn.prototype.process=function(e){const n=this.ruler.getRules("");for(let u=0,t=n.length;u<t;u++)n[u](e)};bn.prototype.State=mu;function z(e,n,u,t){this.src=e,this.md=n,this.env=u,this.tokens=t,this.bMarks=[],this.eMarks=[],this.tShift=[],this.sCount=[],this.bsCount=[],this.blkIndent=0,this.line=0,this.lineMax=0,this.tight=!1,this.ddIndent=-1,this.listIndent=-1,this.parentType="root",this.level=0;const r=this.src;for(let o=0,i=0,a=0,s=0,c=r.length,l=!1;i<c;i++){const d=r.charCodeAt(i);if(!l)if(v(d)){a++,d===9?s+=4-s%4:s++;continue}else l=!0;(d===10||i===c-1)&&(d!==10&&i++,this.bMarks.push(o),this.eMarks.push(i),this.tShift.push(a),this.sCount.push(s),this.bsCount.push(0),l=!1,a=0,s=0,o=i+1)}this.bMarks.push(r.length),this.eMarks.push(r.length),this.tShift.push(0),this.sCount.push(0),this.bsCount.push(0),this.lineMax=this.bMarks.length-1}z.prototype.push=function(e,n,u){const t=new I(e,n,u);return t.block=!0,u<0&&this.level--,t.level=this.level,u>0&&this.level++,this.tokens.push(t),t};z.prototype.isEmpty=function(n){return this.bMarks[n]+this.tShift[n]>=this.eMarks[n]};z.prototype.skipEmptyLines=function(n){for(let u=this.lineMax;n<u&&!(this.bMarks[n]+this.tShift[n]<this.eMarks[n]);n++);return n};z.prototype.skipSpaces=function(n){for(let u=this.src.length;n<u;n++){const t=this.src.charCodeAt(n);if(!v(t))break}return n};z.prototype.skipSpacesBack=function(n,u){if(n<=u)return n;for(;n>u;)if(!v(this.src.charCodeAt(--n)))return n+1;return n};z.prototype.skipChars=function(n,u){for(let t=this.src.length;n<t&&this.src.charCodeAt(n)===u;n++);return n};z.prototype.skipCharsBack=function(n,u,t){if(n<=t)return n;for(;n>t;)if(u!==this.src.charCodeAt(--n))return n+1;return n};z.prototype.getLines=function(n,u,t,r){if(n>=u)return"";const o=new Array(u-n);for(let i=0,a=n;a<u;a++,i++){let s=0;const c=this.bMarks[a];let l=c,d;for(a+1<u||r?d=this.eMarks[a]+1:d=this.eMarks[a];l<d&&s<t;){const h=this.src.charCodeAt(l);if(v(h))h===9?s+=4-(s+this.bsCount[a])%4:s++;else if(l-c<this.tShift[a])s++;else break;l++}s>t?o[i]=new Array(s-t+1).join(" ")+this.src.slice(l,d):o[i]=this.src.slice(l,d)}return o.join("")};z.prototype.Token=I;const fo=65536;function Ke(e,n){const u=e.bMarks[n]+e.tShift[n],t=e.eMarks[n];return e.src.slice(u,t)}function On(e){const n=[],u=e.length;let t=0,r=e.charCodeAt(t),o=!1,i=0,a="";for(;t<u;)r===124&&(o?(a+=e.substring(i,t-1),i=t):(n.push(a+e.substring(i,t)),a="",i=t+1)),o=r===92,t++,r=e.charCodeAt(t);return n.push(a+e.substring(i)),n}function po(e,n,u,t){if(n+2>u)return!1;let r=n+1;if(e.sCount[r]<e.blkIndent||e.sCount[r]-e.blkIndent>=4)return!1;let o=e.bMarks[r]+e.tShift[r];if(o>=e.eMarks[r])return!1;const i=e.src.charCodeAt(o++);if(i!==124&&i!==45&&i!==58||o>=e.eMarks[r])return!1;const a=e.src.charCodeAt(o++);if(a!==124&&a!==45&&a!==58&&!v(a)||i===45&&v(a))return!1;for(;o<e.eMarks[r];){const x=e.src.charCodeAt(o);if(x!==124&&x!==45&&x!==58&&!v(x))return!1;o++}let s=Ke(e,n+1),c=s.split("|");const l=[];for(let x=0;x<c.length;x++){const y=c[x].trim();if(!y){if(x===0||x===c.length-1)continue;return!1}if(!/^:?-+:?$/.test(y))return!1;y.charCodeAt(y.length-1)===58?l.push(y.charCodeAt(0)===58?"center":"right"):y.charCodeAt(0)===58?l.push("left"):l.push("")}if(s=Ke(e,n).trim(),s.indexOf("|")===-1||e.sCount[n]-e.blkIndent>=4)return!1;c=On(s),c.length&&c[0]===""&&c.shift(),c.length&&c[c.length-1]===""&&c.pop();const d=c.length;if(d===0||d!==l.length)return!1;if(t)return!0;const h=e.parentType;e.parentType="table";const p=e.md.block.ruler.getRules("blockquote"),f=e.push("table_open","table",1),m=[n,0];f.map=m;const g=e.push("thead_open","thead",1);g.map=[n,n+1];const C=e.push("tr_open","tr",1);C.map=[n,n+1];for(let x=0;x<c.length;x++){const y=e.push("th_open","th",1);l[x]&&(y.attrs=[["style","text-align:"+l[x]]]);const k=e.push("inline","",0);k.content=c[x].trim(),k.children=[],e.push("th_close","th",-1)}e.push("tr_close","tr",-1),e.push("thead_close","thead",-1);let _,b=0;for(r=n+2;r<u&&!(e.sCount[r]<e.blkIndent);r++){let x=!1;for(let k=0,S=p.length;k<S;k++)if(p[k](e,r,u,!0)){x=!0;break}if(x||(s=Ke(e,r).trim(),!s)||e.sCount[r]-e.blkIndent>=4||(c=On(s),c.length&&c[0]===""&&c.shift(),c.length&&c[c.length-1]===""&&c.pop(),b+=d-c.length,b>fo))break;if(r===n+2){const k=e.push("tbody_open","tbody",1);k.map=_=[n+2,0]}const y=e.push("tr_open","tr",1);y.map=[r,r+1];for(let k=0;k<d;k++){const S=e.push("td_open","td",1);l[k]&&(S.attrs=[["style","text-align:"+l[k]]]);const F=e.push("inline","",0);F.content=c[k]?c[k].trim():"",F.children=[],e.push("td_close","td",-1)}e.push("tr_close","tr",-1)}return _&&(e.push("tbody_close","tbody",-1),_[1]=r),e.push("table_close","table",-1),m[1]=r,e.parentType=h,e.line=r,!0}function ho(e,n,u){if(e.sCount[n]-e.blkIndent<4)return!1;let t=n+1,r=t;for(;t<u;){if(e.isEmpty(t)){t++;continue}if(e.sCount[t]-e.blkIndent>=4){t++,r=t;continue}break}e.line=r;const o=e.push("code_block","code",0);return o.content=e.getLines(n,r,4+e.blkIndent,!1)+`
`,o.map=[n,e.line],!0}function bo(e,n,u,t){let r=e.bMarks[n]+e.tShift[n],o=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4||r+3>o)return!1;const i=e.src.charCodeAt(r);if(i!==126&&i!==96)return!1;let a=r;r=e.skipChars(r,i);let s=r-a;if(s<3)return!1;const c=e.src.slice(a,r),l=e.src.slice(r,o);if(i===96&&l.indexOf(String.fromCharCode(i))>=0)return!1;if(t)return!0;let d=n,h=!1;for(;d++,!(d>=u||(r=a=e.bMarks[d]+e.tShift[d],o=e.eMarks[d],r<o&&e.sCount[d]<e.blkIndent));)if(e.src.charCodeAt(r)===i&&!(e.sCount[d]-e.blkIndent>=4)&&(r=e.skipChars(r,i),!(r-a<s)&&(r=e.skipSpaces(r),!(r<o)))){h=!0;break}s=e.sCount[n],e.line=d+(h?1:0);const p=e.push("fence","code",0);return p.info=l,p.content=e.getLines(n+1,d,s,!0),p.markup=c,p.map=[n,e.line],!0}function mo(e,n,u,t){let r=e.bMarks[n]+e.tShift[n],o=e.eMarks[n];const i=e.lineMax;if(e.sCount[n]-e.blkIndent>=4||e.src.charCodeAt(r)!==62)return!1;if(t)return!0;const a=[],s=[],c=[],l=[],d=e.md.block.ruler.getRules("blockquote"),h=e.parentType;e.parentType="blockquote";let p=!1,f;for(f=n;f<u;f++){const b=e.sCount[f]<e.blkIndent;if(r=e.bMarks[f]+e.tShift[f],o=e.eMarks[f],r>=o)break;if(e.src.charCodeAt(r++)===62&&!b){let y=e.sCount[f]+1,k,S;e.src.charCodeAt(r)===32?(r++,y++,S=!1,k=!0):e.src.charCodeAt(r)===9?(k=!0,(e.bsCount[f]+y)%4===3?(r++,y++,S=!1):S=!0):k=!1;let F=y;for(a.push(e.bMarks[f]),e.bMarks[f]=r;r<o;){const G=e.src.charCodeAt(r);if(v(G))G===9?F+=4-(F+e.bsCount[f]+(S?1:0))%4:F++;else break;r++}p=r>=o,s.push(e.bsCount[f]),e.bsCount[f]=e.sCount[f]+1+(k?1:0),c.push(e.sCount[f]),e.sCount[f]=F-y,l.push(e.tShift[f]),e.tShift[f]=r-e.bMarks[f];continue}if(p)break;let x=!1;for(let y=0,k=d.length;y<k;y++)if(d[y](e,f,u,!0)){x=!0;break}if(x){e.lineMax=f,e.blkIndent!==0&&(a.push(e.bMarks[f]),s.push(e.bsCount[f]),l.push(e.tShift[f]),c.push(e.sCount[f]),e.sCount[f]-=e.blkIndent);break}a.push(e.bMarks[f]),s.push(e.bsCount[f]),l.push(e.tShift[f]),c.push(e.sCount[f]),e.sCount[f]=-1}const m=e.blkIndent;e.blkIndent=0;const g=e.push("blockquote_open","blockquote",1);g.markup=">";const C=[n,0];g.map=C,e.md.block.tokenize(e,n,f);const _=e.push("blockquote_close","blockquote",-1);_.markup=">",e.lineMax=i,e.parentType=h,C[1]=e.line;for(let b=0;b<l.length;b++)e.bMarks[b+n]=a[b],e.tShift[b+n]=l[b],e.sCount[b+n]=c[b],e.bsCount[b+n]=s[b];return e.blkIndent=m,!0}function go(e,n,u,t){const r=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4)return!1;let o=e.bMarks[n]+e.tShift[n];const i=e.src.charCodeAt(o++);if(i!==42&&i!==45&&i!==95)return!1;let a=1;for(;o<r;){const c=e.src.charCodeAt(o++);if(c!==i&&!v(c))return!1;c===i&&a++}if(a<3)return!1;if(t)return!0;e.line=n+1;const s=e.push("hr","hr",0);return s.map=[n,e.line],s.markup=Array(a+1).join(String.fromCharCode(i)),!0}function Hn(e,n){const u=e.eMarks[n];let t=e.bMarks[n]+e.tShift[n];const r=e.src.charCodeAt(t++);if(r!==42&&r!==45&&r!==43)return-1;if(t<u){const o=e.src.charCodeAt(t);if(!v(o))return-1}return t}function zn(e,n){const u=e.bMarks[n]+e.tShift[n],t=e.eMarks[n];let r=u;if(r+1>=t)return-1;let o=e.src.charCodeAt(r++);if(o<48||o>57)return-1;for(;;){if(r>=t)return-1;if(o=e.src.charCodeAt(r++),o>=48&&o<=57){if(r-u>=10)return-1;continue}if(o===41||o===46)break;return-1}return r<t&&(o=e.src.charCodeAt(r),!v(o))?-1:r}function xo(e,n){const u=e.level+2;for(let t=n+2,r=e.tokens.length-2;t<r;t++)e.tokens[t].level===u&&e.tokens[t].type==="paragraph_open"&&(e.tokens[t+2].hidden=!0,e.tokens[t].hidden=!0,t+=2)}function _o(e,n,u,t){let r,o,i,a,s=n,c=!0;if(e.sCount[s]-e.blkIndent>=4||e.listIndent>=0&&e.sCount[s]-e.listIndent>=4&&e.sCount[s]<e.blkIndent)return!1;let l=!1;t&&e.parentType==="paragraph"&&e.sCount[s]>=e.blkIndent&&(l=!0);let d,h,p;if((p=zn(e,s))>=0){if(d=!0,i=e.bMarks[s]+e.tShift[s],h=Number(e.src.slice(i,p-1)),l&&h!==1)return!1}else if((p=Hn(e,s))>=0)d=!1;else return!1;if(l&&e.skipSpaces(p)>=e.eMarks[s])return!1;if(t)return!0;const f=e.src.charCodeAt(p-1),m=e.tokens.length;d?(a=e.push("ordered_list_open","ol",1),h!==1&&(a.attrs=[["start",h]])):a=e.push("bullet_list_open","ul",1);const g=[s,0];a.map=g,a.markup=String.fromCharCode(f);let C=!1;const _=e.md.block.ruler.getRules("list"),b=e.parentType;for(e.parentType="list";s<u;){o=p,r=e.eMarks[s];const x=e.sCount[s]+p-(e.bMarks[s]+e.tShift[s]);let y=x;for(;o<r;){const ne=e.src.charCodeAt(o);if(ne===9)y+=4-(y+e.bsCount[s])%4;else if(ne===32)y++;else break;o++}const k=o;let S;k>=r?S=1:S=y-x,S>4&&(S=1);const F=x+S;a=e.push("list_item_open","li",1),a.markup=String.fromCharCode(f);const G=[s,0];a.map=G,d&&(a.info=e.src.slice(i,p-1));const le=e.tight,je=e.tShift[s],Ju=e.sCount[s],Xu=e.listIndent;if(e.listIndent=e.blkIndent,e.blkIndent=F,e.tight=!0,e.tShift[s]=k-e.bMarks[s],e.sCount[s]=y,k>=r&&e.isEmpty(s+1)?e.line=Math.min(e.line+2,u):e.md.block.tokenize(e,s,u,!0),(!e.tight||C)&&(c=!1),C=e.line-s>1&&e.isEmpty(e.line-1),e.blkIndent=e.listIndent,e.listIndent=Xu,e.tShift[s]=je,e.sCount[s]=Ju,e.tight=le,a=e.push("list_item_close","li",-1),a.markup=String.fromCharCode(f),s=e.line,G[1]=s,s>=u||e.sCount[s]<e.blkIndent||e.sCount[s]-e.blkIndent>=4)break;let vn=!1;for(let ne=0,Yu=_.length;ne<Yu;ne++)if(_[ne](e,s,u,!0)){vn=!0;break}if(vn)break;if(d){if(p=zn(e,s),p<0)break;i=e.bMarks[s]+e.tShift[s]}else if(p=Hn(e,s),p<0)break;if(f!==e.src.charCodeAt(p-1))break}return d?a=e.push("ordered_list_close","ol",-1):a=e.push("bullet_list_close","ul",-1),a.markup=String.fromCharCode(f),g[1]=s,e.line=s,e.parentType=b,c&&xo(e,m),!0}function yo(e,n,u,t){let r=e.bMarks[n]+e.tShift[n],o=e.eMarks[n],i=n+1;if(e.sCount[n]-e.blkIndent>=4||e.src.charCodeAt(r)!==91)return!1;function a(_){const b=e.lineMax;if(_>=b||e.isEmpty(_))return null;let x=!1;if(e.sCount[_]-e.blkIndent>3&&(x=!0),e.sCount[_]<0&&(x=!0),!x){const S=e.md.block.ruler.getRules("reference"),F=e.parentType;e.parentType="reference";let G=!1;for(let le=0,je=S.length;le<je;le++)if(S[le](e,_,b,!0)){G=!0;break}if(e.parentType=F,G)return null}const y=e.bMarks[_]+e.tShift[_],k=e.eMarks[_];return e.src.slice(y,k+1)}let s=e.src.slice(r,o+1);o=s.length;let c=-1;for(r=1;r<o;r++){const _=s.charCodeAt(r);if(_===91)return!1;if(_===93){c=r;break}else if(_===10){const b=a(i);b!==null&&(s+=b,o=s.length,i++)}else if(_===92&&(r++,r<o&&s.charCodeAt(r)===10)){const b=a(i);b!==null&&(s+=b,o=s.length,i++)}}if(c<0||s.charCodeAt(c+1)!==58)return!1;for(r=c+2;r<o;r++){const _=s.charCodeAt(r);if(_===10){const b=a(i);b!==null&&(s+=b,o=s.length,i++)}else if(!v(_))break}const l=e.md.helpers.parseLinkDestination(s,r,o);if(!l.ok)return!1;const d=e.md.normalizeLink(l.str);if(!e.md.validateLink(d))return!1;r=l.pos;const h=r,p=i,f=r;for(;r<o;r++){const _=s.charCodeAt(r);if(_===10){const b=a(i);b!==null&&(s+=b,o=s.length,i++)}else if(!v(_))break}let m=e.md.helpers.parseLinkTitle(s,r,o);for(;m.can_continue;){const _=a(i);if(_===null)break;s+=_,r=o,o=s.length,i++,m=e.md.helpers.parseLinkTitle(s,r,o,m)}let g;for(r<o&&f!==r&&m.ok?(g=m.str,r=m.pos):(g="",r=h,i=p);r<o;){const _=s.charCodeAt(r);if(!v(_))break;r++}if(r<o&&s.charCodeAt(r)!==10&&g)for(g="",r=h,i=p;r<o;){const _=s.charCodeAt(r);if(!v(_))break;r++}if(r<o&&s.charCodeAt(r)!==10)return!1;const C=Oe(s.slice(1,c));return C?(t||(typeof e.env.references>"u"&&(e.env.references={}),typeof e.env.references[C]>"u"&&(e.env.references[C]={title:g,href:d}),e.line=i),!0):!1}const ko=["address","article","aside","base","basefont","blockquote","body","caption","center","col","colgroup","dd","details","dialog","dir","div","dl","dt","fieldset","figcaption","figure","footer","form","frame","frameset","h1","h2","h3","h4","h5","h6","head","header","hr","html","iframe","legend","li","link","main","menu","menuitem","nav","noframes","ol","optgroup","option","p","param","search","section","summary","table","tbody","td","tfoot","th","thead","title","tr","track","ul"],Co="[a-zA-Z_:][a-zA-Z0-9:._-]*",wo="[^\"'=<>`\\x00-\\x20]+",vo="'[^']*'",So='"[^"]*"',To="(?:"+wo+"|"+vo+"|"+So+")",Do="(?:\\s+"+Co+"(?:\\s*=\\s*"+To+")?)",xu="<[A-Za-z][A-Za-z0-9\\-]*"+Do+"*\\s*\\/?>",_u="<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>",Ro="<!---?>|<!--(?:[^-]|-[^-]|--[^>])*-->",Eo="<[?][\\s\\S]*?[?]>",Ao="<![A-Za-z][^>]*>",Po="<!\\[CDATA\\[[\\s\\S]*?\\]\\]>",Fo=new RegExp("^(?:"+xu+"|"+_u+"|"+Ro+"|"+Eo+"|"+Ao+"|"+Po+")"),Io=new RegExp("^(?:"+xu+"|"+_u+")"),Z=[[/^<(script|pre|style|textarea)(?=(\s|>|$))/i,/<\/(script|pre|style|textarea)>/i,!0],[/^<!--/,/-->/,!0],[/^<\?/,/\?>/,!0],[/^<![A-Z]/,/>/,!0],[/^<!\[CDATA\[/,/\]\]>/,!0],[new RegExp("^</?("+ko.join("|")+")(?=(\\s|/?>|$))","i"),/^$/,!0],[new RegExp(Io.source+"\\s*$"),/^$/,!1]];function Lo(e,n,u,t){let r=e.bMarks[n]+e.tShift[n],o=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4||!e.md.options.html||e.src.charCodeAt(r)!==60)return!1;let i=e.src.slice(r,o),a=0;for(;a<Z.length&&!Z[a][0].test(i);a++);if(a===Z.length)return!1;if(t)return Z[a][2];let s=n+1;const c=Z[a][1].test("");if(!Z[a][1].test(i)){for(;s<u&&!(e.sCount[s]<e.blkIndent&&(c||!e.isEmpty(s)));s++)if(r=e.bMarks[s]+e.tShift[s],o=e.eMarks[s],i=e.src.slice(r,o),Z[a][1].test(i)){i.length!==0&&s++;break}}e.line=s;const l=e.push("html_block","",0);return l.map=[n,s],l.content=e.getLines(n,s,e.blkIndent,!0),!0}function Mo(e,n,u,t){let r=e.bMarks[n]+e.tShift[n],o=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4)return!1;let i=e.src.charCodeAt(r);if(i!==35||r>=o)return!1;let a=1;for(i=e.src.charCodeAt(++r);i===35&&r<o&&a<=6;)a++,i=e.src.charCodeAt(++r);if(a>6||r<o&&!v(i))return!1;if(t)return!0;o=e.skipSpacesBack(o,r);const s=e.skipCharsBack(o,35,r);s>r&&v(e.src.charCodeAt(s-1))&&(o=s),e.line=n+1;const c=e.push("heading_open","h"+String(a),1);c.markup="########".slice(0,a),c.map=[n,e.line];const l=e.push("inline","",0);l.content=He(e.src.slice(r,o)),l.map=[n,e.line],l.children=[];const d=e.push("heading_close","h"+String(a),-1);return d.markup="########".slice(0,a),!0}function Wo(e,n,u){const t=e.md.block.ruler.getRules("paragraph");if(e.sCount[n]-e.blkIndent>=4)return!1;const r=e.parentType;e.parentType="paragraph";let o=0,i,a=n+1;for(;a<u&&!e.isEmpty(a);a++){if(e.sCount[a]-e.blkIndent>3)continue;if(e.sCount[a]>=e.blkIndent){let p=e.bMarks[a]+e.tShift[a];const f=e.eMarks[a];if(p<f&&(i=e.src.charCodeAt(p),(i===45||i===61)&&(p=e.skipChars(p,i),p=e.skipSpaces(p),p>=f))){o=i===61?1:2;break}}if(e.sCount[a]<0)continue;let h=!1;for(let p=0,f=t.length;p<f;p++)if(t[p](e,a,u,!0)){h=!0;break}if(h)break}if(!o)return e.parentType=r,!1;const s=He(e.getLines(n,a,e.blkIndent,!1));e.line=a+1;const c=e.push("heading_open","h"+String(o),1);c.markup=String.fromCharCode(i),c.map=[n,e.line];const l=e.push("inline","",0);l.content=s,l.map=[n,e.line-1],l.children=[];const d=e.push("heading_close","h"+String(o),-1);return d.markup=String.fromCharCode(i),e.parentType=r,!0}function No(e,n,u){const t=e.md.block.ruler.getRules("paragraph"),r=e.parentType;let o=n+1;for(e.parentType="paragraph";o<u&&!e.isEmpty(o);o++){if(e.sCount[o]-e.blkIndent>3||e.sCount[o]<0)continue;let c=!1;for(let l=0,d=t.length;l<d;l++)if(t[l](e,o,u,!0)){c=!0;break}if(c)break}const i=He(e.getLines(n,o,e.blkIndent,!1));e.line=o;const a=e.push("paragraph_open","p",1);a.map=[n,e.line];const s=e.push("inline","",0);return s.content=i,s.map=[n,e.line],s.children=[],e.push("paragraph_close","p",-1),e.parentType=r,!0}const De=[["table",po,["paragraph","reference"]],["code",ho],["fence",bo,["paragraph","reference","blockquote","list"]],["blockquote",mo,["paragraph","reference","blockquote","list"]],["hr",go,["paragraph","reference","blockquote","list"]],["list",_o,["paragraph","reference","blockquote"]],["reference",yo],["html_block",Lo,["paragraph","reference","blockquote"]],["heading",Mo,["paragraph","reference","blockquote"]],["lheading",Wo],["paragraph",No]];function ze(){this.ruler=new E;for(let e=0;e<De.length;e++)this.ruler.push(De[e][0],De[e][1],{alt:(De[e][2]||[]).slice()})}ze.prototype.tokenize=function(e,n,u){const t=this.ruler.getRules(""),r=t.length,o=e.md.options.maxNesting;let i=n,a=!1;for(;i<u&&(e.line=i=e.skipEmptyLines(i),!(i>=u||e.sCount[i]<e.blkIndent));){if(e.level>=o){e.line=u;break}const s=e.line;let c=!1;for(let l=0;l<r;l++)if(c=t[l](e,i,u,!1),c){if(s>=e.line)throw new Error("block rule didn't increment state.line");break}if(!c)throw new Error("none of the block rules matched");e.tight=!a,e.isEmpty(e.line-1)&&(a=!0),i=e.line,i<u&&e.isEmpty(i)&&(a=!0,i++,e.line=i)}};ze.prototype.parse=function(e,n,u,t){if(!e)return;const r=new this.State(e,n,u,t);this.tokenize(r,r.line,r.lineMax)};ze.prototype.State=z;function we(e,n,u,t){this.src=e,this.env=u,this.md=n,this.tokens=t,this.tokens_meta=Array(t.length),this.pos=0,this.posMax=this.src.length,this.level=0,this.pending="",this.pendingLevel=0,this.cache={},this.delimiters=[],this._prev_delimiters=[],this.backticks={},this.backticksScanned=!1,this.linkLevel=0}we.prototype.pushPending=function(){const e=new I("text","",0);return e.content=this.pending,e.level=this.pendingLevel,this.tokens.push(e),this.pending="",e};we.prototype.push=function(e,n,u){this.pending&&this.pushPending();const t=new I(e,n,u);let r=null;return u<0&&(this.level--,this.delimiters=this._prev_delimiters.pop()),t.level=this.level,u>0&&(this.level++,this._prev_delimiters.push(this.delimiters),this.delimiters=[],r={delimiters:this.delimiters}),this.pendingLevel=this.level,this.tokens.push(t),this.tokens_meta.push(r),t};we.prototype.scanDelims=function(e,n){const u=this.posMax,t=this.src.charCodeAt(e);let r;if(e===0)r=32;else if(e===1)r=this.src.charCodeAt(0),(r&63488)===55296&&(r=65533);else if(r=this.src.charCodeAt(e-1),(r&64512)===56320){const g=this.src.charCodeAt(e-2);r=(g&64512)===55296?65536+(g-55296<<10)+(r-56320):65533}else(r&64512)===55296&&(r=65533);let o=e;for(;o<u&&this.src.charCodeAt(o)===t;)o++;const i=o-e;let a=o<u?this.src.charCodeAt(o):32;if((a&64512)===55296){const g=this.src.charCodeAt(o+1);a=(g&64512)===56320?65536+(a-55296<<10)+(g-56320):65533}else(a&64512)===56320&&(a=65533);const s=ge(r)||me(r),c=ge(a)||me(a),l=be(r),d=be(a),h=!d&&(!c||l||s),p=!l&&(!s||d||c);return{can_open:h&&(n||!p||s),can_close:p&&(n||!h||c),length:i}};we.prototype.Token=I;function Oo(e){switch(e){case 10:case 33:case 35:case 36:case 37:case 38:case 42:case 43:case 45:case 58:case 60:case 61:case 62:case 64:case 91:case 92:case 93:case 94:case 95:case 96:case 123:case 125:case 126:return!0;default:return!1}}function Ho(e,n){let u=e.pos;for(;u<e.posMax&&!Oo(e.src.charCodeAt(u));)u++;return u===e.pos?!1:(n||(e.pending+=e.src.slice(e.pos,u)),e.pos=u,!0)}const zo=/(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i;function Bo(e,n){if(!e.md.options.linkify||e.linkLevel>0)return!1;const u=e.pos,t=e.posMax;if(u+3>t||e.src.charCodeAt(u)!==58||e.src.charCodeAt(u+1)!==47||e.src.charCodeAt(u+2)!==47)return!1;const r=e.pending.match(zo);if(!r)return!1;const o=r[1],i=e.md.linkify.matchAtStart(e.src.slice(u-o.length));if(!i)return!1;let a=i.url;if(a.length<=o.length)return!1;let s=a.length;for(;s>0&&a.charCodeAt(s-1)===42;)s--;s!==a.length&&(a=a.slice(0,s));const c=e.md.normalizeLink(a);if(!e.md.validateLink(c))return!1;if(!n){e.pending=e.pending.slice(0,-o.length);const l=e.push("link_open","a",1);l.attrs=[["href",c]],l.markup="linkify",l.info="auto";const d=e.push("text","",0);d.content=e.md.normalizeLinkText(a);const h=e.push("link_close","a",-1);h.markup="linkify",h.info="auto"}return e.pos+=a.length-o.length,!0}function qo(e,n){let u=e.pos;if(e.src.charCodeAt(u)!==10)return!1;const t=e.pending.length-1,r=e.posMax;if(!n)if(t>=0&&e.pending.charCodeAt(t)===32)if(t>=1&&e.pending.charCodeAt(t-1)===32){let o=t-1;for(;o>=1&&e.pending.charCodeAt(o-1)===32;)o--;e.pending=e.pending.slice(0,o),e.push("hardbreak","br",0)}else e.pending=e.pending.slice(0,-1),e.push("softbreak","br",0);else e.push("softbreak","br",0);for(u++;u<r&&v(e.src.charCodeAt(u));)u++;return e.pos=u,!0}const mn=[];for(let e=0;e<256;e++)mn.push(0);"\\!\"#$%&'()*+,./:;<=>?@[]^_`{|}~-".split("").forEach(function(e){mn[e.charCodeAt(0)]=1});function Go(e,n){let u=e.pos;const t=e.posMax;if(e.src.charCodeAt(u)!==92||(u++,u>=t))return!1;let r=e.src.charCodeAt(u);if(r===10){for(n||e.push("hardbreak","br",0),u++;u<t&&(r=e.src.charCodeAt(u),!!v(r));)u++;return e.pos=u,!0}let o=e.src[u];if(r>=55296&&r<=56319&&u+1<t){const a=e.src.charCodeAt(u+1);a>=56320&&a<=57343&&(o+=e.src[u+1],u++)}const i="\\"+o;if(!n){const a=e.push("text_special","",0);r<256&&mn[r]!==0?a.content=o:a.content=i,a.markup=i,a.info="escape"}return e.pos=u+1,!0}function jo(e,n){let u=e.pos;if(e.src.charCodeAt(u)!==96)return!1;const r=u;u++;const o=e.posMax;for(;u<o&&e.src.charCodeAt(u)===96;)u++;const i=e.src.slice(r,u),a=i.length;if(e.backticksScanned&&(e.backticks[a]||0)<=r)return n||(e.pending+=i),e.pos+=a,!0;let s=u,c;for(;(c=e.src.indexOf("`",s))!==-1;){for(s=c+1;s<o&&e.src.charCodeAt(s)===96;)s++;const l=s-c;if(l===a){if(!n){const d=e.push("code_inline","code",0);d.markup=i,d.content=e.src.slice(u,c).replace(/\n/g," ").replace(/^ (.+) $/,"$1")}return e.pos=s,!0}e.backticks[l]=c}return e.backticksScanned=!0,n||(e.pending+=i),e.pos+=a,!0}function Uo(e,n){const u=e.pos,t=e.src.charCodeAt(u);if(n||t!==126)return!1;const r=e.scanDelims(e.pos,!0);let o=r.length;const i=String.fromCharCode(t);if(o<2)return!1;let a;o%2&&(a=e.push("text","",0),a.content=i,o--);for(let s=0;s<o;s+=2)a=e.push("text","",0),a.content=i+i,e.delimiters.push({marker:t,length:0,token:e.tokens.length-1,end:-1,open:r.can_open,close:r.can_close});return e.pos+=r.length,!0}function Bn(e,n){let u;const t=[],r=n.length;for(let o=0;o<r;o++){const i=n[o];if(i.marker!==126||i.end===-1)continue;const a=n[i.end];u=e.tokens[i.token],u.type="s_open",u.tag="s",u.nesting=1,u.markup="~~",u.content="",u=e.tokens[a.token],u.type="s_close",u.tag="s",u.nesting=-1,u.markup="~~",u.content="",e.tokens[a.token-1].type==="text"&&e.tokens[a.token-1].content==="~"&&t.push(a.token-1)}for(;t.length;){const o=t.pop();let i=o+1;for(;i<e.tokens.length&&e.tokens[i].type==="s_close";)i++;i--,o!==i&&(u=e.tokens[i],e.tokens[i]=e.tokens[o],e.tokens[o]=u)}}function Vo(e){const n=e.tokens_meta,u=e.tokens_meta.length;Bn(e,e.delimiters);for(let t=0;t<u;t++)n[t]&&n[t].delimiters&&Bn(e,n[t].delimiters)}const yu={tokenize:Uo,postProcess:Vo};function $o(e,n){const u=e.pos,t=e.src.charCodeAt(u);if(n||t!==95&&t!==42)return!1;const r=e.scanDelims(e.pos,t===42);for(let o=0;o<r.length;o++){const i=e.push("text","",0);i.content=String.fromCharCode(t),e.delimiters.push({marker:t,length:r.length,token:e.tokens.length-1,end:-1,open:r.can_open,close:r.can_close})}return e.pos+=r.length,!0}function qn(e,n){const u=n.length;for(let t=u-1;t>=0;t--){const r=n[t];if(r.marker!==95&&r.marker!==42||r.end===-1)continue;const o=n[r.end],i=t>0&&n[t-1].end===r.end+1&&n[t-1].marker===r.marker&&n[t-1].token===r.token-1&&n[r.end+1].token===o.token+1,a=String.fromCharCode(r.marker),s=e.tokens[r.token];s.type=i?"strong_open":"em_open",s.tag=i?"strong":"em",s.nesting=1,s.markup=i?a+a:a,s.content="";const c=e.tokens[o.token];c.type=i?"strong_close":"em_close",c.tag=i?"strong":"em",c.nesting=-1,c.markup=i?a+a:a,c.content="",i&&(e.tokens[n[t-1].token].content="",e.tokens[n[r.end+1].token].content="",t--)}}function Zo(e){const n=e.tokens_meta,u=e.tokens_meta.length;qn(e,e.delimiters);for(let t=0;t<u;t++)n[t]&&n[t].delimiters&&qn(e,n[t].delimiters)}const ku={tokenize:$o,postProcess:Zo};function Ko(e,n){let u,t,r,o,i="",a="",s=e.pos,c=!0;if(e.src.charCodeAt(e.pos)!==91)return!1;const l=e.pos,d=e.posMax,h=e.pos+1,p=e.md.helpers.parseLinkLabel(e,e.pos,!0);if(p<0)return!1;let f=p+1;if(f<d&&e.src.charCodeAt(f)===40){for(c=!1,f++;f<d&&(u=e.src.charCodeAt(f),!(!v(u)&&u!==10));f++);if(f>=d)return!1;if(s=f,r=e.md.helpers.parseLinkDestination(e.src,f,e.posMax),r.ok){for(i=e.md.normalizeLink(r.str),e.md.validateLink(i)?f=r.pos:i="",s=f;f<d&&(u=e.src.charCodeAt(f),!(!v(u)&&u!==10));f++);if(r=e.md.helpers.parseLinkTitle(e.src,f,e.posMax),f<d&&s!==f&&r.ok)for(a=r.str,f=r.pos;f<d&&(u=e.src.charCodeAt(f),!(!v(u)&&u!==10));f++);}(f>=d||e.src.charCodeAt(f)!==41)&&(c=!0),f++}if(c){if(typeof e.env.references>"u")return!1;if(f<d&&e.src.charCodeAt(f)===91?(s=f+1,f=e.md.helpers.parseLinkLabel(e,f),f>=0?t=e.src.slice(s,f++):f=p+1):f=p+1,t||(t=e.src.slice(h,p)),o=e.env.references[Oe(t)],!o)return e.pos=l,!1;i=o.href,a=o.title}if(!n){e.pos=h,e.posMax=p;const m=e.push("link_open","a",1),g=[["href",i]];m.attrs=g,a&&g.push(["title",a]),e.linkLevel++,e.md.inline.tokenize(e),e.linkLevel--,e.push("link_close","a",-1)}return e.pos=f,e.posMax=d,!0}function Jo(e,n){let u,t,r,o,i,a,s,c,l="";const d=e.pos,h=e.posMax;if(e.src.charCodeAt(e.pos)!==33||e.src.charCodeAt(e.pos+1)!==91)return!1;const p=e.pos+2,f=e.md.helpers.parseLinkLabel(e,e.pos+1,!1);if(f<0)return!1;if(o=f+1,o<h&&e.src.charCodeAt(o)===40){for(o++;o<h&&(u=e.src.charCodeAt(o),!(!v(u)&&u!==10));o++);if(o>=h)return!1;for(c=o,a=e.md.helpers.parseLinkDestination(e.src,o,e.posMax),a.ok&&(l=e.md.normalizeLink(a.str),e.md.validateLink(l)?o=a.pos:l=""),c=o;o<h&&(u=e.src.charCodeAt(o),!(!v(u)&&u!==10));o++);if(a=e.md.helpers.parseLinkTitle(e.src,o,e.posMax),o<h&&c!==o&&a.ok)for(s=a.str,o=a.pos;o<h&&(u=e.src.charCodeAt(o),!(!v(u)&&u!==10));o++);else s="";if(o>=h||e.src.charCodeAt(o)!==41)return e.pos=d,!1;o++}else{if(typeof e.env.references>"u")return!1;if(o<h&&e.src.charCodeAt(o)===91?(c=o+1,o=e.md.helpers.parseLinkLabel(e,o),o>=0?r=e.src.slice(c,o++):o=f+1):o=f+1,r||(r=e.src.slice(p,f)),i=e.env.references[Oe(r)],!i)return e.pos=d,!1;l=i.href,s=i.title}if(!n){t=e.src.slice(p,f);const m=[];e.md.inline.parse(t,e.md,e.env,m);const g=e.push("image","img",0),C=[["src",l],["alt",""]];g.attrs=C,g.children=m,g.content=t,s&&C.push(["title",s])}return e.pos=o,e.posMax=h,!0}const Xo=/^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/,Yo=/^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;function Qo(e,n){let u=e.pos;if(e.src.charCodeAt(u)!==60)return!1;const t=e.pos,r=e.posMax;for(;;){if(++u>=r)return!1;const i=e.src.charCodeAt(u);if(i===60)return!1;if(i===62)break}const o=e.src.slice(t+1,u);if(Yo.test(o)){const i=e.md.normalizeLink(o);if(!e.md.validateLink(i))return!1;if(!n){const a=e.push("link_open","a",1);a.attrs=[["href",i]],a.markup="autolink",a.info="auto";const s=e.push("text","",0);s.content=e.md.normalizeLinkText(o);const c=e.push("link_close","a",-1);c.markup="autolink",c.info="auto"}return e.pos+=o.length+2,!0}if(Xo.test(o)){const i=e.md.normalizeLink("mailto:"+o);if(!e.md.validateLink(i))return!1;if(!n){const a=e.push("link_open","a",1);a.attrs=[["href",i]],a.markup="autolink",a.info="auto";const s=e.push("text","",0);s.content=e.md.normalizeLinkText(o);const c=e.push("link_close","a",-1);c.markup="autolink",c.info="auto"}return e.pos+=o.length+2,!0}return!1}function ei(e){return/^<a[>\s]/i.test(e)}function ni(e){return/^<\/a\s*>/i.test(e)}function ui(e){const n=e|32;return n>=97&&n<=122}function ti(e,n){if(!e.md.options.html)return!1;const u=e.posMax,t=e.pos;if(e.src.charCodeAt(t)!==60||t+2>=u)return!1;const r=e.src.charCodeAt(t+1);if(r!==33&&r!==63&&r!==47&&!ui(r))return!1;const o=e.src.slice(t).match(Fo);if(!o)return!1;if(!n){const i=e.push("html_inline","",0);i.content=o[0],ei(i.content)&&e.linkLevel++,ni(i.content)&&e.linkLevel--}return e.pos+=o[0].length,!0}const ri=/^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,oi=/^&([a-z][a-z0-9]{1,31});/i;function ii(e,n){const u=e.pos,t=e.posMax;if(e.src.charCodeAt(u)!==38||u+1>=t)return!1;if(e.src.charCodeAt(u+1)===35){const o=e.src.slice(u).match(ri);if(o){if(!n){const i=o[1][0].toLowerCase()==="x"?parseInt(o[1].slice(1),16):parseInt(o[1],10),a=e.push("text_special","",0);a.content=hn(i)?he(i):he(65533),a.markup=o[0],a.info="entity"}return e.pos+=o[0].length,!0}}else{const o=e.src.slice(u).match(oi);if(o){const i=vr(o[0]);if(i!==o[0]){if(!n){const a=e.push("text_special","",0);a.content=i,a.markup=o[0],a.info="entity"}return e.pos+=o[0].length,!0}}}return!1}function Gn(e){const n={},u=e.length;if(!u)return;let t=0,r=-2;const o=[];for(let i=0;i<u;i++){const a=e[i];if(o.push(0),(e[t].marker!==a.marker||r!==a.token-1)&&(t=i),r=a.token,a.length=a.length||0,!a.close)continue;n.hasOwnProperty(a.marker)||(n[a.marker]=[-1,-1,-1,-1,-1,-1]);const s=n[a.marker][(a.open?3:0)+a.length%3];let c=t-o[t]-1,l=c;for(;c>s;c-=o[c]+1){const d=e[c];if(d.marker===a.marker&&d.open&&d.end<0){let h=!1;if((d.close||a.open)&&(d.length+a.length)%3===0&&(d.length%3!==0||a.length%3!==0)&&(h=!0),!h){const p=c>0&&!e[c-1].open?o[c-1]+1:0;o[i]=i-c+p,o[c]=p,a.open=!1,d.end=i,d.close=!1,l=-1,r=-2;break}}}l!==-1&&(n[a.marker][(a.open?3:0)+(a.length||0)%3]=l)}}function ai(e){const n=e.tokens_meta,u=e.tokens_meta.length;Gn(e.delimiters);for(let t=0;t<u;t++)n[t]&&n[t].delimiters&&Gn(n[t].delimiters)}function si(e){let n,u,t=0;const r=e.tokens,o=e.tokens.length;for(n=u=0;n<o;n++)r[n].nesting<0&&t--,r[n].level=t,r[n].nesting>0&&t++,r[n].type==="text"&&n+1<o&&r[n+1].type==="text"?r[n+1].content=r[n].content+r[n+1].content:(n!==u&&(r[u]=r[n]),u++);n!==u&&(r.length=u)}const Je=[["text",Ho],["linkify",Bo],["newline",qo],["escape",Go],["backticks",jo],["strikethrough",yu.tokenize],["emphasis",ku.tokenize],["link",Ko],["image",Jo],["autolink",Qo],["html_inline",ti],["entity",ii]],Xe=[["balance_pairs",ai],["strikethrough",yu.postProcess],["emphasis",ku.postProcess],["fragments_join",si]];function ve(){this.ruler=new E;for(let e=0;e<Je.length;e++)this.ruler.push(Je[e][0],Je[e][1]);this.ruler2=new E;for(let e=0;e<Xe.length;e++)this.ruler2.push(Xe[e][0],Xe[e][1])}ve.prototype.skipToken=function(e){const n=e.pos,u=this.ruler.getRules(""),t=u.length,r=e.md.options.maxNesting,o=e.cache;if(typeof o[n]<"u"){e.pos=o[n];return}let i=!1;if(e.level<r){for(let a=0;a<t;a++)if(e.level++,i=u[a](e,!0),e.level--,i){if(n>=e.pos)throw new Error("inline rule didn't increment state.pos");break}}else e.pos=e.posMax;i||e.pos++,o[n]=e.pos};ve.prototype.tokenize=function(e){const n=this.ruler.getRules(""),u=n.length,t=e.posMax,r=e.md.options.maxNesting;for(;e.pos<t;){const o=e.pos;let i=!1;if(e.level<r){for(let a=0;a<u;a++)if(i=n[a](e,!1),i){if(o>=e.pos)throw new Error("inline rule didn't increment state.pos");break}}if(i){if(e.pos>=t)break;continue}e.pending+=e.src[e.pos++]}e.pending&&e.pushPending()};ve.prototype.parse=function(e,n,u,t){const r=new this.State(e,n,u,t);this.tokenize(r);const o=this.ruler2.getRules(""),i=o.length;for(let a=0;a<i;a++)o[a](r)};ve.prototype.State=we;function ci(e){const n={};e=e||{},n.src_Any=au.source,n.src_Cc=su.source,n.src_Z=lu.source,n.src_P=fn.source,n.src_ZPCc=[n.src_Z,n.src_P,n.src_Cc].join("|"),n.src_ZCc=[n.src_Z,n.src_Cc].join("|");const u="[><｜]";return n.src_pseudo_letter="(?:(?!"+u+"|"+n.src_ZPCc+")"+n.src_Any+")",n.src_ip4="(?:(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)",n.src_auth="(?:(?:(?!"+n.src_ZCc+"|[@/\\[\\]()]).)+@)?",n.src_port="(?::(?:6(?:[0-4]\\d{3}|5(?:[0-4]\\d{2}|5(?:[0-2]\\d|3[0-5])))|[1-5]?\\d{1,4}))?",n.src_host_terminator="(?=$|"+u+"|"+n.src_ZPCc+")(?!"+(e["---"]?"-(?!--)|":"-|")+"_|:\\d|\\.-|\\.(?!$|"+n.src_ZPCc+"))",n.src_path="(?:[/?#](?:(?!"+n.src_ZCc+"|"+u+`|[()[\\]{}.,"'?!\\-;]).|\\[(?:(?!`+n.src_ZCc+"|\\]).)*\\]|\\((?:(?!"+n.src_ZCc+"|[)]).)*\\)|\\{(?:(?!"+n.src_ZCc+'|[}]).)*\\}|\\"(?:(?!'+n.src_ZCc+`|["]).)+\\"|\\'(?:(?!`+n.src_ZCc+"|[']).)+\\'|\\'(?="+n.src_pseudo_letter+"|[-])|\\.{2,}[a-zA-Z0-9%/&]|\\.(?!"+n.src_ZCc+"|[.]|$)|"+(e["---"]?"\\-(?!--(?:[^-]|$))(?:-*)|":"\\-+|")+",(?!"+n.src_ZCc+"|$)|;(?!"+n.src_ZCc+"|$)|\\!+(?!"+n.src_ZCc+"|[!]|$)|\\?(?!"+n.src_ZCc+"|[?]|$))+|\\/)?",n.src_email_name='[\\-;:&=\\+\\$,\\.a-zA-Z0-9_][\\-;:&=\\+\\$,\\"\\.a-zA-Z0-9_]*',n.src_xn="xn--[a-z0-9\\-]{1,59}",n.src_domain_root="(?:"+n.src_xn+"|"+n.src_pseudo_letter+"{1,63})",n.src_domain="(?:"+n.src_xn+"|(?:"+n.src_pseudo_letter+")|(?:"+n.src_pseudo_letter+"(?:-|"+n.src_pseudo_letter+"){0,61}"+n.src_pseudo_letter+"))",n.src_host="(?:(?:(?:(?:"+n.src_domain+")\\.)*"+n.src_domain+"))",n.tpl_host_fuzzy="(?:"+n.src_ip4+"|(?:(?:(?:"+n.src_domain+")\\.)+(?:%TLDS%)))",n.tpl_host_no_ip_fuzzy="(?:(?:(?:"+n.src_domain+")\\.)+(?:%TLDS%))",n.src_host_strict=n.src_host+n.src_host_terminator,n.tpl_host_fuzzy_strict=n.tpl_host_fuzzy+n.src_host_terminator,n.src_host_port_strict=n.src_host+n.src_port+n.src_host_terminator,n.tpl_host_port_fuzzy_strict=n.tpl_host_fuzzy+n.src_port+n.src_host_terminator,n.tpl_host_port_no_ip_fuzzy_strict=n.tpl_host_no_ip_fuzzy+n.src_port+n.src_host_terminator,n.tpl_host_fuzzy_test="localhost|www\\.|\\.\\d{1,3}\\.|(?:\\.(?:%TLDS%)(?:"+n.src_ZPCc+"|>|$))",n.tpl_email_fuzzy="(^|"+u+'|"|\\(|'+n.src_ZCc+")("+n.src_email_name+"@"+n.tpl_host_fuzzy_strict+")",n.tpl_link_fuzzy="(^|(?![.:/\\-_@])(?:[$+<=>^`|｜]|"+n.src_ZPCc+"))((?![$+<=>^`|｜])"+n.tpl_host_port_fuzzy_strict+n.src_path+")",n.tpl_link_no_ip_fuzzy="(^|(?![.:/\\-_@])(?:[$+<=>^`|｜]|"+n.src_ZPCc+"))((?![$+<=>^`|｜])"+n.tpl_host_port_no_ip_fuzzy_strict+n.src_path+")",n}function on(e){return Array.prototype.slice.call(arguments,1).forEach(function(u){u&&Object.keys(u).forEach(function(t){e[t]=u[t]})}),e}function Be(e){return Object.prototype.toString.call(e)}function li(e){return Be(e)==="[object String]"}function di(e){return Be(e)==="[object Object]"}function fi(e){return Be(e)==="[object RegExp]"}function jn(e){return Be(e)==="[object Function]"}function pi(e){return e.replace(/[.?*+^$[\]\\(){}|-]/g,"\\$&")}const Cu={fuzzyLink:!0,fuzzyEmail:!0,fuzzyIP:!1};function hi(e){return Object.keys(e||{}).reduce(function(n,u){return n||Cu.hasOwnProperty(u)},!1)}const bi={"http:":{validate:function(e,n,u){const t=e.slice(n);return u.re.http||(u.re.http=new RegExp("^\\/\\/"+u.re.src_auth+u.re.src_host_port_strict+u.re.src_path,"i")),u.re.http.test(t)?t.match(u.re.http)[0].length:0}},"https:":"http:","ftp:":"http:","//":{validate:function(e,n,u){const t=e.slice(n);return u.re.no_http||(u.re.no_http=new RegExp("^"+u.re.src_auth+"(?:localhost|(?:(?:"+u.re.src_domain+")\\.)+"+u.re.src_domain_root+")"+u.re.src_port+u.re.src_host_terminator+u.re.src_path,"i")),u.re.no_http.test(t)?n>=3&&e[n-3]===":"||n>=3&&e[n-3]==="/"?0:t.match(u.re.no_http)[0].length:0}},"mailto:":{validate:function(e,n,u){const t=e.slice(n);return u.re.mailto||(u.re.mailto=new RegExp("^"+u.re.src_email_name+"@"+u.re.src_host_strict,"i")),u.re.mailto.test(t)?t.match(u.re.mailto)[0].length:0}}},mi="a[cdefgilmnoqrstuwxz]|b[abdefghijmnorstvwyz]|c[acdfghiklmnoruvwxyz]|d[ejkmoz]|e[cegrstu]|f[ijkmor]|g[abdefghilmnpqrstuwy]|h[kmnrtu]|i[delmnoqrst]|j[emop]|k[eghimnprwyz]|l[abcikrstuvy]|m[acdeghklmnopqrstuvwxyz]|n[acefgilopruz]|om|p[aefghklmnrstwy]|qa|r[eosuw]|s[abcdeghijklmnortuvxyz]|t[cdfghjklmnortvwz]|u[agksyz]|v[aceginu]|w[fs]|y[et]|z[amw]",gi="biz|com|edu|gov|net|org|pro|web|xxx|aero|asia|coop|info|museum|name|shop|рф".split("|");function xi(e){return function(n,u){const t=n.slice(u);return e.test(t)?t.match(e)[0].length:0}}function Un(){return function(e,n){n.normalize(e)}}function Ae(e){const n=e.re=ci(e.__opts__),u=e.__tlds__.slice();e.onCompile(),e.__tlds_replaced__||u.push(mi),u.push(n.src_xn),n.src_tlds=u.join("|");function t(a){return a.replace("%TLDS%",n.src_tlds)}n.email_fuzzy=RegExp(t(n.tpl_email_fuzzy),"i"),n.email_fuzzy_global=RegExp(t(n.tpl_email_fuzzy),"ig"),n.link_fuzzy=RegExp(t(n.tpl_link_fuzzy),"i"),n.link_fuzzy_global=RegExp(t(n.tpl_link_fuzzy),"ig"),n.link_no_ip_fuzzy=RegExp(t(n.tpl_link_no_ip_fuzzy),"i"),n.link_no_ip_fuzzy_global=RegExp(t(n.tpl_link_no_ip_fuzzy),"ig"),n.host_fuzzy_test=RegExp(t(n.tpl_host_fuzzy_test),"i");const r=[];e.__compiled__={};function o(a,s){throw new Error('(LinkifyIt) Invalid schema "'+a+'": '+s)}Object.keys(e.__schemas__).forEach(function(a){const s=e.__schemas__[a];if(s===null)return;const c={validate:null,link:null};if(e.__compiled__[a]=c,di(s)){fi(s.validate)?c.validate=xi(s.validate):jn(s.validate)?c.validate=s.validate:o(a,s),jn(s.normalize)?c.normalize=s.normalize:s.normalize?o(a,s):c.normalize=Un();return}if(li(s)){r.push(a);return}o(a,s)}),r.forEach(function(a){e.__compiled__[e.__schemas__[a]]&&(e.__compiled__[a].validate=e.__compiled__[e.__schemas__[a]].validate,e.__compiled__[a].normalize=e.__compiled__[e.__schemas__[a]].normalize)}),e.__compiled__[""]={validate:null,normalize:Un()};const i=Object.keys(e.__compiled__).filter(function(a){return a.length>0&&e.__compiled__[a]}).map(pi).join("|");e.re.schema_test=RegExp("(^|(?!_)(?:[><｜]|"+n.src_ZPCc+"))("+i+")","i"),e.re.schema_search=RegExp("(^|(?!_)(?:[><｜]|"+n.src_ZPCc+"))("+i+")","ig"),e.re.schema_at_start=RegExp("^"+e.re.schema_search.source,"i"),e.re.pretest=RegExp("("+e.re.schema_test.source+")|("+e.re.host_fuzzy_test.source+")|@","i")}function wu(e,n,u,t){const r=e.slice(u,t);this.schema=n.toLowerCase(),this.index=u,this.lastIndex=t,this.raw=r,this.text=r,this.url=r}function A(e,n){if(!(this instanceof A))return new A(e,n);n||hi(e)&&(n=e,e={}),this.__opts__=on({},Cu,n),this.__schemas__=on({},bi,e),this.__compiled__={},this.__tlds__=gi,this.__tlds_replaced__=!1,this.re={},Ae(this)}A.prototype.add=function(n,u){return this.__schemas__[n]=u,Ae(this),this};A.prototype.set=function(n){return this.__opts__=on(this.__opts__,n),this};A.prototype.test=function(n){if(!n.length)return!1;let u,t;if(this.re.schema_test.test(n)){for(t=this.re.schema_search,t.lastIndex=0;(u=t.exec(n))!==null;)if(this.testSchemaAt(n,u[2],t.lastIndex))return!0}return!!(this.__opts__.fuzzyLink&&this.__compiled__["http:"]&&n.search(this.re.host_fuzzy_test)>=0&&n.match(this.__opts__.fuzzyIP?this.re.link_fuzzy:this.re.link_no_ip_fuzzy)!==null||this.__opts__.fuzzyEmail&&this.__compiled__["mailto:"]&&n.indexOf("@")>=0&&n.match(this.re.email_fuzzy)!==null)};A.prototype.pretest=function(n){return this.re.pretest.test(n)};A.prototype.testSchemaAt=function(n,u,t){return this.__compiled__[u.toLowerCase()]?this.__compiled__[u.toLowerCase()].validate(n,t,this):0};A.prototype.match=function(n){const u=[],t=[],r=[],o=[];let i,a,s;function c(h,p){return h?p?h.index!==p.index?h.index<p.index?h:p:h.lastIndex>=p.lastIndex?h:p:h:p}if(!n.length)return null;if(this.re.schema_test.test(n))for(s=this.re.schema_search,s.lastIndex=0;(i=s.exec(n))!==null;)a=this.testSchemaAt(n,i[2],s.lastIndex),a&&t.push({schema:i[2],index:i.index+i[1].length,lastIndex:i.index+i[0].length+a});if(this.__opts__.fuzzyLink&&this.__compiled__["http:"])for(s=this.__opts__.fuzzyIP?this.re.link_fuzzy_global:this.re.link_no_ip_fuzzy_global,s.lastIndex=0;(i=s.exec(n))!==null;)r.push({schema:"",index:i.index+i[1].length,lastIndex:i.index+i[0].length});if(this.__opts__.fuzzyEmail&&this.__compiled__["mailto:"])for(s=this.re.email_fuzzy_global,s.lastIndex=0;(i=s.exec(n))!==null;)o.push({schema:"mailto:",index:i.index+i[1].length,lastIndex:i.index+i[0].length});const l=[0,0,0];let d=0;for(;;){const h=[t[l[0]],o[l[1]],r[l[2]]],p=c(c(h[0],h[1]),h[2]);if(!p)break;if(p===h[0]?l[0]++:p===h[1]?l[1]++:l[2]++,p.index<d)continue;const f=new wu(n,p.schema,p.index,p.lastIndex);this.__compiled__[f.schema].normalize(f,this),u.push(f),d=p.lastIndex}return u.length?u:null};A.prototype.matchAtStart=function(n){if(!n.length)return null;const u=this.re.schema_at_start.exec(n);if(!u)return null;const t=this.testSchemaAt(n,u[2],u[0].length);if(!t)return null;const r=new wu(n,u[2],u.index+u[1].length,u.index+u[0].length+t);return this.__compiled__[r.schema].normalize(r,this),r};A.prototype.tlds=function(n,u){return n=Array.isArray(n)?n:[n],u?(this.__tlds__=this.__tlds__.concat(n).sort().filter(function(t,r,o){return t!==o[r-1]}).reverse(),Ae(this),this):(this.__tlds__=n.slice(),this.__tlds_replaced__=!0,Ae(this),this)};A.prototype.normalize=function(n){n.schema||(n.url="http://"+n.url),n.schema==="mailto:"&&!/^mailto:/i.test(n.url)&&(n.url="mailto:"+n.url)};A.prototype.onCompile=function(){};const ue=2147483647,W=36,gn=1,xe=26,_i=38,yi=700,vu=72,Su=128,Tu="-",ki=/^xn--/,Ci=/[^\0-\x7F]/,wi=/[\x2E\u3002\uFF0E\uFF61]/g,vi={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)","invalid-input":"Invalid input"},Ye=W-gn,N=Math.floor,Qe=String.fromCharCode;function U(e){throw new RangeError(vi[e])}function Si(e,n){const u=[];let t=e.length;for(;t--;)u[t]=n(e[t]);return u}function Du(e,n){const u=e.split("@");let t="";u.length>1&&(t=u[0]+"@",e=u[1]),e=e.replace(wi,".");const r=e.split("."),o=Si(r,n).join(".");return t+o}function Ru(e){const n=[];let u=0;const t=e.length;for(;u<t;){const r=e.charCodeAt(u++);if(r>=55296&&r<=56319&&u<t){const o=e.charCodeAt(u++);(o&64512)==56320?n.push(((r&1023)<<10)+(o&1023)+65536):(n.push(r),u--)}else n.push(r)}return n}const Ti=e=>String.fromCodePoint(...e),Di=function(e){return e>=48&&e<58?26+(e-48):e>=65&&e<91?e-65:e>=97&&e<123?e-97:W},Vn=function(e,n){return e+22+75*(e<26)-((n!=0)<<5)},Eu=function(e,n,u){let t=0;for(e=u?N(e/yi):e>>1,e+=N(e/n);e>Ye*xe>>1;t+=W)e=N(e/Ye);return N(t+(Ye+1)*e/(e+_i))},Au=function(e){const n=[],u=e.length;let t=0,r=Su,o=vu,i=e.lastIndexOf(Tu);i<0&&(i=0);for(let a=0;a<i;++a)e.charCodeAt(a)>=128&&U("not-basic"),n.push(e.charCodeAt(a));for(let a=i>0?i+1:0;a<u;){const s=t;for(let l=1,d=W;;d+=W){a>=u&&U("invalid-input");const h=Di(e.charCodeAt(a++));h>=W&&U("invalid-input"),h>N((ue-t)/l)&&U("overflow"),t+=h*l;const p=d<=o?gn:d>=o+xe?xe:d-o;if(h<p)break;const f=W-p;l>N(ue/f)&&U("overflow"),l*=f}const c=n.length+1;o=Eu(t-s,c,s==0),N(t/c)>ue-r&&U("overflow"),r+=N(t/c),t%=c,n.splice(t++,0,r)}return String.fromCodePoint(...n)},Pu=function(e){const n=[];e=Ru(e);const u=e.length;let t=Su,r=0,o=vu;for(const s of e)s<128&&n.push(Qe(s));const i=n.length;let a=i;for(i&&n.push(Tu);a<u;){let s=ue;for(const l of e)l>=t&&l<s&&(s=l);const c=a+1;s-t>N((ue-r)/c)&&U("overflow"),r+=(s-t)*c,t=s;for(const l of e)if(l<t&&++r>ue&&U("overflow"),l===t){let d=r;for(let h=W;;h+=W){const p=h<=o?gn:h>=o+xe?xe:h-o;if(d<p)break;const f=d-p,m=W-p;n.push(Qe(Vn(p+f%m,0))),d=N(f/m)}n.push(Qe(Vn(d,0))),o=Eu(r,c,a===i),r=0,++a}++r,++t}return n.join("")},Ri=function(e){return Du(e,function(n){return ki.test(n)?Au(n.slice(4).toLowerCase()):n})},Ei=function(e){return Du(e,function(n){return Ci.test(n)?"xn--"+Pu(n):n})},Fu={version:"2.3.1",ucs2:{decode:Ru,encode:Ti},decode:Au,encode:Pu,toASCII:Ei,toUnicode:Ri},Ai={options:{html:!1,xhtmlOut:!1,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:100},components:{core:{},block:{},inline:{}}},Pi={options:{html:!1,xhtmlOut:!1,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:20},components:{core:{rules:["normalize","block","inline","text_join"]},block:{rules:["paragraph"]},inline:{rules:["text"],rules2:["balance_pairs","fragments_join"]}}},Fi={options:{html:!0,xhtmlOut:!0,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:20},components:{core:{rules:["normalize","block","inline","text_join"]},block:{rules:["blockquote","code","fence","heading","hr","html_block","lheading","list","reference","paragraph"]},inline:{rules:["autolink","backticks","emphasis","entity","escape","html_inline","image","link","newline","text"],rules2:["balance_pairs","emphasis","fragments_join"]}}},Ii={default:Ai,zero:Pi,commonmark:Fi},Li=/^(vbscript|javascript|file|data):/,Mi=/^data:image\/(gif|png|jpeg|webp);/;function Wi(e){const n=e.trim().toLowerCase();return Li.test(n)?Mi.test(n):!0}const Iu=["http:","https:","mailto:"];function Ni(e){const n=dn(e,!0);if(n.hostname&&(!n.protocol||Iu.indexOf(n.protocol)>=0))try{n.hostname=Fu.toASCII(n.hostname)}catch{}return Ce(ln(n))}function Oi(e){const n=dn(e,!0);if(n.hostname&&(!n.protocol||Iu.indexOf(n.protocol)>=0))try{n.hostname=Fu.toUnicode(n.hostname)}catch{}return re(ln(n),re.defaultChars+"%")}function P(e,n){if(!(this instanceof P))return new P(e,n);n||pn(e)||(n=e||{},e="default"),this.inline=new ve,this.block=new ze,this.core=new bn,this.renderer=new ce,this.linkify=new A,this.validateLink=Wi,this.normalizeLink=Ni,this.normalizeLinkText=Oi,this.utils=zr,this.helpers=Ne({},jr),this.options={},this.configure(e),n&&this.set(n)}P.prototype.set=function(e){return Ne(this.options,e),this};P.prototype.configure=function(e){const n=this;if(pn(e)){const u=e;if(e=Ii[u],!e)throw new Error('Wrong `markdown-it` preset "'+u+'", check name')}if(!e)throw new Error("Wrong `markdown-it` preset, can't be empty");return e.options&&n.set(e.options),e.components&&Object.keys(e.components).forEach(function(u){e.components[u].rules&&n[u].ruler.enableOnly(e.components[u].rules),e.components[u].rules2&&n[u].ruler2.enableOnly(e.components[u].rules2)}),this};P.prototype.enable=function(e,n){let u=[];Array.isArray(e)||(e=[e]),["core","block","inline"].forEach(function(r){u=u.concat(this[r].ruler.enable(e,!0))},this),u=u.concat(this.inline.ruler2.enable(e,!0));const t=e.filter(function(r){return u.indexOf(r)<0});if(t.length&&!n)throw new Error("MarkdownIt. Failed to enable unknown rule(s): "+t);return this};P.prototype.disable=function(e,n){let u=[];Array.isArray(e)||(e=[e]),["core","block","inline"].forEach(function(r){u=u.concat(this[r].ruler.disable(e,!0))},this),u=u.concat(this.inline.ruler2.disable(e,!0));const t=e.filter(function(r){return u.indexOf(r)<0});if(t.length&&!n)throw new Error("MarkdownIt. Failed to disable unknown rule(s): "+t);return this};P.prototype.use=function(e){const n=[this].concat(Array.prototype.slice.call(arguments,1));return e.apply(e,n),this};P.prototype.parse=function(e,n){if(typeof e!="string")throw new Error("Input data should be a String");const u=new this.core.State(e,this,n);return this.core.process(u),u.tokens};P.prototype.render=function(e,n){return n=n||{},this.renderer.render(this.parse(e,n),this.options,n)};P.prototype.parseInline=function(e,n){const u=new this.core.State(e,this,n);return u.inlineMode=!0,this.core.process(u),u.tokens};P.prototype.renderInline=function(e,n){return n=n||{},this.renderer.render(this.parseInline(e,n),this.options,n)};var $n=!1,ie={false:"push",true:"unshift",after:"push",before:"unshift"},Pe={isPermalinkSymbol:!0};function an(e,n,u,t){var r;if(!$n){var o="Using deprecated markdown-it-anchor permalink option, see https://github.com/valeriangalliat/markdown-it-anchor#permalinks";typeof process=="object"&&process&&process.emitWarning?process.emitWarning(o):console.warn(o),$n=!0}var i=[Object.assign(new u.Token("link_open","a",1),{attrs:[].concat(n.permalinkClass?[["class",n.permalinkClass]]:[],[["href",n.permalinkHref(e,u)]],Object.entries(n.permalinkAttrs(e,u)))}),Object.assign(new u.Token("html_block","",0),{content:n.permalinkSymbol,meta:Pe}),new u.Token("link_close","a",-1)];n.permalinkSpace&&u.tokens[t+1].children[ie[n.permalinkBefore]](Object.assign(new u.Token("text","",0),{content:" "})),(r=u.tokens[t+1].children)[ie[n.permalinkBefore]].apply(r,i)}function Lu(e){return"#"+e}function Mu(e){return{}}var Hi={class:"header-anchor",symbol:"#",renderHref:Lu,renderAttrs:Mu};function Se(e){function n(u){return u=Object.assign({},n.defaults,u),function(t,r,o,i){return e(t,u,r,o,i)}}return n.defaults=Object.assign({},Hi),n.renderPermalinkImpl=e,n}function xn(e){var n=[],u=e.filter(function(t){if(t[0]!=="class")return!0;n.push(t[1])});return n.length>0&&u.unshift(["class",n.join(" ")]),u}var qe=Se(function(e,n,u,t,r){var o,i=[Object.assign(new t.Token("link_open","a",1),{attrs:xn([].concat(n.class?[["class",n.class]]:[],[["href",n.renderHref(e,t)]],n.ariaHidden?[["aria-hidden","true"]]:[],Object.entries(n.renderAttrs(e,t))))}),Object.assign(new t.Token("html_inline","",0),{content:n.symbol,meta:Pe}),new t.Token("link_close","a",-1)];if(n.space){var a=typeof n.space=="string"?n.space:" ";t.tokens[r+1].children[ie[n.placement]](Object.assign(new t.Token(typeof n.space=="string"?"html_inline":"text","",0),{content:a}))}(o=t.tokens[r+1].children)[ie[n.placement]].apply(o,i)});Object.assign(qe.defaults,{space:!0,placement:"after",ariaHidden:!1});var K=Se(qe.renderPermalinkImpl);K.defaults=Object.assign({},qe.defaults,{ariaHidden:!0});var Wu=Se(function(e,n,u,t,r){var o=[Object.assign(new t.Token("link_open","a",1),{attrs:xn([].concat(n.class?[["class",n.class]]:[],[["href",n.renderHref(e,t)]],Object.entries(n.renderAttrs(e,t))))})].concat(n.safariReaderFix?[new t.Token("span_open","span",1)]:[],t.tokens[r+1].children,n.safariReaderFix?[new t.Token("span_close","span",-1)]:[],[new t.Token("link_close","a",-1)]);t.tokens[r+1]=Object.assign(new t.Token("inline","",0),{children:o})});Object.assign(Wu.defaults,{safariReaderFix:!1});var Zn=Se(function(e,n,u,t,r){var o;if(!["visually-hidden","aria-label","aria-describedby","aria-labelledby"].includes(n.style))throw new Error("`permalink.linkAfterHeader` called with unknown style option `"+n.style+"`");if(!["aria-describedby","aria-labelledby"].includes(n.style)&&!n.assistiveText)throw new Error("`permalink.linkAfterHeader` called without the `assistiveText` option in `"+n.style+"` style");if(n.style==="visually-hidden"&&!n.visuallyHiddenClass)throw new Error("`permalink.linkAfterHeader` called without the `visuallyHiddenClass` option in `visually-hidden` style");var i=t.tokens[r+1].children.filter(function(d){return d.type==="text"||d.type==="code_inline"}).reduce(function(d,h){return d+h.content},""),a=[],s=[];if(n.class&&s.push(["class",n.class]),s.push(["href",n.renderHref(e,t)]),s.push.apply(s,Object.entries(n.renderAttrs(e,t))),n.style==="visually-hidden"){if(a.push(Object.assign(new t.Token("span_open","span",1),{attrs:[["class",n.visuallyHiddenClass]]}),Object.assign(new t.Token("text","",0),{content:n.assistiveText(i)}),new t.Token("span_close","span",-1)),n.space){var c=typeof n.space=="string"?n.space:" ";a[ie[n.placement]](Object.assign(new t.Token(typeof n.space=="string"?"html_inline":"text","",0),{content:c}))}a[ie[n.placement]](Object.assign(new t.Token("span_open","span",1),{attrs:[["aria-hidden","true"]]}),Object.assign(new t.Token("html_inline","",0),{content:n.symbol,meta:Pe}),new t.Token("span_close","span",-1))}else a.push(Object.assign(new t.Token("html_inline","",0),{content:n.symbol,meta:Pe}));n.style==="aria-label"?s.push(["aria-label",n.assistiveText(i)]):["aria-describedby","aria-labelledby"].includes(n.style)&&s.push([n.style,e]);var l=[Object.assign(new t.Token("link_open","a",1),{attrs:xn(s)})].concat(a,[new t.Token("link_close","a",-1)]);(o=t.tokens).splice.apply(o,[r+3,0].concat(l)),n.wrapper&&(t.tokens.splice(r,0,Object.assign(new t.Token("html_block","",0),{content:n.wrapper[0]+`
`})),t.tokens.splice(r+3+l.length+1,0,Object.assign(new t.Token("html_block","",0),{content:n.wrapper[1]+`
`})))});function Kn(e,n,u,t){var r=e,o=t;if(u&&Object.prototype.hasOwnProperty.call(n,r))throw new Error("User defined `id` attribute `"+e+"` is not unique. Please fix it in your Markdown to continue.");for(;Object.prototype.hasOwnProperty.call(n,r);)r=e+"-"+o,o+=1;return n[r]=!0,r}function X(e,n){n=Object.assign({},X.defaults,n),e.core.ruler.push("anchor",function(u){for(var t,r={},o=u.tokens,i=Array.isArray(n.level)?(t=n.level,function(d){return t.includes(d)}):(function(d){return function(h){return h>=d}})(n.level),a=0;a<o.length;a++){var s=o[a];if(s.type==="heading_open"&&i(Number(s.tag.substr(1)))){var c=n.getTokensText(o[a+1].children),l=s.attrGet("id");l=l==null?Kn(l=n.slugifyWithState?n.slugifyWithState(c,u):n.slugify(c),r,!1,n.uniqueSlugStartIndex):Kn(l,r,!0,n.uniqueSlugStartIndex),s.attrSet("id",l),n.tabIndex!==!1&&s.attrSet("tabindex",""+n.tabIndex),typeof n.permalink=="function"?n.permalink(l,n,u,a):(n.permalink||n.renderPermalink&&n.renderPermalink!==an)&&n.renderPermalink(l,n,u,a),a=o.indexOf(s),n.callback&&n.callback(s,{slug:l,title:c})}}})}Object.assign(Zn.defaults,{style:"visually-hidden",space:!0,placement:"after",wrapper:null}),X.permalink={__proto__:null,legacy:an,renderHref:Lu,renderAttrs:Mu,makePermalink:Se,linkInsideHeader:qe,ariaHidden:K,headerLink:Wu,linkAfterHeader:Zn},X.defaults={level:1,slugify:function(e){return encodeURIComponent(String(e).trim().toLowerCase().replace(/\s+/g,"-"))},uniqueSlugStartIndex:1,tabIndex:"-1",getTokensText:function(e){return e.filter(function(n){return["text","code_inline"].includes(n.type)}).map(function(n){return n.content}).join("")},permalink:!1,renderPermalink:an,permalinkClass:K.defaults.class,permalinkSpace:K.defaults.space,permalinkSymbol:"¶",permalinkBefore:K.defaults.placement==="before",permalinkHref:K.defaults.renderHref,permalinkAttrs:K.defaults.renderAttrs},X.default=X;const Nu="rtsp-doc-language",ae="overview.md",Ou=new Set(["zh","en"]),Fe={zh:[{group:"开始使用",items:[{title:"项目总览",path:"overview.md"},{title:"在线 Demo",path:"online-demo.md"},{title:"一键安装器",path:"installers.md"},{title:"排障指南",path:"troubleshooting.md"}]},{group:"集成方案",items:[{title:"Chrome 扩展方案",path:"chrome-extension.md"},{title:"Web 组件 Gateway 指引",path:"web-component-gateway.md"},{title:"通用组件方案",path:"universal-components.md"},{title:"桌面免插件",path:"desktop-native.md"},{title:"SDK API",path:"sdk-api.md"},{title:"多路与生命周期",path:"multi-stream-lifecycle.md"}]},{group:"协议与运维",items:[{title:"WebRTC / H.265",path:"webrtc-hevc.md"},{title:"小米摄像头",path:"xiaomi-rtsp.md"},{title:"安全模型",path:"security.md"},{title:"部署发布",path:"deployment.md"},{title:"验证记录",path:"validation.md"}]}],en:[{group:"Getting Started",items:[{title:"Overview",path:"overview.md"},{title:"Online Demo",path:"online-demo.md"},{title:"One-Click Installers",path:"installers.md"},{title:"Troubleshooting",path:"troubleshooting.md"}]},{group:"Integration",items:[{title:"Chrome Extension Runtime",path:"chrome-extension.md"},{title:"Gateway for Web Components",path:"web-component-gateway.md"},{title:"Universal Components",path:"universal-components.md"},{title:"Desktop Without Plugin",path:"desktop-native.md"},{title:"SDK API",path:"sdk-api.md"},{title:"Multi-Stream Lifecycle",path:"multi-stream-lifecycle.md"}]},{group:"Protocols and Ops",items:[{title:"WebRTC / H.265",path:"webrtc-hevc.md"},{title:"Xiaomi via micam",path:"xiaomi-rtsp.md"},{title:"Security Model",path:"security.md"},{title:"Deployment",path:"deployment.md"},{title:"Validation Log",path:"validation.md"}]}]},Jn={zh:{"nav.schemes":"方案","nav.demo":"Demo","nav.sdk":"SDK","nav.docs":"文档","nav.validation":"验证","nav.install":"安装","docs.eyebrow":"Docs","docs.title":"文档","docs.intro":"所有项目文档都可以在这里沉浸式阅读，左侧切换目录，右侧渲染 Markdown 内容。","docs.loading":"正在加载文档…","docs.errorTitle":"文档加载失败","install.detecting":"检测中","install.waitExtension":"等待扩展响应","install.pending":"待检测","install.notFound":"未检测到","install.waitInstall":"等待安装","install.notAllowed":"未授权当前站点","install.allowed":"已授权","install.ok":"正常","installer.mac.label":"macOS 安装器","installer.windows.label":"Windows 安装器","installer.linux.label":"Linux 安装器","installer.mac.copy":"下载 DMG，打开 RTSP Installer.app，按提示完成安装。","installer.windows.copy":"下载 ZIP，解压后打开 RTSP Installer.hta，按提示完成安装。","installer.linux.copy":"下载压缩包，解压后打开 RTSP Installer.desktop 或运行 install-gui.sh。","installer.download":"下载","live.placeholderTitle":"等待真实 RTSP 输入","live.placeholderCopy":"安装 runtime 后，这里会挂载扩展播放器 iframe。","live.stopped":"真实播放已停止。","live.ready":"真实 RTSP 播放器已就绪。","live.recovering":"播放中断，正在自动恢复","live.recovered":"播放已自动恢复。","live.needExtension":"请输入 Chrome 扩展 ID。","live.needUrl":"请输入 rtsp:// 开头的 RTSP URL。","live.waiting":"正在请求 Chrome 扩展播放器。若画面未出现，请检查扩展 ID、origin 授权和 Native Host。","live.timeout":"仍在等待扩展响应。请确认扩展已安装，并已授权当前站点 origin。","live.installReady":"扩展、Native Runtime 和当前站点授权均已就绪。"},en:{"nav.schemes":"Solutions","nav.demo":"Demo","nav.sdk":"SDK","nav.docs":"Docs","nav.validation":"Validation","nav.install":"Install","docs.eyebrow":"Docs","docs.title":"Documentation","docs.intro":"Read the complete project documentation here. Use the sidebar to switch topics; Markdown is rendered as an immersive page.","docs.loading":"Loading documentation...","docs.errorTitle":"Documentation failed to load","install.detecting":"Checking","install.waitExtension":"Waiting for extension","install.pending":"Not checked","install.notFound":"Not detected","install.waitInstall":"Waiting for install","install.notAllowed":"Current site not allowed","install.allowed":"Allowed","install.ok":"OK","installer.mac.label":"macOS Installer","installer.windows.label":"Windows Installer","installer.linux.label":"Linux Installer","installer.mac.copy":"Download the DMG, open RTSP Installer.app, and follow the prompts.","installer.windows.copy":"Download the ZIP, unzip it, open RTSP Installer.hta, and follow the prompts.","installer.linux.copy":"Download the archive, then open RTSP Installer.desktop or run install-gui.sh.","installer.download":"Download","live.placeholderTitle":"Waiting for an RTSP URL","live.placeholderCopy":"After the runtime is installed, the extension player iframe appears here.","live.stopped":"Real playback stopped.","live.ready":"Real RTSP player is ready.","live.recovering":"Playback interrupted. Recovering","live.recovered":"Playback recovered.","live.needExtension":"Enter the Chrome extension ID.","live.needUrl":"Enter an RTSP URL that starts with rtsp://.","live.waiting":"Requesting the Chrome extension player. If no video appears, check the extension ID, origin allowlist, and Native Host.","live.timeout":"Still waiting for the extension. Confirm it is installed and this site origin is allowed.","live.installReady":"Extension, Native Runtime, and current site origin are ready."}};let B=Ji(),se=qu(B);const zi=Object.assign({"../../docs/articles/rtsp-player-latest-wechat.md":Qu,"../../docs/articles/rtsp-player-wechat.md":et,"../../docs/chrome-extension.md":nt,"../../docs/deployment.md":ut,"../../docs/desktop-native.md":tt,"../../docs/en/chrome-extension.md":rt,"../../docs/en/deployment.md":ot,"../../docs/en/desktop-native.md":it,"../../docs/en/installers.md":at,"../../docs/en/multi-stream-lifecycle.md":st,"../../docs/en/online-demo.md":ct,"../../docs/en/overview.md":lt,"../../docs/en/sdk-api.md":dt,"../../docs/en/security.md":ft,"../../docs/en/troubleshooting.md":pt,"../../docs/en/universal-components.md":ht,"../../docs/en/validation.md":bt,"../../docs/en/web-component-gateway.md":mt,"../../docs/en/webrtc-hevc.md":gt,"../../docs/en/xiaomi-rtsp.md":xt,"../../docs/installers.md":_t,"../../docs/multi-stream-lifecycle.md":yt,"../../docs/online-demo.md":kt,"../../docs/overview.md":Ct,"../../docs/sdk-api.md":wt,"../../docs/security.md":vt,"../../docs/troubleshooting.md":St,"../../docs/universal-components.md":Tt,"../../docs/validation.md":Dt,"../../docs/web-component-gateway.md":Rt,"../../docs/webrtc-hevc.md":Et,"../../docs/xiaomi-rtsp.md":At}),Bi=Object.assign({"../../docs/assets/contact.jpg":Pt,"../../docs/assets/donate-alipay.jpg":Ft,"../../docs/assets/donate-wx.jpg":It,"../../docs/assets/mp.png":Lt,"../../docs/assets/public-rtsp-e2e.png":Mt,"../../docs/assets/rtsp-player-latest-architecture.png":Wt,"../../docs/assets/rtsp-player-latest-architecture.svg":Nt,"../../docs/assets/rtsp-player-latest-cover-bg.png":Ot,"../../docs/assets/rtsp-player-latest-cover.png":Ht,"../../docs/assets/rtsp-player-wechat-cover.png":zt}),qi=new Map(Object.entries(zi).map(([e,n])=>[Ge(e.replace(/^.*\/docs\//,"")),n])),Gi=new Map(Object.entries(Bi).map(([e,n])=>[`/docs/assets/${e.split("/").pop()}`,n])),ee=new P({html:!1,linkify:!0,typographer:!0}).use(X,{slugify:ua,permalink:X.permalink.linkInsideHeader({symbol:"#",placement:"after",class:"docs-anchor",ariaHidden:!0})}),ji=ee.renderer.rules.link_open||((e,n,u,t,r)=>r.renderToken(e,n,u)),Ui=ee.renderer.rules.image||((e,n,u,t,r)=>r.renderToken(e,n,u));ee.renderer.rules.link_open=(e,n,u,t,r)=>{const o=e[n],i=o.attrGet("href");if(i){const a=na(i,t.currentPath||"overview.md");o.attrSet("href",a),/^https?:\/\//i.test(a)&&(o.attrSet("target","_blank"),o.attrSet("rel","noreferrer"))}return ji(e,n,u,t,r)};ee.renderer.rules.image=(e,n,u,t,r)=>{const o=e[n],i=o.attrGet("src");return i&&o.attrSet("src",$u(i,t.currentPath||"overview.md")),o.attrSet("loading","lazy"),o.attrSet("decoding","async"),Ui(e,n,u,t,r)};ee.renderer.rules.table_open=()=>'<div class="docs-table-wrap"><table>';ee.renderer.rules.table_close=()=>"</table></div>";const Xn=Array.from(document.querySelectorAll("[data-tab]")),Vi=Array.from(document.querySelectorAll("[data-panel]"));for(const e of Xn)e.addEventListener("click",()=>{const n=e.dataset.tab;for(const u of Xn)u.classList.toggle("active",u===e);for(const u of Vi)u.classList.toggle("active",u.dataset.panel===n)});const $i=Array.from(document.querySelectorAll("main section[id]")),Yn=new Map(Array.from(document.querySelectorAll(".primary-nav a[href^='#']")).map(e=>[e.getAttribute("href").slice(1),e])),Zi=new IntersectionObserver(e=>{const n=e.filter(u=>u.isIntersecting).sort((u,t)=>t.intersectionRatio-u.intersectionRatio)[0];if(n){for(const u of Yn.values())u.removeAttribute("aria-current");Yn.get(n.target.id)?.setAttribute("aria-current","page")}},{rootMargin:"-20% 0px -60% 0px",threshold:[.1,.4,.7]});for(const e of $i)Zi.observe(e);const _e=document.querySelector("#docs-nav"),te=document.querySelector("#docs-content"),Hu=Array.from(document.querySelectorAll("[data-lang-switch]"));let Re="";ju();Uu();for(const e of Hu)e.addEventListener("click",()=>{Gu(e.dataset.langSwitch,{scroll:!1}),kn(),D||Zu()});_e&&te&&(zu(),window.addEventListener("hashchange",()=>{location.hash.startsWith("#docs")&&ye(Qn(),{scroll:!1})}),ye(Qn(),{scroll:!1}));function zu(){_e.innerHTML="";for(const e of Fe[B]||Fe.zh){const n=document.createElement("section");n.className="docs-nav-group";const u=document.createElement("h3");u.textContent=e.group,n.appendChild(u);for(const t of e.items){const r=document.createElement("button");r.type="button",r.dataset.docPath=t.path,r.textContent=t.title,r.addEventListener("click",()=>{history.replaceState(null,"",`#docs/${t.path}`),ye(t.path,{scroll:!0})}),n.appendChild(r)}_e.appendChild(n)}}function Qn(){const e=decodeURIComponent(location.hash||"").match(/^#docs\/(.+)$/),n=Xi(e?.[1]||ae);return n.lang&&n.lang!==B&&Gu(n.lang,{reloadDoc:!1}),se.has(n.path)?n.path:ae}async function ye(e,{scroll:n=!1}={}){e=ke(e),se.has(e)||(e=ae),Re=e,Bu(e),te.innerHTML=`<div class="docs-loading">${pe(w("docs.loading"))}</div>`;try{const u=Yi(e),t=qi.get(u)??await Qi(u);te.innerHTML=ea(t,u),Ki(u),n&&document.querySelector("#docs")?.scrollIntoView({block:"start"})}catch(u){te.innerHTML=`
      <div class="docs-error">
        <h2>${pe(w("docs.errorTitle"))}</h2>
        <p>${pe(u?.message||String(u))}</p>
      </div>
    `}}function Bu(e){_e.querySelectorAll("button[data-doc-path]").forEach(n=>{n.classList.toggle("active",n.dataset.docPath===e)})}function Ki(e){te.querySelectorAll("a[href]").forEach(n=>{const u=n.getAttribute("href")||"",t=Vu(u,e);!t||!se.has(t)||n.addEventListener("click",r=>{r.preventDefault(),history.replaceState(null,"",`#docs/${t}`),ye(t,{scroll:!0})})})}function qu(e){const n=Fe[e]||Fe.zh;return new Map(n.flatMap(u=>u.items.map(t=>[t.path,t])))}function w(e){return Jn[B]?.[e]||Jn.zh[e]||e}function Ji(){const e=decodeURIComponent(location.hash||"").match(/^#docs\/(.+)$/)?.[1]||"",n=Ge(e).match(/^(zh|en)\//)?.[1],u=new URLSearchParams(location.search).get("lang"),t=localStorage.getItem(Nu),r=navigator.language?.toLowerCase().startsWith("zh")?"zh":"en";return[n,u,t,r].find(o=>Ou.has(o))||"zh"}function Gu(e,{reloadDoc:n=!0,scroll:u=!1}={}){if(Ou.has(e)&&(B=e,localStorage.setItem(Nu,e),document.documentElement.lang=e==="zh"?"zh-CN":"en",se=qu(e),ju(),Uu(),_e&&(zu(),Bu(Re)),n&&te)){const t=se.has(Re)?Re:ae;location.hash.startsWith("#docs")&&history.replaceState(null,"",`#docs/${t}`),ye(t,{scroll:u})}}function ju(){document.documentElement.lang=B==="zh"?"zh-CN":"en",document.querySelectorAll("[data-i18n]").forEach(e=>{e.textContent=w(e.dataset.i18n)})}function Uu(){for(const e of Hu){const n=e.dataset.langSwitch===B;e.classList.toggle("active",n),e.setAttribute("aria-pressed",String(n))}}function Xi(e){const n=Ge(e),u=n.match(/^(zh|en)\/(.+)$/);return{lang:u?.[1]||"",path:ke(u?.[2]||n||ae)}}function Yi(e){const n=ke(e||ae);return B==="en"?`en/${n}`:n}function Ge(e){return String(e||"").replace(/^\/?docs\//,"").replace(/^\.\//,"").replace(/\/+/g,"/")}function ke(e){return Ge(e).replace(/^(zh|en)\//,"")}function Vu(e,n){if(!e||e.startsWith("#")||/^https?:\/\//i.test(e))return"";const u=e.split("#")[0].split("?")[0];if(!u.endsWith(".md"))return"";if(u.startsWith("/docs/"))return ke(u);const t=n.split("/").slice(0,-1);for(const r of u.split("/"))!r||r==="."||(r===".."?t.pop():t.push(r));return ke(t.join("/"))}async function Qi(e){const n=await fetch(`/docs/${e}`);if(!n.ok)throw new Error(`HTTP ${n.status}`);const u=await n.text();if(/^\s*(<!doctype html|<html\b)/i.test(u))throw new Error("Markdown document endpoint returned HTML fallback.");return u}function ea(e,n){const u=e.replace(/^---[\s\S]*?---\s*/,"").replace(/\r\n/g,`
`);return`<div class="docs-markdown">${ee.render(u,{currentPath:n})}</div>`}function $u(e,n){if(/^(https?:)?\/\//i.test(e)||e.startsWith("data:"))return e;const u=`/docs/${n}`.split("/").slice(0,-1);for(const r of e.split("/"))!r||r==="."||(r===".."?u.pop():u.push(r));const t=u.join("/");return Gi.get(t)||t}function na(e,n){const u=Vu(e,n);return u&&se.has(u)?`#docs/${u}`:/^(https?:)?\/\//i.test(e)||e.startsWith("#")||e.startsWith("/")?e:$u(e,n)}function ua(e){return e.toLowerCase().replace(/<[^>]+>/g,"").replace(/[^\p{Letter}\p{Number}]+/gu,"-").replace(/^-+|-+$/g,"")||"section"}function pe(e){return String(e).replace(/[&<>"']/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[n])}const j=document.querySelector("#demo-canvas"),en=document.querySelector("#demo-toggle"),ta=document.querySelector("#demo-state"),ra=document.querySelector("#demo-fps"),oa=document.querySelector("#demo-latency"),ia=document.querySelector("#demo-queue"),aa=document.querySelector("#demo-dropped");if(j){const e=j.getContext("2d",{alpha:!1});let n=!0,u=0,t=performance.now(),r=60,o=0,i=0,a=0;const s=()=>{const d=j.getBoundingClientRect(),h=Math.min(window.devicePixelRatio||1,2),p=Math.max(320,Math.round(d.width*h)),f=Math.max(180,Math.round(d.height*h));return(j.width!==p||j.height!==f)&&(j.width=p,j.height=f),e.setTransform(h,0,0,h,0,0),{width:p/h,height:f/h,ratio:h}},c=(d,h,p)=>{e.strokeStyle="rgba(143, 184, 216, .12)",e.lineWidth=1;const f=p/30%48;for(let m=-48+f;m<d+48;m+=48)e.beginPath(),e.moveTo(m,0),e.lineTo(m,h),e.stroke();for(let m=-48+f;m<h+48;m+=48)e.beginPath(),e.moveTo(0,m),e.lineTo(d,m),e.stroke()},l=d=>{a||(a=d),n&&(i+=d-a),a=d;const h=i,{width:p,height:f}=s(),m=h/1400%1,g=e.createLinearGradient(0,0,p,f);g.addColorStop(0,"#07110f"),g.addColorStop(.55,"#111716"),g.addColorStop(1,"#1b1d19"),e.fillStyle=g,e.fillRect(0,0,p,f),c(p,f,h),e.fillStyle="rgba(154, 210, 157, .10)",e.fillRect(0,f*m,p,3);const C=f*.66;e.fillStyle="rgba(244, 245, 242, .08)",e.fillRect(0,C,p,f*.18),e.fillStyle="rgba(228, 198, 122, .55)";for(let y=0;y<12;y+=1){const k=(h/9+y*120)%(p+140)-100;e.fillRect(k,C+f*.08,62,3)}const _=h/16%(p+260)-180;e.fillStyle="#8fb8d8",e.fillRect(_,C-28,92,26),e.fillStyle="#dfe8dd",e.fillRect(_+18,C-42,38,16),e.fillStyle="#050706",e.beginPath(),e.arc(_+22,C,7,0,Math.PI*2),e.arc(_+72,C,7,0,Math.PI*2),e.fill();const b=p*.76+Math.sin(h/700)*32,x=f*.46;if(e.strokeStyle="#e4c67a",e.lineWidth=5,e.beginPath(),e.arc(b,x-18,9,0,Math.PI*2),e.moveTo(b,x-8),e.lineTo(b,x+24),e.moveTo(b-18,x+3),e.lineTo(b+18,x+3),e.moveTo(b,x+24),e.lineTo(b-16,x+52),e.moveTo(b,x+24),e.lineTo(b+16,x+52),e.stroke(),e.strokeStyle="rgba(154, 210, 157, .9)",e.lineWidth=2,e.strokeRect(b-38,x-42,76,112),e.fillStyle="rgba(154, 210, 157, .15)",e.fillRect(b-38,x-42,76,18),e.fillStyle="rgba(5, 7, 6, .78)",e.fillRect(14,14,260,82),e.fillStyle="#f4f5f2",e.font="700 18px system-ui, sans-serif",e.fillText("RTSP Online Demo",28,44),e.font="13px system-ui, sans-serif",e.fillStyle="#b6bbb4",e.fillText(new Date().toLocaleTimeString(B==="zh"?"zh-CN":"en-US",{hour12:!1}),28,70),e.fillText("Simulated low-latency preview",112,70),n){u+=1;const y=d-t;if(y>=500){r=Math.round(u*1e3/y),u=0,t=d;const k=42+Math.round(Math.abs(Math.sin(h/900))*18),S=Math.round(Math.abs(Math.sin(h/1300))*1);Math.sin(h/2800)>.995&&(o+=1),ra.textContent=String(r),oa.textContent=`${k}ms`,ia.textContent=String(S),aa.textContent=String(o)}}requestAnimationFrame(l)};en?.addEventListener("click",()=>{n=!n,en.textContent=n?"Pause":"Play",en.setAttribute("aria-pressed",String(n)),ta.textContent=n?"Live Preview":"Paused"}),new ResizeObserver(s).observe(j),requestAnimationFrame(l)}const sa=document.querySelector("#live-demo-form"),ca=document.querySelector("#live-stop"),Ie=document.querySelector("#live-player-mount"),nn=document.querySelector("#live-demo-status"),Y=document.querySelector("#live-extension-id"),Le=document.querySelector("#live-rtsp-url");let D=null,fe=0;const la="giegomfhcmgebjhdiihnjohoinkbcjbh",eu="rtsp://9627b0bf2a7b.entrypoint.cloud.wowza.com:1935/app-p5260J38/66abe4b9_stream1",da=new Set(["rtsp://127.0.0.1:8554/local","rtsp://192.168.28.62:8554/local"]),fa={mac:"/downloads/rtsp-macos-installer.dmg",windows:"/downloads/rtsp-windows-installer.zip",linux:"/downloads/rtsp-linux-installer.tar.gz"},Q=document.querySelector("#install-dialog"),pa=[document.querySelector("#open-install-assistant"),document.querySelector("#hero-install-assistant")].filter(Boolean),ha=Array.from(document.querySelectorAll("[data-install-close]")),ba=document.querySelector("#recheck-install-status"),Me=document.querySelector("#install-extension-status"),_n=document.querySelector("#install-native-status"),yn=document.querySelector("#install-origin-status"),un=document.querySelector("#recommended-installer"),nu=document.querySelector("#installer-recommend-title"),uu=document.querySelector("#installer-recommend-copy"),tu=document.querySelector("#installer-list");let We=!1,sn=0;function M(e,n="neutral"){nn&&(nn.textContent=e,nn.dataset.tone=n)}function ma(e,n){localStorage.setItem("rtsp-demo-extension-id",e),localStorage.setItem("rtsp-demo-url",n)}function ga(){if(Y&&(Y.value=localStorage.getItem("rtsp-demo-extension-id")||la),Le){const e=(localStorage.getItem("rtsp-demo-url")||"").trim(),n=da.has(e)?eu:e||eu;e&&e!==n&&localStorage.setItem("rtsp-demo-url",n),Le.value=n}}function Zu(){Ie&&(Ie.innerHTML=`
    <div class="mount-placeholder">
      <strong>${pe(w("live.placeholderTitle"))}</strong>
      <span>${pe(w("live.placeholderCopy"))}</span>
    </div>
  `)}function xa(){window.clearTimeout(fe),D?.stop&&D.stop(),D=null,Zu(),M(w("live.stopped"),"neutral")}function _a(){const e=`${navigator.userAgentData?.platform||""} ${navigator.platform||""} ${navigator.userAgent||""}`.toLowerCase();return e.includes("win")?"windows":e.includes("mac")?"mac":e.includes("linux")||e.includes("x11")?"linux":"mac"}function kn(){if(!un||!nu||!uu)return;const e=_a(),n={mac:w("installer.mac.label"),windows:w("installer.windows.label"),linux:w("installer.linux.label")},u={mac:w("installer.mac.copy"),windows:w("installer.windows.copy"),linux:w("installer.linux.copy")};un.href=fa[e],un.textContent=`${w("installer.download")} ${n[e]}`,nu.textContent=n[e],uu.textContent=u[e],tu&&tu.querySelectorAll("[data-installer-platform]").forEach(t=>{t.hidden=t.dataset.installerPlatform!==e})}function O(e,n,u){e&&(e.textContent=n,e.style.color=u?"var(--green)":"var(--amber)")}function Cn(){kn();const e=Q?.classList.contains("open");Q?.classList.add("open"),Q?.setAttribute("aria-hidden","false"),document.body.style.overflow="hidden",e||wn()}function Ku(){Q?.classList.remove("open"),Q?.setAttribute("aria-hidden","true"),document.body.style.overflow="",sessionStorage.setItem("rtsp-install-assistant-dismissed","1")}function wn(){We=!1,O(Me,w("install.detecting"),!1),window.clearTimeout(sn),sn=window.setTimeout(()=>{We||(O(Me,w("install.notFound"),!1),O(_n,w("install.waitInstall"),!1),O(yn,w("install.waitInstall"),!1))},1200),window.postMessage({type:"RTSP_INSTALL_STATUS_REQUEST"},location.origin)}function ya(e){We=!0,window.clearTimeout(sn);const n=!!(e.installed&&e.extensionId),u=!!e.nativeOk,t=!!e.originAllowed;O(Me,n?`${B==="zh"?"已安装":"Installed"} ${e.extensionId}`:w("install.notFound"),n),O(_n,u?`${w("install.ok")} ${e.nativePort||""}`:e.nativeError||w("install.notFound"),u),O(yn,w(t?"install.allowed":"install.notAllowed"),t),n&&Y&&!Y.value&&(Y.value=e.extensionId,localStorage.setItem("rtsp-demo-extension-id",e.extensionId)),!n||!u||!t?sessionStorage.getItem("rtsp-install-assistant-dismissed")||Cn():Q?.classList.contains("open")&&M(w("live.installReady"),"ok")}for(const e of pa)e.addEventListener("click",Cn);for(const e of ha)e.addEventListener("click",Ku);ba?.addEventListener("click",()=>{wn()});window.addEventListener("keydown",e=>{e.key==="Escape"&&Q?.classList.contains("open")&&Ku()});window.addEventListener("message",e=>{if(e.source!==window||e.origin!==location.origin)return;const n=e.data||{};n.source!=="rtsp-web-player-extension"||n.type!=="RTSP_EXTENSION_STATUS"||ya(n)});ga();kn();window.setTimeout(()=>{wn(),window.setTimeout(()=>{!We&&!sessionStorage.getItem("rtsp-install-assistant-dismissed")&&(O(Me,w("install.notFound"),!1),O(_n,w("install.waitInstall"),!1),O(yn,w("install.waitInstall"),!1),Cn())},1100)},400);sa?.addEventListener("submit",e=>{e.preventDefault();const n=Y?.value.trim()||"",u=Le?.value.trim()||"";if(!n){M(w("live.needExtension"),"error"),Y?.focus();return}if(!u||!u.startsWith("rtsp://")){M(w("live.needUrl"),"error"),Le?.focus();return}ma(n,u),Kt("rtsp-live-player",{extensionId:n}),Ie.innerHTML="",D=document.createElement("rtsp-live-player"),D.setAttribute("extension-id",n),D.setAttribute("url",u),D.setAttribute("autoplay",""),D.setAttribute("controls",""),D.setAttribute("transport","auto"),D.setAttribute("codec","auto"),D.setAttribute("width","100%"),D.setAttribute("height","360"),D.addEventListener("ready",()=>{window.clearTimeout(fe),M(w("live.ready"),"ok")}),D.addEventListener("recovering",t=>{const r=t.detail?.attempt||1,o=t.detail?.maxAttempts||6;M(`${w("live.recovering")} (${r}/${o})...`,"error")}),D.addEventListener("recovered",()=>{M(w("live.recovered"),"ok")}),D.addEventListener("error",t=>{window.clearTimeout(fe);const r=t.detail?.error||"播放器返回错误，请检查 RTSP 地址、鉴权和 H.264 编码。";M(r,"error")}),Ie.appendChild(D),M(w("live.waiting")),window.clearTimeout(fe),fe=window.setTimeout(()=>{M(w("live.timeout"),"error")},5e3)});ca?.addEventListener("click",xa);
