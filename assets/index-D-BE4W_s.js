(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))u(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&u(i)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function u(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();const Qt=`---
...
`,iu=`# Electron / Tauri Desktop Native
...
`,Iu="/assets/contact-CNdl1USL.jpg",Lu="/assets/donate-alipay-BSmrWLPt.jpg",Wu="/assets/donate-wx-Dn3cqFoe.jpg",Mu="/assets/mp-CqDGcv-x.png",Ou="/assets/public-rtsp-e2e-SF2azekD.png",Nu="/assets/rtsp-player-latest-architecture-DXNX5NGC.png",Hu="/assets/rtsp-player-latest-architecture-DHNnpsnF.svg",zu="/assets/rtsp-player-latest-cover-bg-DdSb4E2y.png",Bu="/assets/rtsp-player-latest-cover-B7Gc5T4f.png",qu="/assets/rtsp-player-wechat-cover-BddK3DxA.png",un="rtsp-player",Gu="640px",Uu="360px",Y={extensionId:"",tagName:un,runtime:"extension"},je=new WeakMap,Ve=6,ju=700,Vu=8e3,$u=45e3,Ku=3e3,Zu=9e3;function Yu(){return typeof document>"u"?"":document.currentScript?.dataset?.extensionId||""}function cn(e){return String(e||"").trim().replace(/^chrome-extension:\/\//,"").replace(/\/.*$/,"")}function Xu(e){const n=cn(e);return n?`chrome-extension://${n}`:""}function vn(e,n){if(e==null||e==="")return n;const t=String(e);return/^\d+$/.test(t)?`${t}px`:t}function rt(e){const n=String(e||"").trim().toLowerCase();return n==="desktop"||n==="auto"||n==="extension"?n:"extension"}function Ju(e){const n=String(e).trim().toLowerCase();return n==="webrtc"||n==="ws-annexb"||n==="auto"?n:"auto"}function ot(e){const n=String(e||"").trim().toLowerCase();return n==="h265"||n==="hevc"?"h265":n==="h264"||n==="avc"?"h264":"auto"}function de(){return typeof window>"u"?null:window.rtspNative||window.__RTSP_DESKTOP__||null}function it(){return!!de()?.startStream}function L(e,n,t={}){e.dispatchEvent(new CustomEvent(n,{detail:t,bubbles:!0,composed:!0}))}function Qu(e={}){return e.extensionId!==void 0&&(Y.extensionId=cn(e.extensionId)),e.tagName&&(Y.tagName=String(e.tagName)),e.runtime&&(Y.runtime=rt(e.runtime)),{...Y}}async function Tn(e="auto"){const n=ot(e),t={desktopRuntime:it(),webcodecs:"VideoDecoder"in globalThis,webrtc:"RTCPeerConnection"in globalThis,h264WebRTC:!1,h265WebRTC:!1,h264WebCodecs:!1,h265WebCodecs:!1};try{const r=(globalThis.RTCRtpReceiver?.getCapabilities?.("video")?.codecs||[]).map(o=>String(o.mimeType||"").toLowerCase());t.h264WebRTC=r.includes("video/h264"),t.h265WebRTC=r.includes("video/h265")||r.includes("video/hevc")}catch{}if(t.webcodecs){try{t.h264WebCodecs=!!(await VideoDecoder.isConfigSupported({codec:"avc1.42E01E",hardwareAcceleration:"prefer-hardware",optimizeForLatency:!0})).supported}catch{}try{t.h265WebCodecs=!!(await VideoDecoder.isConfigSupported({codec:"hvc1.1.6.L93.B0",hardwareAcceleration:"prefer-hardware",optimizeForLatency:!0})).supported}catch{}}return t.requestedCodec=n,t}function er(e=Y.tagName||un,n={}){if(typeof window>"u"||typeof customElements>"u")return;Qu(n);const t=String(e||un),u=customElements.get(t);if(u)return u;class r extends HTMLElement{static get observedAttributes(){return["url","src","width","height","autoplay","controls","muted","transport","media-transport","rtsp-transport","codec","runtime","extension-id"]}constructor(){super(),this._iframe=null,this._loaded=!1,this._player=null,this._pc=null,this._video=null,this._mode="",this._streamId="",this._streamToken="",this._playGeneration=0,this._recoveryAttempts=0,this._recoveryTimer=0,this._userStopped=!1,this.attachShadow({mode:"open"})}connectedCallback(){this._render()}disconnectedCallback(){this.stop(),this._iframe?.contentWindow&&je.delete(this._iframe.contentWindow)}attributeChangedCallback(i){if(i==="runtime"||i==="extension-id"){this.stop(),this._iframe=null,this._loaded=!1,this.shadowRoot&&(this.shadowRoot.innerHTML=""),this._render();return}this._resize(),this._mode==="extension"?this._sendInit():this.hasAttribute("autoplay")&&(i==="url"||i==="src")&&this.play()}play(i){i&&this.setAttribute("url",i),this._mode==="extension"?this._sendInit():this._startDesktop()}stop(){this._userStopped=!0,this._playGeneration+=1,this._clearRecoveryTimer(),this._recoveryAttempts=0;const i=this._streamId;if(this._streamId="",this._streamToken="",this._iframe?.contentWindow&&this._iframe.contentWindow.postMessage({type:"RTSP_PLAYER_STOP"},this._origin()),this._player&&(this._player.close(),this._player=null),this._pc){try{this._pc.close()}catch{}this._pc=null}if(this._video){try{this._video.srcObject=null}catch{}this._video.remove(),this._video=null}const a=de();i&&a?.stopStream&&a.stopStream({streamId:i}).catch?.(()=>{})}async capabilities(){return Tn(this._codec())}_runtime(){const i=rt(this.getAttribute("runtime")||Y.runtime);return i==="auto"?it()?"desktop":"extension":i}_extensionId(){return cn(this.getAttribute("extension-id")||Y.extensionId||window.RTSP_EXTENSION_ID||window.RTSP_WEB_PLAYER_EXTENSION_ID||Yu())}_origin(){return Xu(this._extensionId())}_url(){return this.getAttribute("url")||this.getAttribute("src")||""}_rtspTransport(){const i=this.getAttribute("rtsp-transport"),a=this.getAttribute("transport");return i||(a==="tcp"||a==="udp"?a:"tcp")}_mediaTransport(){return Ju(this.getAttribute("media-transport")||this.getAttribute("transport")||"auto")}_codec(){return ot(this.getAttribute("codec")||"auto")}_render(){if(!this.shadowRoot||this.shadowRoot.innerHTML)return;this._resize(),this._runtime()==="desktop"?this._renderDesktop():this._renderExtension()}_renderExtension(){this._mode="extension",this.shadowRoot.innerHTML=`
      ...
      `;const i=this.shadowRoot.querySelector(".rtsp-host"),a=this._origin();if(!a){i.innerHTML=this._gatewayGuideHTML("需要安装 RTSP Gateway","普通网页不能直接访问 rtsp://。请先安装 RTSP Gateway 与 Chrome 扩展，或在 Electron/Tauri 中使用 desktop runtime bridge。");return}const s=document.createElement("iframe");s.src=`${a}/player/player.html`,s.allow="autoplay; fullscreen",s.referrerPolicy="no-referrer",s.addEventListener("load",()=>{this._loaded=!0,je.set(s.contentWindow,this),this._sendInit()}),i.appendChild(s),this._iframe=s}_renderDesktop(){this._mode="desktop",this.shadowRoot.innerHTML=`
        <style>
          :host{display:inline-block;background:#050505;min-width:160px;min-height:90px;contain:content;}
          .rtsp-host{width:100%;height:100%;background:#050505;position:relative;overflow:hidden;border-radius:6px;}
...
`),o+=(r.nesting===-1?"</":"<")+r.tag,o+=this.renderAttrs(r),r.nesting===0&&u.xhtmlOut&&(o+=" /");let i=!1;if(r.block&&(i=!0,r.nesting===1&&t+1<n.length)){const a=n[t+1];(a.type==="inline"||a.hidden||a.nesting===-1&&a.tag===r.tag)&&(i=!1)}return o+=i?`>
`:">",o};ce.prototype.renderInline=function(e,n,t){let u="";const r=this.rules;for(let o=0,i=e.length;o<i;o++){const a=e[o].type;typeof r[a]<"u"?u+=r[a](e,o,n,t,this):u+=this.renderToken(e,o,n)}return u};ce.prototype.renderInlineAsText=function(e,n,t){let u="";for(let r=0,o=e.length;r<o;r++)switch(e[r].type){case"text":u+=e[r].content;break;case"image":u+=this.renderInlineAsText(e[r].children,n,t);break;case"html_inline":case"html_block":u+=e[r].content;break;case"softbreak":case"hardbreak":u+=`
`;break}return u};ce.prototype.render=function(e,n,t){let u="";const r=this.rules;for(let o=0,i=e.length;o<i;o++){const a=e[o].type;a==="inline"?u+=this.renderInline(e[o].children,n,t):typeof r[a]<"u"?u+=r[a](e,o,n,t,this):u+=this.renderToken(e,o,n,t)}return u};function E(){this.__rules__=[],this.__cache__=null}E.prototype.__find__=function(e){for(let n=0;n<this.__rules__.length;n++)if(this.__rules__[n].name===e)return n;return-1};E.prototype.__compile__=function(){const e=this,n=[""];e.__rules__.forEach(function(t){t.enabled&&t.alt.forEach(function(u){n.indexOf(u)<0&&n.push(u)})}),e.__cache__={},n.forEach(function(t){e.__cache__[t]=[],e.__rules__.forEach(function(u){u.enabled&&(t&&u.alt.indexOf(t)<0||e.__cache__[t].push(u.fn))})})};E.prototype.at=function(e,n,t){const u=this.__find__(e),r=t||{};if(u===-1)throw new Error("Parser rule not found: "+e);this.__rules__[u].fn=n,this.__rules__[u].alt=r.alt||[],this.__cache__=null};E.prototype.before=function(e,n,t,u){const r=this.__find__(e),o=u||{};if(r===-1)throw new Error("Parser rule not found: "+e);this.__rules__.splice(r,0,{name:n,enabled:!0,fn:t,alt:o.alt||[]}),this.__cache__=null};E.prototype.after=function(e,n,t,u){const r=this.__find__(e),o=u||{};if(r===-1)throw new Error("Parser rule not found: "+e);this.__rules__.splice(r+1,0,{name:n,enabled:!0,fn:t,alt:o.alt||[]}),this.__cache__=null};E.prototype.push=function(e,n,t){const u=t||{};this.__rules__.push({name:e,enabled:!0,fn:n,alt:u.alt||[]}),this.__cache__=null};E.prototype.enable=function(e,n){Array.isArray(e)||(e=[e]);const t=[];return e.forEach(function(u){const r=this.__find__(u);if(r<0){if(n)return;throw new Error("Rules manager: invalid rule name "+u)}this.__rules__[r].enabled=!0,t.push(u)},this),this.__cache__=null,t};E.prototype.enableOnly=function(e,n){Array.isArray(e)||(e=[e]),this.__rules__.forEach(function(t){t.enabled=!1}),this.enable(e,n)};E.prototype.disable=function(e,n){Array.isArray(e)||(e=[e]);const t=[];return e.forEach(function(u){const r=this.__find__(u);if(r<0){if(n)return;throw new Error("Rules manager: invalid rule name "+u)}this.__rules__[r].enabled=!1,t.push(u)},this),this.__cache__=null,t};E.prototype.getRules=function(e){return this.__cache__===null&&this.__compile__(),this.__cache__[e]||[]};function I(e,n,t){this.type=e,this.tag=n,this.attrs=null,this.map=null,this.nesting=t,this.level=0,this.children=null,this.content="",this.markup="",this.info="",this.meta=null,this.block=!1,this.hidden=!1}I.prototype.attrIndex=function(n){if(!this.attrs)return-1;const t=this.attrs;for(let u=0,r=t.length;u<r;u++)if(t[u][0]===n)return u;return-1};I.prototype.attrPush=function(n){this.attrs?this.attrs.push(n):this.attrs=[n]};I.prototype.attrSet=function(n,t){const u=this.attrIndex(n),r=[n,t];u<0?this.attrPush(r):this.attrs[u]=r};I.prototype.attrGet=function(n){const t=this.attrIndex(n);let u=null;return t>=0&&(u=this.attrs[t][1]),u};I.prototype.attrJoin=function(n,t){const u=this.attrIndex(n);u<0?this.attrPush([n,t]):this.attrs[u][1]=this.attrs[u][1]+" "+t};function bt(e,n,t){this.src=e,this.env=t,this.tokens=[],this.inlineMode=!1,this.md=n}bt.prototype.Token=I;const Yr=/\r\n?|\n/g,Xr=/\0/g;function Jr(e){let n;n=e.src.replace(Yr,`
`),n=n.replace(Xr,"�"),e.src=n}function Qr(e){let n;e.inlineMode?(n=new e.Token("inline","",0),n.content=e.src,n.map=[0,1],n.children=[],e.tokens.push(n)):e.md.block.parse(e.src,e.md,e.env,e.tokens)}function eo(e){const n=e.tokens;for(let t=0,u=n.length;t<u;t++){const r=n[t];r.type==="inline"&&e.md.inline.parse(r.content,e.md,e.env,r.children)}}function no(e){return/^<a[>\s]/i.test(e)}function to(e){return/^<\/a\s*>/i.test(e)}function uo(e){const n=e.tokens;if(e.md.options.linkify)for(let t=0,u=n.length;t<u;t++){if(n[t].type!=="inline"||!e.md.linkify.pretest(n[t].content))continue;let r=n[t].children,o=0;for(let i=r.length-1;i>=0;i--){const a=r[i];if(a.type==="link_close"){for(i--;r[i].level!==a.level&&r[i].type!=="link_open";)i--;continue}if(a.type==="html_inline"&&(no(a.content)&&o>0&&o--,to(a.content)&&o++),!(o>0)&&a.type==="text"&&e.md.linkify.test(a.content)){const s=a.content;let c=e.md.linkify.match(s);const l=[];let d=a.level,h=0;c.length>0&&c[0].index===0&&i>0&&r[i-1].type==="text_special"&&(c=c.slice(1));for(let p=0;p<c.length;p++){const f=c[p].url,b=e.md.normalizeLink(f);if(!e.md.validateLink(b))continue;let g=c[p].text;c[p].schema?c[p].schema==="mailto:"&&!/^mailto:/i.test(g)?g=e.md.normalizeLinkText("mailto:"+g).replace(/^mailto:/,""):g=e.md.normalizeLinkText(g):g=e.md.normalizeLinkText("http://"+g).replace(/^http:\/\//,"");const C=c[p].index;if(C>h){const y=new e.Token("text","",0);y.content=s.slice(h,C),y.level=d,l.push(y)}const _=new e.Token("link_open","a",1);_.attrs=[["href",b]],_.level=d++,_.markup="linkify",_.info="auto",l.push(_);const m=new e.Token("text","",0);m.content=g,m.level=d,l.push(m);const x=new e.Token("link_close","a",-1);x.level=--d,x.markup="linkify",x.info="auto",l.push(x),h=c[p].lastIndex}if(h<s.length){const p=new e.Token("text","",0);p.content=s.slice(h),p.level=d,l.push(p)}n[t].children=r=pt(r,i,l)}}}}const gt=/\+-|\.\.|\?\?\?\?|!!!!|,,|--/,ro=/\((c|tm|r)\)/i,oo=/\((c|tm|r)\)/ig,io={c:"©",r:"®",tm:"™"};function ao(e,n){return io[n.toLowerCase()]}function so(e){let n=0;for(let t=e.length-1;t>=0;t--){const u=e[t];u.type==="text"&&!n&&(u.content=u.content.replace(oo,ao)),u.type==="link_open"&&u.info==="auto"&&n--,u.type==="link_close"&&u.info==="auto"&&n++}}function co(e){let n=0;for(let t=e.length-1;t>=0;t--){const u=e[t];u.type==="text"&&!n&&gt.test(u.content)&&(u.content=u.content.replace(/\+-/g,"±").replace(/\.{2,}/g,"…").replace(/([?!])…/g,"$1..").replace(/([?!]){4,}/g,"$1$1$1").replace(/,{2,}/g,",").replace(/(^|[^-])---(?=[^-]|$)/mg,"$1—").replace(/(^|\s)--(?=\s|$)/mg,"$1–").replace(/(^|[^-\s])--(?=[^-\s]|$)/mg,"$1–")),u.type==="link_open"&&u.info==="auto"&&n--,u.type==="link_close"&&u.info==="auto"&&n++}}function lo(e){let n;if(e.md.options.typographer)for(n=e.tokens.length-1;n>=0;n--)e.tokens[n].type==="inline"&&(ro.test(e.tokens[n].content)&&so(e.tokens[n].children),gt.test(e.tokens[n].content)&&co(e.tokens[n].children))}const fo=/['"]/,Mn=/['"]/g,On="’";function Te(e,n,t,u){e[n]||(e[n]=[]),e[n].push({pos:t,ch:u})}function po(e,n){let t="",u=0;n.sort((r,o)=>r.pos-o.pos);for(let r=0;r<n.length;r++){const o=n[r];t+=e.slice(u,o.pos)+o.ch,u=o.pos+1}return t+e.slice(u)}function ho(e,n){let t;const u=[],r={};for(let o=0;o<e.length;o++){const i=e[o],a=e[o].level;for(t=u.length-1;t>=0&&!(u[t].level<=a);t--);if(u.length=t+1,i.type!=="text")continue;const s=i.content;let c=0;const l=s.length;e:for(;c<l;){Mn.lastIndex=c;const d=Mn.exec(s);if(!d)break;let h=!0,p=!0;c=d.index+1;const f=d[0]==="'";let b=32;if(d.index-1>=0)b=s.charCodeAt(d.index-1);else for(t=o-1;t>=0&&!(e[t].type==="softbreak"||e[t].type==="hardbreak");t--)if(e[t].content){b=e[t].content.charCodeAt(e[t].content.length-1);break}let g=32;if(c<l)g=s.charCodeAt(c);else for(t=o+1;t<e.length&&!(e[t].type==="softbreak"||e[t].type==="hardbreak");t++)if(e[t].content){g=e[t].content.charCodeAt(0);break}const C=ge(b)||be(b),_=ge(g)||be(g),m=me(b),x=me(g);if(x?h=!1:_&&(m||C||(h=!1)),m?p=!1:C&&(x||_||(p=!1)),g===34&&d[0]==='"'&&b>=48&&b<=57&&(p=h=!1),h&&p&&(h=C,p=_),!h&&!p){f&&Te(r,o,d.index,On);continue}if(p)for(t=u.length-1;t>=0;t--){let y=u[t];if(u[t].level<a)break;if(y.single===f&&u[t].level===a){y=u[t];let k,v;f?(k=n.md.options.quotes[2],v=n.md.options.quotes[3]):(k=n.md.options.quotes[0],v=n.md.options.quotes[1]),Te(r,o,d.index,v),Te(r,y.token,y.pos,k),u.length=t;continue e}}h?u.push({token:o,pos:d.index,single:f,level:a}):p&&f&&Te(r,o,d.index,On)}}Object.keys(r).forEach(function(o){e[o].content=po(e[o].content,r[o])})}function mo(e){if(e.md.options.typographer)for(let n=e.tokens.length-1;n>=0;n--)e.tokens[n].type!=="inline"||!fo.test(e.tokens[n].content)||ho(e.tokens[n].children,e)}function bo(e){let n,t;const u=e.tokens,r=u.length;for(let o=0;o<r;o++){if(u[o].type!=="inline")continue;const i=u[o].children,a=i.length;for(n=0;n<a;n++)i[n].type==="text_special"&&(i[n].type="text");for(n=t=0;n<a;n++)i[n].type==="text"&&n+1<a&&i[n+1].type==="text"?i[n+1].content=i[n].content+i[n+1].content:(n!==t&&(i[t]=i[n]),t++);n!==t&&(i.length=t)}}const Ke=[["normalize",Jr],["block",Qr],["inline",eo],["linkify",uo],["replacements",lo],["smartquotes",mo],["text_join",bo]];function mn(){this.ruler=new E;for(let e=0;e<Ke.length;e++)this.ruler.push(Ke[e][0],Ke[e][1])}mn.prototype.process=function(e){const n=this.ruler.getRules("");for(let t=0,u=n.length;t<u;t++)n[t](e)};mn.prototype.State=bt;function z(e,n,t,u){this.src=e,this.md=n,this.env=t,this.tokens=u,this.bMarks=[],this.eMarks=[],this.tShift=[],this.sCount=[],this.bsCount=[],this.blkIndent=0,this.line=0,this.lineMax=0,this.tight=!1,this.ddIndent=-1,this.listIndent=-1,this.parentType="root",this.level=0;const r=this.src;for(let o=0,i=0,a=0,s=0,c=r.length,l=!1;i<c;i++){const d=r.charCodeAt(i);if(!l)if(w(d)){a++,d===9?s+=4-s%4:s++;continue}else l=!0;(d===10||i===c-1)&&(d!==10&&i++,this.bMarks.push(o),this.eMarks.push(i),this.tShift.push(a),this.sCount.push(s),this.bsCount.push(0),l=!1,a=0,s=0,o=i+1)}this.bMarks.push(r.length),this.eMarks.push(r.length),this.tShift.push(0),this.sCount.push(0),this.bsCount.push(0),this.lineMax=this.bMarks.length-1}z.prototype.push=function(e,n,t){const u=new I(e,n,t);return u.block=!0,t<0&&this.level--,u.level=this.level,t>0&&this.level++,this.tokens.push(u),u};z.prototype.isEmpty=function(n){return this.bMarks[n]+this.tShift[n]>=this.eMarks[n]};z.prototype.skipEmptyLines=function(n){for(let t=this.lineMax;n<t&&!(this.bMarks[n]+this.tShift[n]<this.eMarks[n]);n++);return n};z.prototype.skipSpaces=function(n){for(let t=this.src.length;n<t;n++){const u=this.src.charCodeAt(n);if(!w(u))break}return n};z.prototype.skipSpacesBack=function(n,t){if(n<=t)return n;for(;n>t;)if(!w(this.src.charCodeAt(--n)))return n+1;return n};z.prototype.skipChars=function(n,t){for(let u=this.src.length;n<u&&this.src.charCodeAt(n)===t;n++);return n};z.prototype.skipCharsBack=function(n,t,u){if(n<=u)return n;for(;n>u;)if(t!==this.src.charCodeAt(--n))return n+1;return n};z.prototype.getLines=function(n,t,u,r){if(n>=t)return"";const o=new Array(t-n);for(let i=0,a=n;a<t;a++,i++){let s=0;const c=this.bMarks[a];let l=c,d;for(a+1<t||r?d=this.eMarks[a]+1:d=this.eMarks[a];l<d&&s<u;){const h=this.src.charCodeAt(l);if(w(h))h===9?s+=4-(s+this.bsCount[a])%4:s++;else if(l-c<this.tShift[a])s++;else break;l++}s>u?o[i]=new Array(s-u+1).join(" ")+this.src.slice(l,d):o[i]=this.src.slice(l,d)}return o.join("")};z.prototype.Token=I;const go=65536;function Ze(e,n){const t=e.bMarks[n]+e.tShift[n],u=e.eMarks[n];return e.src.slice(t,u)}function Nn(e){const n=[],t=e.length;let u=0,r=e.charCodeAt(u),o=!1,i=0,a="";for(;u<t;)r===124&&(o?(a+=e.substring(i,u-1),i=u):(n.push(a+e.substring(i,u)),a="",i=u+1)),o=r===92,u++,r=e.charCodeAt(u);return n.push(a+e.substring(i)),n}function xo(e,n,t,u){if(n+2>t)return!1;let r=n+1;if(e.sCount[r]<e.blkIndent||e.sCount[r]-e.blkIndent>=4)return!1;let o=e.bMarks[r]+e.tShift[r];if(o>=e.eMarks[r])return!1;const i=e.src.charCodeAt(o++);if(i!==124&&i!==45&&i!==58||o>=e.eMarks[r])return!1;const a=e.src.charCodeAt(o++);if(a!==124&&a!==45&&a!==58&&!w(a)||i===45&&w(a))return!1;for(;o<e.eMarks[r];){const x=e.src.charCodeAt(o);if(x!==124&&x!==45&&x!==58&&!w(x))return!1;o++}let s=Ze(e,n+1),c=s.split("|");const l=[];for(let x=0;x<c.length;x++){const y=c[x].trim();if(!y){if(x===0||x===c.length-1)continue;return!1}if(!/^:?-+:?$/.test(y))return!1;y.charCodeAt(y.length-1)===58?l.push(y.charCodeAt(0)===58?"center":"right"):y.charCodeAt(0)===58?l.push("left"):l.push("")}if(s=Ze(e,n).trim(),s.indexOf("|")===-1||e.sCount[n]-e.blkIndent>=4)return!1;c=Nn(s),c.length&&c[0]===""&&c.shift(),c.length&&c[c.length-1]===""&&c.pop();const d=c.length;if(d===0||d!==l.length)return!1;if(u)return!0;const h=e.parentType;e.parentType="table";const p=e.md.block.ruler.getRules("blockquote"),f=e.push("table_open","table",1),b=[n,0];f.map=b;const g=e.push("thead_open","thead",1);g.map=[n,n+1];const C=e.push("tr_open","tr",1);C.map=[n,n+1];for(let x=0;x<c.length;x++){const y=e.push("th_open","th",1);l[x]&&(y.attrs=[["style","text-align:"+l[x]]]);const k=e.push("inline","",0);k.content=c[x].trim(),k.children=[],e.push("th_close","th",-1)}e.push("tr_close","tr",-1),e.push("thead_close","thead",-1);let _,m=0;for(r=n+2;r<t&&!(e.sCount[r]<e.blkIndent);r++){let x=!1;for(let k=0,v=p.length;k<v;k++)if(p[k](e,r,t,!0)){x=!0;break}if(x||(s=Ze(e,r).trim(),!s)||e.sCount[r]-e.blkIndent>=4||(c=Nn(s),c.length&&c[0]===""&&c.shift(),c.length&&c[c.length-1]===""&&c.pop(),m+=d-c.length,m>go))break;if(r===n+2){const k=e.push("tbody_open","tbody",1);k.map=_=[n+2,0]}const y=e.push("tr_open","tr",1);y.map=[r,r+1];for(let k=0;k<d;k++){const v=e.push("td_open","td",1);l[k]&&(v.attrs=[["style","text-align:"+l[k]]]);const F=e.push("inline","",0);F.content=c[k]?c[k].trim():"",F.children=[],e.push("td_close","td",-1)}e.push("tr_close","tr",-1)}return _&&(e.push("tbody_close","tbody",-1),_[1]=r),e.push("table_close","table",-1),b[1]=r,e.parentType=h,e.line=r,!0}function _o(e,n,t){if(e.sCount[n]-e.blkIndent<4)return!1;let u=n+1,r=u;for(;u<t;){if(e.isEmpty(u)){u++;continue}if(e.sCount[u]-e.blkIndent>=4){u++,r=u;continue}break}e.line=r;const o=e.push("code_block","code",0);return o.content=e.getLines(n,r,4+e.blkIndent,!1)+`
`,o.map=[n,e.line],!0}function yo(e,n,t,u){let r=e.bMarks[n]+e.tShift[n],o=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4||r+3>o)return!1;const i=e.src.charCodeAt(r);if(i!==126&&i!==96)return!1;let a=r;r=e.skipChars(r,i);let s=r-a;if(s<3)return!1;const c=e.src.slice(a,r),l=e.src.slice(r,o);if(i===96&&l.indexOf(String.fromCharCode(i))>=0)return!1;if(u)return!0;let d=n,h=!1;for(;d++,!(d>=t||(r=a=e.bMarks[d]+e.tShift[d],o=e.eMarks[d],r<o&&e.sCount[d]<e.blkIndent));)if(e.src.charCodeAt(r)===i&&!(e.sCount[d]-e.blkIndent>=4)&&(r=e.skipChars(r,i),!(r-a<s)&&(r=e.skipSpaces(r),!(r<o)))){h=!0;break}s=e.sCount[n],e.line=d+(h?1:0);const p=e.push("fence","code",0);return p.info=l,p.content=e.getLines(n+1,d,s,!0),p.markup=c,p.map=[n,e.line],!0}function ko(e,n,t,u){let r=e.bMarks[n]+e.tShift[n],o=e.eMarks[n];const i=e.lineMax;if(e.sCount[n]-e.blkIndent>=4||e.src.charCodeAt(r)!==62)return!1;if(u)return!0;const a=[],s=[],c=[],l=[],d=e.md.block.ruler.getRules("blockquote"),h=e.parentType;e.parentType="blockquote";let p=!1,f;for(f=n;f<t;f++){const m=e.sCount[f]<e.blkIndent;if(r=e.bMarks[f]+e.tShift[f],o=e.eMarks[f],r>=o)break;if(e.src.charCodeAt(r++)===62&&!m){let y=e.sCount[f]+1,k,v;e.src.charCodeAt(r)===32?(r++,y++,v=!1,k=!0):e.src.charCodeAt(r)===9?(k=!0,(e.bsCount[f]+y)%4===3?(r++,y++,v=!1):v=!0):k=!1;let F=y;for(a.push(e.bMarks[f]),e.bMarks[f]=r;r<o;){const G=e.src.charCodeAt(r);if(w(G))G===9?F+=4-(F+e.bsCount[f]+(v?1:0))%4:F++;else break;r++}p=r>=o,s.push(e.bsCount[f]),e.bsCount[f]=e.sCount[f]+1+(k?1:0),c.push(e.sCount[f]),e.sCount[f]=F-y,l.push(e.tShift[f]),e.tShift[f]=r-e.bMarks[f];continue}if(p)break;let x=!1;for(let y=0,k=d.length;y<k;y++)if(d[y](e,f,t,!0)){x=!0;break}if(x){e.lineMax=f,e.blkIndent!==0&&(a.push(e.bMarks[f]),s.push(e.bsCount[f]),l.push(e.tShift[f]),c.push(e.sCount[f]),e.sCount[f]-=e.blkIndent);break}a.push(e.bMarks[f]),s.push(e.bsCount[f]),l.push(e.tShift[f]),c.push(e.sCount[f]),e.sCount[f]=-1}const b=e.blkIndent;e.blkIndent=0;const g=e.push("blockquote_open","blockquote",1);g.markup=">";const C=[n,0];g.map=C,e.md.block.tokenize(e,n,f);const _=e.push("blockquote_close","blockquote",-1);_.markup=">",e.lineMax=i,e.parentType=h,C[1]=e.line;for(let m=0;m<l.length;m++)e.bMarks[m+n]=a[m],e.tShift[m+n]=l[m],e.sCount[m+n]=c[m],e.bsCount[m+n]=s[m];return e.blkIndent=b,!0}function Co(e,n,t,u){const r=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4)return!1;let o=e.bMarks[n]+e.tShift[n];const i=e.src.charCodeAt(o++);if(i!==42&&i!==45&&i!==95)return!1;let a=1;for(;o<r;){const c=e.src.charCodeAt(o++);if(c!==i&&!w(c))return!1;c===i&&a++}if(a<3)return!1;if(u)return!0;e.line=n+1;const s=e.push("hr","hr",0);return s.map=[n,e.line],s.markup=Array(a+1).join(String.fromCharCode(i)),!0}function Hn(e,n){const t=e.eMarks[n];let u=e.bMarks[n]+e.tShift[n];const r=e.src.charCodeAt(u++);if(r!==42&&r!==45&&r!==43)return-1;if(u<t){const o=e.src.charCodeAt(u);if(!w(o))return-1}return u}function zn(e,n){const t=e.bMarks[n]+e.tShift[n],u=e.eMarks[n];let r=t;if(r+1>=u)return-1;let o=e.src.charCodeAt(r++);if(o<48||o>57)return-1;for(;;){if(r>=u)return-1;if(o=e.src.charCodeAt(r++),o>=48&&o<=57){if(r-t>=10)return-1;continue}if(o===41||o===46)break;return-1}return r<u&&(o=e.src.charCodeAt(r),!w(o))?-1:r}function So(e,n){const t=e.level+2;for(let u=n+2,r=e.tokens.length-2;u<r;u++)e.tokens[u].level===t&&e.tokens[u].type==="paragraph_open"&&(e.tokens[u+2].hidden=!0,e.tokens[u].hidden=!0,u+=2)}function wo(e,n,t,u){let r,o,i,a,s=n,c=!0;if(e.sCount[s]-e.blkIndent>=4||e.listIndent>=0&&e.sCount[s]-e.listIndent>=4&&e.sCount[s]<e.blkIndent)return!1;let l=!1;u&&e.parentType==="paragraph"&&e.sCount[s]>=e.blkIndent&&(l=!0);let d,h,p;if((p=zn(e,s))>=0){if(d=!0,i=e.bMarks[s]+e.tShift[s],h=Number(e.src.slice(i,p-1)),l&&h!==1)return!1}else if((p=Hn(e,s))>=0)d=!1;else return!1;if(l&&e.skipSpaces(p)>=e.eMarks[s])return!1;if(u)return!0;const f=e.src.charCodeAt(p-1),b=e.tokens.length;d?(a=e.push("ordered_list_open","ol",1),h!==1&&(a.attrs=[["start",h]])):a=e.push("bullet_list_open","ul",1);const g=[s,0];a.map=g,a.markup=String.fromCharCode(f);let C=!1;const _=e.md.block.ruler.getRules("list"),m=e.parentType;for(e.parentType="list";s<t;){o=p,r=e.eMarks[s];const x=e.sCount[s]+p-(e.bMarks[s]+e.tShift[s]);let y=x;for(;o<r;){const ne=e.src.charCodeAt(o);if(ne===9)y+=4-(y+e.bsCount[s])%4;else if(ne===32)y++;else break;o++}const k=o;let v;k>=r?v=1:v=y-x,v>4&&(v=1);const F=x+v;a=e.push("list_item_open","li",1),a.markup=String.fromCharCode(f);const G=[s,0];a.map=G,d&&(a.info=e.src.slice(i,p-1));const le=e.tight,Ue=e.tShift[s],Yt=e.sCount[s],Xt=e.listIndent;if(e.listIndent=e.blkIndent,e.blkIndent=F,e.tight=!0,e.tShift[s]=k-e.bMarks[s],e.sCount[s]=y,k>=r&&e.isEmpty(s+1)?e.line=Math.min(e.line+2,t):e.md.block.tokenize(e,s,t,!0),(!e.tight||C)&&(c=!1),C=e.line-s>1&&e.isEmpty(e.line-1),e.blkIndent=e.listIndent,e.listIndent=Xt,e.tShift[s]=Ue,e.sCount[s]=Yt,e.tight=le,a=e.push("list_item_close","li",-1),a.markup=String.fromCharCode(f),s=e.line,G[1]=s,s>=t||e.sCount[s]<e.blkIndent||e.sCount[s]-e.blkIndent>=4)break;let wn=!1;for(let ne=0,Jt=_.length;ne<Jt;ne++)if(_[ne](e,s,t,!0)){wn=!0;break}if(wn)break;if(d){if(p=zn(e,s),p<0)break;i=e.bMarks[s]+e.tShift[s]}else if(p=Hn(e,s),p<0)break;if(f!==e.src.charCodeAt(p-1))break}return d?a=e.push("ordered_list_close","ol",-1):a=e.push("bullet_list_close","ul",-1),a.markup=String.fromCharCode(f),g[1]=s,e.line=s,e.parentType=m,c&&So(e,b),!0}function vo(e,n,t,u){let r=e.bMarks[n]+e.tShift[n],o=e.eMarks[n],i=n+1;if(e.sCount[n]-e.blkIndent>=4||e.src.charCodeAt(r)!==91)return!1;function a(_){const m=e.lineMax;if(_>=m||e.isEmpty(_))return null;let x=!1;if(e.sCount[_]-e.blkIndent>3&&(x=!0),e.sCount[_]<0&&(x=!0),!x){const v=e.md.block.ruler.getRules("reference"),F=e.parentType;e.parentType="reference";let G=!1;for(let le=0,Ue=v.length;le<Ue;le++)if(v[le](e,_,m,!0)){G=!0;break}if(e.parentType=F,G)return null}const y=e.bMarks[_]+e.tShift[_],k=e.eMarks[_];return e.src.slice(y,k+1)}let s=e.src.slice(r,o+1);o=s.length;let c=-1;for(r=1;r<o;r++){const _=s.charCodeAt(r);if(_===91)return!1;if(_===93){c=r;break}else if(_===10){const m=a(i);m!==null&&(s+=m,o=s.length,i++)}else if(_===92&&(r++,r<o&&s.charCodeAt(r)===10)){const m=a(i);m!==null&&(s+=m,o=s.length,i++)}}if(c<0||s.charCodeAt(c+1)!==58)return!1;for(r=c+2;r<o;r++){const _=s.charCodeAt(r);if(_===10){const m=a(i);m!==null&&(s+=m,o=s.length,i++)}else if(!w(_))break}const l=e.md.helpers.parseLinkDestination(s,r,o);if(!l.ok)return!1;const d=e.md.normalizeLink(l.str);if(!e.md.validateLink(d))return!1;r=l.pos;const h=r,p=i,f=r;for(;r<o;r++){const _=s.charCodeAt(r);if(_===10){const m=a(i);m!==null&&(s+=m,o=s.length,i++)}else if(!w(_))break}let b=e.md.helpers.parseLinkTitle(s,r,o);for(;b.can_continue;){const _=a(i);if(_===null)break;s+=_,r=o,o=s.length,i++,b=e.md.helpers.parseLinkTitle(s,r,o,b)}let g;for(r<o&&f!==r&&b.ok?(g=b.str,r=b.pos):(g="",r=h,i=p);r<o;){const _=s.charCodeAt(r);if(!w(_))break;r++}if(r<o&&s.charCodeAt(r)!==10&&g)for(g="",r=h,i=p;r<o;){const _=s.charCodeAt(r);if(!w(_))break;r++}if(r<o&&s.charCodeAt(r)!==10)return!1;const C=Ne(s.slice(1,c));return C?(u||(typeof e.env.references>"u"&&(e.env.references={}),typeof e.env.references[C]>"u"&&(e.env.references[C]={title:g,href:d}),e.line=i),!0):!1}const To=["address","article","aside","base","basefont","blockquote","body","caption","center","col","colgroup","dd","details","dialog","dir","div","dl","dt","fieldset","figcaption","figure","footer","form","frame","frameset","h1","h2","h3","h4","h5","h6","head","header","hr","html","iframe","legend","li","link","main","menu","menuitem","nav","noframes","ol","optgroup","option","p","param","search","section","summary","table","tbody","td","tfoot","th","thead","title","tr","track","ul"],Ro="[a-zA-Z_:][a-zA-Z0-9:._-]*",Do="[^\"'=<>`\\x00-\\x20]+",Eo="'[^']*'",Po='"[^"]*"',Ao="(?:"+Do+"|"+Eo+"|"+Po+")",Fo="(?:\\s+"+Ro+"(?:\\s*=\\s*"+Ao+")?)",xt="<[A-Za-z][A-Za-z0-9\\-]*"+Fo+"*\\s*\\/?>",_t="<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>",Io="<!---?>|<!--(?:[^-]|-[^-]|--[^>])*-->",Lo="<[?][\\s\\S]*?[?]>",Wo="<![A-Za-z][^>]*>",Mo="<!\\[CDATA\\[[\\s\\S]*?\\]\\]>",Oo=new RegExp("^(?:"+xt+"|"+_t+"|"+Io+"|"+Lo+"|"+Wo+"|"+Mo+")"),No=new RegExp("^(?:"+xt+"|"+_t+")"),K=[[/^<(script|pre|style|textarea)(?=(\s|>|$))/i,/<\/(script|pre|style|textarea)>/i,!0],[/^<!--/,/-->/,!0],[/^<\?/,/\?>/,!0],[/^<![A-Z]/,/>/,!0],[/^<!\[CDATA\[/,/\]\]>/,!0],[new RegExp("^</?("+To.join("|")+")(?=(\\s|/?>|$))","i"),/^$/,!0],[new RegExp(No.source+"\\s*$"),/^$/,!1]];function Ho(e,n,t,u){let r=e.bMarks[n]+e.tShift[n],o=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4||!e.md.options.html||e.src.charCodeAt(r)!==60)return!1;let i=e.src.slice(r,o),a=0;for(;a<K.length&&!K[a][0].test(i);a++);if(a===K.length)return!1;if(u)return K[a][2];let s=n+1;const c=K[a][1].test("");if(!K[a][1].test(i)){for(;s<t&&!(e.sCount[s]<e.blkIndent&&(c||!e.isEmpty(s)));s++)if(r=e.bMarks[s]+e.tShift[s],o=e.eMarks[s],i=e.src.slice(r,o),K[a][1].test(i)){i.length!==0&&s++;break}}e.line=s;const l=e.push("html_block","",0);return l.map=[n,s],l.content=e.getLines(n,s,e.blkIndent,!0),!0}function zo(e,n,t,u){let r=e.bMarks[n]+e.tShift[n],o=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4)return!1;let i=e.src.charCodeAt(r);if(i!==35||r>=o)return!1;let a=1;for(i=e.src.charCodeAt(++r);i===35&&r<o&&a<=6;)a++,i=e.src.charCodeAt(++r);if(a>6||r<o&&!w(i))return!1;if(u)return!0;o=e.skipSpacesBack(o,r);const s=e.skipCharsBack(o,35,r);s>r&&w(e.src.charCodeAt(s-1))&&(o=s),e.line=n+1;const c=e.push("heading_open","h"+String(a),1);c.markup="########".slice(0,a),c.map=[n,e.line];const l=e.push("inline","",0);l.content=He(e.src.slice(r,o)),l.map=[n,e.line],l.children=[];const d=e.push("heading_close","h"+String(a),-1);return d.markup="########".slice(0,a),!0}function Bo(e,n,t){const u=e.md.block.ruler.getRules("paragraph");if(e.sCount[n]-e.blkIndent>=4)return!1;const r=e.parentType;e.parentType="paragraph";let o=0,i,a=n+1;for(;a<t&&!e.isEmpty(a);a++){if(e.sCount[a]-e.blkIndent>3)continue;if(e.sCount[a]>=e.blkIndent){let p=e.bMarks[a]+e.tShift[a];const f=e.eMarks[a];if(p<f&&(i=e.src.charCodeAt(p),(i===45||i===61)&&(p=e.skipChars(p,i),p=e.skipSpaces(p),p>=f))){o=i===61?1:2;break}}if(e.sCount[a]<0)continue;let h=!1;for(let p=0,f=u.length;p<f;p++)if(u[p](e,a,t,!0)){h=!0;break}if(h)break}if(!o)return e.parentType=r,!1;const s=He(e.getLines(n,a,e.blkIndent,!1));e.line=a+1;const c=e.push("heading_open","h"+String(o),1);c.markup=String.fromCharCode(i),c.map=[n,e.line];const l=e.push("inline","",0);l.content=s,l.map=[n,e.line-1],l.children=[];const d=e.push("heading_close","h"+String(o),-1);return d.markup=String.fromCharCode(i),e.parentType=r,!0}function qo(e,n,t){const u=e.md.block.ruler.getRules("paragraph"),r=e.parentType;let o=n+1;for(e.parentType="paragraph";o<t&&!e.isEmpty(o);o++){if(e.sCount[o]-e.blkIndent>3||e.sCount[o]<0)continue;let c=!1;for(let l=0,d=u.length;l<d;l++)if(u[l](e,o,t,!0)){c=!0;break}if(c)break}const i=He(e.getLines(n,o,e.blkIndent,!1));e.line=o;const a=e.push("paragraph_open","p",1);a.map=[n,e.line];const s=e.push("inline","",0);return s.content=i,s.map=[n,e.line],s.children=[],e.push("paragraph_close","p",-1),e.parentType=r,!0}const Re=[["table",xo,["paragraph","reference"]],["code",_o],["fence",yo,["paragraph","reference","blockquote","list"]],["blockquote",ko,["paragraph","reference","blockquote","list"]],["hr",Co,["paragraph","reference","blockquote","list"]],["list",wo,["paragraph","reference","blockquote"]],["reference",vo],["html_block",Ho,["paragraph","reference","blockquote"]],["heading",zo,["paragraph","reference","blockquote"]],["lheading",Bo],["paragraph",qo]];function ze(){this.ruler=new E;for(let e=0;e<Re.length;e++)this.ruler.push(Re[e][0],Re[e][1],{alt:(Re[e][2]||[]).slice()})}ze.prototype.tokenize=function(e,n,t){const u=this.ruler.getRules(""),r=u.length,o=e.md.options.maxNesting;let i=n,a=!1;for(;i<t&&(e.line=i=e.skipEmptyLines(i),!(i>=t||e.sCount[i]<e.blkIndent));){if(e.level>=o){e.line=t;break}const s=e.line;let c=!1;for(let l=0;l<r;l++)if(c=u[l](e,i,t,!1),c){if(s>=e.line)throw new Error("block rule didn't increment state.line");break}if(!c)throw new Error("none of the block rules matched");e.tight=!a,e.isEmpty(e.line-1)&&(a=!0),i=e.line,i<t&&e.isEmpty(i)&&(a=!0,i++,e.line=i)}};ze.prototype.parse=function(e,n,t,u){if(!e)return;const r=new this.State(e,n,t,u);this.tokenize(r,r.line,r.lineMax)};ze.prototype.State=z;function Se(e,n,t,u){this.src=e,this.env=t,this.md=n,this.tokens=u,this.tokens_meta=Array(u.length),this.pos=0,this.posMax=this.src.length,this.level=0,this.pending="",this.pendingLevel=0,this.cache={},this.delimiters=[],this._prev_delimiters=[],this.backticks={},this.backticksScanned=!1,this.linkLevel=0}Se.prototype.pushPending=function(){const e=new I("text","",0);return e.content=this.pending,e.level=this.pendingLevel,this.tokens.push(e),this.pending="",e};Se.prototype.push=function(e,n,t){this.pending&&this.pushPending();const u=new I(e,n,t);let r=null;return t<0&&(this.level--,this.delimiters=this._prev_delimiters.pop()),u.level=this.level,t>0&&(this.level++,this._prev_delimiters.push(this.delimiters),this.delimiters=[],r={delimiters:this.delimiters}),this.pendingLevel=this.level,this.tokens.push(u),this.tokens_meta.push(r),u};Se.prototype.scanDelims=function(e,n){const t=this.posMax,u=this.src.charCodeAt(e);let r;if(e===0)r=32;else if(e===1)r=this.src.charCodeAt(0),(r&63488)===55296&&(r=65533);else if(r=this.src.charCodeAt(e-1),(r&64512)===56320){const g=this.src.charCodeAt(e-2);r=(g&64512)===55296?65536+(g-55296<<10)+(r-56320):65533}else(r&64512)===55296&&(r=65533);let o=e;for(;o<t&&this.src.charCodeAt(o)===u;)o++;const i=o-e;let a=o<t?this.src.charCodeAt(o):32;if((a&64512)===55296){const g=this.src.charCodeAt(o+1);a=(g&64512)===56320?65536+(a-55296<<10)+(g-56320):65533}else(a&64512)===56320&&(a=65533);const s=ge(r)||be(r),c=ge(a)||be(a),l=me(r),d=me(a),h=!d&&(!c||l||s),p=!l&&(!s||d||c);return{can_open:h&&(n||!p||s),can_close:p&&(n||!h||c),length:i}};Se.prototype.Token=I;function Go(e){switch(e){case 10:case 33:case 35:case 36:case 37:case 38:case 42:case 43:case 45:case 58:case 60:case 61:case 62:case 64:case 91:case 92:case 93:case 94:case 95:case 96:case 123:case 125:case 126:return!0;default:return!1}}function Uo(e,n){let t=e.pos;for(;t<e.posMax&&!Go(e.src.charCodeAt(t));)t++;return t===e.pos?!1:(n||(e.pending+=e.src.slice(e.pos,t)),e.pos=t,!0)}const jo=/(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i;function Vo(e,n){if(!e.md.options.linkify||e.linkLevel>0)return!1;const t=e.pos,u=e.posMax;if(t+3>u||e.src.charCodeAt(t)!==58||e.src.charCodeAt(t+1)!==47||e.src.charCodeAt(t+2)!==47)return!1;const r=e.pending.match(jo);if(!r)return!1;const o=r[1],i=e.md.linkify.matchAtStart(e.src.slice(t-o.length));if(!i)return!1;let a=i.url;if(a.length<=o.length)return!1;let s=a.length;for(;s>0&&a.charCodeAt(s-1)===42;)s--;s!==a.length&&(a=a.slice(0,s));const c=e.md.normalizeLink(a);if(!e.md.validateLink(c))return!1;if(!n){e.pending=e.pending.slice(0,-o.length);const l=e.push("link_open","a",1);l.attrs=[["href",c]],l.markup="linkify",l.info="auto";const d=e.push("text","",0);d.content=e.md.normalizeLinkText(a);const h=e.push("link_close","a",-1);h.markup="linkify",h.info="auto"}return e.pos+=a.length-o.length,!0}function $o(e,n){let t=e.pos;if(e.src.charCodeAt(t)!==10)return!1;const u=e.pending.length-1,r=e.posMax;if(!n)if(u>=0&&e.pending.charCodeAt(u)===32)if(u>=1&&e.pending.charCodeAt(u-1)===32){let o=u-1;for(;o>=1&&e.pending.charCodeAt(o-1)===32;)o--;e.pending=e.pending.slice(0,o),e.push("hardbreak","br",0)}else e.pending=e.pending.slice(0,-1),e.push("softbreak","br",0);else e.push("softbreak","br",0);for(t++;t<r&&w(e.src.charCodeAt(t));)t++;return e.pos=t,!0}const bn=[];for(let e=0;e<256;e++)bn.push(0);"\\!\"#$%&'()*+,./:;<=>?@[]^_`{|}~-".split("").forEach(function(e){bn[e.charCodeAt(0)]=1});function Ko(e,n){let t=e.pos;const u=e.posMax;if(e.src.charCodeAt(t)!==92||(t++,t>=u))return!1;let r=e.src.charCodeAt(t);if(r===10){for(n||e.push("hardbreak","br",0),t++;t<u&&(r=e.src.charCodeAt(t),!!w(r));)t++;return e.pos=t,!0}let o=e.src[t];if(r>=55296&&r<=56319&&t+1<u){const a=e.src.charCodeAt(t+1);a>=56320&&a<=57343&&(o+=e.src[t+1],t++)}const i="\\"+o;if(!n){const a=e.push("text_special","",0);r<256&&bn[r]!==0?a.content=o:a.content=i,a.markup=i,a.info="escape"}return e.pos=t+1,!0}function Zo(e,n){let t=e.pos;if(e.src.charCodeAt(t)!==96)return!1;const r=t;t++;const o=e.posMax;for(;t<o&&e.src.charCodeAt(t)===96;)t++;const i=e.src.slice(r,t),a=i.length;if(e.backticksScanned&&(e.backticks[a]||0)<=r)return n||(e.pending+=i),e.pos+=a,!0;let s=t,c;for(;(c=e.src.indexOf("`",s))!==-1;){for(s=c+1;s<o&&e.src.charCodeAt(s)===96;)s++;const l=s-c;if(l===a){if(!n){const d=e.push("code_inline","code",0);d.markup=i,d.content=e.src.slice(t,c).replace(/\n/g," ").replace(/^ (.+) $/,"$1")}return e.pos=s,!0}e.backticks[l]=c}return e.backticksScanned=!0,n||(e.pending+=i),e.pos+=a,!0}function Yo(e,n){const t=e.pos,u=e.src.charCodeAt(t);if(n||u!==126)return!1;const r=e.scanDelims(e.pos,!0);let o=r.length;const i=String.fromCharCode(u);if(o<2)return!1;let a;o%2&&(a=e.push("text","",0),a.content=i,o--);for(let s=0;s<o;s+=2)a=e.push("text","",0),a.content=i+i,e.delimiters.push({marker:u,length:0,token:e.tokens.length-1,end:-1,open:r.can_open,close:r.can_close});return e.pos+=r.length,!0}function Bn(e,n){let t;const u=[],r=n.length;for(let o=0;o<r;o++){const i=n[o];if(i.marker!==126||i.end===-1)continue;const a=n[i.end];t=e.tokens[i.token],t.type="s_open",t.tag="s",t.nesting=1,t.markup="~~",t.content="",t=e.tokens[a.token],t.type="s_close",t.tag="s",t.nesting=-1,t.markup="~~",t.content="",e.tokens[a.token-1].type==="text"&&e.tokens[a.token-1].content==="~"&&u.push(a.token-1)}for(;u.length;){const o=u.pop();let i=o+1;for(;i<e.tokens.length&&e.tokens[i].type==="s_close";)i++;i--,o!==i&&(t=e.tokens[i],e.tokens[i]=e.tokens[o],e.tokens[o]=t)}}function Xo(e){const n=e.tokens_meta,t=e.tokens_meta.length;Bn(e,e.delimiters);for(let u=0;u<t;u++)n[u]&&n[u].delimiters&&Bn(e,n[u].delimiters)}const yt={tokenize:Yo,postProcess:Xo};function Jo(e,n){const t=e.pos,u=e.src.charCodeAt(t);if(n||u!==95&&u!==42)return!1;const r=e.scanDelims(e.pos,u===42);for(let o=0;o<r.length;o++){const i=e.push("text","",0);i.content=String.fromCharCode(u),e.delimiters.push({marker:u,length:r.length,token:e.tokens.length-1,end:-1,open:r.can_open,close:r.can_close})}return e.pos+=r.length,!0}function qn(e,n){const t=n.length;for(let u=t-1;u>=0;u--){const r=n[u];if(r.marker!==95&&r.marker!==42||r.end===-1)continue;const o=n[r.end],i=u>0&&n[u-1].end===r.end+1&&n[u-1].marker===r.marker&&n[u-1].token===r.token-1&&n[r.end+1].token===o.token+1,a=String.fromCharCode(r.marker),s=e.tokens[r.token];s.type=i?"strong_open":"em_open",s.tag=i?"strong":"em",s.nesting=1,s.markup=i?a+a:a,s.content="";const c=e.tokens[o.token];c.type=i?"strong_close":"em_close",c.tag=i?"strong":"em",c.nesting=-1,c.markup=i?a+a:a,c.content="",i&&(e.tokens[n[u-1].token].content="",e.tokens[n[r.end+1].token].content="",u--)}}function Qo(e){const n=e.tokens_meta,t=e.tokens_meta.length;qn(e,e.delimiters);for(let u=0;u<t;u++)n[u]&&n[u].delimiters&&qn(e,n[u].delimiters)}const kt={tokenize:Jo,postProcess:Qo};function ei(e,n){let t,u,r,o,i="",a="",s=e.pos,c=!0;if(e.src.charCodeAt(e.pos)!==91)return!1;const l=e.pos,d=e.posMax,h=e.pos+1,p=e.md.helpers.parseLinkLabel(e,e.pos,!0);if(p<0)return!1;let f=p+1;if(f<d&&e.src.charCodeAt(f)===40){for(c=!1,f++;f<d&&(t=e.src.charCodeAt(f),!(!w(t)&&t!==10));f++);if(f>=d)return!1;if(s=f,r=e.md.helpers.parseLinkDestination(e.src,f,e.posMax),r.ok){for(i=e.md.normalizeLink(r.str),e.md.validateLink(i)?f=r.pos:i="",s=f;f<d&&(t=e.src.charCodeAt(f),!(!w(t)&&t!==10));f++);if(r=e.md.helpers.parseLinkTitle(e.src,f,e.posMax),f<d&&s!==f&&r.ok)for(a=r.str,f=r.pos;f<d&&(t=e.src.charCodeAt(f),!(!w(t)&&t!==10));f++);}(f>=d||e.src.charCodeAt(f)!==41)&&(c=!0),f++}if(c){if(typeof e.env.references>"u")return!1;if(f<d&&e.src.charCodeAt(f)===91?(s=f+1,f=e.md.helpers.parseLinkLabel(e,f),f>=0?u=e.src.slice(s,f++):f=p+1):f=p+1,u||(u=e.src.slice(h,p)),o=e.env.references[Ne(u)],!o)return e.pos=l,!1;i=o.href,a=o.title}if(!n){e.pos=h,e.posMax=p;const b=e.push("link_open","a",1),g=[["href",i]];b.attrs=g,a&&g.push(["title",a]),e.linkLevel++,e.md.inline.tokenize(e),e.linkLevel--,e.push("link_close","a",-1)}return e.pos=f,e.posMax=d,!0}function ni(e,n){let t,u,r,o,i,a,s,c,l="";const d=e.pos,h=e.posMax;if(e.src.charCodeAt(e.pos)!==33||e.src.charCodeAt(e.pos+1)!==91)return!1;const p=e.pos+2,f=e.md.helpers.parseLinkLabel(e,e.pos+1,!1);if(f<0)return!1;if(o=f+1,o<h&&e.src.charCodeAt(o)===40){for(o++;o<h&&(t=e.src.charCodeAt(o),!(!w(t)&&t!==10));o++);if(o>=h)return!1;for(c=o,a=e.md.helpers.parseLinkDestination(e.src,o,e.posMax),a.ok&&(l=e.md.normalizeLink(a.str),e.md.validateLink(l)?o=a.pos:l=""),c=o;o<h&&(t=e.src.charCodeAt(o),!(!w(t)&&t!==10));o++);if(a=e.md.helpers.parseLinkTitle(e.src,o,e.posMax),o<h&&c!==o&&a.ok)for(s=a.str,o=a.pos;o<h&&(t=e.src.charCodeAt(o),!(!w(t)&&t!==10));o++);else s="";if(o>=h||e.src.charCodeAt(o)!==41)return e.pos=d,!1;o++}else{if(typeof e.env.references>"u")return!1;if(o<h&&e.src.charCodeAt(o)===91?(c=o+1,o=e.md.helpers.parseLinkLabel(e,o),o>=0?r=e.src.slice(c,o++):o=f+1):o=f+1,r||(r=e.src.slice(p,f)),i=e.env.references[Ne(r)],!i)return e.pos=d,!1;l=i.href,s=i.title}if(!n){u=e.src.slice(p,f);const b=[];e.md.inline.parse(u,e.md,e.env,b);const g=e.push("image","img",0),C=[["src",l],["alt",""]];g.attrs=C,g.children=b,g.content=u,s&&C.push(["title",s])}return e.pos=o,e.posMax=h,!0}const ti=/^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/,ui=/^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;function ri(e,n){let t=e.pos;if(e.src.charCodeAt(t)!==60)return!1;const u=e.pos,r=e.posMax;for(;;){if(++t>=r)return!1;const i=e.src.charCodeAt(t);if(i===60)return!1;if(i===62)break}const o=e.src.slice(u+1,t);if(ui.test(o)){const i=e.md.normalizeLink(o);if(!e.md.validateLink(i))return!1;if(!n){const a=e.push("link_open","a",1);a.attrs=[["href",i]],a.markup="autolink",a.info="auto";const s=e.push("text","",0);s.content=e.md.normalizeLinkText(o);const c=e.push("link_close","a",-1);c.markup="autolink",c.info="auto"}return e.pos+=o.length+2,!0}if(ti.test(o)){const i=e.md.normalizeLink("mailto:"+o);if(!e.md.validateLink(i))return!1;if(!n){const a=e.push("link_open","a",1);a.attrs=[["href",i]],a.markup="autolink",a.info="auto";const s=e.push("text","",0);s.content=e.md.normalizeLinkText(o);const c=e.push("link_close","a",-1);c.markup="autolink",c.info="auto"}return e.pos+=o.length+2,!0}return!1}function oi(e){return/^<a[>\s]/i.test(e)}function ii(e){return/^<\/a\s*>/i.test(e)}function ai(e){const n=e|32;return n>=97&&n<=122}function si(e,n){if(!e.md.options.html)return!1;const t=e.posMax,u=e.pos;if(e.src.charCodeAt(u)!==60||u+2>=t)return!1;const r=e.src.charCodeAt(u+1);if(r!==33&&r!==63&&r!==47&&!ai(r))return!1;const o=e.src.slice(u).match(Oo);if(!o)return!1;if(!n){const i=e.push("html_inline","",0);i.content=o[0],oi(i.content)&&e.linkLevel++,ii(i.content)&&e.linkLevel--}return e.pos+=o[0].length,!0}const ci=/^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,li=/^&([a-z][a-z0-9]{1,31});/i;function di(e,n){const t=e.pos,u=e.posMax;if(e.src.charCodeAt(t)!==38||t+1>=u)return!1;if(e.src.charCodeAt(t+1)===35){const o=e.src.slice(t).match(ci);if(o){if(!n){const i=o[1][0].toLowerCase()==="x"?parseInt(o[1].slice(1),16):parseInt(o[1],10),a=e.push("text_special","",0);a.content=hn(i)?he(i):he(65533),a.markup=o[0],a.info="entity"}return e.pos+=o[0].length,!0}}else{const o=e.src.slice(t).match(li);if(o){const i=Er(o[0]);if(i!==o[0]){if(!n){const a=e.push("text_special","",0);a.content=i,a.markup=o[0],a.info="entity"}return e.pos+=o[0].length,!0}}}return!1}function Gn(e){const n={},t=e.length;if(!t)return;let u=0,r=-2;const o=[];for(let i=0;i<t;i++){const a=e[i];if(o.push(0),(e[u].marker!==a.marker||r!==a.token-1)&&(u=i),r=a.token,a.length=a.length||0,!a.close)continue;n.hasOwnProperty(a.marker)||(n[a.marker]=[-1,-1,-1,-1,-1,-1]);const s=n[a.marker][(a.open?3:0)+a.length%3];let c=u-o[u]-1,l=c;for(;c>s;c-=o[c]+1){const d=e[c];if(d.marker===a.marker&&d.open&&d.end<0){let h=!1;if((d.close||a.open)&&(d.length+a.length)%3===0&&(d.length%3!==0||a.length%3!==0)&&(h=!0),!h){const p=c>0&&!e[c-1].open?o[c-1]+1:0;o[i]=i-c+p,o[c]=p,a.open=!1,d.end=i,d.close=!1,l=-1,r=-2;break}}}l!==-1&&(n[a.marker][(a.open?3:0)+(a.length||0)%3]=l)}}function fi(e){const n=e.tokens_meta,t=e.tokens_meta.length;Gn(e.delimiters);for(let u=0;u<t;u++)n[u]&&n[u].delimiters&&Gn(n[u].delimiters)}function pi(e){let n,t,u=0;const r=e.tokens,o=e.tokens.length;for(n=t=0;n<o;n++)r[n].nesting<0&&u--,r[n].level=u,r[n].nesting>0&&u++,r[n].type==="text"&&n+1<o&&r[n+1].type==="text"?r[n+1].content=r[n].content+r[n+1].content:(n!==t&&(r[t]=r[n]),t++);n!==t&&(r.length=t)}const Ye=[["text",Uo],["linkify",Vo],["newline",$o],["escape",Ko],["backticks",Zo],["strikethrough",yt.tokenize],["emphasis",kt.tokenize],["link",ei],["image",ni],["autolink",ri],["html_inline",si],["entity",di]],Xe=[["balance_pairs",fi],["strikethrough",yt.postProcess],["emphasis",kt.postProcess],["fragments_join",pi]];function we(){this.ruler=new E;for(let e=0;e<Ye.length;e++)this.ruler.push(Ye[e][0],Ye[e][1]);this.ruler2=new E;for(let e=0;e<Xe.length;e++)this.ruler2.push(Xe[e][0],Xe[e][1])}we.prototype.skipToken=function(e){const n=e.pos,t=this.ruler.getRules(""),u=t.length,r=e.md.options.maxNesting,o=e.cache;if(typeof o[n]<"u"){e.pos=o[n];return}let i=!1;if(e.level<r){for(let a=0;a<u;a++)if(e.level++,i=t[a](e,!0),e.level--,i){if(n>=e.pos)throw new Error("inline rule didn't increment state.pos");break}}else e.pos=e.posMax;i||e.pos++,o[n]=e.pos};we.prototype.tokenize=function(e){const n=this.ruler.getRules(""),t=n.length,u=e.posMax,r=e.md.options.maxNesting;for(;e.pos<u;){const o=e.pos;let i=!1;if(e.level<r){for(let a=0;a<t;a++)if(i=n[a](e,!1),i){if(o>=e.pos)throw new Error("inline rule didn't increment state.pos");break}}if(i){if(e.pos>=u)break;continue}e.pending+=e.src[e.pos++]}e.pending&&e.pushPending()};we.prototype.parse=function(e,n,t,u){const r=new this.State(e,n,t,u);this.tokenize(r);const o=this.ruler2.getRules(""),i=o.length;for(let a=0;a<i;a++)o[a](r)};we.prototype.State=Se;function hi(e){const n={};e=e||{},n.src_Any=at.source,n.src_Cc=st.source,n.src_Z=lt.source,n.src_P=fn.source,n.src_ZPCc=[n.src_Z,n.src_P,n.src_Cc].join("|"),n.src_ZCc=[n.src_Z,n.src_Cc].join("|");const t="[><｜]";return n.src_pseudo_letter="(?:(?!"+t+"|"+n.src_ZPCc+")"+n.src_Any+")",n.src_ip4="(?:(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)",n.src_auth="(?:(?:(?!"+n.src_ZCc+"|[@/\\[\\]()]).)+@)?",n.src_port="(?::(?:6(?:[0-4]\\d{3}|5(?:[0-4]\\d{2}|5(?:[0-2]\\d|3[0-5])))|[1-5]?\\d{1,4}))?",n.src_host_terminator="(?=$|"+t+"|"+n.src_ZPCc+")(?!"+(e["---"]?"-(?!--)|":"-|")+"_|:\\d|\\.-|\\.(?!$|"+n.src_ZPCc+"))",n.src_path="(?:[/?#](?:(?!"+n.src_ZCc+"|"+t+`|[()[\\]{}.,"'?!\\-;]).|\\[(?:(?!`+n.src_ZCc+"|\\]).)*\\]|\\((?:(?!"+n.src_ZCc+"|[)]).)*\\)|\\{(?:(?!"+n.src_ZCc+'|[}]).)*\\}|\\"(?:(?!'+n.src_ZCc+`|["]).)+\\"|\\'(?:(?!`+n.src_ZCc+"|[']).)+\\'|\\'(?="+n.src_pseudo_letter+"|[-])|\\.{2,}[a-zA-Z0-9%/&]|\\.(?!"+n.src_ZCc+"|[.]|$)|"+(e["---"]?"\\-(?!--(?:[^-]|$))(?:-*)|":"\\-+|")+",(?!"+n.src_ZCc+"|$)|;(?!"+n.src_ZCc+"|$)|\\!+(?!"+n.src_ZCc+"|[!]|$)|\\?(?!"+n.src_ZCc+"|[?]|$))+|\\/)?",n.src_email_name='[\\-;:&=\\+\\$,\\.a-zA-Z0-9_][\\-;:&=\\+\\$,\\"\\.a-zA-Z0-9_]*',n.src_xn="xn--[a-z0-9\\-]{1,59}",n.src_domain_root="(?:"+n.src_xn+"|"+n.src_pseudo_letter+"{1,63})",n.src_domain="(?:"+n.src_xn+"|(?:"+n.src_pseudo_letter+")|(?:"+n.src_pseudo_letter+"(?:-|"+n.src_pseudo_letter+"){0,61}"+n.src_pseudo_letter+"))",n.src_host="(?:(?:(?:(?:"+n.src_domain+")\\.)*"+n.src_domain+"))",n.tpl_host_fuzzy="(?:"+n.src_ip4+"|(?:(?:(?:"+n.src_domain+")\\.)+(?:%TLDS%)))",n.tpl_host_no_ip_fuzzy="(?:(?:(?:"+n.src_domain+")\\.)+(?:%TLDS%))",n.src_host_strict=n.src_host+n.src_host_terminator,n.tpl_host_fuzzy_strict=n.tpl_host_fuzzy+n.src_host_terminator,n.src_host_port_strict=n.src_host+n.src_port+n.src_host_terminator,n.tpl_host_port_fuzzy_strict=n.tpl_host_fuzzy+n.src_port+n.src_host_terminator,n.tpl_host_port_no_ip_fuzzy_strict=n.tpl_host_no_ip_fuzzy+n.src_port+n.src_host_terminator,n.tpl_host_fuzzy_test="localhost|www\\.|\\.\\d{1,3}\\.|(?:\\.(?:%TLDS%)(?:"+n.src_ZPCc+"|>|$))",n.tpl_email_fuzzy="(^|"+t+'|"|\\(|'+n.src_ZCc+")("+n.src_email_name+"@"+n.tpl_host_fuzzy_strict+")",n.tpl_link_fuzzy="(^|(?![.:/\\-_@])(?:[$+<=>^`|｜]|"+n.src_ZPCc+"))((?![$+<=>^`|｜])"+n.tpl_host_port_fuzzy_strict+n.src_path+")",n.tpl_link_no_ip_fuzzy="(^|(?![.:/\\-_@])(?:[$+<=>^`|｜]|"+n.src_ZPCc+"))((?![$+<=>^`|｜])"+n.tpl_host_port_no_ip_fuzzy_strict+n.src_path+")",n}function on(e){return Array.prototype.slice.call(arguments,1).forEach(function(t){t&&Object.keys(t).forEach(function(u){e[u]=t[u]})}),e}function Be(e){return Object.prototype.toString.call(e)}function mi(e){return Be(e)==="[object String]"}function bi(e){return Be(e)==="[object Object]"}function gi(e){return Be(e)==="[object RegExp]"}function Un(e){return Be(e)==="[object Function]"}function xi(e){return e.replace(/[.?*+^$[\]\\(){}|-]/g,"\\$&")}const Ct={fuzzyLink:!0,fuzzyEmail:!0,fuzzyIP:!1};function _i(e){return Object.keys(e||{}).reduce(function(n,t){return n||Ct.hasOwnProperty(t)},!1)}const yi={"http:":{validate:function(e,n,t){const u=e.slice(n);return t.re.http||(t.re.http=new RegExp("^\\/\\/"+t.re.src_auth+t.re.src_host_port_strict+t.re.src_path,"i")),t.re.http.test(u)?u.match(t.re.http)[0].length:0}},"https:":"http:","ftp:":"http:","//":{validate:function(e,n,t){const u=e.slice(n);return t.re.no_http||(t.re.no_http=new RegExp("^"+t.re.src_auth+"(?:localhost|(?:(?:"+t.re.src_domain+")\\.)+"+t.re.src_domain_root+")"+t.re.src_port+t.re.src_host_terminator+t.re.src_path,"i")),t.re.no_http.test(u)?n>=3&&e[n-3]===":"||n>=3&&e[n-3]==="/"?0:u.match(t.re.no_http)[0].length:0}},"mailto:":{validate:function(e,n,t){const u=e.slice(n);return t.re.mailto||(t.re.mailto=new RegExp("^"+t.re.src_email_name+"@"+t.re.src_host_strict,"i")),t.re.mailto.test(u)?u.match(t.re.mailto)[0].length:0}}},ki="a[cdefgilmnoqrstuwxz]|b[abdefghijmnorstvwyz]|c[acdfghiklmnoruvwxyz]|d[ejkmoz]|e[cegrstu]|f[ijkmor]|g[abdefghilmnpqrstuwy]|h[kmnrtu]|i[delmnoqrst]|j[emop]|k[eghimnprwyz]|l[abcikrstuvy]|m[acdeghklmnopqrstuvwxyz]|n[acefgilopruz]|om|p[aefghklmnrstwy]|qa|r[eosuw]|s[abcdeghijklmnortuvxyz]|t[cdfghjklmnortvwz]|u[agksyz]|v[aceginu]|w[fs]|y[et]|z[amw]",Ci="biz|com|edu|gov|net|org|pro|web|xxx|aero|asia|coop|info|museum|name|shop|рф".split("|");function Si(e){return function(n,t){const u=n.slice(t);return e.test(u)?u.match(e)[0].length:0}}function jn(){return function(e,n){n.normalize(e)}}function Pe(e){const n=e.re=hi(e.__opts__),t=e.__tlds__.slice();e.onCompile(),e.__tlds_replaced__||t.push(ki),t.push(n.src_xn),n.src_tlds=t.join("|");function u(a){return a.replace("%TLDS%",n.src_tlds)}n.email_fuzzy=RegExp(u(n.tpl_email_fuzzy),"i"),n.email_fuzzy_global=RegExp(u(n.tpl_email_fuzzy),"ig"),n.link_fuzzy=RegExp(u(n.tpl_link_fuzzy),"i"),n.link_fuzzy_global=RegExp(u(n.tpl_link_fuzzy),"ig"),n.link_no_ip_fuzzy=RegExp(u(n.tpl_link_no_ip_fuzzy),"i"),n.link_no_ip_fuzzy_global=RegExp(u(n.tpl_link_no_ip_fuzzy),"ig"),n.host_fuzzy_test=RegExp(u(n.tpl_host_fuzzy_test),"i");const r=[];e.__compiled__={};function o(a,s){throw new Error('(LinkifyIt) Invalid schema "'+a+'": '+s)}Object.keys(e.__schemas__).forEach(function(a){const s=e.__schemas__[a];if(s===null)return;const c={validate:null,link:null};if(e.__compiled__[a]=c,bi(s)){gi(s.validate)?c.validate=Si(s.validate):Un(s.validate)?c.validate=s.validate:o(a,s),Un(s.normalize)?c.normalize=s.normalize:s.normalize?o(a,s):c.normalize=jn();return}if(mi(s)){r.push(a);return}o(a,s)}),r.forEach(function(a){e.__compiled__[e.__schemas__[a]]&&(e.__compiled__[a].validate=e.__compiled__[e.__schemas__[a]].validate,e.__compiled__[a].normalize=e.__compiled__[e.__schemas__[a]].normalize)}),e.__compiled__[""]={validate:null,normalize:jn()};const i=Object.keys(e.__compiled__).filter(function(a){return a.length>0&&e.__compiled__[a]}).map(xi).join("|");e.re.schema_test=RegExp("(^|(?!_)(?:[><｜]|"+n.src_ZPCc+"))("+i+")","i"),e.re.schema_search=RegExp("(^|(?!_)(?:[><｜]|"+n.src_ZPCc+"))("+i+")","ig"),e.re.schema_at_start=RegExp("^"+e.re.schema_search.source,"i"),e.re.pretest=RegExp("("+e.re.schema_test.source+")|("+e.re.host_fuzzy_test.source+")|@","i")}function St(e,n,t,u){const r=e.slice(t,u);this.schema=n.toLowerCase(),this.index=t,this.lastIndex=u,this.raw=r,this.text=r,this.url=r}function P(e,n){if(!(this instanceof P))return new P(e,n);n||_i(e)&&(n=e,e={}),this.__opts__=on({},Ct,n),this.__schemas__=on({},yi,e),this.__compiled__={},this.__tlds__=Ci,this.__tlds_replaced__=!1,this.re={},Pe(this)}P.prototype.add=function(n,t){return this.__schemas__[n]=t,Pe(this),this};P.prototype.set=function(n){return this.__opts__=on(this.__opts__,n),this};P.prototype.test=function(n){if(!n.length)return!1;let t,u;if(this.re.schema_test.test(n)){for(u=this.re.schema_search,u.lastIndex=0;(t=u.exec(n))!==null;)if(this.testSchemaAt(n,t[2],u.lastIndex))return!0}return!!(this.__opts__.fuzzyLink&&this.__compiled__["http:"]&&n.search(this.re.host_fuzzy_test)>=0&&n.match(this.__opts__.fuzzyIP?this.re.link_fuzzy:this.re.link_no_ip_fuzzy)!==null||this.__opts__.fuzzyEmail&&this.__compiled__["mailto:"]&&n.indexOf("@")>=0&&n.match(this.re.email_fuzzy)!==null)};P.prototype.pretest=function(n){return this.re.pretest.test(n)};P.prototype.testSchemaAt=function(n,t,u){return this.__compiled__[t.toLowerCase()]?this.__compiled__[t.toLowerCase()].validate(n,u,this):0};P.prototype.match=function(n){const t=[],u=[],r=[],o=[];let i,a,s;function c(h,p){return h?p?h.index!==p.index?h.index<p.index?h:p:h.lastIndex>=p.lastIndex?h:p:h:p}if(!n.length)return null;if(this.re.schema_test.test(n))for(s=this.re.schema_search,s.lastIndex=0;(i=s.exec(n))!==null;)a=this.testSchemaAt(n,i[2],s.lastIndex),a&&u.push({schema:i[2],index:i.index+i[1].length,lastIndex:i.index+i[0].length+a});if(this.__opts__.fuzzyLink&&this.__compiled__["http:"])for(s=this.__opts__.fuzzyIP?this.re.link_fuzzy_global:this.re.link_no_ip_fuzzy_global,s.lastIndex=0;(i=s.exec(n))!==null;)r.push({schema:"",index:i.index+i[1].length,lastIndex:i.index+i[0].length});if(this.__opts__.fuzzyEmail&&this.__compiled__["mailto:"])for(s=this.re.email_fuzzy_global,s.lastIndex=0;(i=s.exec(n))!==null;)o.push({schema:"mailto:",index:i.index+i[1].length,lastIndex:i.index+i[0].length});const l=[0,0,0];let d=0;for(;;){const h=[u[l[0]],o[l[1]],r[l[2]]],p=c(c(h[0],h[1]),h[2]);if(!p)break;if(p===h[0]?l[0]++:p===h[1]?l[1]++:l[2]++,p.index<d)continue;const f=new St(n,p.schema,p.index,p.lastIndex);this.__compiled__[f.schema].normalize(f,this),t.push(f),d=p.lastIndex}return t.length?t:null};P.prototype.matchAtStart=function(n){if(!n.length)return null;const t=this.re.schema_at_start.exec(n);if(!t)return null;const u=this.testSchemaAt(n,t[2],t[0].length);if(!u)return null;const r=new St(n,t[2],t.index+t[1].length,t.index+t[0].length+u);return this.__compiled__[r.schema].normalize(r,this),r};P.prototype.tlds=function(n,t){return n=Array.isArray(n)?n:[n],t?(this.__tlds__=this.__tlds__.concat(n).sort().filter(function(u,r,o){return u!==o[r-1]}).reverse(),Pe(this),this):(this.__tlds__=n.slice(),this.__tlds_replaced__=!0,Pe(this),this)};P.prototype.normalize=function(n){n.schema||(n.url="http://"+n.url),n.schema==="mailto:"&&!/^mailto:/i.test(n.url)&&(n.url="mailto:"+n.url)};P.prototype.onCompile=function(){};const te=2147483647,M=36,gn=1,xe=26,wi=38,vi=700,wt=72,vt=128,Tt="-",Ti=/^xn--/,Ri=/[^\0-\x7F]/,Di=/[\x2E\u3002\uFF0E\uFF61]/g,Ei={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)","invalid-input":"Invalid input"},Je=M-gn,O=Math.floor,Qe=String.fromCharCode;function j(e){throw new RangeError(Ei[e])}function Pi(e,n){const t=[];let u=e.length;for(;u--;)t[u]=n(e[u]);return t}function Rt(e,n){const t=e.split("@");let u="";t.length>1&&(u=t[0]+"@",e=t[1]),e=e.replace(Di,".");const r=e.split("."),o=Pi(r,n).join(".");return u+o}function Dt(e){const n=[];let t=0;const u=e.length;for(;t<u;){const r=e.charCodeAt(t++);if(r>=55296&&r<=56319&&t<u){const o=e.charCodeAt(t++);(o&64512)==56320?n.push(((r&1023)<<10)+(o&1023)+65536):(n.push(r),t--)}else n.push(r)}return n}const Ai=e=>String.fromCodePoint(...e),Fi=function(e){return e>=48&&e<58?26+(e-48):e>=65&&e<91?e-65:e>=97&&e<123?e-97:M},Vn=function(e,n){return e+22+75*(e<26)-((n!=0)<<5)},Et=function(e,n,t){let u=0;for(e=t?O(e/vi):e>>1,e+=O(e/n);e>Je*xe>>1;u+=M)e=O(e/Je);return O(u+(Je+1)*e/(e+wi))},Pt=function(e){const n=[],t=e.length;let u=0,r=vt,o=wt,i=e.lastIndexOf(Tt);i<0&&(i=0);for(let a=0;a<i;++a)e.charCodeAt(a)>=128&&j("not-basic"),n.push(e.charCodeAt(a));for(let a=i>0?i+1:0;a<t;){const s=u;for(let l=1,d=M;;d+=M){a>=t&&j("invalid-input");const h=Fi(e.charCodeAt(a++));h>=M&&j("invalid-input"),h>O((te-u)/l)&&j("overflow"),u+=h*l;const p=d<=o?gn:d>=o+xe?xe:d-o;if(h<p)break;const f=M-p;l>O(te/f)&&j("overflow"),l*=f}const c=n.length+1;o=Et(u-s,c,s==0),O(u/c)>te-r&&j("overflow"),r+=O(u/c),u%=c,n.splice(u++,0,r)}return String.fromCodePoint(...n)},At=function(e){const n=[];e=Dt(e);const t=e.length;let u=vt,r=0,o=wt;for(const s of e)s<128&&n.push(Qe(s));const i=n.length;let a=i;for(i&&n.push(Tt);a<t;){let s=te;for(const l of e)l>=u&&l<s&&(s=l);const c=a+1;s-u>O((te-r)/c)&&j("overflow"),r+=(s-u)*c,u=s;for(const l of e)if(l<u&&++r>te&&j("overflow"),l===u){let d=r;for(let h=M;;h+=M){const p=h<=o?gn:h>=o+xe?xe:h-o;if(d<p)break;const f=d-p,b=M-p;n.push(Qe(Vn(p+f%b,0))),d=O(f/b)}n.push(Qe(Vn(d,0))),o=Et(r,c,a===i),r=0,++a}++r,++u}return n.join("")},Ii=function(e){return Rt(e,function(n){return Ti.test(n)?Pt(n.slice(4).toLowerCase()):n})},Li=function(e){return Rt(e,function(n){return Ri.test(n)?"xn--"+At(n):n})},Ft={version:"2.3.1",ucs2:{decode:Dt,encode:Ai},decode:Pt,encode:At,toASCII:Li,toUnicode:Ii},Wi={options:{html:!1,xhtmlOut:!1,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:100},components:{core:{},block:{},inline:{}}},Mi={options:{html:!1,xhtmlOut:!1,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:20},components:{core:{rules:["normalize","block","inline","text_join"]},block:{rules:["paragraph"]},inline:{rules:["text"],rules2:["balance_pairs","fragments_join"]}}},Oi={options:{html:!0,xhtmlOut:!0,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:20},components:{core:{rules:["normalize","block","inline","text_join"]},block:{rules:["blockquote","code","fence","heading","hr","html_block","lheading","list","reference","paragraph"]},inline:{rules:["autolink","backticks","emphasis","entity","escape","html_inline","image","link","newline","text"],rules2:["balance_pairs","emphasis","fragments_join"]}}},Ni={default:Wi,zero:Mi,commonmark:Oi},Hi=/^(vbscript|javascript|file|data):/,zi=/^data:image\/(gif|png|jpeg|webp);/;function Bi(e){const n=e.trim().toLowerCase();return Hi.test(n)?zi.test(n):!0}const It=["http:","https:","mailto:"];function qi(e){const n=dn(e,!0);if(n.hostname&&(!n.protocol||It.indexOf(n.protocol)>=0))try{n.hostname=Ft.toASCII(n.hostname)}catch{}return Ce(ln(n))}function Gi(e){const n=dn(e,!0);if(n.hostname&&(!n.protocol||It.indexOf(n.protocol)>=0))try{n.hostname=Ft.toUnicode(n.hostname)}catch{}return re(ln(n),re.defaultChars+"%")}function A(e,n){if(!(this instanceof A))return new A(e,n);n||pn(e)||(n=e||{},e="default"),this.inline=new we,this.block=new ze,this.core=new mn,this.renderer=new ce,this.linkify=new P,this.validateLink=Bi,this.normalizeLink=qi,this.normalizeLinkText=Gi,this.utils=jr,this.helpers=Oe({},Zr),this.options={},this.configure(e),n&&this.set(n)}A.prototype.set=function(e){return Oe(this.options,e),this};A.prototype.configure=function(e){const n=this;if(pn(e)){const t=e;if(e=Ni[t],!e)throw new Error('Wrong `markdown-it` preset "'+t+'", check name')}if(!e)throw new Error("Wrong `markdown-it` preset, can't be empty");return e.options&&n.set(e.options),e.components&&Object.keys(e.components).forEach(function(t){e.components[t].rules&&n[t].ruler.enableOnly(e.components[t].rules),e.components[t].rules2&&n[t].ruler2.enableOnly(e.components[t].rules2)}),this};A.prototype.enable=function(e,n){let t=[];Array.isArray(e)||(e=[e]),["core","block","inline"].forEach(function(r){t=t.concat(this[r].ruler.enable(e,!0))},this),t=t.concat(this.inline.ruler2.enable(e,!0));const u=e.filter(function(r){return t.indexOf(r)<0});if(u.length&&!n)throw new Error("MarkdownIt. Failed to enable unknown rule(s): "+u);return this};A.prototype.disable=function(e,n){let t=[];Array.isArray(e)||(e=[e]),["core","block","inline"].forEach(function(r){t=t.concat(this[r].ruler.disable(e,!0))},this),t=t.concat(this.inline.ruler2.disable(e,!0));const u=e.filter(function(r){return t.indexOf(r)<0});if(u.length&&!n)throw new Error("MarkdownIt. Failed to disable unknown rule(s): "+u);return this};A.prototype.use=function(e){const n=[this].concat(Array.prototype.slice.call(arguments,1));return e.apply(e,n),this};A.prototype.parse=function(e,n){if(typeof e!="string")throw new Error("Input data should be a String");const t=new this.core.State(e,this,n);return this.core.process(t),t.tokens};A.prototype.render=function(e,n){return n=n||{},this.renderer.render(this.parse(e,n),this.options,n)};A.prototype.parseInline=function(e,n){const t=new this.core.State(e,this,n);return t.inlineMode=!0,this.core.process(t),t.tokens};A.prototype.renderInline=function(e,n){return n=n||{},this.renderer.render(this.parseInline(e,n),this.options,n)};var $n=!1,ie={false:"push",true:"unshift",after:"push",before:"unshift"},Ae={isPermalinkSymbol:!0};function an(e,n,t,u){var r;if(!$n){var o="Using deprecated markdown-it-anchor permalink option, see https://github.com/valeriangalliat/markdown-it-anchor#permalinks";typeof process=="object"&&process&&process.emitWarning?process.emitWarning(o):console.warn(o),$n=!0}var i=[Object.assign(new t.Token("link_open","a",1),{attrs:[].concat(n.permalinkClass?[["class",n.permalinkClass]]:[],[["href",n.permalinkHref(e,t)]],Object.entries(n.permalinkAttrs(e,t)))}),Object.assign(new t.Token("html_block","",0),{content:n.permalinkSymbol,meta:Ae}),new t.Token("link_close","a",-1)];n.permalinkSpace&&t.tokens[u+1].children[ie[n.permalinkBefore]](Object.assign(new t.Token("text","",0),{content:" "})),(r=t.tokens[u+1].children)[ie[n.permalinkBefore]].apply(r,i)}function Lt(e){return"#"+e}function Wt(e){return{}}var Ui={class:"header-anchor",symbol:"#",renderHref:Lt,renderAttrs:Wt};function ve(e){function n(t){return t=Object.assign({},n.defaults,t),function(u,r,o,i){return e(u,t,r,o,i)}}return n.defaults=Object.assign({},Ui),n.renderPermalinkImpl=e,n}function xn(e){var n=[],t=e.filter(function(u){if(u[0]!=="class")return!0;n.push(u[1])});return n.length>0&&t.unshift(["class",n.join(" ")]),t}var qe=ve(function(e,n,t,u,r){var o,i=[Object.assign(new u.Token("link_open","a",1),{attrs:xn([].concat(n.class?[["class",n.class]]:[],[["href",n.renderHref(e,u)]],n.ariaHidden?[["aria-hidden","true"]]:[],Object.entries(n.renderAttrs(e,u))))}),Object.assign(new u.Token("html_inline","",0),{content:n.symbol,meta:Ae}),new u.Token("link_close","a",-1)];if(n.space){var a=typeof n.space=="string"?n.space:" ";u.tokens[r+1].children[ie[n.placement]](Object.assign(new u.Token(typeof n.space=="string"?"html_inline":"text","",0),{content:a}))}(o=u.tokens[r+1].children)[ie[n.placement]].apply(o,i)});Object.assign(qe.defaults,{space:!0,placement:"after",ariaHidden:!1});var Z=ve(qe.renderPermalinkImpl);Z.defaults=Object.assign({},qe.defaults,{ariaHidden:!0});var Mt=ve(function(e,n,t,u,r){var o=[Object.assign(new u.Token("link_open","a",1),{attrs:xn([].concat(n.class?[["class",n.class]]:[],[["href",n.renderHref(e,u)]],Object.entries(n.renderAttrs(e,u))))})].concat(n.safariReaderFix?[new u.Token("span_open","span",1)]:[],u.tokens[r+1].children,n.safariReaderFix?[new u.Token("span_close","span",-1)]:[],[new u.Token("link_close","a",-1)]);u.tokens[r+1]=Object.assign(new u.Token("inline","",0),{children:o})});Object.assign(Mt.defaults,{safariReaderFix:!1});var Kn=ve(function(e,n,t,u,r){var o;if(!["visually-hidden","aria-label","aria-describedby","aria-labelledby"].includes(n.style))throw new Error("`permalink.linkAfterHeader` called with unknown style option `"+n.style+"`");if(!["aria-describedby","aria-labelledby"].includes(n.style)&&!n.assistiveText)throw new Error("`permalink.linkAfterHeader` called without the `assistiveText` option in `"+n.style+"` style");if(n.style==="visually-hidden"&&!n.visuallyHiddenClass)throw new Error("`permalink.linkAfterHeader` called without the `visuallyHiddenClass` option in `visually-hidden` style");var i=u.tokens[r+1].children.filter(function(d){return d.type==="text"||d.type==="code_inline"}).reduce(function(d,h){return d+h.content},""),a=[],s=[];if(n.class&&s.push(["class",n.class]),s.push(["href",n.renderHref(e,u)]),s.push.apply(s,Object.entries(n.renderAttrs(e,u))),n.style==="visually-hidden"){if(a.push(Object.assign(new u.Token("span_open","span",1),{attrs:[["class",n.visuallyHiddenClass]]}),Object.assign(new u.Token("text","",0),{content:n.assistiveText(i)}),new u.Token("span_close","span",-1)),n.space){var c=typeof n.space=="string"?n.space:" ";a[ie[n.placement]](Object.assign(new u.Token(typeof n.space=="string"?"html_inline":"text","",0),{content:c}))}a[ie[n.placement]](Object.assign(new u.Token("span_open","span",1),{attrs:[["aria-hidden","true"]]}),Object.assign(new u.Token("html_inline","",0),{content:n.symbol,meta:Ae}),new u.Token("span_close","span",-1))}else a.push(Object.assign(new u.Token("html_inline","",0),{content:n.symbol,meta:Ae}));n.style==="aria-label"?s.push(["aria-label",n.assistiveText(i)]):["aria-describedby","aria-labelledby"].includes(n.style)&&s.push([n.style,e]);var l=[Object.assign(new u.Token("link_open","a",1),{attrs:xn(s)})].concat(a,[new u.Token("link_close","a",-1)]);(o=u.tokens).splice.apply(o,[r+3,0].concat(l)),n.wrapper&&(u.tokens.splice(r,0,Object.assign(new u.Token("html_block","",0),{content:n.wrapper[0]+`
`})),u.tokens.splice(r+3+l.length+1,0,Object.assign(new u.Token("html_block","",0),{content:n.wrapper[1]+`
`})))});function Zn(e,n,t,u){var r=e,o=u;if(t&&Object.prototype.hasOwnProperty.call(n,r))throw new Error("User defined `id` attribute `"+e+"` is not unique. Please fix it in your Markdown to continue.");for(;Object.prototype.hasOwnProperty.call(n,r);)r=e+"-"+o,o+=1;return n[r]=!0,r}function X(e,n){n=Object.assign({},X.defaults,n),e.core.ruler.push("anchor",function(t){for(var u,r={},o=t.tokens,i=Array.isArray(n.level)?(u=n.level,function(d){return u.includes(d)}):(function(d){return function(h){return h>=d}})(n.level),a=0;a<o.length;a++){var s=o[a];if(s.type==="heading_open"&&i(Number(s.tag.substr(1)))){var c=n.getTokensText(o[a+1].children),l=s.attrGet("id");l=l==null?Zn(l=n.slugifyWithState?n.slugifyWithState(c,t):n.slugify(c),r,!1,n.uniqueSlugStartIndex):Zn(l,r,!0,n.uniqueSlugStartIndex),s.attrSet("id",l),n.tabIndex!==!1&&s.attrSet("tabindex",""+n.tabIndex),typeof n.permalink=="function"?n.permalink(l,n,t,a):(n.permalink||n.renderPermalink&&n.renderPermalink!==an)&&n.renderPermalink(l,n,t,a),a=o.indexOf(s),n.callback&&n.callback(s,{slug:l,title:c})}}})}Object.assign(Kn.defaults,{style:"visually-hidden",space:!0,placement:"after",wrapper:null}),X.permalink={__proto__:null,legacy:an,renderHref:Lt,renderAttrs:Wt,makePermalink:ve,linkInsideHeader:qe,ariaHidden:Z,headerLink:Mt,linkAfterHeader:Kn},X.defaults={level:1,slugify:function(e){return encodeURIComponent(String(e).trim().toLowerCase().replace(/\s+/g,"-"))},uniqueSlugStartIndex:1,tabIndex:"-1",getTokensText:function(e){return e.filter(function(n){return["text","code_inline"].includes(n.type)}).map(function(n){return n.content}).join("")},permalink:!1,renderPermalink:an,permalinkClass:Z.defaults.class,permalinkSpace:Z.defaults.space,permalinkSymbol:"¶",permalinkBefore:Z.defaults.placement==="before",permalinkHref:Z.defaults.renderHref,permalinkAttrs:Z.defaults.renderAttrs},X.default=X;const Ot="rtsp-doc-language",ae="overview.md",Nt=new Set(["zh","en"]),Fe={zh:[{group:"开始使用",items:[{title:"项目总览",path:"overview.md"},{title:"在线 Demo",path:"online-demo.md"},{title:"一键安装器",path:"installers.md"},{title:"排障指南",path:"troubleshooting.md"}]},{group:"集成方案",items:[{title:"Chrome 扩展方案",path:"chrome-extension.md"},{title:"Web 组件 Gateway 指引",path:"web-component-gateway.md"},{title:"通用组件方案",path:"universal-components.md"},{title:"桌面免插件",path:"desktop-native.md"},{title:"SDK API",path:"sdk-api.md"},{title:"多路与生命周期",path:"multi-stream-lifecycle.md"}]},{group:"协议与运维",items:[{title:"WebRTC / H.265",path:"webrtc-hevc.md"},{title:"RTSP 兼容性",path:"rtsp-compatibility.md"},{title:"小米摄像头",path:"xiaomi-rtsp.md"},{title:"安全模型",path:"security.md"},{title:"部署发布",path:"deployment.md"},{title:"验证记录",path:"validation.md"}]}],en:[{group:"Getting Started",items:[{title:"Overview",path:"overview.md"},{title:"Online Demo",path:"online-demo.md"},{title:"One-Click Installers",path:"installers.md"},{title:"Troubleshooting",path:"troubleshooting.md"}]},{group:"Integration",items:[{title:"Chrome Extension Runtime",path:"chrome-extension.md"},{title:"Gateway for Web Components",path:"web-component-gateway.md"},{title:"Universal Components",path:"universal-components.md"},{title:"Desktop Without Plugin",path:"desktop-native.md"},{title:"SDK API",path:"sdk-api.md"},{title:"Multi-Stream Lifecycle",path:"multi-stream-lifecycle.md"}]},{group:"Protocols and Ops",items:[{title:"WebRTC / H.265",path:"webrtc-hevc.md"},{title:"RTSP Compatibility",path:"rtsp-compatibility.md"},{title:"Xiaomi via micam",path:"xiaomi-rtsp.md"},{title:"Security Model",path:"security.md"},{title:"Deployment",path:"deployment.md"},{title:"Validation Log",path:"validation.md"}]}]},Yn={zh:{"nav.schemes":"方案","nav.demo":"Demo","nav.sdk":"SDK","nav.docs":"文档","nav.validation":"验证","nav.install":"安装","docs.eyebrow":"Docs","docs.title":"文档","docs.intro":"所有项目文档都可以在这里沉浸式阅读，左侧切换目录，右侧渲染 Markdown 内容。","docs.loading":"正在加载文档…","docs.errorTitle":"文档加载失败","install.detecting":"检测中","install.waitExtension":"等待扩展响应","install.pending":"待检测","install.notFound":"未检测到","install.waitInstall":"等待安装","install.notAllowed":"未授权当前站点","install.allowed":"已授权","install.ok":"正常","installer.mac.label":"macOS 安装器","installer.windows.label":"Windows 安装器","installer.linux.label":"Linux 安装器","installer.mac.copy":"下载 DMG，打开 RTSP Installer.app，按提示完成安装。","installer.windows.copy":"下载 ZIP，解压后打开 RTSP Installer.hta，按提示完成安装。","installer.linux.copy":"下载压缩包，解压后打开 RTSP Installer.desktop 或运行 install-gui.sh。","installer.download":"下载","live.placeholderTitle":"等待真实 RTSP 输入","live.placeholderCopy":"安装 runtime 后，这里会挂载扩展播放器 iframe。","live.stopped":"真实播放已停止。","live.ready":"真实 RTSP 播放器已就绪。","live.recovering":"播放中断，正在自动恢复","live.recovered":"播放已自动恢复。","live.needExtension":"请输入 Chrome 扩展 ID。","live.needUrl":"请输入 rtsp:// 开头的 RTSP URL。","live.waiting":"正在请求 Chrome 扩展播放器。若画面未出现，请检查扩展 ID、origin 授权和 Native Host。","live.timeout":"仍在等待扩展响应。请确认扩展已安装，并已授权当前站点 origin。","live.installReady":"扩展、Native Runtime 和当前站点授权均已就绪。"},en:{"nav.schemes":"Solutions","nav.demo":"Demo","nav.sdk":"SDK","nav.docs":"Docs","nav.validation":"Validation","nav.install":"Install","docs.eyebrow":"Docs","docs.title":"Documentation","docs.intro":"Read the complete project documentation here. Use the sidebar to switch topics; Markdown is rendered as an immersive page.","docs.loading":"Loading documentation...","docs.errorTitle":"Documentation failed to load","install.detecting":"Checking","install.waitExtension":"Waiting for extension","install.pending":"Not checked","install.notFound":"Not detected","install.waitInstall":"Waiting for install","install.notAllowed":"Current site not allowed","install.allowed":"Allowed","install.ok":"OK","installer.mac.label":"macOS Installer","installer.windows.label":"Windows Installer","installer.linux.label":"Linux Installer","installer.mac.copy":"Download the DMG, open RTSP Installer.app, and follow the prompts.","installer.windows.copy":"Download the ZIP, unzip it, open RTSP Installer.hta, and follow the prompts.","installer.linux.copy":"Download the archive, then open RTSP Installer.desktop or run install-gui.sh.","installer.download":"Download","live.placeholderTitle":"Waiting for an RTSP URL","live.placeholderCopy":"After the runtime is installed, the extension player iframe appears here.","live.stopped":"Real playback stopped.","live.ready":"Real RTSP player is ready.","live.recovering":"Playback interrupted. Recovering","live.recovered":"Playback recovered.","live.needExtension":"Enter the Chrome extension ID.","live.needUrl":"Enter an RTSP URL that starts with rtsp://.","live.waiting":"Requesting the Chrome extension player. If no video appears, check the extension ID, origin allowlist, and Native Host.","live.timeout":"Still waiting for the extension. Confirm it is installed and this site origin is allowed.","live.installReady":"Extension, Native Runtime, and current site origin are ready."}};let B=na(),se=qt(B);const ji=Object.assign({"../../docs/articles/rtsp-player-latest-wechat.md":Qt,"../../docs/articles/rtsp-player-wechat.md":eu,"../../docs/chrome-extension.md":nu,"../../docs/deployment.md":tu,"../../docs/desktop-native.md":uu,"../../docs/en/chrome-extension.md":ru,"../../docs/en/deployment.md":ou,"../../docs/en/desktop-native.md":iu,"../../docs/en/installers.md":au,"../../docs/en/multi-stream-lifecycle.md":su,"../../docs/en/online-demo.md":cu,"../../docs/en/overview.md":lu,"../../docs/en/rtsp-compatibility.md":du,"../../docs/en/sdk-api.md":fu,"../../docs/en/security.md":pu,"../../docs/en/troubleshooting.md":hu,"../../docs/en/universal-components.md":mu,"../../docs/en/validation.md":bu,"../../docs/en/web-component-gateway.md":gu,"../../docs/en/webrtc-hevc.md":xu,"../../docs/en/xiaomi-rtsp.md":_u,"../../docs/installers.md":yu,"../../docs/multi-stream-lifecycle.md":ku,"../../docs/online-demo.md":Cu,"../../docs/overview.md":Su,"../../docs/rtsp-compatibility.md":wu,"../../docs/sdk-api.md":vu,"../../docs/security.md":Tu,"../../docs/troubleshooting.md":Ru,"../../docs/universal-components.md":Du,"../../docs/validation.md":Eu,"../../docs/web-component-gateway.md":Pu,"../../docs/webrtc-hevc.md":Au,"../../docs/xiaomi-rtsp.md":Fu}),Vi=Object.assign({"../../docs/assets/contact.jpg":Iu,"../../docs/assets/donate-alipay.jpg":Lu,"../../docs/assets/donate-wx.jpg":Wu,"../../docs/assets/mp.png":Mu,"../../docs/assets/public-rtsp-e2e.png":Ou,"../../docs/assets/rtsp-player-latest-architecture.png":Nu,"../../docs/assets/rtsp-player-latest-architecture.svg":Hu,"../../docs/assets/rtsp-player-latest-cover-bg.png":zu,"../../docs/assets/rtsp-player-latest-cover.png":Bu,"../../docs/assets/rtsp-player-wechat-cover.png":qu}),$i=new Map(Object.entries(ji).map(([e,n])=>[Ge(e.replace(/^.*\/docs\//,"")),n])),Ki=new Map(Object.entries(Vi).map(([e,n])=>[`/docs/assets/${e.split("/").pop()}`,n])),ee=new A({html:!1,linkify:!0,typographer:!0}).use(X,{slugify:aa,permalink:X.permalink.linkInsideHeader({symbol:"#",placement:"after",class:"docs-anchor",ariaHidden:!0})}),Zi=ee.renderer.rules.link_open||((e,n,t,u,r)=>r.renderToken(e,n,t)),Yi=ee.renderer.rules.image||((e,n,t,u,r)=>r.renderToken(e,n,t));ee.renderer.rules.link_open=(e,n,t,u,r)=>{const o=e[n],i=o.attrGet("href");if(i){const a=ia(i,u.currentPath||"overview.md");o.attrSet("href",a),/^https?:\/\//i.test(a)&&(o.attrSet("target","_blank"),o.attrSet("rel","noreferrer"))}return Zi(e,n,t,u,r)};ee.renderer.rules.image=(e,n,t,u,r)=>{const o=e[n],i=o.attrGet("src");return i&&o.attrSet("src",$t(i,u.currentPath||"overview.md")),o.attrSet("loading","lazy"),o.attrSet("decoding","async"),Yi(e,n,t,u,r)};ee.renderer.rules.table_open=()=>'<div class="docs-table-wrap"><table>';ee.renderer.rules.table_close=()=>"</table></div>";const Xn=Array.from(document.querySelectorAll("[data-tab]")),Xi=Array.from(document.querySelectorAll("[data-panel]"));for(const e of Xn)e.addEventListener("click",()=>{const n=e.dataset.tab;for(const t of Xn)t.classList.toggle("active",t===e);for(const t of Xi)t.classList.toggle("active",t.dataset.panel===n)});const Ji=Array.from(document.querySelectorAll("main section[id]")),Jn=new Map(Array.from(document.querySelectorAll(".primary-nav a[href^='#']")).map(e=>[e.getAttribute("href").slice(1),e])),Qi=new IntersectionObserver(e=>{const n=e.filter(t=>t.isIntersecting).sort((t,u)=>u.intersectionRatio-t.intersectionRatio)[0];if(n){for(const t of Jn.values())t.removeAttribute("aria-current");Jn.get(n.target.id)?.setAttribute("aria-current","page")}},{rootMargin:"-20% 0px -60% 0px",threshold:[.1,.4,.7]});for(const e of Ji)Qi.observe(e);const _e=document.querySelector("#docs-nav"),ue=document.querySelector("#docs-content"),Ht=Array.from(document.querySelectorAll("[data-lang-switch]"));let De="";Ut();jt();for(const e of Ht)e.addEventListener("click",()=>{Gt(e.dataset.langSwitch,{scroll:!1}),kn(),R||Kt()});_e&&ue&&(zt(),window.addEventListener("hashchange",()=>{location.hash.startsWith("#docs")&&ye(Qn(),{scroll:!1})}),ye(Qn(),{scroll:!1}));function zt(){_e.innerHTML="";for(const e of Fe[B]||Fe.zh){const n=document.createElement("section");n.className="docs-nav-group";const t=document.createElement("h3");t.textContent=e.group,n.appendChild(t);for(const u of e.items){const r=document.createElement("button");r.type="button",r.dataset.docPath=u.path,r.textContent=u.title,r.addEventListener("click",()=>{history.replaceState(null,"",`#docs/${u.path}`),ye(u.path,{scroll:!0})}),n.appendChild(r)}_e.appendChild(n)}}function Qn(){const e=decodeURIComponent(location.hash||"").match(/^#docs\/(.+)$/),n=ta(e?.[1]||ae);return n.lang&&n.lang!==B&&Gt(n.lang,{reloadDoc:!1}),se.has(n.path)?n.path:ae}async function ye(e,{scroll:n=!1}={}){e=ke(e),se.has(e)||(e=ae),De=e,Bt(e),ue.innerHTML=`<div class="docs-loading">${pe(S("docs.loading"))}</div>`;try{const t=ua(e),u=$i.get(t)??await ra(t);ue.innerHTML=oa(u,t),ea(t),n&&document.querySelector("#docs")?.scrollIntoView({block:"start"})}catch(t){ue.innerHTML=`
      <div class="docs-error">
        <h2>${pe(S("docs.errorTitle"))}</h2>
        <p>${pe(t?.message||String(t))}</p>
      </div>
    `}}function Bt(e){_e.querySelectorAll("button[data-doc-path]").forEach(n=>{n.classList.toggle("active",n.dataset.docPath===e)})}function ea(e){ue.querySelectorAll("a[href]").forEach(n=>{const t=n.getAttribute("href")||"",u=Vt(t,e);!u||!se.has(u)||n.addEventListener("click",r=>{r.preventDefault(),history.replaceState(null,"",`#docs/${u}`),ye(u,{scroll:!0})})})}function qt(e){const n=Fe[e]||Fe.zh;return new Map(n.flatMap(t=>t.items.map(u=>[u.path,u])))}function S(e){return Yn[B]?.[e]||Yn.zh[e]||e}function na(){const e=decodeURIComponent(location.hash||"").match(/^#docs\/(.+)$/)?.[1]||"",n=Ge(e).match(/^(zh|en)\//)?.[1],t=new URLSearchParams(location.search).get("lang"),u=localStorage.getItem(Ot),r=navigator.language?.toLowerCase().startsWith("zh")?"zh":"en";return[n,t,u,r].find(o=>Nt.has(o))||"zh"}function Gt(e,{reloadDoc:n=!0,scroll:t=!1}={}){if(Nt.has(e)&&(B=e,localStorage.setItem(Ot,e),document.documentElement.lang=e==="zh"?"zh-CN":"en",se=qt(e),Ut(),jt(),_e&&(zt(),Bt(De)),n&&ue)){const u=se.has(De)?De:ae;location.hash.startsWith("#docs")&&history.replaceState(null,"",`#docs/${u}`),ye(u,{scroll:t})}}function Ut(){document.documentElement.lang=B==="zh"?"zh-CN":"en",document.querySelectorAll("[data-i18n]").forEach(e=>{e.textContent=S(e.dataset.i18n)})}function jt(){for(const e of Ht){const n=e.dataset.langSwitch===B;e.classList.toggle("active",n),e.setAttribute("aria-pressed",String(n))}}function ta(e){const n=Ge(e),t=n.match(/^(zh|en)\/(.+)$/);return{lang:t?.[1]||"",path:ke(t?.[2]||n||ae)}}function ua(e){const n=ke(e||ae);return B==="en"?`en/${n}`:n}function Ge(e){return String(e||"").replace(/^\/?docs\//,"").replace(/^\.\//,"").replace(/\/+/g,"/")}function ke(e){return Ge(e).replace(/^(zh|en)\//,"")}function Vt(e,n){if(!e||e.startsWith("#")||/^https?:\/\//i.test(e))return"";const t=e.split("#")[0].split("?")[0];if(!t.endsWith(".md"))return"";if(t.startsWith("/docs/"))return ke(t);const u=n.split("/").slice(0,-1);for(const r of t.split("/"))!r||r==="."||(r===".."?u.pop():u.push(r));return ke(u.join("/"))}async function ra(e){const n=await fetch(`/docs/${e}`);if(!n.ok)throw new Error(`HTTP ${n.status}`);const t=await n.text();if(/^\s*(<!doctype html|<html\b)/i.test(t))throw new Error("Markdown document endpoint returned HTML fallback.");return t}function oa(e,n){const t=e.replace(/^---[\s\S]*?---\s*/,"").replace(/\r\n/g,`
`);return`<div class="docs-markdown">${ee.render(t,{currentPath:n})}</div>`}function $t(e,n){if(/^(https?:)?\/\//i.test(e)||e.startsWith("data:"))return e;const t=`/docs/${n}`.split("/").slice(0,-1);for(const r of e.split("/"))!r||r==="."||(r===".."?t.pop():t.push(r));const u=t.join("/");return Ki.get(u)||u}function ia(e,n){const t=Vt(e,n);return t&&se.has(t)?`#docs/${t}`:/^(https?:)?\/\//i.test(e)||e.startsWith("#")||e.startsWith("/")?e:$t(e,n)}function aa(e){return e.toLowerCase().replace(/<[^>]+>/g,"").replace(/[^\p{Letter}\p{Number}]+/gu,"-").replace(/^-+|-+$/g,"")||"section"}function pe(e){return String(e).replace(/[&<>"']/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[n])}const U=document.querySelector("#demo-canvas"),en=document.querySelector("#demo-toggle"),sa=document.querySelector("#demo-state"),ca=document.querySelector("#demo-fps"),la=document.querySelector("#demo-latency"),da=document.querySelector("#demo-queue"),fa=document.querySelector("#demo-dropped");if(U){const e=U.getContext("2d",{alpha:!1});let n=!0,t=0,u=performance.now(),r=60,o=0,i=0,a=0;const s=()=>{const d=U.getBoundingClientRect(),h=Math.min(window.devicePixelRatio||1,2),p=Math.max(320,Math.round(d.width*h)),f=Math.max(180,Math.round(d.height*h));return(U.width!==p||U.height!==f)&&(U.width=p,U.height=f),e.setTransform(h,0,0,h,0,0),{width:p/h,height:f/h,ratio:h}},c=(d,h,p)=>{e.strokeStyle="rgba(143, 184, 216, .12)",e.lineWidth=1;const f=p/30%48;for(let b=-48+f;b<d+48;b+=48)e.beginPath(),e.moveTo(b,0),e.lineTo(b,h),e.stroke();for(let b=-48+f;b<h+48;b+=48)e.beginPath(),e.moveTo(0,b),e.lineTo(d,b),e.stroke()},l=d=>{a||(a=d),n&&(i+=d-a),a=d;const h=i,{width:p,height:f}=s(),b=h/1400%1,g=e.createLinearGradient(0,0,p,f);g.addColorStop(0,"#07110f"),g.addColorStop(.55,"#111716"),g.addColorStop(1,"#1b1d19"),e.fillStyle=g,e.fillRect(0,0,p,f),c(p,f,h),e.fillStyle="rgba(154, 210, 157, .10)",e.fillRect(0,f*b,p,3);const C=f*.66;e.fillStyle="rgba(244, 245, 242, .08)",e.fillRect(0,C,p,f*.18),e.fillStyle="rgba(228, 198, 122, .55)";for(let y=0;y<12;y+=1){const k=(h/9+y*120)%(p+140)-100;e.fillRect(k,C+f*.08,62,3)}const _=h/16%(p+260)-180;e.fillStyle="#8fb8d8",e.fillRect(_,C-28,92,26),e.fillStyle="#dfe8dd",e.fillRect(_+18,C-42,38,16),e.fillStyle="#050706",e.beginPath(),e.arc(_+22,C,7,0,Math.PI*2),e.arc(_+72,C,7,0,Math.PI*2),e.fill();const m=p*.76+Math.sin(h/700)*32,x=f*.46;if(e.strokeStyle="#e4c67a",e.lineWidth=5,e.beginPath(),e.arc(m,x-18,9,0,Math.PI*2),e.moveTo(m,x-8),e.lineTo(m,x+24),e.moveTo(m-18,x+3),e.lineTo(m+18,x+3),e.moveTo(m,x+24),e.lineTo(m-16,x+52),e.moveTo(m,x+24),e.lineTo(m+16,x+52),e.stroke(),e.strokeStyle="rgba(154, 210, 157, .9)",e.lineWidth=2,e.strokeRect(m-38,x-42,76,112),e.fillStyle="rgba(154, 210, 157, .15)",e.fillRect(m-38,x-42,76,18),e.fillStyle="rgba(5, 7, 6, .78)",e.fillRect(14,14,260,82),e.fillStyle="#f4f5f2",e.font="700 18px system-ui, sans-serif",e.fillText("RTSP Online Demo",28,44),e.font="13px system-ui, sans-serif",e.fillStyle="#b6bbb4",e.fillText(new Date().toLocaleTimeString(B==="zh"?"zh-CN":"en-US",{hour12:!1}),28,70),e.fillText("Simulated low-latency preview",112,70),n){t+=1;const y=d-u;if(y>=500){r=Math.round(t*1e3/y),t=0,u=d;const k=42+Math.round(Math.abs(Math.sin(h/900))*18),v=Math.round(Math.abs(Math.sin(h/1300))*1);Math.sin(h/2800)>.995&&(o+=1),ca.textContent=String(r),la.textContent=`${k}ms`,da.textContent=String(v),fa.textContent=String(o)}}requestAnimationFrame(l)};en?.addEventListener("click",()=>{n=!n,en.textContent=n?"Pause":"Play",en.setAttribute("aria-pressed",String(n)),sa.textContent=n?"Live Preview":"Paused"}),new ResizeObserver(s).observe(U),requestAnimationFrame(l)}const pa=document.querySelector("#live-demo-form"),ha=document.querySelector("#live-stop"),Ie=document.querySelector("#live-player-mount"),nn=document.querySelector("#live-demo-status"),J=document.querySelector("#live-extension-id"),Le=document.querySelector("#live-rtsp-url");let R=null,fe=0;const ma="giegomfhcmgebjhdiihnjohoinkbcjbh",et="rtsp://9627b0bf2a7b.entrypoint.cloud.wowza.com:1935/app-p5260J38/66abe4b9_stream1",ba=new Set(["rtsp://127.0.0.1:8554/local","rtsp://192.168.28.62:8554/local"]),ga={mac:"/downloads/rtsp-macos-installer.dmg",windows:"/downloads/rtsp-windows-installer.zip",linux:"/downloads/rtsp-linux-installer.tar.gz"},Q=document.querySelector("#install-dialog"),xa=[document.querySelector("#open-install-assistant"),document.querySelector("#hero-install-assistant")].filter(Boolean),_a=Array.from(document.querySelectorAll("[data-install-close]")),ya=document.querySelector("#recheck-install-status"),We=document.querySelector("#install-extension-status"),_n=document.querySelector("#install-native-status"),yn=document.querySelector("#install-origin-status"),tn=document.querySelector("#recommended-installer"),nt=document.querySelector("#installer-recommend-title"),tt=document.querySelector("#installer-recommend-copy"),ut=document.querySelector("#installer-list");let Me=!1,sn=0;function W(e,n="neutral"){nn&&(nn.textContent=e,nn.dataset.tone=n)}function ka(e,n){localStorage.setItem("rtsp-demo-extension-id",e),localStorage.setItem("rtsp-demo-url",n)}function Ca(){if(J&&(J.value=localStorage.getItem("rtsp-demo-extension-id")||ma),Le){const e=(localStorage.getItem("rtsp-demo-url")||"").trim(),n=ba.has(e)?et:e||et;e&&e!==n&&localStorage.setItem("rtsp-demo-url",n),Le.value=n}}function Kt(){Ie&&(Ie.innerHTML=`
    <div class="mount-placeholder">
      <strong>${pe(S("live.placeholderTitle"))}</strong>
      <span>${pe(S("live.placeholderCopy"))}</span>
    </div>
  `)}function Sa(){window.clearTimeout(fe),R?.stop&&R.stop(),R=null,Kt(),W(S("live.stopped"),"neutral")}function wa(){const e=`${navigator.userAgentData?.platform||""} ${navigator.platform||""} ${navigator.userAgent||""}`.toLowerCase();return e.includes("win")?"windows":e.includes("mac")?"mac":e.includes("linux")||e.includes("x11")?"linux":"mac"}function kn(){if(!tn||!nt||!tt)return;const e=wa(),n={mac:S("installer.mac.label"),windows:S("installer.windows.label"),linux:S("installer.linux.label")},t={mac:S("installer.mac.copy"),windows:S("installer.windows.copy"),linux:S("installer.linux.copy")};tn.href=ga[e],tn.textContent=`${S("installer.download")} ${n[e]}`,nt.textContent=n[e],tt.textContent=t[e],ut&&ut.querySelectorAll("[data-installer-platform]").forEach(u=>{u.hidden=u.dataset.installerPlatform!==e})}function N(e,n,t){e&&(e.textContent=n,e.style.color=t?"var(--green)":"var(--amber)")}function Cn(){kn();const e=Q?.classList.contains("open");Q?.classList.add("open"),Q?.setAttribute("aria-hidden","false"),document.body.style.overflow="hidden",e||Sn()}function Zt(){Q?.classList.remove("open"),Q?.setAttribute("aria-hidden","true"),document.body.style.overflow="",sessionStorage.setItem("rtsp-install-assistant-dismissed","1")}function Sn(){Me=!1,N(We,S("install.detecting"),!1),window.clearTimeout(sn),sn=window.setTimeout(()=>{Me||(N(We,S("install.notFound"),!1),N(_n,S("install.waitInstall"),!1),N(yn,S("install.waitInstall"),!1))},1200),window.postMessage({type:"RTSP_INSTALL_STATUS_REQUEST"},location.origin)}function va(e){Me=!0,window.clearTimeout(sn);const n=!!(e.installed&&e.extensionId),t=!!e.nativeOk,u=!!e.originAllowed;N(We,n?`${B==="zh"?"已安装":"Installed"} ${e.extensionId}`:S("install.notFound"),n),N(_n,t?`${S("install.ok")} ${e.nativePort||""}`:e.nativeError||S("install.notFound"),t),N(yn,S(u?"install.allowed":"install.notAllowed"),u),n&&J&&!J.value&&(J.value=e.extensionId,localStorage.setItem("rtsp-demo-extension-id",e.extensionId)),!n||!t||!u?sessionStorage.getItem("rtsp-install-assistant-dismissed")||Cn():Q?.classList.contains("open")&&W(S("live.installReady"),"ok")}for(const e of xa)e.addEventListener("click",Cn);for(const e of _a)e.addEventListener("click",Zt);ya?.addEventListener("click",()=>{Sn()});window.addEventListener("keydown",e=>{e.key==="Escape"&&Q?.classList.contains("open")&&Zt()});window.addEventListener("message",e=>{if(e.source!==window||e.origin!==location.origin)return;const n=e.data||{};n.source!=="rtsp-web-player-extension"||n.type!=="RTSP_EXTENSION_STATUS"||va(n)});Ca();kn();window.setTimeout(()=>{Sn(),window.setTimeout(()=>{!Me&&!sessionStorage.getItem("rtsp-install-assistant-dismissed")&&(N(We,S("install.notFound"),!1),N(_n,S("install.waitInstall"),!1),N(yn,S("install.waitInstall"),!1),Cn())},1100)},400);pa?.addEventListener("submit",e=>{e.preventDefault();const n=J?.value.trim()||"",t=Le?.value.trim()||"";if(!n){W(S("live.needExtension"),"error"),J?.focus();return}if(!t||!t.startsWith("rtsp://")){W(S("live.needUrl"),"error"),Le?.focus();return}ka(n,t),er("rtsp-live-player",{extensionId:n}),Ie.innerHTML="",R=document.createElement("rtsp-live-player"),R.setAttribute("extension-id",n),R.setAttribute("url",t),R.setAttribute("autoplay",""),R.setAttribute("controls",""),R.setAttribute("transport","auto"),R.setAttribute("codec","auto"),R.setAttribute("width","100%"),R.setAttribute("height","360"),R.addEventListener("ready",()=>{window.clearTimeout(fe),W(S("live.ready"),"ok")}),R.addEventListener("recovering",u=>{const r=u.detail?.attempt||1,o=u.detail?.maxAttempts||6;W(`${S("live.recovering")} (${r}/${o})...`,"error")}),R.addEventListener("recovered",()=>{W(S("live.recovered"),"ok")}),R.addEventListener("error",u=>{window.clearTimeout(fe);const r=u.detail?.error||"播放器返回错误，请检查 RTSP 地址、鉴权和 H.264 编码。";W(r,"error")}),Ie.appendChild(R),W(S("live.waiting")),window.clearTimeout(fe),fe=window.setTimeout(()=>{W(S("live.timeout"),"error")},5e3)});ha?.addEventListener("click",Sa);
