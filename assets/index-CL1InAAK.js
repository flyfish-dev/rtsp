...
\`0.1.20\` switches the WebRTC pipeline to \`deepch/vdk\` (the same Go streaming library that powers \`deepch/RTSPtoWeb\`) to fix camera compatibility issues at the root:
...
- 0.1.20 uses vdk's \`format/rtspv2\` for RTSP demux and \`format/webrtcv3\` for the WebRTC muxer. Both libraries have been battle-tested by RTSPtoWeb against Chinese IP cameras, natapp relays, and assorted SPS extensions for years: the demuxer extracts clean SPS/PPS into the codec data, and the muxer re-injects that clean data right before every IDR. The browser decoder happily skips the vendor SPS and uses the clean one.
- RTP repacketization is now handed off to Pion's \`TrackLocalStaticSample\`, replacing our hand-rolled FU-A loop with the standard packetization-mode=1 splitter and proven sequence-number / timestamp logic.
...
`);return`<div class="docs-markdown">${ee.render(t,{currentPath:n})}</div>`}function $t(e,n){if(/^(https?:)?\/\//i.test(e)||e.startsWith("data:"))return e;const t=`/docs/${n}`.split("/").slice(0,-1);for(const r of e.split("/"))!r||r==="."||(r===".."?t.pop():t.push(r));const u=t.join("/");return Ka.get(u)||u}function as(e,n){const t=Vt(e,n);return t&&ie.has(t)?`#docs/${t}`:/^(https?:)?\/\//i.test(e)||e.startsWith("#")||e.startsWith("/")?e:$t(e,n)}function ss(e){return e.toLowerCase().replace(/<[^>]+>/g,"").replace(/[^\p{Letter}\p{Number}]+/gu,"-").replace(/^-+|-+$/g,"")||"section"}function pe(e){return String(e).replace(/[&<>"']/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[n])}const U=document.querySelector("#demo-canvas"),en=document.querySelector("#demo-toggle"),is=document.querySelector("#demo-state"),cs=document.querySelector("#demo-fps"),ls=document.querySelector("#demo-latency"),ds=document.querySelector("#demo-queue"),fs=document.querySelector("#demo-dropped");if(U){const e=U.getContext("2d",{alpha:!1});let n=!0,t=0,u=performance.now(),r=60,o=0,a=0,s=0;const i=()=>{const d=U.getBoundingClientRect(),h=Math.min(window.devicePixelRatio||1,2),p=Math.max(320,Math.round(d.width*h)),f=Math.max(180,Math.round(d.height*h));return(U.width!==p||U.height!==f)&&(U.width=p,U.height=f),e.setTransform(h,0,0,h,0,0),{width:p/h,height:f/h,ratio:h}},c=(d,h,p)=>{e.strokeStyle="rgba(143, 184, 216, .12)",e.lineWidth=1;const f=p/30%48;for(let b=-48+f;b<d+48;b+=48)e.beginPath(),e.moveTo(b,0),e.lineTo(b,h),e.stroke();for(let b=-48+f;b<h+48;b+=48)e.beginPath(),e.moveTo(0,b),e.lineTo(d,b),e.stroke()},l=d=>{s||(s=d),n&&(a+=d-s),s=d;const h=a,{width:p,height:f}=i(),b=h/1400%1,g=e.createLinearGradient(0,0,p,f);g.addColorStop(0,"#07110f"),g.addColorStop(.55,"#111716"),g.addColorStop(1,"#1b1d19"),e.fillStyle=g,e.fillRect(0,0,p,f),c(p,f,h),e.fillStyle="rgba(154, 210, 157, .10)",e.fillRect(0,f*b,p,3);const S=f*.66;e.fillStyle="rgba(244, 245, 242, .08)",e.fillRect(0,S,p,f*.18),e.fillStyle="rgba(228, 198, 122, .55)";for(let _=0;_<12;_+=1){const k=(h/9+_*120)%(p+140)-100;e.fillRect(k,S+f*.08,62,3)}const y=h/16%(p+260)-180;e.fillStyle="#8fb8d8",e.fillRect(y,S-28,92,26),e.fillStyle="#dfe8dd",e.fillRect(y+18,S-42,38,16),e.fillStyle="#050706",e.beginPath(),e.arc(y+22,S,7,0,Math.PI*2),e.arc(y+72,S,7,0,Math.PI*2),e.fill();const m=p*.76+Math.sin(h/700)*32,x=f*.46;if(e.strokeStyle="#e4c67a",e.lineWidth=5,e.beginPath(),e.arc(m,x-18,9,0,Math.PI*2),e.moveTo(m,x-8),e.lineTo(m,x+24),e.moveTo(m-18,x+3),e.lineTo(m+18,x+3),e.moveTo(m,x+24),e.lineTo(m-16,x+52),e.moveTo(m,x+24),e.lineTo(m+16,x+52),e.stroke(),e.strokeStyle="rgba(154, 210, 157, .9)",e.lineWidth=2,e.strokeRect(m-38,x-42,76,112),e.fillStyle="rgba(154, 210, 157, .15)",e.fillRect(m-38,x-42,76,18),e.fillStyle="rgba(5, 7, 6, .78)",e.fillRect(14,14,260,82),e.fillStyle="#f4f5f2",e.font="700 18px system-ui, sans-serif",e.fillText("RTSP Online Demo",28,44),e.font="13px system-ui, sans-serif",e.fillStyle="#b6bbb4",e.fillText(new Date().toLocaleTimeString(z==="zh"?"zh-CN":"en-US",{hour12:!1}),28,70),e.fillText("Simulated low-latency preview",112,70),n){t+=1;const _=d-u;if(_>=500){r=Math.round(t*1e3/_),t=0,u=d;const k=42+Math.round(Math.abs(Math.sin(h/900))*18),v=Math.round(Math.abs(Math.sin(h/1300))*1);Math.sin(h/2800)>.995&&(o+=1),cs.textContent=String(r),ls.textContent=`${k}ms`,ds.textContent=String(v),fs.textContent=String(o)}}requestAnimationFrame(l)};en?.addEventListener("click",()=>{n=!n,en.textContent=n?"Pause":"Play",en.setAttribute("aria-pressed",String(n)),is.textContent=n?"Live Preview":"Paused"}),new ResizeObserver(i).observe(U),requestAnimationFrame(l)}const ps=document.querySelector("#live-demo-form"),hs=document.querySelector("#live-stop"),Ie=document.querySelector("#live-player-mount"),nn=document.querySelector("#live-demo-status"),J=document.querySelector("#live-extension-id"),Le=document.querySelector("#live-rtsp-url");let P=null,fe=0;const ms="giegomfhcmgebjhdiihnjohoinkbcjbh",et="rtsp://9627b0bf2a7b.entrypoint.cloud.wowza.com:1935/app-p5260J38/66abe4b9_stream1",bs=new Set(["rtsp://127.0.0.1:8554/local","rtsp://192.168.28.62:8554/local"]),gs={mac:"/downloads/rtsp-macos-installer.dmg",windows:"/downloads/rtsp-windows-installer.zip",linux:"/downloads/rtsp-linux-installer.tar.gz"},Q=document.querySelector("#install-dialog"),xs=[document.querySelector("#open-install-assistant"),document.querySelector("#hero-install-assistant")].filter(Boolean),ys=Array.from(document.querySelectorAll("[data-install-close]")),_s=document.querySelector("#recheck-install-status"),We=document.querySelector("#install-extension-status"),yn=document.querySelector("#install-native-status"),_n=document.querySelector("#install-origin-status"),tn=document.querySelector("#recommended-installer"),nt=document.querySelector("#installer-recommend-title"),tt=document.querySelector("#installer-recommend-copy"),ut=document.querySelector("#installer-list");let Me=!1,sn=0;function W(e,n="neutral"){nn&&(nn.textContent=e,nn.dataset.tone=n)}function ks(e,n){localStorage.setItem("rtsp-demo-extension-id",e),localStorage.setItem("rtsp-demo-url",n)}function Ss(){if(J&&(J.value=localStorage.getItem("rtsp-demo-extension-id")||ms),Le){const e=(localStorage.getItem("rtsp-demo-url")||"").trim(),n=bs.has(e)?et:e||et;e&&e!==n&&localStorage.setItem("rtsp-demo-url",n),Le.value=n}}function Kt(){Ie&&(Ie.innerHTML=`
    <div class="mount-placeholder">
      <strong>${pe(C("live.placeholderTitle"))}</strong>
      <span>${pe(C("live.placeholderCopy"))}</span>
    </div>
  `)}function Cs(){window.clearTimeout(fe),P?.stop&&P.stop(),P=null,Kt(),W(C("live.stopped"),"neutral")}function ws(){const e=`${navigator.userAgentData?.platform||""} ${navigator.platform||""} ${navigator.userAgent||""}`.toLowerCase();return e.includes("win")?"windows":e.includes("mac")?"mac":e.includes("linux")||e.includes("x11")?"linux":"mac"}function kn(){if(!tn||!nt||!tt)return;const e=ws(),n={mac:C("installer.mac.label"),windows:C("installer.windows.label"),linux:C("installer.linux.label")},t={mac:C("installer.mac.copy"),windows:C("installer.windows.copy"),linux:C("installer.linux.copy")};tn.href=gs[e],tn.textContent=`${C("installer.download")} ${n[e]}`,nt.textContent=n[e],tt.textContent=t[e],ut&&ut.querySelectorAll("[data-installer-platform]").forEach(u=>{u.hidden=u.dataset.installerPlatform!==e})}function O(e,n,t){e&&(e.textContent=n,e.style.color=t?"var(--green)":"var(--amber)")}function Sn(){kn();const e=Q?.classList.contains("open");Q?.classList.add("open"),Q?.setAttribute("aria-hidden","false"),document.body.style.overflow="hidden",e||Cn()}function Zt(){Q?.classList.remove("open"),Q?.setAttribute("aria-hidden","true"),document.body.style.overflow="",sessionStorage.setItem("rtsp-install-assistant-dismissed","1")}function Cn(){Me=!1,O(We,C("install.detecting"),!1),window.clearTimeout(sn),sn=window.setTimeout(()=>{Me||(O(We,C("install.notFound"),!1),O(yn,C("install.waitInstall"),!1),O(_n,C("install.waitInstall"),!1))},1200),window.postMessage({type:"RTSP_INSTALL_STATUS_REQUEST"},location.origin)}function vs(e){Me=!0,window.clearTimeout(sn);const n=!!(e.installed&&e.extensionId),t=!!e.nativeOk,u=!!e.originAllowed;O(We,n?`${z==="zh"?"已安装":"Installed"} ${e.extensionId}`:C("install.notFound"),n),O(yn,t?`${C("install.ok")} ${e.nativePort||""}`:e.nativeError||C("install.notFound"),t),O(_n,C(u?"install.allowed":"install.notAllowed"),u),n&&J&&!J.value&&(J.value=e.extensionId,localStorage.setItem("rtsp-demo-extension-id",e.extensionId)),!n||!t||!u?sessionStorage.getItem("rtsp-install-assistant-dismissed")||Sn():Q?.classList.contains("open")&&W(C("live.installReady"),"ok")}for(const e of xs)e.addEventListener("click",Sn);for(const e of ys)e.addEventListener("click",Zt);_s?.addEventListener("click",()=>{Cn()});window.addEventListener("keydown",e=>{e.key==="Escape"&&Q?.classList.contains("open")&&Zt()});window.addEventListener("message",e=>{if(e.source!==window||e.origin!==location.origin)return;const n=e.data||{};n.source!=="rtsp-web-player-extension"||n.type!=="RTSP_EXTENSION_STATUS"||vs(n)});Ss();kn();window.setTimeout(()=>{Cn(),window.setTimeout(()=>{!Me&&!sessionStorage.getItem("rtsp-install-assistant-dismissed")&&(O(We,C("install.notFound"),!1),O(yn,C("install.waitInstall"),!1),O(_n,C("install.waitInstall"),!1),Sn())},1100)},400);ps?.addEventListener("submit",e=>{e.preventDefault();const n=J?.value.trim()||"",t=Le?.value.trim()||"";if(!n){W(C("live.needExtension"),"error"),J?.focus();return}if(!t||!t.startsWith("rtsp://")){W(C("live.needUrl"),"error"),Le?.focus();return}ks(n,t),er("rtsp-live-player",{extensionId:n}),Ie.innerHTML="",P=document.createElement("rtsp-live-player"),P.setAttribute("extension-id",n),P.setAttribute("url",t),P.setAttribute("autoplay",""),P.setAttribute("controls",""),P.setAttribute("transport","auto"),P.setAttribute("codec","auto"),P.setAttribute("width","100%"),P.setAttribute("height","360"),P.addEventListener("ready",()=>{window.clearTimeout(fe),W(C("live.ready"),"ok")}),P.addEventListener("recovering",u=>{const r=u.detail?.attempt||1,o=u.detail?.maxAttempts||6;W(`${C("live.recovering")} (${r}/${o})...`,"error")}),P.addEventListener("recovered",()=>{W(C("live.recovered"),"ok")}),P.addEventListener("error",u=>{window.clearTimeout(fe);const r=u.detail?.error||"播放器返回错误，请检查 RTSP 地址、鉴权和 H.264 编码。";W(r,"error")}),Ie.appendChild(P),W(C("live.waiting")),window.clearTimeout(fe),fe=window.setTimeout(()=>{W(C("live.timeout"),"error")},5e3)});hs?.addEventListener("click",Cs);
