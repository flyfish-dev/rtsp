(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))u(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&u(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function u(r){if(r.ep)return;r.ep=!0;const a=t(r);fetch(r.href,a)}})();const Qt=`---
...
RTSP Player 现在采用 **WebRTC 优先** 的传输策略。H.264 进入本地 Go Gateway 后，默认由 vdk 拉流并整理为干净 access unit，再写入 Pion WebRTC sample track；H.265 在能力允许时走 RTP passthrough。浏览器能够处理 H.264，也在越来越多平台上开始具备 H.265 / HEVC 能力。
...
\`\`\`txt
优先：RTSP → vdk/Pion WebRTC → 浏览器硬件解码
...
`,ou=`# Electron / Tauri Desktop Native
...
Electron/Tauri UI
  ...
  -> Go sidecar gateway
  -> RTSP over TCP interleaved
  -> H.264 sample track / H.265 RTP passthrough WebRTC first
...
\`\`\`js
import { configureRTSP, createRTSPPlayer, defineRTSPPlayer } from "@flyfish-dev/rtsp-player";
...
`,yu=`# Xiaomi / Mi Camera RTSP Bridge
...
`,Iu="/assets/contact-CNdl1USL.jpg",Lu="/assets/donate-alipay-BSmrWLPt.jpg",Wu="/assets/donate-wx-Dn3cqFoe.jpg",Mu="/assets/mp-CqDGcv-x.png",Ou="/assets/public-rtsp-e2e-SF2azekD.png",Hu="/assets/rtsp-player-latest-architecture-DXNX5NGC.png",Nu="/assets/rtsp-player-latest-architecture-DHNnpsnF.svg",Bu="/assets/rtsp-player-latest-cover-bg-DdSb4E2y.png",zu="/assets/rtsp-player-latest-cover-B7Gc5T4f.png",Gu="/assets/rtsp-player-wechat-cover-BddK3DxA.png",un="rtsp-player",qu="640px",Uu="360px",Y={extensionId:"",tagName:un,runtime:"extension"},je=new WeakMap,Ve=6,ju=700,Vu=8e3,$u=45e3,Ku=3e3,Zu=5e3;function Yu(){return typeof document>"u"?"":document.currentScript?.dataset?.extensionId||""}function cn(e){return String(e||"").trim().replace(/^chrome-extension:\/\//,"").replace(/\/.*$/,"")}function Ju(e){const n=cn(e);return n?`chrome-extension://${n}`:""}function vn(e,n){if(e==null||e==="")return n;const t=String(e);return/^\d+$/.test(t)?`${t}px`:t}function rt(e){const n=String(e||"").trim().toLowerCase();return n==="desktop"||n==="auto"||n==="extension"?n:"extension"}function Xu(e){const n=String(e).trim().toLowerCase();return n==="webrtc"||n==="ws-annexb"||n==="auto"?n:"auto"}function at(e){const n=String(e||"").trim().toLowerCase();return n==="h265"||n==="hevc"?"h265":n==="h264"||n==="avc"?"h264":"auto"}function de(){return typeof window>"u"?null:window.rtspNative||window.__RTSP_DESKTOP__||null}function ot(){return!!de()?.startStream}function L(e,n,t={}){e.dispatchEvent(new CustomEvent(n,{detail:t,bubbles:!0,composed:!0}))}function Qu(e={}){return e.extensionId!==void 0&&(Y.extensionId=cn(e.extensionId)),e.tagName&&(Y.tagName=String(e.tagName)),e.runtime&&(Y.runtime=rt(e.runtime)),{...Y}}async function Tn(e="auto"){const n=at(e),t={desktopRuntime:ot(),webcodecs:"VideoDecoder"in globalThis,webrtc:"RTCPeerConnection"in globalThis,h264WebRTC:!1,h265WebRTC:!1,h264WebCodecs:!1,h265WebCodecs:!1};try{const r=(globalThis.RTCRtpReceiver?.getCapabilities?.("video")?.codecs||[]).map(a=>String(a.mimeType||"").toLowerCase());t.h264WebRTC=r.includes("video/h264"),t.h265WebRTC=r.includes("video/h265")||r.includes("video/hevc")}catch{}if(t.webcodecs){try{t.h264WebCodecs=!!(await VideoDecoder.isConfigSupported({codec:"avc1.42E01E",hardwareAcceleration:"prefer-hardware",optimizeForLatency:!0})).supported}catch{}try{t.h265WebCodecs=!!(await VideoDecoder.isConfigSupported({codec:"hvc1.1.6.L93.B0",hardwareAcceleration:"prefer-hardware",optimizeForLatency:!0})).supported}catch{}}return t.requestedCodec=n,t}function er(e=Y.tagName||un,n={}){if(typeof window>"u"||typeof customElements>"u")return;Qu(n);const t=String(e||un),u=customElements.get(t);if(u)return u;class r extends HTMLElement{static get observedAttributes(){return["url","src","width","height","autoplay","controls","muted","transport","media-transport","rtsp-transport","codec","runtime","extension-id"]}constructor(){super(),this._iframe=null,this._loaded=!1,this._player=null,this._pc=null,this._video=null,this._mode="",this._streamId="",this._streamToken="",this._playGeneration=0,this._recoveryAttempts=0,this._recoveryTimer=0,this._userStopped=!1,this.attachShadow({mode:"open"})}connectedCallback(){this._render()}disconnectedCallback(){this.stop(),this._iframe?.contentWindow&&je.delete(this._iframe.contentWindow)}attributeChangedCallback(o){if(o==="runtime"||o==="extension-id"){this.stop(),this._iframe=null,this._loaded=!1,this.shadowRoot&&(this.shadowRoot.innerHTML=""),this._render();return}this._resize(),this._mode==="extension"?this._sendInit():this.hasAttribute("autoplay")&&(o==="url"||o==="src")&&this.play()}play(o){o&&this.setAttribute("url",o),this._mode==="extension"?this._sendInit():this._startDesktop()}stop(){this._userStopped=!0,this._playGeneration+=1,this._clearRecoveryTimer(),this._recoveryAttempts=0;const o=this._streamId;if(this._streamId="",this._streamToken="",this._iframe?.contentWindow&&this._iframe.contentWindow.postMessage({type:"RTSP_PLAYER_STOP"},this._origin()),this._player&&(this._player.close(),this._player=null),this._pc){try{this._pc.close()}catch{}this._pc=null}if(this._video){try{this._video.srcObject=null}catch{}this._video.remove(),this._video=null}const s=de();o&&s?.stopStream&&s.stopStream({streamId:o}).catch?.(()=>{})}async capabilities(){return Tn(this._codec())}_runtime(){const o=rt(this.getAttribute("runtime")||Y.runtime);return o==="auto"?ot()?"desktop":"extension":o}_extensionId(){return cn(this.getAttribute("extension-id")||Y.extensionId||window.RTSP_EXTENSION_ID||window.RTSP_WEB_PLAYER_EXTENSION_ID||Yu())}_origin(){return Ju(this._extensionId())}_url(){return this.getAttribute("url")||this.getAttribute("src")||""}_rtspTransport(){const o=this.getAttribute("rtsp-transport"),s=this.getAttribute("transport");return o||(s==="tcp"||s==="udp"?s:"tcp")}_mediaTransport(){return Xu(this.getAttribute("media-transport")||this.getAttribute("transport")||"auto")}_codec(){return at(this.getAttribute("codec")||"auto")}_render(){if(!this.shadowRoot||this.shadowRoot.innerHTML)return;this._resize(),this._runtime()==="desktop"?this._renderDesktop():this._renderExtension()}_renderExtension(){this._mode="extension",this.shadowRoot.innerHTML=`
        <style>
      ...
      `;const o=this.shadowRoot.querySelector(".rtsp-host"),s=this._origin();if(!s){o.innerHTML=this._gatewayGuideHTML("需要安装 RTSP Gateway","普通网页不能直接访问 rtsp://。请先安装 RTSP Gateway 与 Chrome 扩展，或在 Electron/Tauri 中使用 desktop runtime bridge。");return}const i=document.createElement("iframe");i.src=`${s}/player/player.html`,i.allow="autoplay; fullscreen",i.referrerPolicy="no-referrer",i.addEventListener("load",()=>{this._loaded=!0,je.set(i.contentWindow,this),this._sendInit()}),o.appendChild(i),this._iframe=i}_renderDesktop(){this._mode="desktop",this.shadowRoot.innerHTML=`
        <style>
          :host{display:inline-block;background:#050505;min-width:160px;min-height:90px;contain:content;}
          .rtsp-host{width:100%;height:100%;background:#050505;position:relative;overflow:hidden;border-radius:6px;}
      ...
      `,this.hasAttribute("autoplay")&&this._url()&&this._startDesktop()}_resize(){this.style.width=vn(this.getAttribute("width")||this.style.width,qu),this.style.height=vn(this.getAttribute("height")||this.style.height,Uu)}_sendInit(){const o=this._origin();!this._loaded||!this._iframe?.contentWindow||!o||this._iframe.contentWindow.postMessage({type:"RTSP_PLAYER_INIT",url:this._url(),autoplay:this.hasAttribute("autoplay"),controls:this.hasAttribute("controls"),muted:this.hasAttribute("muted"),transport:this._rtspTransport(),rtspTransport:this._rtspTransport(),mediaTransport:this._mediaTransport(),codec:this._codec()},o)}async _startDesktop(){const o=de(),s=this._url().trim();if(!o?.startStream){this._showGatewayGuide("未检测到 RTSP Gateway bridge","Web 组件免插件接入需要先安装 Gateway，并在页面中注入 window.rtspNative 或 window.__RTSP_DESKTOP__。"),this._status("Desktop runtime bridge is not available.","error"),L(this,"error",{error:"Desktop runtime bridge is not available."});return}if(!/^rtsps?:\/\//i.test(s)){this._status("RTSP URL must start with rtsp:// or rtsps://.","error");return}this._stopMediaOnly(),this._userStopped=!1,this._clearRecoveryTimer(),this._recoveryAttempts=0;const i=++this._playGeneration;L(this,"starting",{runtime:"desktop",transport:this._mediaTransport(),codec:this._codec()}),this._status("Starting desktop runtime...");const c=this._mediaTransport(),l=this._codec();(c==="auto"||c==="webrtc")&&await this._canAttemptWebRTC(l)&&await this._startWebRTC(o,s,l,i)||await this._startWebSocket(o,s,l,i)}async _canAttemptWebRTC(o){if(!("RTCPeerConnection"in window))return!1;const s=await Tn(o);return o==="h265"?s.h265WebRTC:o==="h264"?s.h264WebRTC:s.h265WebRTC||s.h264WebRTC}async _startWebRTC(o,s,i,c){if(!o.createWebRTCOffer||!o.startStream)return!1;const l=await o.startStream({url:s,codec:i,transport:this._rtspTransport(),mediaTransport:"webrtc",origin:location.origin});if(!l?.ok||!l.streamId)return this._status(l?.error||"Desktop runtime WebRTC start failed."),!1;this._streamId=l.streamId||"",this._streamToken=l.streamToken||"";const d=new RTCPeerConnection({iceServers:[]});this._pc=d;const h=new MediaStream;let p=!1;d.addTransceiver("video",{direction:"recvonly"}),d.addEventListener("connectionstatechange",()=>{const g=d.connectionState;p&&(g==="failed"||g==="disconnected")&&this._scheduleRecovery(c,`webrtc-connection-${g}`,{codec:i,state:g})}),d.ontrack=g=>{p=!0,g.track?.addEventListener?.("ended",()=>this._scheduleRecovery(c,"webrtc-track-ended",{codec:i})),h.addTrack(g.track),this._attachVideoStream(h,c),this._status(`WebRTC ${i||"auto"} ready.`,"ok"),L(this,"ready",{runtime:"desktop",mediaTransport:"webrtc",codec:i})};const f=await d.createOffer();await d.setLocalDescription(f),await nr(d);const b=await o.createWebRTCOffer({url:s,codec:i,origin:location.origin,streamId:this._streamId,streamToken:this._streamToken,offer:d.localDescription?.sdp||f.sdp});if(!b?.ok||!b.answer){this._status(b?.error||"WebRTC unavailable, falling back to WebSocket.");try{d.close()}catch{}return this._pc=null,await o.stopStream?.({streamId:this._streamId}).catch?.(()=>{}),this._streamId="",this._streamToken="",!1}if(await d.setRemoteDescription({type:"answer",sdp:b.answer}),i=b.codec||i,await tr(Zu),p)return!0;this._status("WebRTC negotiated but no video arrived; falling back to WebSocket.");try{d.close()}catch{}return this._pc=null,await o.stopStream?.({streamId:this._streamId}).catch?.(()=>{}),this._streamId="",this._streamToken="",!1}async _startWebSocket(o,s,i,c){const l=await o.startStream({url:s,codec:i,transport:this._rtspTransport(),mediaTransport:"ws-annexb",origin:location.origin});if(!l?.ok||!l.wsUrl){const h=l?.error||"Desktop runtime start failed.";if(this._recoveryAttempts>0){this._scheduleRecovery(c,"desktop-start-failed",{error:h});return}this._status(h,"error"),L(this,"error",{error:h});return}this._streamId=l.streamId||"",this._streamToken=l.streamToken||"";const d=this.shadowRoot.querySelector("canvas");this._player=new ur(d,{onStatus:(h,p)=>this._status(h,p),onReady:()=>L(this,"ready",{runtime:"desktop",mediaTransport:"ws-annexb",codec:i}),onError:h=>L(this,"error",{error:h}),onHealthy:()=>this._markHealthy(c),onRecoverableError:(h,p)=>this._scheduleRecovery(c,h,p)}),this._player.connect(l.wsUrl)}_attachVideoStream(o,s){const i=document.createElement("video");i.muted=!0,i.autoplay=!0,i.playsInline=!0,i.srcObject=o,i.play().catch(()=>{}),this._video=i;const c=this.shadowRoot.querySelector("canvas"),l=c.getContext("2d");let d=0,h=!1;const p=()=>{this._video&&(i.videoWidth&&i.videoHeight&&((c.width!==i.videoWidth||c.height!==i.videoHeight)&&(c.width=i.videoWidth,c.height=i.videoHeight),l.drawImage(i,0,0,c.width,c.height),d=performance.now(),h||(h=!0,this._markHealthy(s))),requestAnimationFrame(p))};requestAnimationFrame(p);const f=setInterval(()=>{if(this._video!==i){clearInterval(f);return}d&&performance.now()-d>1e4&&(clearInterval(f),this._scheduleRecovery(s,"webrtc-video-stall",{msSinceFrame:Math.round(performance.now()-d)}))},2e3)}_status(o,s=""){const i=this.shadowRoot?.querySelector(".status");i&&(i.textContent=o||"",i.className=`status ${s||""}`)}_gatewayGuideHTML(o,s){return`
      ...
      `}_showGatewayGuide(o,s){const i=this.shadowRoot?.querySelector(".rtsp-host");!i||i.querySelector(".gateway-guide")||i.insertAdjacentHTML("beforeend",this._gatewayGuideHTML(o,s))}_stopMediaOnly(){const o=this._streamId;if(this._streamId="",this._streamToken="",this._player&&(this._player.close(),this._player=null),this._pc){try{this._pc.close()}catch{}this._pc=null}if(this._video){try{this._video.srcObject=null}catch{}this._video.remove(),this._video=null}const s=de();o&&s?.stopStream&&s.stopStream({streamId:o}).catch?.(()=>{})}_clearRecoveryTimer(){this._recoveryTimer&&(clearTimeout(this._recoveryTimer),this._recoveryTimer=0)}_markHealthy(o){o!==this._playGeneration||this._userStopped||(this._recoveryAttempts>0&&L(this,"recovered",{attempt:this._recoveryAttempts}),this._recoveryAttempts=0)}_scheduleRecovery(o,s,i={}){if(o!==this._playGeneration||this._userStopped||this._recoveryTimer)return;if(this._recoveryAttempts>=Ve){const l=`Playback recovery failed: ${s}`;this._status(l,"error"),L(this,"error",{error:l,reason:s,details:i});return}this._recoveryAttempts+=1;const c=Math.min(Vu,ju*2**Math.max(0,this._recoveryAttempts-1));this._status(`Playback interrupted. Recovering (${this._recoveryAttempts}/${Ve})...`,"error"),L(this,"recovering",{reason:s,details:i,attempt:this._recoveryAttempts,maxAttempts:Ve,delay:c}),this._stopMediaOnly(),this._recoveryTimer=setTimeout(()=>{this._recoveryTimer=0,this._restartDesktopAfterRecovery(o)},c)}async _restartDesktopAfterRecovery(o){if(this._userStopped||o!==this._playGeneration)return;const s=de(),i=this._url().trim();if(!s?.startStream||!/^rtsps?:\/\//i.test(i))return;const c=++this._playGeneration,l=this._codec();await this._startWebSocket(s,i,l,c)}}return customElements.define(t,r),window.__RTSP_PLAYER_MESSAGE_BRIDGE__||(window.__RTSP_PLAYER_MESSAGE_BRIDGE__=!0,window.addEventListener("message",a=>{const o=a.source,s=o?je.get(o):null;if(!s||!a.data?.type?.startsWith?.("RTSP_PLAYER_")||a.origin!==s._origin())return;const i=a.data.type.replace(/^RTSP_PLAYER_/,"").toLowerCase();L(s,i,a.data)})),r}function nr(e){return e.iceGatheringState==="complete"?Promise.resolve():new Promise(n=>{const t=setTimeout(u,1200);function u(){clearTimeout(t),e.removeEventListener("icegatheringstatechange",r),n()}function r(){e.iceGatheringState==="complete"&&u()}e.addEventListener("icegatheringstatechange",r)})}function tr(e){return new Promise(n=>setTimeout(n,e))}function Pn(e){return String(e).replace(/[&<>"']/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[n])}class ur{constructor(n,t={}){this.canvas=n,this.ctx=n.getContext("2d"),this.hooks=t,this.ws=null,this.decoder=null,this.codec="",this.gotKey=!1,this.closed=!1,this.lastTimestamp=-1,this.configuredAt=0,this.lastFrameAt=0,this.reportedHealthy=!1,this.decoderErrorTimes=[],this.recovering=!1,this.watchdog=0,this.waitingKeyLogged=!1,this.waitingKeyStatusAt=0}connect(n){this.ws=new WebSocket(n),this.ws.binaryType="arraybuffer",this.ws.onopen=()=>this.hooks.onStatus?.("Connected to desktop gateway."),this.ws.onerror=()=>this.hooks.onStatus?.("WebSocket connection error.","error"),this.ws.onclose=()=>{this.closed||(this.hooks.onStatus?.("Video connection closed.","error"),this.notifyRecoverable("websocket-closed"))},this.ws.onmessage=t=>this.handleMessage(t.data),this.startWatchdog()}async handleMessage(n){if(typeof n=="string"){let t;try{t=JSON.parse(n)}catch{return}t.type==="config"?await this.configure(t.codec):t.type==="error"&&this.notifyRecoverable("gateway-error",{error:t.error||"RTSP error"});return}n instanceof ArrayBuffer&&this.handleAccessUnit(n)}async configure(n){if(n||="avc1.42E01E",this.decoder&&this.codec===n)return;if(this.codec=n,this.decoder)try{this.decoder.close()}catch{}if(!("VideoDecoder"in window)){this.hooks.onStatus?.("VideoDecoder is not supported in this runtime.","error"),this.hooks.onError?.("VideoDecoder is not supported in this runtime.");return}const t={codec:n,hardwareAcceleration:"prefer-hardware",optimizeForLatency:!0};try{if(!(await VideoDecoder.isConfigSupported(t)).supported){const r=`Runtime does not support codec ${n}.`;this.hooks.onStatus?.(r,"error"),this.hooks.onError?.(r);return}}catch{}this.decoder=new VideoDecoder({output:u=>this.render(u),error:u=>this.recoverDecoder(u?.message||String(u))}),this.decoder.configure(t),this.gotKey=!1,this.configuredAt=performance.now(),this.waitingKeyLogged=!1,this.waitingKeyStatusAt=0,this.hooks.onStatus?.(`Decoder ready: ${n}. Waiting for the first key/startup frame...`,"ok")}handleAccessUnit(n){if(n.byteLength<16||!this.decoder||this.decoder.state!=="configured")return;const t=new DataView(n);if(t.getUint8(0)!==1)return;const u=t.getUint8(1)===1;let r=Number(t.getBigUint64(4,!0));const a=t.getUint32(12,!0);if(!(a<=0||16+a>n.byteLength)){if(!u&&!this.gotKey){const o=performance.now();(!this.waitingKeyLogged||o-this.waitingKeyStatusAt>5e3)&&(this.waitingKeyLogged=!0,this.waitingKeyStatusAt=o,this.hooks.onStatus?.("Waiting for the first camera key/startup frame..."));return}if(u&&!this.gotKey&&(this.gotKey=!0,this.hooks.onStatus?.("Keyframe received. Rendering first frame...")),r<=this.lastTimestamp&&(r=this.lastTimestamp+1),this.lastTimestamp=r,!(!u&&this.decoder.decodeQueueSize>6))try{this.decoder.decode(new EncodedVideoChunk({type:u?"key":"delta",timestamp:r,data:new Uint8Array(n,16,a)}))}catch(o){this.recoverDecoder(o?.message||String(o))}}}render(n){try{(this.canvas.width!==n.displayWidth||this.canvas.height!==n.displayHeight)&&(this.canvas.width=n.displayWidth,this.canvas.height=n.displayHeight),this.ctx.drawImage(n,0,0,this.canvas.width,this.canvas.height),this.lastFrameAt=performance.now(),this.reportedHealthy||(this.reportedHealthy=!0,this.hooks.onStatus?.(`Video ready: ${n.displayWidth}x${n.displayHeight}`,"ok"),this.hooks.onReady?.(),this.hooks.onHealthy?.())}finally{n.close()}}recoverDecoder(n){if(this.closed||this.recovering)return;const t=performance.now();if(this.decoderErrorTimes=this.decoderErrorTimes.filter(u=>t-u<1e4),this.decoderErrorTimes.push(t),this.decoderErrorTimes.length>2){this.notifyRecoverable("decoder-error-loop",{error:n,codec:this.codec,decoderErrors:this.decoderErrorTimes.length});return}this.recovering=!0;try{this.decoder&&this.decoder.close()}catch{}this.decoder=null,this.gotKey=!1,this.hooks.onStatus?.("Decoder error. Rebuilding decoder...","error"),setTimeout(()=>{this.closed||(this.recovering=!1,this.configure(this.codec).catch(u=>{this.notifyRecoverable("decoder-reconfigure-failed",{error:u?.message||String(u),codec:this.codec})}))},180)}startWatchdog(){this.watchdog||(this.watchdog=setInterval(()=>{if(this.closed||this.recovering)return;const n=performance.now();if(this.configuredAt&&!this.lastFrameAt&&n-this.configuredAt>Ku&&!this.waitingKeyLogged&&(this.waitingKeyLogged=!0,this.waitingKeyStatusAt=n,this.hooks.onStatus?.("Waiting for the first camera key/startup frame...")),this.configuredAt&&!this.lastFrameAt&&n-this.configuredAt>$u){this.notifyRecoverable("video-stall-before-first-frame",{codec:this.codec});return}this.lastFrameAt&&n-this.lastFrameAt>1e4&&this.notifyRecoverable("video-stall",{codec:this.codec,msSinceFrame:Math.round(n-this.lastFrameAt)})},2e3))}notifyRecoverable(n,t={}){this.closed||this.recovering||(this.recovering=!0,this.hooks.onRecoverableError?.(n,t))}close(){if(this.closed=!0,this.watchdog&&(clearInterval(this.watchdog),this.watchdog=0),this.ws){try{this.ws.close()}catch{}this.ws=null}if(this.decoder){try{this.decoder.close()}catch{}this.decoder=null}}}const Rn={};function rr(e){let n=Rn[e];if(n)return n;n=Rn[e]=[];for(let t=0;t<128;t++){const u=String.fromCharCode(t);n.push(u)}for(let t=0;t<e.length;t++){const u=e.charCodeAt(t);n[u]="%"+("0"+u.toString(16).toUpperCase()).slice(-2)}return n}function re(e,n){typeof n!="string"&&(n=re.defaultChars);const t=rr(n);return e.replace(/(%[a-f0-9]{2})+/gi,function(u){let r="";for(let a=0,o=u.length;a<o;a+=3){const s=parseInt(u.slice(a+1,a+3),16);if(s<128){r+=t[s];continue}if((s&224)===192&&a+3<o){const i=parseInt(u.slice(a+4,a+6),16);if((i&192)===128){const c=s<<6&1984|i&63;c<128?r+="��":r+=String.fromCharCode(c),a+=3;continue}}if((s&240)===224&&a+6<o){const i=parseInt(u.slice(a+4,a+6),16),c=parseInt(u.slice(a+7,a+9),16);if((i&192)===128&&(c&192)===128){const l=s<<12&61440|i<<6&4032|c&63;l<2048||l>=55296&&l<=57343?r+="���":r+=String.fromCharCode(l),a+=6;continue}}if((s&248)===240&&a+9<o){const i=parseInt(u.slice(a+4,a+6),16),c=parseInt(u.slice(a+7,a+9),16),l=parseInt(u.slice(a+10,a+12),16);if((i&192)===128&&(c&192)===128&&(l&192)===128){let d=s<<18&1835008|i<<12&258048|c<<6&4032|l&63;d<65536||d>1114111?r+="����":(d-=65536,r+=String.fromCharCode(55296+(d>>10),56320+(d&1023))),a+=9;continue}}r+="�"}return r})}re.defaultChars=";/?:@&=+$,#";re.componentChars="";const Dn={};function ar(e){let n=Dn[e];if(n)return n;n=Dn[e]=[];for(let t=0;t<128;t++){const u=String.fromCharCode(t);/^[0-9a-z]$/i.test(u)?n.push(u):n.push("%"+("0"+t.toString(16).toUpperCase()).slice(-2))}for(let t=0;t<e.length;t++)n[e.charCodeAt(t)]=e[t];return n}function Se(e,n,t){typeof n!="string"&&(t=n,n=Se.defaultChars),typeof t>"u"&&(t=!0);const u=ar(n);let r="";for(let a=0,o=e.length;a<o;a++){const s=e.charCodeAt(a);if(t&&s===37&&a+2<o&&/^[0-9a-f]{2}$/i.test(e.slice(a+1,a+3))){r+=e.slice(a,a+3),a+=2;continue}if(s<128){r+=u[s];continue}if(s>=55296&&s<=57343){if(s>=55296&&s<=56319&&a+1<o){const i=e.charCodeAt(a+1);if(i>=56320&&i<=57343){r+=encodeURIComponent(e[a]+e[a+1]),a++;continue}}r+="%EF%BF%BD";continue}r+=encodeURIComponent(e[a])}return r}Se.defaultChars=";/?:@&=+$,-_.!~*'()#";Se.componentChars="-_.!~*'()";function ln(e){let n="";return n+=e.protocol||"",n+=e.slashes?"//":"",n+=e.auth?e.auth+"@":"",e.hostname&&e.hostname.indexOf(":")!==-1?n+="["+e.hostname+"]":n+=e.hostname||"",n+=e.port?":"+e.port:"",n+=e.pathname||"",n+=e.search||"",n+=e.hash||"",n}function De(){this.protocol=null,this.slashes=null,this.auth=null,this.port=null,this.hostname=null,this.hash=null,this.search=null,this.pathname=null}const or=/^([a-z0-9.+-]+:)/i,sr=/:[0-9]*$/,ir=/^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/,cr=["<",">",'"',"`"," ","\r",`
`,"	"],lr=["{","}","|","\\","^","`"].concat(cr),dr=["'"].concat(lr),En=["%","/","?",";","#"].concat(dr),An=["/","?","#"],fr=255,Fn=/^[+a-z0-9A-Z_-]{0,63}$/,pr=/^([+a-z0-9A-Z_-]{0,63})(.*)$/,In={javascript:!0,"javascript:":!0},Ln={http:!0,https:!0,ftp:!0,gopher:!0,file:!0,"http:":!0,"https:":!0,"ftp:":!0,"gopher:":!0,"file:":!0};function dn(e,n){if(e&&e instanceof De)return e;const t=new De;return t.parse(e,n),t}De.prototype.parse=function(e,n){let t,u,r,a=e;if(a=a.trim(),!n&&e.split("#").length===1){const c=ir.exec(a);if(c)return this.pathname=c[1],c[2]&&(this.search=c[2]),this}let o=or.exec(a);if(o&&(o=o[0],t=o.toLowerCase(),this.protocol=o,a=a.substr(o.length)),(n||o||a.match(/^\/\/[^@\/]+@[^@\/]+/))&&(r=a.substr(0,2)==="//",r&&!(o&&In[o])&&(a=a.substr(2),this.slashes=!0)),!In[o]&&(r||o&&!Ln[o])){let c=-1;for(let f=0;f<An.length;f++)u=a.indexOf(An[f]),u!==-1&&(c===-1||u<c)&&(c=u);let l,d;c===-1?d=a.lastIndexOf("@"):d=a.lastIndexOf("@",c),d!==-1&&(l=a.slice(0,d),a=a.slice(d+1),this.auth=l),c=-1;for(let f=0;f<En.length;f++)u=a.indexOf(En[f]),u!==-1&&(c===-1||u<c)&&(c=u);c===-1&&(c=a.length),a[c-1]===":"&&c--;const h=a.slice(0,c);a=a.slice(c),this.parseHost(h),this.hostname=this.hostname||"";const p=this.hostname[0]==="["&&this.hostname[this.hostname.length-1]==="]";if(!p){const f=this.hostname.split(/\./);for(let b=0,g=f.length;b<g;b++){const S=f[b];if(S&&!S.match(Fn)){let y="";for(let m=0,x=S.length;m<x;m++)S.charCodeAt(m)>127?y+="x":y+=S[m];if(!y.match(Fn)){const m=f.slice(0,b),x=f.slice(b+1),_=S.match(pr);_&&(m.push(_[1]),x.unshift(_[2])),x.length&&(a=x.join(".")+a),this.hostname=m.join(".");break}}}}this.hostname.length>fr&&(this.hostname=""),p&&(this.hostname=this.hostname.substr(1,this.hostname.length-2))}const s=a.indexOf("#");s!==-1&&(this.hash=a.substr(s),a=a.slice(0,s));const i=a.indexOf("?");return i!==-1&&(this.search=a.substr(i),a=a.slice(0,i)),a&&(this.pathname=a),Ln[t]&&this.hostname&&!this.pathname&&(this.pathname=""),this};De.prototype.parseHost=function(e){let n=sr.exec(e);n&&(n=n[0],n!==":"&&(this.port=n.substr(1)),e=e.substr(0,e.length-n.length)),e&&(this.hostname=e)};const hr=Object.freeze(Object.defineProperty({__proto__:null,decode:re,encode:Se,format:ln,parse:dn},Symbol.toStringTag,{value:"Module"})),st=/[\0-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,it=/[\0-\x1F\x7F-\x9F]/,mr=/[\xAD\u0600-\u0605\u061C\u06DD\u070F\u0890\u0891\u08E2\u180E\u200B-\u200F\u202A-\u202E\u2060-\u2064\u2066-\u206F\uFEFF\uFFF9-\uFFFB]|\uD804[\uDCBD\uDCCD]|\uD80D[\uDC30-\uDC3F]|\uD82F[\uDCA0-\uDCA3]|\uD834[\uDD73-\uDD7A]|\uDB40[\uDC01\uDC20-\uDC7F]/,fn=/[!-#%-\*,-\/:;\?@\[-\]_\{\}\xA1\xA7\xAB\xB6\xB7\xBB\xBF\u037E\u0387\u055A-\u055F\u0589\u058A\u05BE\u05C0\u05C3\u05C6\u05F3\u05F4\u0609\u060A\u060C\u060D\u061B\u061D-\u061F\u066A-\u066D\u06D4\u0700-\u070D\u07F7-\u07F9\u0830-\u083E\u085E\u0964\u0965\u0970\u09FD\u0A76\u0AF0\u0C77\u0C84\u0DF4\u0E4F\u0E5A\u0E5B\u0F04-\u0F12\u0F14\u0F3A-\u0F3D\u0F85\u0FD0-\u0FD4\u0FD9\u0FDA\u104A-\u104F\u10FB\u1360-\u1368\u1400\u166E\u169B\u169C\u16EB-\u16ED\u1735\u1736\u17D4-\u17D6\u17D8-\u17DA\u1800-\u180A\u1944\u1945\u1A1E\u1A1F\u1AA0-\u1AA6\u1AA8-\u1AAD\u1B5A-\u1B60\u1B7D\u1B7E\u1BFC-\u1BFF\u1C3B-\u1C3F\u1C7E\u1C7F\u1CC0-\u1CC7\u1CD3\u2010-\u2027\u2030-\u2043\u2045-\u2051\u2053-\u205E\u207D\u207E\u208D\u208E\u2308-\u230B\u2329\u232A\u2768-\u2775\u27C5\u27C6\u27E6-\u27EF\u2983-\u2998\u29D8-\u29DB\u29FC\u29FD\u2CF9-\u2CFC\u2CFE\u2CFF\u2D70\u2E00-\u2E2E\u2E30-\u2E4F\u2E52-\u2E5D\u3001-\u3003\u3008-\u3011\u3014-\u301F\u3030\u303D\u30A0\u30FB\uA4FE\uA4FF\uA60D-\uA60F\uA673\uA67E\uA6F2-\uA6F7\uA874-\uA877\uA8CE\uA8CF\uA8F8-\uA8FA\uA8FC\uA92E\uA92F\uA95F\uA9C1-\uA9CD\uA9DE\uA9DF\uAA5C-\uAA5F\uAADE\uAADF\uAAF0\uAAF1\uABEB\uFD3E\uFD3F\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE61\uFE63\uFE68\uFE6A\uFE6B\uFF01-\uFF03\uFF05-\uFF0A\uFF0C-\uFF0F\uFF1A\uFF1B\uFF1F\uFF20\uFF3B-\uFF3D\uFF3F\uFF5B\uFF5D\uFF5F-\uFF65]|\uD800[\uDD00-\uDD02\uDF9F\uDFD0]|\uD801\uDD6F|\uD802[\uDC57\uDD1F\uDD3F\uDE50-\uDE58\uDE7F\uDEF0-\uDEF6\uDF39-\uDF3F\uDF99-\uDF9C]|\uD803[\uDEAD\uDF55-\uDF59\uDF86-\uDF89]|\uD804[\uDC47-\uDC4D\uDCBB\uDCBC\uDCBE-\uDCC1\uDD40-\uDD43\uDD74\uDD75\uDDC5-\uDDC8\uDDCD\uDDDB\uDDDD-\uDDDF\uDE38-\uDE3D\uDEA9]|\uD805[\uDC4B-\uDC4F\uDC5A\uDC5B\uDC5D\uDCC6\uDDC1-\uDDD7\uDE41-\uDE43\uDE60-\uDE6C\uDEB9\uDF3C-\uDF3E]|\uD806[\uDC3B\uDD44-\uDD46\uDDE2\uDE3F-\uDE46\uDE9A-\uDE9C\uDE9E-\uDEA2\uDF00-\uDF09]|\uD807[\uDC41-\uDC45\uDC70\uDC71\uDEF7\uDEF8\uDF43-\uDF4F\uDFFF]|\uD809[\uDC70-\uDC74]|\uD80B[\uDFF1\uDFF2]|\uD81A[\uDE6E\uDE6F\uDEF5\uDF37-\uDF3B\uDF44]|\uD81B[\uDE97-\uDE9A\uDFE2]|\uD82F\uDC9F|\uD836[\uDE87-\uDE8B]|\uD83A[\uDD5E\uDD5F]/,ct=/[\$\+<->\^`\|~\xA2-\xA6\xA8\xA9\xAC\xAE-\xB1\xB4\xB8\xD7\xF7\u02C2-\u02C5\u02D2-\u02DF\u02E5-\u02EB\u02ED\u02EF-\u02FF\u0375\u0384\u0385\u03F6\u0482\u058D-\u058F\u0606-\u0608\u060B\u060E\u060F\u06DE\u06E9\u06FD\u06FE\u07F6\u07FE\u07FF\u0888\u09F2\u09F3\u09FA\u09FB\u0AF1\u0B70\u0BF3-\u0BFA\u0C7F\u0D4F\u0D79\u0E3F\u0F01-\u0F03\u0F13\u0F15-\u0F17\u0F1A-\u0F1F\u0F34\u0F36\u0F38\u0FBE-\u0FC5\u0FC7-\u0FCC\u0FCE\u0FCF\u0FD5-\u0FD8\u109E\u109F\u1390-\u1399\u166D\u17DB\u1940\u19DE-\u19FF\u1B61-\u1B6A\u1B74-\u1B7C\u1FBD\u1FBF-\u1FC1\u1FCD-\u1FCF\u1FDD-\u1FDF\u1FED-\u1FEF\u1FFD\u1FFE\u2044\u2052\u207A-\u207C\u208A-\u208C\u20A0-\u20C0\u2100\u2101\u2103-\u2106\u2108\u2109\u2114\u2116-\u2118\u211E-\u2123\u2125\u2127\u2129\u212E\u213A\u213B\u2140-\u2144\u214A-\u214D\u214F\u218A\u218B\u2190-\u2307\u230C-\u2328\u232B-\u2426\u2440-\u244A\u249C-\u24E9\u2500-\u2767\u2794-\u27C4\u27C7-\u27E5\u27F0-\u2982\u2999-\u29D7\u29DC-\u29FB\u29FE-\u2B73\u2B76-\u2B95\u2B97-\u2BFF\u2CE5-\u2CEA\u2E50\u2E51\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFF\u3004\u3012\u3013\u3020\u3036\u3037\u303E\u303F\u309B\u309C\u3190\u3191\u3196-\u319F\u31C0-\u31E3\u31EF\u3200-\u321E\u322A-\u3247\u3250\u3260-\u327F\u328A-\u32B0\u32C0-\u33FF\u4DC0-\u4DFF\uA490-\uA4C6\uA700-\uA716\uA720\uA721\uA789\uA78A\uA828-\uA82B\uA836-\uA839\uAA77-\uAA79\uAB5B\uAB6A\uAB6B\uFB29\uFBB2-\uFBC2\uFD40-\uFD4F\uFDCF\uFDFC-\uFDFF\uFE62\uFE64-\uFE66\uFE69\uFF04\uFF0B\uFF1C-\uFF1E\uFF3E\uFF40\uFF5C\uFF5E\uFFE0-\uFFE6\uFFE8-\uFFEE\uFFFC\uFFFD]|\uD800[\uDD37-\uDD3F\uDD79-\uDD89\uDD8C-\uDD8E\uDD90-\uDD9C\uDDA0\uDDD0-\uDDFC]|\uD802[\uDC77\uDC78\uDEC8]|\uD805\uDF3F|\uD807[\uDFD5-\uDFF1]|\uD81A[\uDF3C-\uDF3F\uDF45]|\uD82F\uDC9C|\uD833[\uDF50-\uDFC3]|\uD834[\uDC00-\uDCF5\uDD00-\uDD26\uDD29-\uDD64\uDD6A-\uDD6C\uDD83\uDD84\uDD8C-\uDDA9\uDDAE-\uDDEA\uDE00-\uDE41\uDE45\uDF00-\uDF56]|\uD835[\uDEC1\uDEDB\uDEFB\uDF15\uDF35\uDF4F\uDF6F\uDF89\uDFA9\uDFC3]|\uD836[\uDC00-\uDDFF\uDE37-\uDE3A\uDE6D-\uDE74\uDE76-\uDE83\uDE85\uDE86]|\uD838[\uDD4F\uDEFF]|\uD83B[\uDCAC\uDCB0\uDD2E\uDEF0\uDEF1]|\uD83C[\uDC00-\uDC2B\uDC30-\uDC93\uDCA0-\uDCAE\uDCB1-\uDCBF\uDCC1-\uDCCF\uDCD1-\uDCF5\uDD0D-\uDDAD\uDDE6-\uDE02\uDE10-\uDE3B\uDE40-\uDE48\uDE50\uDE51\uDE60-\uDE65\uDF00-\uDFFF]|\uD83D[\uDC00-\uDED7\uDEDC-\uDEEC\uDEF0-\uDEFC\uDF00-\uDF76\uDF7B-\uDFD9\uDFE0-\uDFEB\uDFF0]|\uD83E[\uDC00-\uDC0B\uDC10-\uDC47\uDC50-\uDC59\uDC60-\uDC87\uDC90-\uDCAD\uDCB0\uDCB1\uDD00-\uDE53\uDE60-\uDE6D\uDE70-\uDE7C\uDE80-\uDE88\uDE90-\uDEBD\uDEBF-\uDEC5\uDECE-\uDEDB\uDEE0-\uDEE8\uDEF0-\uDEF8\uDF00-\uDF92\uDF94-\uDFCA]/,lt=/[ \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000]/,br=Object.freeze(Object.defineProperty({__proto__:null,Any:st,Cc:it,Cf:mr,P:fn,S:ct,Z:lt},Symbol.toStringTag,{value:"Module"})),gr=new Uint16Array('ᵁ<Õıʊҝջאٵ۞ޢߖࠏ੊ઑඡ๭༉༦჊ረዡᐕᒝᓃᓟᔥ\0\0\0\0\0\0ᕫᛍᦍᰒᷝ὾⁠↰⊍⏀⏻⑂⠤⤒ⴈ⹈⿎〖㊺㘹㞬㣾㨨㩱㫠㬮ࠀEMabcfglmnoprstu\\bfms¦³¹ÈÏlig耻Æ䃆P耻&䀦cute耻Á䃁reve;䄂Āiyx}rc耻Â䃂;䐐r;쀀𝔄rave耻À䃀pha;䎑acr;䄀d;橓Āgp¡on;䄄f;쀀𝔸plyFunction;恡ing耻Å䃅Ācs¾Ãr;쀀𝒜ign;扔ilde耻Ã䃃ml耻Ä䃄ЀaceforsuåûþėĜĢħĪĀcrêòkslash;或Ŷöø;櫧ed;挆y;䐑ƀcrtąċĔause;戵noullis;愬a;䎒r;쀀𝔅pf;쀀𝔹eve;䋘còēmpeq;扎܀HOacdefhilorsuōőŖƀƞƢƵƷƺǜȕɳɸɾcy;䐧PY耻©䂩ƀcpyŝŢźute;䄆Ā;iŧŨ拒talDifferentialD;慅leys;愭ȀaeioƉƎƔƘron;䄌dil耻Ç䃇rc;䄈nint;戰ot;䄊ĀdnƧƭilla;䂸terDot;䂷òſi;䎧rcleȀDMPTǇǋǑǖot;抙inus;抖lus;投imes;抗oĀcsǢǸkwiseContourIntegral;戲eCurlyĀDQȃȏoubleQuote;思uote;怙ȀlnpuȞȨɇɕonĀ;eȥȦ户;橴ƀgitȯȶȺruent;扡nt;戯ourIntegral;戮ĀfrɌɎ;愂oduct;成nterClockwiseContourIntegral;戳oss;樯cr;쀀𝒞pĀ;Cʄʅ拓ap;才րDJSZacefiosʠʬʰʴʸˋ˗ˡ˦̳ҍĀ;oŹʥtrahd;椑cy;䐂cy;䐅cy;䐏ƀgrsʿ˄ˇger;�
‮耻½䂽;慓耻¼䂼;慕;慙;慛Ƴ‴\0‶;慔;慖ʴ‾⁁\0\0⁃耻¾䂾;慗;慜5;慘ƶ⁌\0⁎;慚;慝8;慞l;恄wn;挢cr;쀀𝒻ࢀEabcdefgijlnorstv₂₉₟₥₰₴⃰⃵⃺⃿℃ℒℸ̗ℾ⅒↞Ā;lٍ₇;檌ƀcmpₐₕ₝ute;䇵maĀ;dₜ᳚䎳;檆reve;䄟Āiy₪₮rc;䄝;䐳ot;䄡Ȁ;lqsؾق₽⃉ƀ;qsؾٌ⃄lanô٥Ȁ;cdl٥⃒⃥⃕c;檩otĀ;o⃜⃝檀Ā;l⃢⃣檂;檄Ā;e⃪⃭쀀⋛︀s;檔r;쀀𝔤Ā;gٳ؛mel;愷cy;䑓Ȁ;Eajٚℌℎℐ;檒;檥;檤ȀEaesℛℝ℩ℴ;扩pĀ;p℣ℤ檊rox»ℤĀ;q℮ℯ檈Ā;q℮ℛim;拧pf;쀀𝕘Āci⅃ⅆr;愊mƀ;el٫ⅎ⅐;檎;檐茀>;cdlqr׮ⅠⅪⅮⅳⅹĀciⅥⅧ;檧r;橺ot;拗Par;榕uest;橼ʀadelsↄⅪ←ٖ↛ǰ↉\0↎proø₞r;楸qĀlqؿ↖lesó₈ií٫Āen↣↭rtneqq;쀀≩︀Å↪ԀAabcefkosy⇄⇇⇱⇵⇺∘∝∯≨≽ròΠȀilmr⇐⇔⇗⇛rsðᒄf»․ilôکĀdr⇠⇤cy;䑊ƀ;cwࣴ⇫⇯ir;楈;憭ar;意irc;䄥ƀalr∁∎∓rtsĀ;u∉∊晥it»∊lip;怦con;抹r;쀀𝔥sĀew∣∩arow;椥arow;椦ʀamopr∺∾≃≞≣rr;懿tht;戻kĀlr≉≓eftarrow;憩ightarrow;憪f;쀀𝕙bar;怕ƀclt≯≴≸r;쀀𝒽asè⇴rok;䄧Ābp⊂⊇ull;恃hen»ᱛૡ⊣\0⊪\0⊸⋅⋎\0⋕⋳\0\0⋸⌢⍧⍢⍿\0⎆⎪⎴cute耻í䃭ƀ;iyݱ⊰⊵rc耻î䃮;䐸Ācx⊼⊿y;䐵cl耻¡䂡ĀfrΟ⋉;쀀𝔦rave耻ì䃬Ȁ;inoܾ⋝⋩⋮Āin⋢⋦nt;樌t;戭fin;槜ta;愩lig;䄳ƀaop⋾⌚⌝ƀcgt⌅⌈⌗r;䄫ƀelpܟ⌏⌓inåގarôܠh;䄱f;抷ed;䆵ʀ;cfotӴ⌬⌱⌽⍁are;愅inĀ;t⌸⌹戞ie;槝doô⌙ʀ;celpݗ⍌⍐⍛⍡al;抺Āgr⍕⍙eróᕣã⍍arhk;樗rod;樼Ȁcgpt⍯⍲⍶⍻y;䑑on;䄯f;쀀𝕚a;䎹uest耻¿䂿Āci⎊⎏r;쀀𝒾nʀ;EdsvӴ⎛⎝⎡ӳ;拹ot;拵Ā;v⎦⎧拴;拳Ā;iݷ⎮lde;䄩ǫ⎸\0⎼cy;䑖l耻ï䃯̀cfm
��萀<;cdhilqrࠫ⟒☹⟜⟠⟥⟪⟰Āci⟗⟙;檦r;橹reå◲mes;拉arr;楶uest;橻ĀPi⟵⟹ar;榖ƀ;ef⠀भ᠛旃rĀdu⠇⠍shar;楊har;楦Āen⠗⠡rtneqq;쀀≨︀Å⠞܀Dacdefhilnopsu⡀⡅⢂⢎⢓⢠⢥⢨⣚⣢⣤ઃ⣳⤂Dot;戺Ȁclpr⡎⡒⡣⡽r耻¯䂯Āet⡗⡙;時Ā;e⡞⡟朠se»⡟Ā;sျ⡨toȀ;dluျ⡳⡷⡻owîҌefôएðᏑker;斮Āoy⢇⢌mma;権;䐼ash;怔asuredangle»ᘦr;쀀𝔪o;愧ƀcdn⢯⢴⣉ro耻µ䂵Ȁ;acdᑤ⢽⣀⣄sôᚧir;櫰ot肻·Ƶusƀ;bd⣒ᤃ⣓戒Ā;uᴼ⣘;横ţ⣞⣡p;櫛ò−ðઁĀdp⣩⣮els;抧f;쀀𝕞Āct⣸⣽r;쀀𝓂pos»ᖝƀ;lm⤉⤊⤍䎼timap;抸ఀGLRVabcdefghijlmoprstuvw⥂⥓⥾⦉⦘⧚⧩⨕⨚⩘⩝⪃⪕⪤⪨⬄⬇⭄⭿⮮ⰴⱧⱼ⳩Āgt⥇⥋;쀀⋙̸Ā;v⥐௏쀀≫⃒ƀelt⥚⥲⥶ftĀar⥡⥧rrow;懍ightarrow;懎;쀀⋘̸Ā;v⥻ే쀀≪⃒ightarrow;懏ĀDd⦎⦓ash;抯ash;抮ʀbcnpt⦣⦧⦬⦱⧌la»˞ute;䅄g;쀀∠⃒ʀ;Eiop඄⦼⧀⧅⧈;쀀⩰̸d;쀀≋̸s;䅉roø඄urĀ;a⧓⧔普lĀ;s⧓ସǳ⧟\0⧣p肻 ଷmpĀ;e௹ఀʀaeouy⧴⧾⨃⨐⨓ǰ⧹\0⧻;橃on;䅈dil;䅆ngĀ;dൾ⨊ot;쀀⩭̸p;橂;䐽ash;怓΀;Aadqsxஒ⨩⨭⨻⩁⩅⩐rr;懗rĀhr⨳⨶k;椤Ā;oᏲᏰot;쀀≐̸uiöୣĀei⩊⩎ar;椨í஘istĀ;s஠டr;쀀𝔫ȀEest௅⩦⩹⩼ƀ;qs஼⩭௡ƀ;qs஼௅⩴lanô௢ií௪Ā;rஶ⪁»ஷƀAap⪊⪍⪑rò⥱rr;憮ar;櫲ƀ;svྍ⪜ྌĀ;d⪡⪢拼;拺cy;䑚΀AEadest⪷⪺⪾⫂⫅⫶⫹rò⥦;쀀≦̸rr;憚r;急Ȁ;fqs఻⫎⫣⫯tĀar⫔⫙rro÷⫁ightarro÷⪐ƀ;qs఻⪺⫪lanôౕĀ;sౕ⫴»శiíౝĀ;rవ⫾iĀ;eచథiäඐĀpt⬌⬑f;쀀𝕟膀¬;in⬙⬚⬶䂬nȀ;Edvஉ⬤⬨⬮;쀀⋹̸ot;쀀⋵̸ǡஉ⬳⬵;拷;拶iĀ;vಸ⬼ǡಸ⭁⭃;拾;拽�
��㥭gmá㎳Ābp㥲㦄setneqĀ;q㥽㦀쀀⊊︀;쀀⫋︀setneqĀ;q㦏㦒쀀⊋︀;쀀⫌︀Āhr㦛㦟etá㚜iangleĀlr㦪㦯eft»थight»ၑy;䐲ash»ံƀelr㧄㧒㧗ƀ;beⷪ㧋㧏ar;抻q;扚lip;拮Ābt㧜ᑨaòᑩr;쀀𝔳tré㦮suĀbp㧯㧱»ജ»൙pf;쀀𝕧roð໻tré㦴Ācu㨆㨋r;쀀𝓋Ābp㨐㨘nĀEe㦀㨖»㥾nĀEe㦒㨞»㦐igzag;榚΀cefoprs㨶㨻㩖㩛㩔㩡㩪irc;䅵Ādi㩀㩑Ābg㩅㩉ar;機eĀ;qᗺ㩏;扙erp;愘r;쀀𝔴pf;쀀𝕨Ā;eᑹ㩦atèᑹcr;쀀𝓌ૣណ㪇\0㪋\0㪐㪛\0\0㪝㪨㪫㪯\0\0㫃㫎\0㫘ៜ៟tré៑r;쀀𝔵ĀAa㪔㪗ròσrò৶;䎾ĀAa㪡㪤ròθrò৫að✓is;拻ƀdptឤ㪵㪾Āfl㪺ឩ;쀀𝕩imåឲĀAa㫇㫊ròώròਁĀcq㫒ីr;쀀𝓍Āpt៖㫜ré។Ѐacefiosu㫰㫽㬈㬌㬑㬕㬛㬡cĀuy㫶㫻te耻ý䃽;䑏Āiy㬂㬆rc;䅷;䑋n耻¥䂥r;쀀𝔶cy;䑗pf;쀀𝕪cr;쀀𝓎Ācm㬦㬩y;䑎l耻ÿ䃿Ԁacdefhiosw㭂㭈㭔㭘㭤㭩㭭㭴㭺㮀cute;䅺Āay㭍㭒ron;䅾;䐷ot;䅼Āet㭝㭡træᕟa;䎶r;쀀𝔷cy;䐶grarr;懝pf;쀀𝕫cr;쀀𝓏Ājn㮅㮇;怍j;怌'.split("").map(e=>e.charCodeAt(0))),xr=new Uint16Array("Ȁaglq	\x1Bɭ\0\0p;䀦os;䀧t;䀾t;䀼uot;䀢".split("").map(e=>e.charCodeAt(0)));var $e;const yr=new Map([[0,65533],[128,8364],[130,8218],[131,402],[132,8222],[133,8230],[134,8224],[135,8225],[136,710],[137,8240],[138,352],[139,8249],[140,338],[142,381],[145,8216],[146,8217],[147,8220],[148,8221],[149,8226],[150,8211],[151,8212],[152,732],[153,8482],[154,353],[155,8250],[156,339],[158,382],[159,376]]),_r=($e=String.fromCodePoint)!==null&&$e!==void 0?$e:function(e){let n="";return e>65535&&(e-=65536,n+=String.fromCharCode(e>>>10&1023|55296),e=56320|e&1023),n+=String.fromCharCode(e),n};function kr(e){var n;return e>=55296&&e<=57343||e>1114111?65533:(n=yr.get(e))!==null&&n!==void 0?n:e}var R;(function(e){e[e.NUM=35]="NUM",e[e.SEMI=59]="SEMI",e[e.EQUALS=61]="EQUALS",e[e.ZERO=48]="ZERO",e[e.NINE=57]="NINE",e[e.LOWER_A=97]="LOWER_A",e[e.LOWER_F=102]="LOWER_F",e[e.LOWER_X=120]="LOWER_X",e[e.LOWER_Z=122]="LOWER_Z",e[e.UPPER_A=65]="UPPER_A",e[e.UPPER_F=70]="UPPER_F",e[e.UPPER_Z=90]="UPPER_Z"})(R||(R={}));const Sr=32;var V;(function(e){e[e.VALUE_LENGTH=49152]="VALUE_LENGTH",e[e.BRANCH_LENGTH=16256]="BRANCH_LENGTH",e[e.JUMP_TABLE=127]="JUMP_TABLE"})(V||(V={}));function rn(e){return e>=R.ZERO&&e<=R.NINE}function wr(e){return e>=R.UPPER_A&&e<=R.UPPER_F||e>=R.LOWER_A&&e<=R.LOWER_F}function Cr(e){return e>=R.UPPER_A&&e<=R.UPPER_Z||e>=R.LOWER_A&&e<=R.LOWER_Z||rn(e)}function vr(e){return e===R.EQUALS||Cr(e)}var T;(function(e){e[e.EntityStart=0]="EntityStart",e[e.NumericStart=1]="NumericStart",e[e.NumericDecimal=2]="NumericDecimal",e[e.NumericHex=3]="NumericHex",e[e.NamedEntity=4]="NamedEntity"})(T||(T={}));var G;(function(e){e[e.Legacy=0]="Legacy",e[e.Strict=1]="Strict",e[e.Attribute=2]="Attribute"})(G||(G={}));class Tr{constructor(n,t,u){this.decodeTree=n,this.emitCodePoint=t,this.errors=u,this.state=T.EntityStart,this.consumed=1,this.result=0,this.treeIndex=0,this.excess=1,this.decodeMode=G.Strict}startEntity(n){this.decodeMode=n,this.state=T.EntityStart,this.result=0,this.treeIndex=0,this.excess=1,this.consumed=1}write(n,t){switch(this.state){case T.EntityStart:return n.charCodeAt(t)===R.NUM?(this.state=T.NumericStart,this.consumed+=1,this.stateNumericStart(n,t+1)):(this.state=T.NamedEntity,this.stateNamedEntity(n,t));case T.NumericStart:return this.stateNumericStart(n,t);case T.NumericDecimal:return this.stateNumericDecimal(n,t);case T.NumericHex:return this.stateNumericHex(n,t);case T.NamedEntity:return this.stateNamedEntity(n,t)}}stateNumericStart(n,t){return t>=n.length?-1:(n.charCodeAt(t)|Sr)===R.LOWER_X?(this.state=T.NumericHex,this.consumed+=1,this.stateNumericHex(n,t+1)):(this.state=T.NumericDecimal,this.stateNumericDecimal(n,t))}addToNumericResult(n,t,u,r){if(t!==u){const a=u-t;this.result=this.result*Math.pow(r,a)+parseInt(n.substr(t,a),r),this.consumed+=a}}stateNumericHex(n,t){const u=t;for(;t<n.length;){const r=n.charCodeAt(t);if(rn(r)||wr(r))t+=1;else return this.addToNumericResult(n,u,t,16),this.emitNumericEntity(r,3)}return this.addToNumericResult(n,u,t,16),-1}stateNumericDecimal(n,t){const u=t;for(;t<n.length;){const r=n.charCodeAt(t);if(rn(r))t+=1;else return this.addToNumericResult(n,u,t,10),this.emitNumericEntity(r,2)}return this.addToNumericResult(n,u,t,10),-1}emitNumericEntity(n,t){var u;if(this.consumed<=t)return(u=this.errors)===null||u===void 0||u.absenceOfDigitsInNumericCharacterReference(this.consumed),0;if(n===R.SEMI)this.consumed+=1;else if(this.decodeMode===G.Strict)return 0;return this.emitCodePoint(kr(this.result),this.consumed),this.errors&&(n!==R.SEMI&&this.errors.missingSemicolonAfterCharacterReference(),this.errors.validateNumericCharacterReference(this.result)),this.consumed}stateNamedEntity(n,t){const{decodeTree:u}=this;let r=u[this.treeIndex],a=(r&V.VALUE_LENGTH)>>14;for(;t<n.length;t++,this.excess++){const o=n.charCodeAt(t);if(this.treeIndex=Pr(u,r,this.treeIndex+Math.max(1,a),o),this.treeIndex<0)return this.result===0||this.decodeMode===G.Attribute&&(a===0||vr(o))?0:this.emitNotTerminatedNamedEntity();if(r=u[this.treeIndex],a=(r&V.VALUE_LENGTH)>>14,a!==0){if(o===R.SEMI)return this.emitNamedEntityData(this.treeIndex,a,this.consumed+this.excess);this.decodeMode!==G.Strict&&(this.result=this.treeIndex,this.consumed+=this.excess,this.excess=0)}}return-1}emitNotTerminatedNamedEntity(){var n;const{result:t,decodeTree:u}=this,r=(u[t]&V.VALUE_LENGTH)>>14;return this.emitNamedEntityData(t,r,this.consumed),(n=this.errors)===null||n===void 0||n.missingSemicolonAfterCharacterReference(),this.consumed}emitNamedEntityData(n,t,u){const{decodeTree:r}=this;return this.emitCodePoint(t===1?r[n]&~V.VALUE_LENGTH:r[n+1],u),t===3&&this.emitCodePoint(r[n+2],u),u}end(){var n;switch(this.state){case T.NamedEntity:return this.result!==0&&(this.decodeMode!==G.Attribute||this.result===this.treeIndex)?this.emitNotTerminatedNamedEntity():0;case T.NumericDecimal:return this.emitNumericEntity(0,2);case T.NumericHex:return this.emitNumericEntity(0,3);case T.NumericStart:return(n=this.errors)===null||n===void 0||n.absenceOfDigitsInNumericCharacterReference(this.consumed),0;case T.EntityStart:return 0}}}function dt(e){let n="";const t=new Tr(e,u=>n+=_r(u));return function(r,a){let o=0,s=0;for(;(s=r.indexOf("&",s))>=0;){n+=r.slice(o,s),t.startEntity(a);const c=t.write(r,s+1);if(c<0){o=s+t.end();break}o=s+c,s=c===0?o+1:o}const i=n+r.slice(o);return n="",i}}function Pr(e,n,t,u){const r=(n&V.BRANCH_LENGTH)>>7,a=n&V.JUMP_TABLE;if(r===0)return a!==0&&u===a?t:-1;if(a){const i=u-a;return i<0||i>=r?-1:e[t+i]-1}let o=t,s=o+r-1;for(;o<=s;){const i=o+s>>>1,c=e[i];if(c<u)o=i+1;else if(c>u)s=i-1;else return e[i+r]}return-1}const ft=dt(gr);dt(xr);function Rr(e,n=G.Legacy){return ft(e,n)}function Dr(e){return ft(e,G.Strict)}function Er(e){return Object.prototype.toString.call(e)}function pn(e){return Er(e)==="[object String]"}const Ar=Object.prototype.hasOwnProperty;function Fr(e,n){return Ar.call(e,n)}function Oe(e){return Array.prototype.slice.call(arguments,1).forEach(function(t){if(t){if(typeof t!="object")throw new TypeError(t+"must be object");Object.keys(t).forEach(function(u){e[u]=t[u]})}}),e}function pt(e,n,t){return[].concat(e.slice(0,n),t,e.slice(n+1))}function hn(e){return!(e>=55296&&e<=57343||e>=64976&&e<=65007||(e&65535)===65535||(e&65535)===65534||e>=0&&e<=8||e===11||e>=14&&e<=31||e>=127&&e<=159||e>1114111)}function he(e){if(e>65535){e-=65536;const n=55296+(e>>10),t=56320+(e&1023);return String.fromCharCode(n,t)}return String.fromCharCode(e)}const ht=/\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g,Ir=/&([a-z#][a-z0-9]{1,31});/gi,Lr=new RegExp(ht.source+"|"+Ir.source,"gi"),Wr=/^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))$/i;function Mr(e,n){if(n.charCodeAt(0)===35&&Wr.test(n)){const u=n[1].toLowerCase()==="x"?parseInt(n.slice(2),16):parseInt(n.slice(1),10);return hn(u)?he(u):e}const t=Rr(e);return t!==e?t:e}function Or(e){return e.indexOf("\\")<0?e:e.replace(ht,"$1")}function ae(e){return e.indexOf("\\")<0&&e.indexOf("&")<0?e:e.replace(Lr,function(n,t,u){return t||Mr(n,u)})}const Hr=/[&<>"]/,Nr=/[&<>"]/g,Br={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"};function zr(e){return Br[e]}function $(e){return Hr.test(e)?e.replace(Nr,zr):e}const Gr=/[.?*+^$[\]\\(){}|-]/g;function qr(e){return e.replace(Gr,"\\$&")}function C(e){switch(e){case 9:case 32:return!0}return!1}function me(e){if(e>=8192&&e<=8202)return!0;switch(e){case 9:case 10:case 11:case 12:case 13:case 32:case 160:case 5760:case 8239:case 8287:case 12288:return!0}return!1}function mt(e){return fn.test(e)||ct.test(e)}function be(e){return mt(he(e))}function ge(e){switch(e){case 33:case 34:case 35:case 36:case 37:case 38:case 39:case 40:case 41:case 42:case 43:case 44:case 45:case 46:case 47:case 58:case 59:case 60:case 61:case 62:case 63:case 64:case 91:case 92:case 93:case 94:case 95:case 96:case 123:case 124:case 125:case 126:return!0;default:return!1}}function He(e){return e=e.trim().replace(/\s+/g," "),"ẞ".toLowerCase()==="Ṿ"&&(e=e.replace(/ẞ/g,"ß")),e.toLowerCase().toUpperCase()}function Wn(e){return e===32||e===9||e===10||e===13}function Ne(e){let n=0;for(;n<e.length&&Wn(e.charCodeAt(n));n++);let t=e.length-1;for(;t>=n&&Wn(e.charCodeAt(t));t--);return e.slice(n,t+1)}const Ur={mdurl:hr,ucmicro:br},jr=Object.freeze(Object.defineProperty({__proto__:null,arrayReplaceAt:pt,asciiTrim:Ne,assign:Oe,escapeHtml:$,escapeRE:qr,fromCodePoint:he,has:Fr,isMdAsciiPunct:ge,isPunctChar:mt,isPunctCharCode:be,isSpace:C,isString:pn,isValidEntityCode:hn,isWhiteSpace:me,lib:Ur,normalizeReference:He,unescapeAll:ae,unescapeMd:Or},Symbol.toStringTag,{value:"Module"}));function Vr(e,n,t){let u,r,a,o;const s=e.posMax,i=e.pos;for(e.pos=n+1,u=1;e.pos<s;){if(a=e.src.charCodeAt(e.pos),a===93&&(u--,u===0)){r=!0;break}if(o=e.pos,e.md.inline.skipToken(e),a===91){if(o===e.pos-1)u++;else if(t)return e.pos=i,-1}}let c=-1;return r&&(c=e.pos),e.pos=i,c}function $r(e,n,t){let u,r=n;const a={ok:!1,pos:0,str:""};if(e.charCodeAt(r)===60){for(r++;r<t;){if(u=e.charCodeAt(r),u===10||u===60)return a;if(u===62)return a.pos=r+1,a.str=ae(e.slice(n+1,r)),a.ok=!0,a;if(u===92&&r+1<t){r+=2;continue}r++}return a}let o=0;for(;r<t&&(u=e.charCodeAt(r),!(u===32||u<32||u===127));){if(u===92&&r+1<t){if(e.charCodeAt(r+1)===32)break;r+=2;continue}if(u===40&&(o++,o>32))return a;if(u===41){if(o===0)break;o--}r++}return n===r||o!==0||(a.str=ae(e.slice(n,r)),a.pos=r,a.ok=!0),a}function Kr(e,n,t,u){let r,a=n;const o={ok:!1,can_continue:!1,pos:0,str:"",marker:0};if(u)o.str=u.str,o.marker=u.marker;else{if(a>=t)return o;let s=e.charCodeAt(a);if(s!==34&&s!==39&&s!==40)return o;n++,a++,s===40&&(s=41),o.marker=s}for(;a<t;){if(r=e.charCodeAt(a),r===o.marker)return o.pos=a+1,o.str+=ae(e.slice(n,a)),o.ok=!0,o;if(r===40&&o.marker===41)return o;r===92&&a+1<t&&a++,a++}return o.can_continue=!0,o.str+=ae(e.slice(n,a)),o}const Zr=Object.freeze(Object.defineProperty({__proto__:null,parseLinkDestination:$r,parseLinkLabel:Vr,parseLinkTitle:Kr},Symbol.toStringTag,{value:"Module"})),N={};N.code_inline=function(e,n,t,u,r){const a=e[n];return"<code"+r.renderAttrs(a)+">"+$(a.content)+"</code>"};N.code_block=function(e,n,t,u,r){const a=e[n];return"<pre"+r.renderAttrs(a)+"><code>"+$(e[n].content)+`</code></pre>
`};N.fence=function(e,n,t,u,r){const a=e[n],o=a.info?ae(a.info).trim():"";let s="",i="";if(o){const l=o.split(/(\s+)/g);s=l[0],i=l.slice(2).join("")}let c;if(t.highlight?c=t.highlight(a.content,s,i)||$(a.content):c=$(a.content),c.indexOf("<pre")===0)return c+`
`;if(o){const l=a.attrIndex("class"),d=a.attrs?a.attrs.slice():[];l<0?d.push(["class",t.langPrefix+s]):(d[l]=d[l].slice(),d[l][1]+=" "+t.langPrefix+s);const h={attrs:d};return`<pre><code${r.renderAttrs(h)}>${c}</code></pre>
`}return`<pre><code${r.renderAttrs(a)}>${c}</code></pre>
`};N.image=function(e,n,t,u,r){const a=e[n];return a.attrs[a.attrIndex("alt")][1]=r.renderInlineAsText(a.children,t,u),r.renderToken(e,n,t)};N.hardbreak=function(e,n,t){return t.xhtmlOut?`<br />
`:`<br>
`};N.softbreak=function(e,n,t){return t.breaks?t.xhtmlOut?`<br />
`:`<br>
`:`
`};N.text=function(e,n){return $(e[n].content)};N.html_block=function(e,n){return e[n].content};N.html_inline=function(e,n){return e[n].content};function ce(){this.rules=Oe({},N)}ce.prototype.renderAttrs=function(n){let t,u,r;if(!n.attrs)return"";for(r="",t=0,u=n.attrs.length;t<u;t++)r+=" "+$(n.attrs[t][0])+'="'+$(n.attrs[t][1])+'"';return r};ce.prototype.renderToken=function(n,t,u){const r=n[t];let a="";if(r.hidden)return"";r.block&&r.nesting!==-1&&t&&n[t-1].hidden&&(a+=`
`),a+=(r.nesting===-1?"</":"<")+r.tag,a+=this.renderAttrs(r),r.nesting===0&&u.xhtmlOut&&(a+=" /");let o=!1;if(r.block&&(o=!0,r.nesting===1&&t+1<n.length)){const s=n[t+1];(s.type==="inline"||s.hidden||s.nesting===-1&&s.tag===r.tag)&&(o=!1)}return a+=o?`>
`:">",a};ce.prototype.renderInline=function(e,n,t){let u="";const r=this.rules;for(let a=0,o=e.length;a<o;a++){const s=e[a].type;typeof r[s]<"u"?u+=r[s](e,a,n,t,this):u+=this.renderToken(e,a,n)}return u};ce.prototype.renderInlineAsText=function(e,n,t){let u="";for(let r=0,a=e.length;r<a;r++)switch(e[r].type){case"text":u+=e[r].content;break;case"image":u+=this.renderInlineAsText(e[r].children,n,t);break;case"html_inline":case"html_block":u+=e[r].content;break;case"softbreak":case"hardbreak":u+=`
`;break}return u};ce.prototype.render=function(e,n,t){let u="";const r=this.rules;for(let a=0,o=e.length;a<o;a++){const s=e[a].type;s==="inline"?u+=this.renderInline(e[a].children,n,t):typeof r[s]<"u"?u+=r[s](e,a,n,t,this):u+=this.renderToken(e,a,n,t)}return u};function D(){this.__rules__=[],this.__cache__=null}D.prototype.__find__=function(e){for(let n=0;n<this.__rules__.length;n++)if(this.__rules__[n].name===e)return n;return-1};D.prototype.__compile__=function(){const e=this,n=[""];e.__rules__.forEach(function(t){t.enabled&&t.alt.forEach(function(u){n.indexOf(u)<0&&n.push(u)})}),e.__cache__={},n.forEach(function(t){e.__cache__[t]=[],e.__rules__.forEach(function(u){u.enabled&&(t&&u.alt.indexOf(t)<0||e.__cache__[t].push(u.fn))})})};D.prototype.at=function(e,n,t){const u=this.__find__(e),r=t||{};if(u===-1)throw new Error("Parser rule not found: "+e);this.__rules__[u].fn=n,this.__rules__[u].alt=r.alt||[],this.__cache__=null};D.prototype.before=function(e,n,t,u){const r=this.__find__(e),a=u||{};if(r===-1)throw new Error("Parser rule not found: "+e);this.__rules__.splice(r,0,{name:n,enabled:!0,fn:t,alt:a.alt||[]}),this.__cache__=null};D.prototype.after=function(e,n,t,u){const r=this.__find__(e),a=u||{};if(r===-1)throw new Error("Parser rule not found: "+e);this.__rules__.splice(r+1,0,{name:n,enabled:!0,fn:t,alt:a.alt||[]}),this.__cache__=null};D.prototype.push=function(e,n,t){const u=t||{};this.__rules__.push({name:e,enabled:!0,fn:n,alt:u.alt||[]}),this.__cache__=null};D.prototype.enable=function(e,n){Array.isArray(e)||(e=[e]);const t=[];return e.forEach(function(u){const r=this.__find__(u);if(r<0){if(n)return;throw new Error("Rules manager: invalid rule name "+u)}this.__rules__[r].enabled=!0,t.push(u)},this),this.__cache__=null,t};D.prototype.enableOnly=function(e,n){Array.isArray(e)||(e=[e]),this.__rules__.forEach(function(t){t.enabled=!1}),this.enable(e,n)};D.prototype.disable=function(e,n){Array.isArray(e)||(e=[e]);const t=[];return e.forEach(function(u){const r=this.__find__(u);if(r<0){if(n)return;throw new Error("Rules manager: invalid rule name "+u)}this.__rules__[r].enabled=!1,t.push(u)},this),this.__cache__=null,t};D.prototype.getRules=function(e){return this.__cache__===null&&this.__compile__(),this.__cache__[e]||[]};function I(e,n,t){this.type=e,this.tag=n,this.attrs=null,this.map=null,this.nesting=t,this.level=0,this.children=null,this.content="",this.markup="",this.info="",this.meta=null,this.block=!1,this.hidden=!1}I.prototype.attrIndex=function(n){if(!this.attrs)return-1;const t=this.attrs;for(let u=0,r=t.length;u<r;u++)if(t[u][0]===n)return u;return-1};I.prototype.attrPush=function(n){this.attrs?this.attrs.push(n):this.attrs=[n]};I.prototype.attrSet=function(n,t){const u=this.attrIndex(n),r=[n,t];u<0?this.attrPush(r):this.attrs[u]=r};I.prototype.attrGet=function(n){const t=this.attrIndex(n);let u=null;return t>=0&&(u=this.attrs[t][1]),u};I.prototype.attrJoin=function(n,t){const u=this.attrIndex(n);u<0?this.attrPush([n,t]):this.attrs[u][1]=this.attrs[u][1]+" "+t};function bt(e,n,t){this.src=e,this.env=t,this.tokens=[],this.inlineMode=!1,this.md=n}bt.prototype.Token=I;const Yr=/\r\n?|\n/g,Jr=/\0/g;function Xr(e){let n;n=e.src.replace(Yr,`
`),n=n.replace(Jr,"�"),e.src=n}function Qr(e){let n;e.inlineMode?(n=new e.Token("inline","",0),n.content=e.src,n.map=[0,1],n.children=[],e.tokens.push(n)):e.md.block.parse(e.src,e.md,e.env,e.tokens)}function ea(e){const n=e.tokens;for(let t=0,u=n.length;t<u;t++){const r=n[t];r.type==="inline"&&e.md.inline.parse(r.content,e.md,e.env,r.children)}}function na(e){return/^<a[>\s]/i.test(e)}function ta(e){return/^<\/a\s*>/i.test(e)}function ua(e){const n=e.tokens;if(e.md.options.linkify)for(let t=0,u=n.length;t<u;t++){if(n[t].type!=="inline"||!e.md.linkify.pretest(n[t].content))continue;let r=n[t].children,a=0;for(let o=r.length-1;o>=0;o--){const s=r[o];if(s.type==="link_close"){for(o--;r[o].level!==s.level&&r[o].type!=="link_open";)o--;continue}if(s.type==="html_inline"&&(na(s.content)&&a>0&&a--,ta(s.content)&&a++),!(a>0)&&s.type==="text"&&e.md.linkify.test(s.content)){const i=s.content;let c=e.md.linkify.match(i);const l=[];let d=s.level,h=0;c.length>0&&c[0].index===0&&o>0&&r[o-1].type==="text_special"&&(c=c.slice(1));for(let p=0;p<c.length;p++){const f=c[p].url,b=e.md.normalizeLink(f);if(!e.md.validateLink(b))continue;let g=c[p].text;c[p].schema?c[p].schema==="mailto:"&&!/^mailto:/i.test(g)?g=e.md.normalizeLinkText("mailto:"+g).replace(/^mailto:/,""):g=e.md.normalizeLinkText(g):g=e.md.normalizeLinkText("http://"+g).replace(/^http:\/\//,"");const S=c[p].index;if(S>h){const _=new e.Token("text","",0);_.content=i.slice(h,S),_.level=d,l.push(_)}const y=new e.Token("link_open","a",1);y.attrs=[["href",b]],y.level=d++,y.markup="linkify",y.info="auto",l.push(y);const m=new e.Token("text","",0);m.content=g,m.level=d,l.push(m);const x=new e.Token("link_close","a",-1);x.level=--d,x.markup="linkify",x.info="auto",l.push(x),h=c[p].lastIndex}if(h<i.length){const p=new e.Token("text","",0);p.content=i.slice(h),p.level=d,l.push(p)}n[t].children=r=pt(r,o,l)}}}}const gt=/\+-|\.\.|\?\?\?\?|!!!!|,,|--/,ra=/\((c|tm|r)\)/i,aa=/\((c|tm|r)\)/ig,oa={c:"©",r:"®",tm:"™"};function sa(e,n){return oa[n.toLowerCase()]}function ia(e){let n=0;for(let t=e.length-1;t>=0;t--){const u=e[t];u.type==="text"&&!n&&(u.content=u.content.replace(aa,sa)),u.type==="link_open"&&u.info==="auto"&&n--,u.type==="link_close"&&u.info==="auto"&&n++}}function ca(e){let n=0;for(let t=e.length-1;t>=0;t--){const u=e[t];u.type==="text"&&!n&&gt.test(u.content)&&(u.content=u.content.replace(/\+-/g,"±").replace(/\.{2,}/g,"…").replace(/([?!])…/g,"$1..").replace(/([?!]){4,}/g,"$1$1$1").replace(/,{2,}/g,",").replace(/(^|[^-])---(?=[^-]|$)/mg,"$1—").replace(/(^|\s)--(?=\s|$)/mg,"$1–").replace(/(^|[^-\s])--(?=[^-\s]|$)/mg,"$1–")),u.type==="link_open"&&u.info==="auto"&&n--,u.type==="link_close"&&u.info==="auto"&&n++}}function la(e){let n;if(e.md.options.typographer)for(n=e.tokens.length-1;n>=0;n--)e.tokens[n].type==="inline"&&(ra.test(e.tokens[n].content)&&ia(e.tokens[n].children),gt.test(e.tokens[n].content)&&ca(e.tokens[n].children))}const da=/['"]/,Mn=/['"]/g,On="’";function Te(e,n,t,u){e[n]||(e[n]=[]),e[n].push({pos:t,ch:u})}function fa(e,n){let t="",u=0;n.sort((r,a)=>r.pos-a.pos);for(let r=0;r<n.length;r++){const a=n[r];t+=e.slice(u,a.pos)+a.ch,u=a.pos+1}return t+e.slice(u)}function pa(e,n){let t;const u=[],r={};for(let a=0;a<e.length;a++){const o=e[a],s=e[a].level;for(t=u.length-1;t>=0&&!(u[t].level<=s);t--);if(u.length=t+1,o.type!=="text")continue;const i=o.content;let c=0;const l=i.length;e:for(;c<l;){Mn.lastIndex=c;const d=Mn.exec(i);if(!d)break;let h=!0,p=!0;c=d.index+1;const f=d[0]==="'";let b=32;if(d.index-1>=0)b=i.charCodeAt(d.index-1);else for(t=a-1;t>=0&&!(e[t].type==="softbreak"||e[t].type==="hardbreak");t--)if(e[t].content){b=e[t].content.charCodeAt(e[t].content.length-1);break}let g=32;if(c<l)g=i.charCodeAt(c);else for(t=a+1;t<e.length&&!(e[t].type==="softbreak"||e[t].type==="hardbreak");t++)if(e[t].content){g=e[t].content.charCodeAt(0);break}const S=ge(b)||be(b),y=ge(g)||be(g),m=me(b),x=me(g);if(x?h=!1:y&&(m||S||(h=!1)),m?p=!1:S&&(x||y||(p=!1)),g===34&&d[0]==='"'&&b>=48&&b<=57&&(p=h=!1),h&&p&&(h=S,p=y),!h&&!p){f&&Te(r,a,d.index,On);continue}if(p)for(t=u.length-1;t>=0;t--){let _=u[t];if(u[t].level<s)break;if(_.single===f&&u[t].level===s){_=u[t];let k,v;f?(k=n.md.options.quotes[2],v=n.md.options.quotes[3]):(k=n.md.options.quotes[0],v=n.md.options.quotes[1]),Te(r,a,d.index,v),Te(r,_.token,_.pos,k),u.length=t;continue e}}h?u.push({token:a,pos:d.index,single:f,level:s}):p&&f&&Te(r,a,d.index,On)}}Object.keys(r).forEach(function(a){e[a].content=fa(e[a].content,r[a])})}function ha(e){if(e.md.options.typographer)for(let n=e.tokens.length-1;n>=0;n--)e.tokens[n].type!=="inline"||!da.test(e.tokens[n].content)||pa(e.tokens[n].children,e)}function ma(e){let n,t;const u=e.tokens,r=u.length;for(let a=0;a<r;a++){if(u[a].type!=="inline")continue;const o=u[a].children,s=o.length;for(n=0;n<s;n++)o[n].type==="text_special"&&(o[n].type="text");for(n=t=0;n<s;n++)o[n].type==="text"&&n+1<s&&o[n+1].type==="text"?o[n+1].content=o[n].content+o[n+1].content:(n!==t&&(o[t]=o[n]),t++);n!==t&&(o.length=t)}}const Ke=[["normalize",Xr],["block",Qr],["inline",ea],["linkify",ua],["replacements",la],["smartquotes",ha],["text_join",ma]];function mn(){this.ruler=new D;for(let e=0;e<Ke.length;e++)this.ruler.push(Ke[e][0],Ke[e][1])}mn.prototype.process=function(e){const n=this.ruler.getRules("");for(let t=0,u=n.length;t<u;t++)n[t](e)};mn.prototype.State=bt;function B(e,n,t,u){this.src=e,this.md=n,this.env=t,this.tokens=u,this.bMarks=[],this.eMarks=[],this.tShift=[],this.sCount=[],this.bsCount=[],this.blkIndent=0,this.line=0,this.lineMax=0,this.tight=!1,this.ddIndent=-1,this.listIndent=-1,this.parentType="root",this.level=0;const r=this.src;for(let a=0,o=0,s=0,i=0,c=r.length,l=!1;o<c;o++){const d=r.charCodeAt(o);if(!l)if(C(d)){s++,d===9?i+=4-i%4:i++;continue}else l=!0;(d===10||o===c-1)&&(d!==10&&o++,this.bMarks.push(a),this.eMarks.push(o),this.tShift.push(s),this.sCount.push(i),this.bsCount.push(0),l=!1,s=0,i=0,a=o+1)}this.bMarks.push(r.length),this.eMarks.push(r.length),this.tShift.push(0),this.sCount.push(0),this.bsCount.push(0),this.lineMax=this.bMarks.length-1}B.prototype.push=function(e,n,t){const u=new I(e,n,t);return u.block=!0,t<0&&this.level--,u.level=this.level,t>0&&this.level++,this.tokens.push(u),u};B.prototype.isEmpty=function(n){return this.bMarks[n]+this.tShift[n]>=this.eMarks[n]};B.prototype.skipEmptyLines=function(n){for(let t=this.lineMax;n<t&&!(this.bMarks[n]+this.tShift[n]<this.eMarks[n]);n++);return n};B.prototype.skipSpaces=function(n){for(let t=this.src.length;n<t;n++){const u=this.src.charCodeAt(n);if(!C(u))break}return n};B.prototype.skipSpacesBack=function(n,t){if(n<=t)return n;for(;n>t;)if(!C(this.src.charCodeAt(--n)))return n+1;return n};B.prototype.skipChars=function(n,t){for(let u=this.src.length;n<u&&this.src.charCodeAt(n)===t;n++);return n};B.prototype.skipCharsBack=function(n,t,u){if(n<=u)return n;for(;n>u;)if(t!==this.src.charCodeAt(--n))return n+1;return n};B.prototype.getLines=function(n,t,u,r){if(n>=t)return"";const a=new Array(t-n);for(let o=0,s=n;s<t;s++,o++){let i=0;const c=this.bMarks[s];let l=c,d;for(s+1<t||r?d=this.eMarks[s]+1:d=this.eMarks[s];l<d&&i<u;){const h=this.src.charCodeAt(l);if(C(h))h===9?i+=4-(i+this.bsCount[s])%4:i++;else if(l-c<this.tShift[s])i++;else break;l++}i>u?a[o]=new Array(i-u+1).join(" ")+this.src.slice(l,d):a[o]=this.src.slice(l,d)}return a.join("")};B.prototype.Token=I;const ba=65536;function Ze(e,n){const t=e.bMarks[n]+e.tShift[n],u=e.eMarks[n];return e.src.slice(t,u)}function Hn(e){const n=[],t=e.length;let u=0,r=e.charCodeAt(u),a=!1,o=0,s="";for(;u<t;)r===124&&(a?(s+=e.substring(o,u-1),o=u):(n.push(s+e.substring(o,u)),s="",o=u+1)),a=r===92,u++,r=e.charCodeAt(u);return n.push(s+e.substring(o)),n}function ga(e,n,t,u){if(n+2>t)return!1;let r=n+1;if(e.sCount[r]<e.blkIndent||e.sCount[r]-e.blkIndent>=4)return!1;let a=e.bMarks[r]+e.tShift[r];if(a>=e.eMarks[r])return!1;const o=e.src.charCodeAt(a++);if(o!==124&&o!==45&&o!==58||a>=e.eMarks[r])return!1;const s=e.src.charCodeAt(a++);if(s!==124&&s!==45&&s!==58&&!C(s)||o===45&&C(s))return!1;for(;a<e.eMarks[r];){const x=e.src.charCodeAt(a);if(x!==124&&x!==45&&x!==58&&!C(x))return!1;a++}let i=Ze(e,n+1),c=i.split("|");const l=[];for(let x=0;x<c.length;x++){const _=c[x].trim();if(!_){if(x===0||x===c.length-1)continue;return!1}if(!/^:?-+:?$/.test(_))return!1;_.charCodeAt(_.length-1)===58?l.push(_.charCodeAt(0)===58?"center":"right"):_.charCodeAt(0)===58?l.push("left"):l.push("")}if(i=Ze(e,n).trim(),i.indexOf("|")===-1||e.sCount[n]-e.blkIndent>=4)return!1;c=Hn(i),c.length&&c[0]===""&&c.shift(),c.length&&c[c.length-1]===""&&c.pop();const d=c.length;if(d===0||d!==l.length)return!1;if(u)return!0;const h=e.parentType;e.parentType="table";const p=e.md.block.ruler.getRules("blockquote"),f=e.push("table_open","table",1),b=[n,0];f.map=b;const g=e.push("thead_open","thead",1);g.map=[n,n+1];const S=e.push("tr_open","tr",1);S.map=[n,n+1];for(let x=0;x<c.length;x++){const _=e.push("th_open","th",1);l[x]&&(_.attrs=[["style","text-align:"+l[x]]]);const k=e.push("inline","",0);k.content=c[x].trim(),k.children=[],e.push("th_close","th",-1)}e.push("tr_close","tr",-1),e.push("thead_close","thead",-1);let y,m=0;for(r=n+2;r<t&&!(e.sCount[r]<e.blkIndent);r++){let x=!1;for(let k=0,v=p.length;k<v;k++)if(p[k](e,r,t,!0)){x=!0;break}if(x||(i=Ze(e,r).trim(),!i)||e.sCount[r]-e.blkIndent>=4||(c=Hn(i),c.length&&c[0]===""&&c.shift(),c.length&&c[c.length-1]===""&&c.pop(),m+=d-c.length,m>ba))break;if(r===n+2){const k=e.push("tbody_open","tbody",1);k.map=y=[n+2,0]}const _=e.push("tr_open","tr",1);_.map=[r,r+1];for(let k=0;k<d;k++){const v=e.push("td_open","td",1);l[k]&&(v.attrs=[["style","text-align:"+l[k]]]);const F=e.push("inline","",0);F.content=c[k]?c[k].trim():"",F.children=[],e.push("td_close","td",-1)}e.push("tr_close","tr",-1)}return y&&(e.push("tbody_close","tbody",-1),y[1]=r),e.push("table_close","table",-1),b[1]=r,e.parentType=h,e.line=r,!0}function xa(e,n,t){if(e.sCount[n]-e.blkIndent<4)return!1;let u=n+1,r=u;for(;u<t;){if(e.isEmpty(u)){u++;continue}if(e.sCount[u]-e.blkIndent>=4){u++,r=u;continue}break}e.line=r;const a=e.push("code_block","code",0);return a.content=e.getLines(n,r,4+e.blkIndent,!1)+`
`,a.map=[n,e.line],!0}function ya(e,n,t,u){let r=e.bMarks[n]+e.tShift[n],a=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4||r+3>a)return!1;const o=e.src.charCodeAt(r);if(o!==126&&o!==96)return!1;let s=r;r=e.skipChars(r,o);let i=r-s;if(i<3)return!1;const c=e.src.slice(s,r),l=e.src.slice(r,a);if(o===96&&l.indexOf(String.fromCharCode(o))>=0)return!1;if(u)return!0;let d=n,h=!1;for(;d++,!(d>=t||(r=s=e.bMarks[d]+e.tShift[d],a=e.eMarks[d],r<a&&e.sCount[d]<e.blkIndent));)if(e.src.charCodeAt(r)===o&&!(e.sCount[d]-e.blkIndent>=4)&&(r=e.skipChars(r,o),!(r-s<i)&&(r=e.skipSpaces(r),!(r<a)))){h=!0;break}i=e.sCount[n],e.line=d+(h?1:0);const p=e.push("fence","code",0);return p.info=l,p.content=e.getLines(n+1,d,i,!0),p.markup=c,p.map=[n,e.line],!0}function _a(e,n,t,u){let r=e.bMarks[n]+e.tShift[n],a=e.eMarks[n];const o=e.lineMax;if(e.sCount[n]-e.blkIndent>=4||e.src.charCodeAt(r)!==62)return!1;if(u)return!0;const s=[],i=[],c=[],l=[],d=e.md.block.ruler.getRules("blockquote"),h=e.parentType;e.parentType="blockquote";let p=!1,f;for(f=n;f<t;f++){const m=e.sCount[f]<e.blkIndent;if(r=e.bMarks[f]+e.tShift[f],a=e.eMarks[f],r>=a)break;if(e.src.charCodeAt(r++)===62&&!m){let _=e.sCount[f]+1,k,v;e.src.charCodeAt(r)===32?(r++,_++,v=!1,k=!0):e.src.charCodeAt(r)===9?(k=!0,(e.bsCount[f]+_)%4===3?(r++,_++,v=!1):v=!0):k=!1;let F=_;for(s.push(e.bMarks[f]),e.bMarks[f]=r;r<a;){const q=e.src.charCodeAt(r);if(C(q))q===9?F+=4-(F+e.bsCount[f]+(v?1:0))%4:F++;else break;r++}p=r>=a,i.push(e.bsCount[f]),e.bsCount[f]=e.sCount[f]+1+(k?1:0),c.push(e.sCount[f]),e.sCount[f]=F-_,l.push(e.tShift[f]),e.tShift[f]=r-e.bMarks[f];continue}if(p)break;let x=!1;for(let _=0,k=d.length;_<k;_++)if(d[_](e,f,t,!0)){x=!0;break}if(x){e.lineMax=f,e.blkIndent!==0&&(s.push(e.bMarks[f]),i.push(e.bsCount[f]),l.push(e.tShift[f]),c.push(e.sCount[f]),e.sCount[f]-=e.blkIndent);break}s.push(e.bMarks[f]),i.push(e.bsCount[f]),l.push(e.tShift[f]),c.push(e.sCount[f]),e.sCount[f]=-1}const b=e.blkIndent;e.blkIndent=0;const g=e.push("blockquote_open","blockquote",1);g.markup=">";const S=[n,0];g.map=S,e.md.block.tokenize(e,n,f);const y=e.push("blockquote_close","blockquote",-1);y.markup=">",e.lineMax=o,e.parentType=h,S[1]=e.line;for(let m=0;m<l.length;m++)e.bMarks[m+n]=s[m],e.tShift[m+n]=l[m],e.sCount[m+n]=c[m],e.bsCount[m+n]=i[m];return e.blkIndent=b,!0}function ka(e,n,t,u){const r=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4)return!1;let a=e.bMarks[n]+e.tShift[n];const o=e.src.charCodeAt(a++);if(o!==42&&o!==45&&o!==95)return!1;let s=1;for(;a<r;){const c=e.src.charCodeAt(a++);if(c!==o&&!C(c))return!1;c===o&&s++}if(s<3)return!1;if(u)return!0;e.line=n+1;const i=e.push("hr","hr",0);return i.map=[n,e.line],i.markup=Array(s+1).join(String.fromCharCode(o)),!0}function Nn(e,n){const t=e.eMarks[n];let u=e.bMarks[n]+e.tShift[n];const r=e.src.charCodeAt(u++);if(r!==42&&r!==45&&r!==43)return-1;if(u<t){const a=e.src.charCodeAt(u);if(!C(a))return-1}return u}function Bn(e,n){const t=e.bMarks[n]+e.tShift[n],u=e.eMarks[n];let r=t;if(r+1>=u)return-1;let a=e.src.charCodeAt(r++);if(a<48||a>57)return-1;for(;;){if(r>=u)return-1;if(a=e.src.charCodeAt(r++),a>=48&&a<=57){if(r-t>=10)return-1;continue}if(a===41||a===46)break;return-1}return r<u&&(a=e.src.charCodeAt(r),!C(a))?-1:r}function Sa(e,n){const t=e.level+2;for(let u=n+2,r=e.tokens.length-2;u<r;u++)e.tokens[u].level===t&&e.tokens[u].type==="paragraph_open"&&(e.tokens[u+2].hidden=!0,e.tokens[u].hidden=!0,u+=2)}function wa(e,n,t,u){let r,a,o,s,i=n,c=!0;if(e.sCount[i]-e.blkIndent>=4||e.listIndent>=0&&e.sCount[i]-e.listIndent>=4&&e.sCount[i]<e.blkIndent)return!1;let l=!1;u&&e.parentType==="paragraph"&&e.sCount[i]>=e.blkIndent&&(l=!0);let d,h,p;if((p=Bn(e,i))>=0){if(d=!0,o=e.bMarks[i]+e.tShift[i],h=Number(e.src.slice(o,p-1)),l&&h!==1)return!1}else if((p=Nn(e,i))>=0)d=!1;else return!1;if(l&&e.skipSpaces(p)>=e.eMarks[i])return!1;if(u)return!0;const f=e.src.charCodeAt(p-1),b=e.tokens.length;d?(s=e.push("ordered_list_open","ol",1),h!==1&&(s.attrs=[["start",h]])):s=e.push("bullet_list_open","ul",1);const g=[i,0];s.map=g,s.markup=String.fromCharCode(f);let S=!1;const y=e.md.block.ruler.getRules("list"),m=e.parentType;for(e.parentType="list";i<t;){a=p,r=e.eMarks[i];const x=e.sCount[i]+p-(e.bMarks[i]+e.tShift[i]);let _=x;for(;a<r;){const ne=e.src.charCodeAt(a);if(ne===9)_+=4-(_+e.bsCount[i])%4;else if(ne===32)_++;else break;a++}const k=a;let v;k>=r?v=1:v=_-x,v>4&&(v=1);const F=x+v;s=e.push("list_item_open","li",1),s.markup=String.fromCharCode(f);const q=[i,0];s.map=q,d&&(s.info=e.src.slice(o,p-1));const le=e.tight,Ue=e.tShift[i],Yt=e.sCount[i],Jt=e.listIndent;if(e.listIndent=e.blkIndent,e.blkIndent=F,e.tight=!0,e.tShift[i]=k-e.bMarks[i],e.sCount[i]=_,k>=r&&e.isEmpty(i+1)?e.line=Math.min(e.line+2,t):e.md.block.tokenize(e,i,t,!0),(!e.tight||S)&&(c=!1),S=e.line-i>1&&e.isEmpty(e.line-1),e.blkIndent=e.listIndent,e.listIndent=Jt,e.tShift[i]=Ue,e.sCount[i]=Yt,e.tight=le,s=e.push("list_item_close","li",-1),s.markup=String.fromCharCode(f),i=e.line,q[1]=i,i>=t||e.sCount[i]<e.blkIndent||e.sCount[i]-e.blkIndent>=4)break;let Cn=!1;for(let ne=0,Xt=y.length;ne<Xt;ne++)if(y[ne](e,i,t,!0)){Cn=!0;break}if(Cn)break;if(d){if(p=Bn(e,i),p<0)break;o=e.bMarks[i]+e.tShift[i]}else if(p=Nn(e,i),p<0)break;if(f!==e.src.charCodeAt(p-1))break}return d?s=e.push("ordered_list_close","ol",-1):s=e.push("bullet_list_close","ul",-1),s.markup=String.fromCharCode(f),g[1]=i,e.line=i,e.parentType=m,c&&Sa(e,b),!0}function Ca(e,n,t,u){let r=e.bMarks[n]+e.tShift[n],a=e.eMarks[n],o=n+1;if(e.sCount[n]-e.blkIndent>=4||e.src.charCodeAt(r)!==91)return!1;function s(y){const m=e.lineMax;if(y>=m||e.isEmpty(y))return null;let x=!1;if(e.sCount[y]-e.blkIndent>3&&(x=!0),e.sCount[y]<0&&(x=!0),!x){const v=e.md.block.ruler.getRules("reference"),F=e.parentType;e.parentType="reference";let q=!1;for(let le=0,Ue=v.length;le<Ue;le++)if(v[le](e,y,m,!0)){q=!0;break}if(e.parentType=F,q)return null}const _=e.bMarks[y]+e.tShift[y],k=e.eMarks[y];return e.src.slice(_,k+1)}let i=e.src.slice(r,a+1);a=i.length;let c=-1;for(r=1;r<a;r++){const y=i.charCodeAt(r);if(y===91)return!1;if(y===93){c=r;break}else if(y===10){const m=s(o);m!==null&&(i+=m,a=i.length,o++)}else if(y===92&&(r++,r<a&&i.charCodeAt(r)===10)){const m=s(o);m!==null&&(i+=m,a=i.length,o++)}}if(c<0||i.charCodeAt(c+1)!==58)return!1;for(r=c+2;r<a;r++){const y=i.charCodeAt(r);if(y===10){const m=s(o);m!==null&&(i+=m,a=i.length,o++)}else if(!C(y))break}const l=e.md.helpers.parseLinkDestination(i,r,a);if(!l.ok)return!1;const d=e.md.normalizeLink(l.str);if(!e.md.validateLink(d))return!1;r=l.pos;const h=r,p=o,f=r;for(;r<a;r++){const y=i.charCodeAt(r);if(y===10){const m=s(o);m!==null&&(i+=m,a=i.length,o++)}else if(!C(y))break}let b=e.md.helpers.parseLinkTitle(i,r,a);for(;b.can_continue;){const y=s(o);if(y===null)break;i+=y,r=a,a=i.length,o++,b=e.md.helpers.parseLinkTitle(i,r,a,b)}let g;for(r<a&&f!==r&&b.ok?(g=b.str,r=b.pos):(g="",r=h,o=p);r<a;){const y=i.charCodeAt(r);if(!C(y))break;r++}if(r<a&&i.charCodeAt(r)!==10&&g)for(g="",r=h,o=p;r<a;){const y=i.charCodeAt(r);if(!C(y))break;r++}if(r<a&&i.charCodeAt(r)!==10)return!1;const S=He(i.slice(1,c));return S?(u||(typeof e.env.references>"u"&&(e.env.references={}),typeof e.env.references[S]>"u"&&(e.env.references[S]={title:g,href:d}),e.line=o),!0):!1}const va=["address","article","aside","base","basefont","blockquote","body","caption","center","col","colgroup","dd","details","dialog","dir","div","dl","dt","fieldset","figcaption","figure","footer","form","frame","frameset","h1","h2","h3","h4","h5","h6","head","header","hr","html","iframe","legend","li","link","main","menu","menuitem","nav","noframes","ol","optgroup","option","p","param","search","section","summary","table","tbody","td","tfoot","th","thead","title","tr","track","ul"],Ta="[a-zA-Z_:][a-zA-Z0-9:._-]*",Pa="[^\"'=<>`\\x00-\\x20]+",Ra="'[^']*'",Da='"[^"]*"',Ea="(?:"+Pa+"|"+Ra+"|"+Da+")",Aa="(?:\\s+"+Ta+"(?:\\s*=\\s*"+Ea+")?)",xt="<[A-Za-z][A-Za-z0-9\\-]*"+Aa+"*\\s*\\/?>",yt="<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>",Fa="<!---?>|<!--(?:[^-]|-[^-]|--[^>])*-->",Ia="<[?][\\s\\S]*?[?]>",La="<![A-Za-z][^>]*>",Wa="<!\\[CDATA\\[[\\s\\S]*?\\]\\]>",Ma=new RegExp("^(?:"+xt+"|"+yt+"|"+Fa+"|"+Ia+"|"+La+"|"+Wa+")"),Oa=new RegExp("^(?:"+xt+"|"+yt+")"),K=[[/^<(script|pre|style|textarea)(?=(\s|>|$))/i,/<\/(script|pre|style|textarea)>/i,!0],[/^<!--/,/-->/,!0],[/^<\?/,/\?>/,!0],[/^<![A-Z]/,/>/,!0],[/^<!\[CDATA\[/,/\]\]>/,!0],[new RegExp("^</?("+va.join("|")+")(?=(\\s|/?>|$))","i"),/^$/,!0],[new RegExp(Oa.source+"\\s*$"),/^$/,!1]];function Ha(e,n,t,u){let r=e.bMarks[n]+e.tShift[n],a=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4||!e.md.options.html||e.src.charCodeAt(r)!==60)return!1;let o=e.src.slice(r,a),s=0;for(;s<K.length&&!K[s][0].test(o);s++);if(s===K.length)return!1;if(u)return K[s][2];let i=n+1;const c=K[s][1].test("");if(!K[s][1].test(o)){for(;i<t&&!(e.sCount[i]<e.blkIndent&&(c||!e.isEmpty(i)));i++)if(r=e.bMarks[i]+e.tShift[i],a=e.eMarks[i],o=e.src.slice(r,a),K[s][1].test(o)){o.length!==0&&i++;break}}e.line=i;const l=e.push("html_block","",0);return l.map=[n,i],l.content=e.getLines(n,i,e.blkIndent,!0),!0}function Na(e,n,t,u){let r=e.bMarks[n]+e.tShift[n],a=e.eMarks[n];if(e.sCount[n]-e.blkIndent>=4)return!1;let o=e.src.charCodeAt(r);if(o!==35||r>=a)return!1;let s=1;for(o=e.src.charCodeAt(++r);o===35&&r<a&&s<=6;)s++,o=e.src.charCodeAt(++r);if(s>6||r<a&&!C(o))return!1;if(u)return!0;a=e.skipSpacesBack(a,r);const i=e.skipCharsBack(a,35,r);i>r&&C(e.src.charCodeAt(i-1))&&(a=i),e.line=n+1;const c=e.push("heading_open","h"+String(s),1);c.markup="########".slice(0,s),c.map=[n,e.line];const l=e.push("inline","",0);l.content=Ne(e.src.slice(r,a)),l.map=[n,e.line],l.children=[];const d=e.push("heading_close","h"+String(s),-1);return d.markup="########".slice(0,s),!0}function Ba(e,n,t){const u=e.md.block.ruler.getRules("paragraph");if(e.sCount[n]-e.blkIndent>=4)return!1;const r=e.parentType;e.parentType="paragraph";let a=0,o,s=n+1;for(;s<t&&!e.isEmpty(s);s++){if(e.sCount[s]-e.blkIndent>3)continue;if(e.sCount[s]>=e.blkIndent){let p=e.bMarks[s]+e.tShift[s];const f=e.eMarks[s];if(p<f&&(o=e.src.charCodeAt(p),(o===45||o===61)&&(p=e.skipChars(p,o),p=e.skipSpaces(p),p>=f))){a=o===61?1:2;break}}if(e.sCount[s]<0)continue;let h=!1;for(let p=0,f=u.length;p<f;p++)if(u[p](e,s,t,!0)){h=!0;break}if(h)break}if(!a)return e.parentType=r,!1;const i=Ne(e.getLines(n,s,e.blkIndent,!1));e.line=s+1;const c=e.push("heading_open","h"+String(a),1);c.markup=String.fromCharCode(o),c.map=[n,e.line];const l=e.push("inline","",0);l.content=i,l.map=[n,e.line-1],l.children=[];const d=e.push("heading_close","h"+String(a),-1);return d.markup=String.fromCharCode(o),e.parentType=r,!0}function za(e,n,t){const u=e.md.block.ruler.getRules("paragraph"),r=e.parentType;let a=n+1;for(e.parentType="paragraph";a<t&&!e.isEmpty(a);a++){if(e.sCount[a]-e.blkIndent>3||e.sCount[a]<0)continue;let c=!1;for(let l=0,d=u.length;l<d;l++)if(u[l](e,a,t,!0)){c=!0;break}if(c)break}const o=Ne(e.getLines(n,a,e.blkIndent,!1));e.line=a;const s=e.push("paragraph_open","p",1);s.map=[n,e.line];const i=e.push("inline","",0);return i.content=o,i.map=[n,e.line],i.children=[],e.push("paragraph_close","p",-1),e.parentType=r,!0}const Pe=[["table",ga,["paragraph","reference"]],["code",xa],["fence",ya,["paragraph","reference","blockquote","list"]],["blockquote",_a,["paragraph","reference","blockquote","list"]],["hr",ka,["paragraph","reference","blockquote","list"]],["list",wa,["paragraph","reference","blockquote"]],["reference",Ca],["html_block",Ha,["paragraph","reference","blockquote"]],["heading",Na,["paragraph","reference","blockquote"]],["lheading",Ba],["paragraph",za]];function Be(){this.ruler=new D;for(let e=0;e<Pe.length;e++)this.ruler.push(Pe[e][0],Pe[e][1],{alt:(Pe[e][2]||[]).slice()})}Be.prototype.tokenize=function(e,n,t){const u=this.ruler.getRules(""),r=u.length,a=e.md.options.maxNesting;let o=n,s=!1;for(;o<t&&(e.line=o=e.skipEmptyLines(o),!(o>=t||e.sCount[o]<e.blkIndent));){if(e.level>=a){e.line=t;break}const i=e.line;let c=!1;for(let l=0;l<r;l++)if(c=u[l](e,o,t,!1),c){if(i>=e.line)throw new Error("block rule didn't increment state.line");break}if(!c)throw new Error("none of the block rules matched");e.tight=!s,e.isEmpty(e.line-1)&&(s=!0),o=e.line,o<t&&e.isEmpty(o)&&(s=!0,o++,e.line=o)}};Be.prototype.parse=function(e,n,t,u){if(!e)return;const r=new this.State(e,n,t,u);this.tokenize(r,r.line,r.lineMax)};Be.prototype.State=B;function we(e,n,t,u){this.src=e,this.env=t,this.md=n,this.tokens=u,this.tokens_meta=Array(u.length),this.pos=0,this.posMax=this.src.length,this.level=0,this.pending="",this.pendingLevel=0,this.cache={},this.delimiters=[],this._prev_delimiters=[],this.backticks={},this.backticksScanned=!1,this.linkLevel=0}we.prototype.pushPending=function(){const e=new I("text","",0);return e.content=this.pending,e.level=this.pendingLevel,this.tokens.push(e),this.pending="",e};we.prototype.push=function(e,n,t){this.pending&&this.pushPending();const u=new I(e,n,t);let r=null;return t<0&&(this.level--,this.delimiters=this._prev_delimiters.pop()),u.level=this.level,t>0&&(this.level++,this._prev_delimiters.push(this.delimiters),this.delimiters=[],r={delimiters:this.delimiters}),this.pendingLevel=this.level,this.tokens.push(u),this.tokens_meta.push(r),u};we.prototype.scanDelims=function(e,n){const t=this.posMax,u=this.src.charCodeAt(e);let r;if(e===0)r=32;else if(e===1)r=this.src.charCodeAt(0),(r&63488)===55296&&(r=65533);else if(r=this.src.charCodeAt(e-1),(r&64512)===56320){const g=this.src.charCodeAt(e-2);r=(g&64512)===55296?65536+(g-55296<<10)+(r-56320):65533}else(r&64512)===55296&&(r=65533);let a=e;for(;a<t&&this.src.charCodeAt(a)===u;)a++;const o=a-e;let s=a<t?this.src.charCodeAt(a):32;if((s&64512)===55296){const g=this.src.charCodeAt(a+1);s=(g&64512)===56320?65536+(s-55296<<10)+(g-56320):65533}else(s&64512)===56320&&(s=65533);const i=ge(r)||be(r),c=ge(s)||be(s),l=me(r),d=me(s),h=!d&&(!c||l||i),p=!l&&(!i||d||c);return{can_open:h&&(n||!p||i),can_close:p&&(n||!h||c),length:o}};we.prototype.Token=I;function Ga(e){switch(e){case 10:case 33:case 35:case 36:case 37:case 38:case 42:case 43:case 45:case 58:case 60:case 61:case 62:case 64:case 91:case 92:case 93:case 94:case 95:case 96:case 123:case 125:case 126:return!0;default:return!1}}function qa(e,n){let t=e.pos;for(;t<e.posMax&&!Ga(e.src.charCodeAt(t));)t++;return t===e.pos?!1:(n||(e.pending+=e.src.slice(e.pos,t)),e.pos=t,!0)}const Ua=/(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i;function ja(e,n){if(!e.md.options.linkify||e.linkLevel>0)return!1;const t=e.pos,u=e.posMax;if(t+3>u||e.src.charCodeAt(t)!==58||e.src.charCodeAt(t+1)!==47||e.src.charCodeAt(t+2)!==47)return!1;const r=e.pending.match(Ua);if(!r)return!1;const a=r[1],o=e.md.linkify.matchAtStart(e.src.slice(t-a.length));if(!o)return!1;let s=o.url;if(s.length<=a.length)return!1;let i=s.length;for(;i>0&&s.charCodeAt(i-1)===42;)i--;i!==s.length&&(s=s.slice(0,i));const c=e.md.normalizeLink(s);if(!e.md.validateLink(c))return!1;if(!n){e.pending=e.pending.slice(0,-a.length);const l=e.push("link_open","a",1);l.attrs=[["href",c]],l.markup="linkify",l.info="auto";const d=e.push("text","",0);d.content=e.md.normalizeLinkText(s);const h=e.push("link_close","a",-1);h.markup="linkify",h.info="auto"}return e.pos+=s.length-a.length,!0}function Va(e,n){let t=e.pos;if(e.src.charCodeAt(t)!==10)return!1;const u=e.pending.length-1,r=e.posMax;if(!n)if(u>=0&&e.pending.charCodeAt(u)===32)if(u>=1&&e.pending.charCodeAt(u-1)===32){let a=u-1;for(;a>=1&&e.pending.charCodeAt(a-1)===32;)a--;e.pending=e.pending.slice(0,a),e.push("hardbreak","br",0)}else e.pending=e.pending.slice(0,-1),e.push("softbreak","br",0);else e.push("softbreak","br",0);for(t++;t<r&&C(e.src.charCodeAt(t));)t++;return e.pos=t,!0}const bn=[];for(let e=0;e<256;e++)bn.push(0);"\\!\"#$%&'()*+,./:;<=>?@[]^_`{|}~-".split("").forEach(function(e){bn[e.charCodeAt(0)]=1});function $a(e,n){let t=e.pos;const u=e.posMax;if(e.src.charCodeAt(t)!==92||(t++,t>=u))return!1;let r=e.src.charCodeAt(t);if(r===10){for(n||e.push("hardbreak","br",0),t++;t<u&&(r=e.src.charCodeAt(t),!!C(r));)t++;return e.pos=t,!0}let a=e.src[t];if(r>=55296&&r<=56319&&t+1<u){const s=e.src.charCodeAt(t+1);s>=56320&&s<=57343&&(a+=e.src[t+1],t++)}const o="\\"+a;if(!n){const s=e.push("text_special","",0);r<256&&bn[r]!==0?s.content=a:s.content=o,s.markup=o,s.info="escape"}return e.pos=t+1,!0}function Ka(e,n){let t=e.pos;if(e.src.charCodeAt(t)!==96)return!1;const r=t;t++;const a=e.posMax;for(;t<a&&e.src.charCodeAt(t)===96;)t++;const o=e.src.slice(r,t),s=o.length;if(e.backticksScanned&&(e.backticks[s]||0)<=r)return n||(e.pending+=o),e.pos+=s,!0;let i=t,c;for(;(c=e.src.indexOf("`",i))!==-1;){for(i=c+1;i<a&&e.src.charCodeAt(i)===96;)i++;const l=i-c;if(l===s){if(!n){const d=e.push("code_inline","code",0);d.markup=o,d.content=e.src.slice(t,c).replace(/\n/g," ").replace(/^ (.+) $/,"$1")}return e.pos=i,!0}e.backticks[l]=c}return e.backticksScanned=!0,n||(e.pending+=o),e.pos+=s,!0}function Za(e,n){const t=e.pos,u=e.src.charCodeAt(t);if(n||u!==126)return!1;const r=e.scanDelims(e.pos,!0);let a=r.length;const o=String.fromCharCode(u);if(a<2)return!1;let s;a%2&&(s=e.push("text","",0),s.content=o,a--);for(let i=0;i<a;i+=2)s=e.push("text","",0),s.content=o+o,e.delimiters.push({marker:u,length:0,token:e.tokens.length-1,end:-1,open:r.can_open,close:r.can_close});return e.pos+=r.length,!0}function zn(e,n){let t;const u=[],r=n.length;for(let a=0;a<r;a++){const o=n[a];if(o.marker!==126||o.end===-1)continue;const s=n[o.end];t=e.tokens[o.token],t.type="s_open",t.tag="s",t.nesting=1,t.markup="~~",t.content="",t=e.tokens[s.token],t.type="s_close",t.tag="s",t.nesting=-1,t.markup="~~",t.content="",e.tokens[s.token-1].type==="text"&&e.tokens[s.token-1].content==="~"&&u.push(s.token-1)}for(;u.length;){const a=u.pop();let o=a+1;for(;o<e.tokens.length&&e.tokens[o].type==="s_close";)o++;o--,a!==o&&(t=e.tokens[o],e.tokens[o]=e.tokens[a],e.tokens[a]=t)}}function Ya(e){const n=e.tokens_meta,t=e.tokens_meta.length;zn(e,e.delimiters);for(let u=0;u<t;u++)n[u]&&n[u].delimiters&&zn(e,n[u].delimiters)}const _t={tokenize:Za,postProcess:Ya};function Ja(e,n){const t=e.pos,u=e.src.charCodeAt(t);if(n||u!==95&&u!==42)return!1;const r=e.scanDelims(e.pos,u===42);for(let a=0;a<r.length;a++){const o=e.push("text","",0);o.content=String.fromCharCode(u),e.delimiters.push({marker:u,length:r.length,token:e.tokens.length-1,end:-1,open:r.can_open,close:r.can_close})}return e.pos+=r.length,!0}function Gn(e,n){const t=n.length;for(let u=t-1;u>=0;u--){const r=n[u];if(r.marker!==95&&r.marker!==42||r.end===-1)continue;const a=n[r.end],o=u>0&&n[u-1].end===r.end+1&&n[u-1].marker===r.marker&&n[u-1].token===r.token-1&&n[r.end+1].token===a.token+1,s=String.fromCharCode(r.marker),i=e.tokens[r.token];i.type=o?"strong_open":"em_open",i.tag=o?"strong":"em",i.nesting=1,i.markup=o?s+s:s,i.content="";const c=e.tokens[a.token];c.type=o?"strong_close":"em_close",c.tag=o?"strong":"em",c.nesting=-1,c.markup=o?s+s:s,c.content="",o&&(e.tokens[n[u-1].token].content="",e.tokens[n[r.end+1].token].content="",u--)}}function Xa(e){const n=e.tokens_meta,t=e.tokens_meta.length;Gn(e,e.delimiters);for(let u=0;u<t;u++)n[u]&&n[u].delimiters&&Gn(e,n[u].delimiters)}const kt={tokenize:Ja,postProcess:Xa};function Qa(e,n){let t,u,r,a,o="",s="",i=e.pos,c=!0;if(e.src.charCodeAt(e.pos)!==91)return!1;const l=e.pos,d=e.posMax,h=e.pos+1,p=e.md.helpers.parseLinkLabel(e,e.pos,!0);if(p<0)return!1;let f=p+1;if(f<d&&e.src.charCodeAt(f)===40){for(c=!1,f++;f<d&&(t=e.src.charCodeAt(f),!(!C(t)&&t!==10));f++);if(f>=d)return!1;if(i=f,r=e.md.helpers.parseLinkDestination(e.src,f,e.posMax),r.ok){for(o=e.md.normalizeLink(r.str),e.md.validateLink(o)?f=r.pos:o="",i=f;f<d&&(t=e.src.charCodeAt(f),!(!C(t)&&t!==10));f++);if(r=e.md.helpers.parseLinkTitle(e.src,f,e.posMax),f<d&&i!==f&&r.ok)for(s=r.str,f=r.pos;f<d&&(t=e.src.charCodeAt(f),!(!C(t)&&t!==10));f++);}(f>=d||e.src.charCodeAt(f)!==41)&&(c=!0),f++}if(c){if(typeof e.env.references>"u")return!1;if(f<d&&e.src.charCodeAt(f)===91?(i=f+1,f=e.md.helpers.parseLinkLabel(e,f),f>=0?u=e.src.slice(i,f++):f=p+1):f=p+1,u||(u=e.src.slice(h,p)),a=e.env.references[He(u)],!a)return e.pos=l,!1;o=a.href,s=a.title}if(!n){e.pos=h,e.posMax=p;const b=e.push("link_open","a",1),g=[["href",o]];b.attrs=g,s&&g.push(["title",s]),e.linkLevel++,e.md.inline.tokenize(e),e.linkLevel--,e.push("link_close","a",-1)}return e.pos=f,e.posMax=d,!0}function eo(e,n){let t,u,r,a,o,s,i,c,l="";const d=e.pos,h=e.posMax;if(e.src.charCodeAt(e.pos)!==33||e.src.charCodeAt(e.pos+1)!==91)return!1;const p=e.pos+2,f=e.md.helpers.parseLinkLabel(e,e.pos+1,!1);if(f<0)return!1;if(a=f+1,a<h&&e.src.charCodeAt(a)===40){for(a++;a<h&&(t=e.src.charCodeAt(a),!(!C(t)&&t!==10));a++);if(a>=h)return!1;for(c=a,s=e.md.helpers.parseLinkDestination(e.src,a,e.posMax),s.ok&&(l=e.md.normalizeLink(s.str),e.md.validateLink(l)?a=s.pos:l=""),c=a;a<h&&(t=e.src.charCodeAt(a),!(!C(t)&&t!==10));a++);if(s=e.md.helpers.parseLinkTitle(e.src,a,e.posMax),a<h&&c!==a&&s.ok)for(i=s.str,a=s.pos;a<h&&(t=e.src.charCodeAt(a),!(!C(t)&&t!==10));a++);else i="";if(a>=h||e.src.charCodeAt(a)!==41)return e.pos=d,!1;a++}else{if(typeof e.env.references>"u")return!1;if(a<h&&e.src.charCodeAt(a)===91?(c=a+1,a=e.md.helpers.parseLinkLabel(e,a),a>=0?r=e.src.slice(c,a++):a=f+1):a=f+1,r||(r=e.src.slice(p,f)),o=e.env.references[He(r)],!o)return e.pos=d,!1;l=o.href,i=o.title}if(!n){u=e.src.slice(p,f);const b=[];e.md.inline.parse(u,e.md,e.env,b);const g=e.push("image","img",0),S=[["src",l],["alt",""]];g.attrs=S,g.children=b,g.content=u,i&&S.push(["title",i])}return e.pos=a,e.posMax=h,!0}const no=/^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/,to=/^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;function uo(e,n){let t=e.pos;if(e.src.charCodeAt(t)!==60)return!1;const u=e.pos,r=e.posMax;for(;;){if(++t>=r)return!1;const o=e.src.charCodeAt(t);if(o===60)return!1;if(o===62)break}const a=e.src.slice(u+1,t);if(to.test(a)){const o=e.md.normalizeLink(a);if(!e.md.validateLink(o))return!1;if(!n){const s=e.push("link_open","a",1);s.attrs=[["href",o]],s.markup="autolink",s.info="auto";const i=e.push("text","",0);i.content=e.md.normalizeLinkText(a);const c=e.push("link_close","a",-1);c.markup="autolink",c.info="auto"}return e.pos+=a.length+2,!0}if(no.test(a)){const o=e.md.normalizeLink("mailto:"+a);if(!e.md.validateLink(o))return!1;if(!n){const s=e.push("link_open","a",1);s.attrs=[["href",o]],s.markup="autolink",s.info="auto";const i=e.push("text","",0);i.content=e.md.normalizeLinkText(a);const c=e.push("link_close","a",-1);c.markup="autolink",c.info="auto"}return e.pos+=a.length+2,!0}return!1}function ro(e){return/^<a[>\s]/i.test(e)}function ao(e){return/^<\/a\s*>/i.test(e)}function oo(e){const n=e|32;return n>=97&&n<=122}function so(e,n){if(!e.md.options.html)return!1;const t=e.posMax,u=e.pos;if(e.src.charCodeAt(u)!==60||u+2>=t)return!1;const r=e.src.charCodeAt(u+1);if(r!==33&&r!==63&&r!==47&&!oo(r))return!1;const a=e.src.slice(u).match(Ma);if(!a)return!1;if(!n){const o=e.push("html_inline","",0);o.content=a[0],ro(o.content)&&e.linkLevel++,ao(o.content)&&e.linkLevel--}return e.pos+=a[0].length,!0}const io=/^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,co=/^&([a-z][a-z0-9]{1,31});/i;function lo(e,n){const t=e.pos,u=e.posMax;if(e.src.charCodeAt(t)!==38||t+1>=u)return!1;if(e.src.charCodeAt(t+1)===35){const a=e.src.slice(t).match(io);if(a){if(!n){const o=a[1][0].toLowerCase()==="x"?parseInt(a[1].slice(1),16):parseInt(a[1],10),s=e.push("text_special","",0);s.content=hn(o)?he(o):he(65533),s.markup=a[0],s.info="entity"}return e.pos+=a[0].length,!0}}else{const a=e.src.slice(t).match(co);if(a){const o=Dr(a[0]);if(o!==a[0]){if(!n){const s=e.push("text_special","",0);s.content=o,s.markup=a[0],s.info="entity"}return e.pos+=a[0].length,!0}}}return!1}function qn(e){const n={},t=e.length;if(!t)return;let u=0,r=-2;const a=[];for(let o=0;o<t;o++){const s=e[o];if(a.push(0),(e[u].marker!==s.marker||r!==s.token-1)&&(u=o),r=s.token,s.length=s.length||0,!s.close)continue;n.hasOwnProperty(s.marker)||(n[s.marker]=[-1,-1,-1,-1,-1,-1]);const i=n[s.marker][(s.open?3:0)+s.length%3];let c=u-a[u]-1,l=c;for(;c>i;c-=a[c]+1){const d=e[c];if(d.marker===s.marker&&d.open&&d.end<0){let h=!1;if((d.close||s.open)&&(d.length+s.length)%3===0&&(d.length%3!==0||s.length%3!==0)&&(h=!0),!h){const p=c>0&&!e[c-1].open?a[c-1]+1:0;a[o]=o-c+p,a[c]=p,s.open=!1,d.end=o,d.close=!1,l=-1,r=-2;break}}}l!==-1&&(n[s.marker][(s.open?3:0)+(s.length||0)%3]=l)}}function fo(e){const n=e.tokens_meta,t=e.tokens_meta.length;qn(e.delimiters);for(let u=0;u<t;u++)n[u]&&n[u].delimiters&&qn(n[u].delimiters)}function po(e){let n,t,u=0;const r=e.tokens,a=e.tokens.length;for(n=t=0;n<a;n++)r[n].nesting<0&&u--,r[n].level=u,r[n].nesting>0&&u++,r[n].type==="text"&&n+1<a&&r[n+1].type==="text"?r[n+1].content=r[n].content+r[n+1].content:(n!==t&&(r[t]=r[n]),t++);n!==t&&(r.length=t)}const Ye=[["text",qa],["linkify",ja],["newline",Va],["escape",$a],["backticks",Ka],["strikethrough",_t.tokenize],["emphasis",kt.tokenize],["link",Qa],["image",eo],["autolink",uo],["html_inline",so],["entity",lo]],Je=[["balance_pairs",fo],["strikethrough",_t.postProcess],["emphasis",kt.postProcess],["fragments_join",po]];function Ce(){this.ruler=new D;for(let e=0;e<Ye.length;e++)this.ruler.push(Ye[e][0],Ye[e][1]);this.ruler2=new D;for(let e=0;e<Je.length;e++)this.ruler2.push(Je[e][0],Je[e][1])}Ce.prototype.skipToken=function(e){const n=e.pos,t=this.ruler.getRules(""),u=t.length,r=e.md.options.maxNesting,a=e.cache;if(typeof a[n]<"u"){e.pos=a[n];return}let o=!1;if(e.level<r){for(let s=0;s<u;s++)if(e.level++,o=t[s](e,!0),e.level--,o){if(n>=e.pos)throw new Error("inline rule didn't increment state.pos");break}}else e.pos=e.posMax;o||e.pos++,a[n]=e.pos};Ce.prototype.tokenize=function(e){const n=this.ruler.getRules(""),t=n.length,u=e.posMax,r=e.md.options.maxNesting;for(;e.pos<u;){const a=e.pos;let o=!1;if(e.level<r){for(let s=0;s<t;s++)if(o=n[s](e,!1),o){if(a>=e.pos)throw new Error("inline rule didn't increment state.pos");break}}if(o){if(e.pos>=u)break;continue}e.pending+=e.src[e.pos++]}e.pending&&e.pushPending()};Ce.prototype.parse=function(e,n,t,u){const r=new this.State(e,n,t,u);this.tokenize(r);const a=this.ruler2.getRules(""),o=a.length;for(let s=0;s<o;s++)a[s](r)};Ce.prototype.State=we;function ho(e){const n={};e=e||{},n.src_Any=st.source,n.src_Cc=it.source,n.src_Z=lt.source,n.src_P=fn.source,n.src_ZPCc=[n.src_Z,n.src_P,n.src_Cc].join("|"),n.src_ZCc=[n.src_Z,n.src_Cc].join("|");const t="[><｜]";return n.src_pseudo_letter="(?:(?!"+t+"|"+n.src_ZPCc+")"+n.src_Any+")",n.src_ip4="(?:(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)",n.src_auth="(?:(?:(?!"+n.src_ZCc+"|[@/\\[\\]()]).)+@)?",n.src_port="(?::(?:6(?:[0-4]\\d{3}|5(?:[0-4]\\d{2}|5(?:[0-2]\\d|3[0-5])))|[1-5]?\\d{1,4}))?",n.src_host_terminator="(?=$|"+t+"|"+n.src_ZPCc+")(?!"+(e["---"]?"-(?!--)|":"-|")+"_|:\\d|\\.-|\\.(?!$|"+n.src_ZPCc+"))",n.src_path="(?:[/?#](?:(?!"+n.src_ZCc+"|"+t+`|[()[\\]{}.,"'?!\\-;]).|\\[(?:(?!`+n.src_ZCc+"|\\]).)*\\]|\\((?:(?!"+n.src_ZCc+"|[)]).)*\\)|\\{(?:(?!"+n.src_ZCc+'|[}]).)*\\}|\\"(?:(?!'+n.src_ZCc+`|["]).)+\\"|\\'(?:(?!`+n.src_ZCc+"|[']).)+\\'|\\'(?="+n.src_pseudo_letter+"|[-])|\\.{2,}[a-zA-Z0-9%/&]|\\.(?!"+n.src_ZCc+"|[.]|$)|"+(e["---"]?"\\-(?!--(?:[^-]|$))(?:-*)|":"\\-+|")+",(?!"+n.src_ZCc+"|$)|;(?!"+n.src_ZCc+"|$)|\\!+(?!"+n.src_ZCc+"|[!]|$)|\\?(?!"+n.src_ZCc+"|[?]|$))+|\\/)?",n.src_email_name='[\\-;:&=\\+\\$,\\.a-zA-Z0-9_][\\-;:&=\\+\\$,\\"\\.a-zA-Z0-9_]*',n.src_xn="xn--[a-z0-9\\-]{1,59}",n.src_domain_root="(?:"+n.src_xn+"|"+n.src_pseudo_letter+"{1,63})",n.src_domain="(?:"+n.src_xn+"|(?:"+n.src_pseudo_letter+")|(?:"+n.src_pseudo_letter+"(?:-|"+n.src_pseudo_letter+"){0,61}"+n.src_pseudo_letter+"))",n.src_host="(?:(?:(?:(?:"+n.src_domain+")\\.)*"+n.src_domain+"))",n.tpl_host_fuzzy="(?:"+n.src_ip4+"|(?:(?:(?:"+n.src_domain+")\\.)+(?:%TLDS%)))",n.tpl_host_no_ip_fuzzy="(?:(?:(?:"+n.src_domain+")\\.)+(?:%TLDS%))",n.src_host_strict=n.src_host+n.src_host_terminator,n.tpl_host_fuzzy_strict=n.tpl_host_fuzzy+n.src_host_terminator,n.src_host_port_strict=n.src_host+n.src_port+n.src_host_terminator,n.tpl_host_port_fuzzy_strict=n.tpl_host_fuzzy+n.src_port+n.src_host_terminator,n.tpl_host_port_no_ip_fuzzy_strict=n.tpl_host_no_ip_fuzzy+n.src_port+n.src_host_terminator,n.tpl_host_fuzzy_test="localhost|www\\.|\\.\\d{1,3}\\.|(?:\\.(?:%TLDS%)(?:"+n.src_ZPCc+"|>|$))",n.tpl_email_fuzzy="(^|"+t+'|"|\\(|'+n.src_ZCc+")("+n.src_email_name+"@"+n.tpl_host_fuzzy_strict+")",n.tpl_link_fuzzy="(^|(?![.:/\\-_@])(?:[$+<=>^`|｜]|"+n.src_ZPCc+"))((?![$+<=>^`|｜])"+n.tpl_host_port_fuzzy_strict+n.src_path+")",n.tpl_link_no_ip_fuzzy="(^|(?![.:/\\-_@])(?:[$+<=>^`|｜]|"+n.src_ZPCc+"))((?![$+<=>^`|｜])"+n.tpl_host_port_no_ip_fuzzy_strict+n.src_path+")",n}function an(e){return Array.prototype.slice.call(arguments,1).forEach(function(t){t&&Object.keys(t).forEach(function(u){e[u]=t[u]})}),e}function ze(e){return Object.prototype.toString.call(e)}function mo(e){return ze(e)==="[object String]"}function bo(e){return ze(e)==="[object Object]"}function go(e){return ze(e)==="[object RegExp]"}function Un(e){return ze(e)==="[object Function]"}function xo(e){return e.replace(/[.?*+^$[\]\\(){}|-]/g,"\\$&")}const St={fuzzyLink:!0,fuzzyEmail:!0,fuzzyIP:!1};function yo(e){return Object.keys(e||{}).reduce(function(n,t){return n||St.hasOwnProperty(t)},!1)}const _o={"http:":{validate:function(e,n,t){const u=e.slice(n);return t.re.http||(t.re.http=new RegExp("^\\/\\/"+t.re.src_auth+t.re.src_host_port_strict+t.re.src_path,"i")),t.re.http.test(u)?u.match(t.re.http)[0].length:0}},"https:":"http:","ftp:":"http:","//":{validate:function(e,n,t){const u=e.slice(n);return t.re.no_http||(t.re.no_http=new RegExp("^"+t.re.src_auth+"(?:localhost|(?:(?:"+t.re.src_domain+")\\.)+"+t.re.src_domain_root+")"+t.re.src_port+t.re.src_host_terminator+t.re.src_path,"i")),t.re.no_http.test(u)?n>=3&&e[n-3]===":"||n>=3&&e[n-3]==="/"?0:u.match(t.re.no_http)[0].length:0}},"mailto:":{validate:function(e,n,t){const u=e.slice(n);return t.re.mailto||(t.re.mailto=new RegExp("^"+t.re.src_email_name+"@"+t.re.src_host_strict,"i")),t.re.mailto.test(u)?u.match(t.re.mailto)[0].length:0}}},ko="a[cdefgilmnoqrstuwxz]|b[abdefghijmnorstvwyz]|c[acdfghiklmnoruvwxyz]|d[ejkmoz]|e[cegrstu]|f[ijkmor]|g[abdefghilmnpqrstuwy]|h[kmnrtu]|i[delmnoqrst]|j[emop]|k[eghimnprwyz]|l[abcikrstuvy]|m[acdeghklmnopqrstuvwxyz]|n[acefgilopruz]|om|p[aefghklmnrstwy]|qa|r[eosuw]|s[abcdeghijklmnortuvxyz]|t[cdfghjklmnortvwz]|u[agksyz]|v[aceginu]|w[fs]|y[et]|z[amw]",So="biz|com|edu|gov|net|org|pro|web|xxx|aero|asia|coop|info|museum|name|shop|рф".split("|");function wo(e){return function(n,t){const u=n.slice(t);return e.test(u)?u.match(e)[0].length:0}}function jn(){return function(e,n){n.normalize(e)}}function Ee(e){const n=e.re=ho(e.__opts__),t=e.__tlds__.slice();e.onCompile(),e.__tlds_replaced__||t.push(ko),t.push(n.src_xn),n.src_tlds=t.join("|");function u(s){return s.replace("%TLDS%",n.src_tlds)}n.email_fuzzy=RegExp(u(n.tpl_email_fuzzy),"i"),n.email_fuzzy_global=RegExp(u(n.tpl_email_fuzzy),"ig"),n.link_fuzzy=RegExp(u(n.tpl_link_fuzzy),"i"),n.link_fuzzy_global=RegExp(u(n.tpl_link_fuzzy),"ig"),n.link_no_ip_fuzzy=RegExp(u(n.tpl_link_no_ip_fuzzy),"i"),n.link_no_ip_fuzzy_global=RegExp(u(n.tpl_link_no_ip_fuzzy),"ig"),n.host_fuzzy_test=RegExp(u(n.tpl_host_fuzzy_test),"i");const r=[];e.__compiled__={};function a(s,i){throw new Error('(LinkifyIt) Invalid schema "'+s+'": '+i)}Object.keys(e.__schemas__).forEach(function(s){const i=e.__schemas__[s];if(i===null)return;const c={validate:null,link:null};if(e.__compiled__[s]=c,bo(i)){go(i.validate)?c.validate=wo(i.validate):Un(i.validate)?c.validate=i.validate:a(s,i),Un(i.normalize)?c.normalize=i.normalize:i.normalize?a(s,i):c.normalize=jn();return}if(mo(i)){r.push(s);return}a(s,i)}),r.forEach(function(s){e.__compiled__[e.__schemas__[s]]&&(e.__compiled__[s].validate=e.__compiled__[e.__schemas__[s]].validate,e.__compiled__[s].normalize=e.__compiled__[e.__schemas__[s]].normalize)}),e.__compiled__[""]={validate:null,normalize:jn()};const o=Object.keys(e.__compiled__).filter(function(s){return s.length>0&&e.__compiled__[s]}).map(xo).join("|");e.re.schema_test=RegExp("(^|(?!_)(?:[><｜]|"+n.src_ZPCc+"))("+o+")","i"),e.re.schema_search=RegExp("(^|(?!_)(?:[><｜]|"+n.src_ZPCc+"))("+o+")","ig"),e.re.schema_at_start=RegExp("^"+e.re.schema_search.source,"i"),e.re.pretest=RegExp("("+e.re.schema_test.source+")|("+e.re.host_fuzzy_test.source+")|@","i")}function wt(e,n,t,u){const r=e.slice(t,u);this.schema=n.toLowerCase(),this.index=t,this.lastIndex=u,this.raw=r,this.text=r,this.url=r}function E(e,n){if(!(this instanceof E))return new E(e,n);n||yo(e)&&(n=e,e={}),this.__opts__=an({},St,n),this.__schemas__=an({},_o,e),this.__compiled__={},this.__tlds__=So,this.__tlds_replaced__=!1,this.re={},Ee(this)}E.prototype.add=function(n,t){return this.__schemas__[n]=t,Ee(this),this};E.prototype.set=function(n){return this.__opts__=an(this.__opts__,n),this};E.prototype.test=function(n){if(!n.length)return!1;let t,u;if(this.re.schema_test.test(n)){for(u=this.re.schema_search,u.lastIndex=0;(t=u.exec(n))!==null;)if(this.testSchemaAt(n,t[2],u.lastIndex))return!0}return!!(this.__opts__.fuzzyLink&&this.__compiled__["http:"]&&n.search(this.re.host_fuzzy_test)>=0&&n.match(this.__opts__.fuzzyIP?this.re.link_fuzzy:this.re.link_no_ip_fuzzy)!==null||this.__opts__.fuzzyEmail&&this.__compiled__["mailto:"]&&n.indexOf("@")>=0&&n.match(this.re.email_fuzzy)!==null)};E.prototype.pretest=function(n){return this.re.pretest.test(n)};E.prototype.testSchemaAt=function(n,t,u){return this.__compiled__[t.toLowerCase()]?this.__compiled__[t.toLowerCase()].validate(n,u,this):0};E.prototype.match=function(n){const t=[],u=[],r=[],a=[];let o,s,i;function c(h,p){return h?p?h.index!==p.index?h.index<p.index?h:p:h.lastIndex>=p.lastIndex?h:p:h:p}if(!n.length)return null;if(this.re.schema_test.test(n))for(i=this.re.schema_search,i.lastIndex=0;(o=i.exec(n))!==null;)s=this.testSchemaAt(n,o[2],i.lastIndex),s&&u.push({schema:o[2],index:o.index+o[1].length,lastIndex:o.index+o[0].length+s});if(this.__opts__.fuzzyLink&&this.__compiled__["http:"])for(i=this.__opts__.fuzzyIP?this.re.link_fuzzy_global:this.re.link_no_ip_fuzzy_global,i.lastIndex=0;(o=i.exec(n))!==null;)r.push({schema:"",index:o.index+o[1].length,lastIndex:o.index+o[0].length});if(this.__opts__.fuzzyEmail&&this.__compiled__["mailto:"])for(i=this.re.email_fuzzy_global,i.lastIndex=0;(o=i.exec(n))!==null;)a.push({schema:"mailto:",index:o.index+o[1].length,lastIndex:o.index+o[0].length});const l=[0,0,0];let d=0;for(;;){const h=[u[l[0]],a[l[1]],r[l[2]]],p=c(c(h[0],h[1]),h[2]);if(!p)break;if(p===h[0]?l[0]++:p===h[1]?l[1]++:l[2]++,p.index<d)continue;const f=new wt(n,p.schema,p.index,p.lastIndex);this.__compiled__[f.schema].normalize(f,this),t.push(f),d=p.lastIndex}return t.length?t:null};E.prototype.matchAtStart=function(n){if(!n.length)return null;const t=this.re.schema_at_start.exec(n);if(!t)return null;const u=this.testSchemaAt(n,t[2],t[0].length);if(!u)return null;const r=new wt(n,t[2],t.index+t[1].length,t.index+t[0].length+u);return this.__compiled__[r.schema].normalize(r,this),r};E.prototype.tlds=function(n,t){return n=Array.isArray(n)?n:[n],t?(this.__tlds__=this.__tlds__.concat(n).sort().filter(function(u,r,a){return u!==a[r-1]}).reverse(),Ee(this),this):(this.__tlds__=n.slice(),this.__tlds_replaced__=!0,Ee(this),this)};E.prototype.normalize=function(n){n.schema||(n.url="http://"+n.url),n.schema==="mailto:"&&!/^mailto:/i.test(n.url)&&(n.url="mailto:"+n.url)};E.prototype.onCompile=function(){};const te=2147483647,M=36,gn=1,xe=26,Co=38,vo=700,Ct=72,vt=128,Tt="-",To=/^xn--/,Po=/[^\0-\x7F]/,Ro=/[\x2E\u3002\uFF0E\uFF61]/g,Do={overflow:"Overflow: input needs wider integers to process","not-basic":"Illegal input >= 0x80 (not a basic code point)","invalid-input":"Invalid input"},Xe=M-gn,O=Math.floor,Qe=String.fromCharCode;function j(e){throw new RangeError(Do[e])}function Eo(e,n){const t=[];let u=e.length;for(;u--;)t[u]=n(e[u]);return t}function Pt(e,n){const t=e.split("@");let u="";t.length>1&&(u=t[0]+"@",e=t[1]),e=e.replace(Ro,".");const r=e.split("."),a=Eo(r,n).join(".");return u+a}function Rt(e){const n=[];let t=0;const u=e.length;for(;t<u;){const r=e.charCodeAt(t++);if(r>=55296&&r<=56319&&t<u){const a=e.charCodeAt(t++);(a&64512)==56320?n.push(((r&1023)<<10)+(a&1023)+65536):(n.push(r),t--)}else n.push(r)}return n}const Ao=e=>String.fromCodePoint(...e),Fo=function(e){return e>=48&&e<58?26+(e-48):e>=65&&e<91?e-65:e>=97&&e<123?e-97:M},Vn=function(e,n){return e+22+75*(e<26)-((n!=0)<<5)},Dt=function(e,n,t){let u=0;for(e=t?O(e/vo):e>>1,e+=O(e/n);e>Xe*xe>>1;u+=M)e=O(e/Xe);return O(u+(Xe+1)*e/(e+Co))},Et=function(e){const n=[],t=e.length;let u=0,r=vt,a=Ct,o=e.lastIndexOf(Tt);o<0&&(o=0);for(let s=0;s<o;++s)e.charCodeAt(s)>=128&&j("not-basic"),n.push(e.charCodeAt(s));for(let s=o>0?o+1:0;s<t;){const i=u;for(let l=1,d=M;;d+=M){s>=t&&j("invalid-input");const h=Fo(e.charCodeAt(s++));h>=M&&j("invalid-input"),h>O((te-u)/l)&&j("overflow"),u+=h*l;const p=d<=a?gn:d>=a+xe?xe:d-a;if(h<p)break;const f=M-p;l>O(te/f)&&j("overflow"),l*=f}const c=n.length+1;a=Dt(u-i,c,i==0),O(u/c)>te-r&&j("overflow"),r+=O(u/c),u%=c,n.splice(u++,0,r)}return String.fromCodePoint(...n)},At=function(e){const n=[];e=Rt(e);const t=e.length;let u=vt,r=0,a=Ct;for(const i of e)i<128&&n.push(Qe(i));const o=n.length;let s=o;for(o&&n.push(Tt);s<t;){let i=te;for(const l of e)l>=u&&l<i&&(i=l);const c=s+1;i-u>O((te-r)/c)&&j("overflow"),r+=(i-u)*c,u=i;for(const l of e)if(l<u&&++r>te&&j("overflow"),l===u){let d=r;for(let h=M;;h+=M){const p=h<=a?gn:h>=a+xe?xe:h-a;if(d<p)break;const f=d-p,b=M-p;n.push(Qe(Vn(p+f%b,0))),d=O(f/b)}n.push(Qe(Vn(d,0))),a=Dt(r,c,s===o),r=0,++s}++r,++u}return n.join("")},Io=function(e){return Pt(e,function(n){return To.test(n)?Et(n.slice(4).toLowerCase()):n})},Lo=function(e){return Pt(e,function(n){return Po.test(n)?"xn--"+At(n):n})},Ft={version:"2.3.1",ucs2:{decode:Rt,encode:Ao},decode:Et,encode:At,toASCII:Lo,toUnicode:Io},Wo={options:{html:!1,xhtmlOut:!1,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:100},components:{core:{},block:{},inline:{}}},Mo={options:{html:!1,xhtmlOut:!1,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:20},components:{core:{rules:["normalize","block","inline","text_join"]},block:{rules:["paragraph"]},inline:{rules:["text"],rules2:["balance_pairs","fragments_join"]}}},Oo={options:{html:!0,xhtmlOut:!0,breaks:!1,langPrefix:"language-",linkify:!1,typographer:!1,quotes:"“”‘’",highlight:null,maxNesting:20},components:{core:{rules:["normalize","block","inline","text_join"]},block:{rules:["blockquote","code","fence","heading","hr","html_block","lheading","list","reference","paragraph"]},inline:{rules:["autolink","backticks","emphasis","entity","escape","html_inline","image","link","newline","text"],rules2:["balance_pairs","emphasis","fragments_join"]}}},Ho={default:Wo,zero:Mo,commonmark:Oo},No=/^(vbscript|javascript|file|data):/,Bo=/^data:image\/(gif|png|jpeg|webp);/;function zo(e){const n=e.trim().toLowerCase();return No.test(n)?Bo.test(n):!0}const It=["http:","https:","mailto:"];function Go(e){const n=dn(e,!0);if(n.hostname&&(!n.protocol||It.indexOf(n.protocol)>=0))try{n.hostname=Ft.toASCII(n.hostname)}catch{}return Se(ln(n))}function qo(e){const n=dn(e,!0);if(n.hostname&&(!n.protocol||It.indexOf(n.protocol)>=0))try{n.hostname=Ft.toUnicode(n.hostname)}catch{}return re(ln(n),re.defaultChars+"%")}function A(e,n){if(!(this instanceof A))return new A(e,n);n||pn(e)||(n=e||{},e="default"),this.inline=new Ce,this.block=new Be,this.core=new mn,this.renderer=new ce,this.linkify=new E,this.validateLink=zo,this.normalizeLink=Go,this.normalizeLinkText=qo,this.utils=jr,this.helpers=Oe({},Zr),this.options={},this.configure(e),n&&this.set(n)}A.prototype.set=function(e){return Oe(this.options,e),this};A.prototype.configure=function(e){const n=this;if(pn(e)){const t=e;if(e=Ho[t],!e)throw new Error('Wrong `markdown-it` preset "'+t+'", check name')}if(!e)throw new Error("Wrong `markdown-it` preset, can't be empty");return e.options&&n.set(e.options),e.components&&Object.keys(e.components).forEach(function(t){e.components[t].rules&&n[t].ruler.enableOnly(e.components[t].rules),e.components[t].rules2&&n[t].ruler2.enableOnly(e.components[t].rules2)}),this};A.prototype.enable=function(e,n){let t=[];Array.isArray(e)||(e=[e]),["core","block","inline"].forEach(function(r){t=t.concat(this[r].ruler.enable(e,!0))},this),t=t.concat(this.inline.ruler2.enable(e,!0));const u=e.filter(function(r){return t.indexOf(r)<0});if(u.length&&!n)throw new Error("MarkdownIt. Failed to enable unknown rule(s): "+u);return this};A.prototype.disable=function(e,n){let t=[];Array.isArray(e)||(e=[e]),["core","block","inline"].forEach(function(r){t=t.concat(this[r].ruler.disable(e,!0))},this),t=t.concat(this.inline.ruler2.disable(e,!0));const u=e.filter(function(r){return t.indexOf(r)<0});if(u.length&&!n)throw new Error("MarkdownIt. Failed to disable unknown rule(s): "+u);return this};A.prototype.use=function(e){const n=[this].concat(Array.prototype.slice.call(arguments,1));return e.apply(e,n),this};A.prototype.parse=function(e,n){if(typeof e!="string")throw new Error("Input data should be a String");const t=new this.core.State(e,this,n);return this.core.process(t),t.tokens};A.prototype.render=function(e,n){return n=n||{},this.renderer.render(this.parse(e,n),this.options,n)};A.prototype.parseInline=function(e,n){const t=new this.core.State(e,this,n);return t.inlineMode=!0,this.core.process(t),t.tokens};A.prototype.renderInline=function(e,n){return n=n||{},this.renderer.render(this.parseInline(e,n),this.options,n)};var $n=!1,oe={false:"push",true:"unshift",after:"push",before:"unshift"},Ae={isPermalinkSymbol:!0};function on(e,n,t,u){var r;if(!$n){var a="Using deprecated markdown-it-anchor permalink option, see https://github.com/valeriangalliat/markdown-it-anchor#permalinks";typeof process=="object"&&process&&process.emitWarning?process.emitWarning(a):console.warn(a),$n=!0}var o=[Object.assign(new t.Token("link_open","a",1),{attrs:[].concat(n.permalinkClass?[["class",n.permalinkClass]]:[],[["href",n.permalinkHref(e,t)]],Object.entries(n.permalinkAttrs(e,t)))}),Object.assign(new t.Token("html_block","",0),{content:n.permalinkSymbol,meta:Ae}),new t.Token("link_close","a",-1)];n.permalinkSpace&&t.tokens[u+1].children[oe[n.permalinkBefore]](Object.assign(new t.Token("text","",0),{content:" "})),(r=t.tokens[u+1].children)[oe[n.permalinkBefore]].apply(r,o)}function Lt(e){return"#"+e}function Wt(e){return{}}var Uo={class:"header-anchor",symbol:"#",renderHref:Lt,renderAttrs:Wt};function ve(e){function n(t){return t=Object.assign({},n.defaults,t),function(u,r,a,o){return e(u,t,r,a,o)}}return n.defaults=Object.assign({},Uo),n.renderPermalinkImpl=e,n}function xn(e){var n=[],t=e.filter(function(u){if(u[0]!=="class")return!0;n.push(u[1])});return n.length>0&&t.unshift(["class",n.join(" ")]),t}var Ge=ve(function(e,n,t,u,r){var a,o=[Object.assign(new u.Token("link_open","a",1),{attrs:xn([].concat(n.class?[["class",n.class]]:[],[["href",n.renderHref(e,u)]],n.ariaHidden?[["aria-hidden","true"]]:[],Object.entries(n.renderAttrs(e,u))))}),Object.assign(new u.Token("html_inline","",0),{content:n.symbol,meta:Ae}),new u.Token("link_close","a",-1)];if(n.space){var s=typeof n.space=="string"?n.space:" ";u.tokens[r+1].children[oe[n.placement]](Object.assign(new u.Token(typeof n.space=="string"?"html_inline":"text","",0),{content:s}))}(a=u.tokens[r+1].children)[oe[n.placement]].apply(a,o)});Object.assign(Ge.defaults,{space:!0,placement:"after",ariaHidden:!1});var Z=ve(Ge.renderPermalinkImpl);Z.defaults=Object.assign({},Ge.defaults,{ariaHidden:!0});var Mt=ve(function(e,n,t,u,r){var a=[Object.assign(new u.Token("link_open","a",1),{attrs:xn([].concat(n.class?[["class",n.class]]:[],[["href",n.renderHref(e,u)]],Object.entries(n.renderAttrs(e,u))))})].concat(n.safariReaderFix?[new u.Token("span_open","span",1)]:[],u.tokens[r+1].children,n.safariReaderFix?[new u.Token("span_close","span",-1)]:[],[new u.Token("link_close","a",-1)]);u.tokens[r+1]=Object.assign(new u.Token("inline","",0),{children:a})});Object.assign(Mt.defaults,{safariReaderFix:!1});var Kn=ve(function(e,n,t,u,r){var a;if(!["visually-hidden","aria-label","aria-describedby","aria-labelledby"].includes(n.style))throw new Error("`permalink.linkAfterHeader` called with unknown style option `"+n.style+"`");if(!["aria-describedby","aria-labelledby"].includes(n.style)&&!n.assistiveText)throw new Error("`permalink.linkAfterHeader` called without the `assistiveText` option in `"+n.style+"` style");if(n.style==="visually-hidden"&&!n.visuallyHiddenClass)throw new Error("`permalink.linkAfterHeader` called without the `visuallyHiddenClass` option in `visually-hidden` style");var o=u.tokens[r+1].children.filter(function(d){return d.type==="text"||d.type==="code_inline"}).reduce(function(d,h){return d+h.content},""),s=[],i=[];if(n.class&&i.push(["class",n.class]),i.push(["href",n.renderHref(e,u)]),i.push.apply(i,Object.entries(n.renderAttrs(e,u))),n.style==="visually-hidden"){if(s.push(Object.assign(new u.Token("span_open","span",1),{attrs:[["class",n.visuallyHiddenClass]]}),Object.assign(new u.Token("text","",0),{content:n.assistiveText(o)}),new u.Token("span_close","span",-1)),n.space){var c=typeof n.space=="string"?n.space:" ";s[oe[n.placement]](Object.assign(new u.Token(typeof n.space=="string"?"html_inline":"text","",0),{content:c}))}s[oe[n.placement]](Object.assign(new u.Token("span_open","span",1),{attrs:[["aria-hidden","true"]]}),Object.assign(new u.Token("html_inline","",0),{content:n.symbol,meta:Ae}),new u.Token("span_close","span",-1))}else s.push(Object.assign(new u.Token("html_inline","",0),{content:n.symbol,meta:Ae}));n.style==="aria-label"?i.push(["aria-label",n.assistiveText(o)]):["aria-describedby","aria-labelledby"].includes(n.style)&&i.push([n.style,e]);var l=[Object.assign(new u.Token("link_open","a",1),{attrs:xn(i)})].concat(s,[new u.Token("link_close","a",-1)]);(a=u.tokens).splice.apply(a,[r+3,0].concat(l)),n.wrapper&&(u.tokens.splice(r,0,Object.assign(new u.Token("html_block","",0),{content:n.wrapper[0]+`
`})),u.tokens.splice(r+3+l.length+1,0,Object.assign(new u.Token("html_block","",0),{content:n.wrapper[1]+`
`})))});function Zn(e,n,t,u){var r=e,a=u;if(t&&Object.prototype.hasOwnProperty.call(n,r))throw new Error("User defined `id` attribute `"+e+"` is not unique. Please fix it in your Markdown to continue.");for(;Object.prototype.hasOwnProperty.call(n,r);)r=e+"-"+a,a+=1;return n[r]=!0,r}function J(e,n){n=Object.assign({},J.defaults,n),e.core.ruler.push("anchor",function(t){for(var u,r={},a=t.tokens,o=Array.isArray(n.level)?(u=n.level,function(d){return u.includes(d)}):(function(d){return function(h){return h>=d}})(n.level),s=0;s<a.length;s++){var i=a[s];if(i.type==="heading_open"&&o(Number(i.tag.substr(1)))){var c=n.getTokensText(a[s+1].children),l=i.attrGet("id");l=l==null?Zn(l=n.slugifyWithState?n.slugifyWithState(c,t):n.slugify(c),r,!1,n.uniqueSlugStartIndex):Zn(l,r,!0,n.uniqueSlugStartIndex),i.attrSet("id",l),n.tabIndex!==!1&&i.attrSet("tabindex",""+n.tabIndex),typeof n.permalink=="function"?n.permalink(l,n,t,s):(n.permalink||n.renderPermalink&&n.renderPermalink!==on)&&n.renderPermalink(l,n,t,s),s=a.indexOf(i),n.callback&&n.callback(i,{slug:l,title:c})}}})}Object.assign(Kn.defaults,{style:"visually-hidden",space:!0,placement:"after",wrapper:null}),J.permalink={__proto__:null,legacy:on,renderHref:Lt,renderAttrs:Wt,makePermalink:ve,linkInsideHeader:Ge,ariaHidden:Z,headerLink:Mt,linkAfterHeader:Kn},J.defaults={level:1,slugify:function(e){return encodeURIComponent(String(e).trim().toLowerCase().replace(/\s+/g,"-"))},uniqueSlugStartIndex:1,tabIndex:"-1",getTokensText:function(e){return e.filter(function(n){return["text","code_inline"].includes(n.type)}).map(function(n){return n.content}).join("")},permalink:!1,renderPermalink:on,permalinkClass:Z.defaults.class,permalinkSpace:Z.defaults.space,permalinkSymbol:"¶",permalinkBefore:Z.defaults.placement==="before",permalinkHref:Z.defaults.renderHref,permalinkAttrs:Z.defaults.renderAttrs},J.default=J;const Ot="rtsp-doc-language",se="overview.md",Ht=new Set(["zh","en"]),Fe={zh:[{group:"开始使用",items:[{title:"项目总览",path:"overview.md"},{title:"在线 Demo",path:"online-demo.md"},{title:"一键安装器",path:"installers.md"},{title:"排障指南",path:"troubleshooting.md"}]},{group:"集成方案",items:[{title:"Chrome 扩展方案",path:"chrome-extension.md"},{title:"Web 组件 Gateway 指引",path:"web-component-gateway.md"},{title:"通用组件方案",path:"universal-components.md"},{title:"桌面免插件",path:"desktop-native.md"},{title:"SDK API",path:"sdk-api.md"},{title:"多路与生命周期",path:"multi-stream-lifecycle.md"}]},{group:"协议与运维",items:[{title:"WebRTC / H.265",path:"webrtc-hevc.md"},{title:"RTSP 兼容性",path:"rtsp-compatibility.md"},{title:"小米摄像头",path:"xiaomi-rtsp.md"},{title:"安全模型",path:"security.md"},{title:"部署发布",path:"deployment.md"},{title:"验证记录",path:"validation.md"}]}],en:[{group:"Getting Started",items:[{title:"Overview",path:"overview.md"},{title:"Online Demo",path:"online-demo.md"},{title:"One-Click Installers",path:"installers.md"},{title:"Troubleshooting",path:"troubleshooting.md"}]},{group:"Integration",items:[{title:"Chrome Extension Runtime",path:"chrome-extension.md"},{title:"Gateway for Web Components",path:"web-component-gateway.md"},{title:"Universal Components",path:"universal-components.md"},{title:"Desktop Without Plugin",path:"desktop-native.md"},{title:"SDK API",path:"sdk-api.md"},{title:"Multi-Stream Lifecycle",path:"multi-stream-lifecycle.md"}]},{group:"Protocols and Ops",items:[{title:"WebRTC / H.265",path:"webrtc-hevc.md"},{title:"RTSP Compatibility",path:"rtsp-compatibility.md"},{title:"Xiaomi via micam",path:"xiaomi-rtsp.md"},{title:"Security Model",path:"security.md"},{title:"Deployment",path:"deployment.md"},{title:"Validation Log",path:"validation.md"}]}]},Yn={zh:{"nav.schemes":"方案","nav.demo":"Demo","nav.sdk":"SDK","nav.docs":"文档","nav.validation":"验证","nav.install":"安装","docs.eyebrow":"Docs","docs.title":"文档","docs.intro":"所有项目文档都可以在这里沉浸式阅读，左侧切换目录，右侧渲染 Markdown 内容。","docs.loading":"正在加载文档…","docs.errorTitle":"文档加载失败","install.detecting":"检测中","install.waitExtension":"等待扩展响应","install.pending":"待检测","install.notFound":"未检测到","install.waitInstall":"等待安装","install.notAllowed":"未授权当前站点","install.allowed":"已授权","install.ok":"正常","installer.mac.label":"macOS 安装器","installer.windows.label":"Windows 安装器","installer.linux.label":"Linux 安装器","installer.mac.copy":"下载 DMG，打开 RTSP Installer.app，按提示完成安装。","installer.windows.copy":"下载 ZIP，解压后打开 RTSP Installer.hta，按提示完成安装。","installer.linux.copy":"下载压缩包，解压后打开 RTSP Installer.desktop 或运行 install-gui.sh。","installer.download":"下载","live.placeholderTitle":"等待真实 RTSP 输入","live.placeholderCopy":"安装 runtime 后，这里会挂载扩展播放器 iframe。","live.stopped":"真实播放已停止。","live.ready":"真实 RTSP 播放器已就绪。","live.recovering":"播放中断，正在自动恢复","live.recovered":"播放已自动恢复。","live.needExtension":"请输入 Chrome 扩展 ID。","live.needUrl":"请输入 rtsp:// 开头的 RTSP URL。","live.waiting":"正在请求 Chrome 扩展播放器。若画面未出现，请检查扩展 ID、origin 授权和 Native Host。","live.timeout":"仍在等待扩展响应。请确认扩展已安装，并已授权当前站点 origin。","live.installReady":"扩展、Native Runtime 和当前站点授权均已就绪。"},en:{"nav.schemes":"Solutions","nav.demo":"Demo","nav.sdk":"SDK","nav.docs":"Docs","nav.validation":"Validation","nav.install":"Install","docs.eyebrow":"Docs","docs.title":"Documentation","docs.intro":"Read the complete project documentation here. Use the sidebar to switch topics; Markdown is rendered as an immersive page.","docs.loading":"Loading documentation...","docs.errorTitle":"Documentation failed to load","install.detecting":"Checking","install.waitExtension":"Waiting for extension","install.pending":"Not checked","install.notFound":"Not detected","install.waitInstall":"Waiting for install","install.notAllowed":"Current site not allowed","install.allowed":"Allowed","install.ok":"OK","installer.mac.label":"macOS Installer","installer.windows.label":"Windows Installer","installer.linux.label":"Linux Installer","installer.mac.copy":"Download the DMG, open RTSP Installer.app, and follow the prompts.","installer.windows.copy":"Download the ZIP, unzip it, open RTSP Installer.hta, and follow the prompts.","installer.linux.copy":"Download the archive, then open RTSP Installer.desktop or run install-gui.sh.","installer.download":"Download","live.placeholderTitle":"Waiting for an RTSP URL","live.placeholderCopy":"After the runtime is installed, the extension player iframe appears here.","live.stopped":"Real playback stopped.","live.ready":"Real RTSP player is ready.","live.recovering":"Playback interrupted. Recovering","live.recovered":"Playback recovered.","live.needExtension":"Enter the Chrome extension ID.","live.needUrl":"Enter an RTSP URL that starts with rtsp://.","live.waiting":"Requesting the Chrome extension player. If no video appears, check the extension ID, origin allowlist, and Native Host.","live.timeout":"Still waiting for the extension. Confirm it is installed and this site origin is allowed.","live.installReady":"Extension, Native Runtime, and current site origin are ready."}};let z=ns(),ie=Gt(z);const jo=Object.assign({"../../docs/articles/rtsp-player-latest-wechat.md":Qt,"../../docs/articles/rtsp-player-wechat.md":eu,"../../docs/chrome-extension.md":nu,"../../docs/deployment.md":tu,"../../docs/desktop-native.md":uu,"../../docs/en/chrome-extension.md":ru,"../../docs/en/deployment.md":au,"../../docs/en/desktop-native.md":ou,"../../docs/en/installers.md":su,"../../docs/en/multi-stream-lifecycle.md":iu,"../../docs/en/online-demo.md":cu,"../../docs/en/overview.md":lu,"../../docs/en/rtsp-compatibility.md":du,"../../docs/en/sdk-api.md":fu,"../../docs/en/security.md":pu,"../../docs/en/troubleshooting.md":hu,"../../docs/en/universal-components.md":mu,"../../docs/en/validation.md":bu,"../../docs/en/web-component-gateway.md":gu,"../../docs/en/webrtc-hevc.md":xu,"../../docs/en/xiaomi-rtsp.md":yu,"../../docs/installers.md":_u,"../../docs/multi-stream-lifecycle.md":ku,"../../docs/online-demo.md":Su,"../../docs/overview.md":wu,"../../docs/rtsp-compatibility.md":Cu,"../../docs/sdk-api.md":vu,"../../docs/security.md":Tu,"../../docs/troubleshooting.md":Pu,"../../docs/universal-components.md":Ru,"../../docs/validation.md":Du,"../../docs/web-component-gateway.md":Eu,"../../docs/webrtc-hevc.md":Au,"../../docs/xiaomi-rtsp.md":Fu}),Vo=Object.assign({"../../docs/assets/contact.jpg":Iu,"../../docs/assets/donate-alipay.jpg":Lu,"../../docs/assets/donate-wx.jpg":Wu,"../../docs/assets/mp.png":Mu,"../../docs/assets/public-rtsp-e2e.png":Ou,"../../docs/assets/rtsp-player-latest-architecture.png":Hu,"../../docs/assets/rtsp-player-latest-architecture.svg":Nu,"../../docs/assets/rtsp-player-latest-cover-bg.png":Bu,"../../docs/assets/rtsp-player-latest-cover.png":zu,"../../docs/assets/rtsp-player-wechat-cover.png":Gu}),$o=new Map(Object.entries(jo).map(([e,n])=>[qe(e.replace(/^.*\/docs\//,"")),n])),Ko=new Map(Object.entries(Vo).map(([e,n])=>[`/docs/assets/${e.split("/").pop()}`,n])),ee=new A({html:!1,linkify:!0,typographer:!0}).use(J,{slugify:ss,permalink:J.permalink.linkInsideHeader({symbol:"#",placement:"after",class:"docs-anchor",ariaHidden:!0})}),Zo=ee.renderer.rules.link_open||((e,n,t,u,r)=>r.renderToken(e,n,t)),Yo=ee.renderer.rules.image||((e,n,t,u,r)=>r.renderToken(e,n,t));ee.renderer.rules.link_open=(e,n,t,u,r)=>{const a=e[n],o=a.attrGet("href");if(o){const s=os(o,u.currentPath||"overview.md");a.attrSet("href",s),/^https?:\/\//i.test(s)&&(a.attrSet("target","_blank"),a.attrSet("rel","noreferrer"))}return Zo(e,n,t,u,r)};ee.renderer.rules.image=(e,n,t,u,r)=>{const a=e[n],o=a.attrGet("src");return o&&a.attrSet("src",$t(o,u.currentPath||"overview.md")),a.attrSet("loading","lazy"),a.attrSet("decoding","async"),Yo(e,n,t,u,r)};ee.renderer.rules.table_open=()=>'<div class="docs-table-wrap"><table>';ee.renderer.rules.table_close=()=>"</table></div>";const Jn=Array.from(document.querySelectorAll("[data-tab]")),Jo=Array.from(document.querySelectorAll("[data-panel]"));for(const e of Jn)e.addEventListener("click",()=>{const n=e.dataset.tab;for(const t of Jn)t.classList.toggle("active",t===e);for(const t of Jo)t.classList.toggle("active",t.dataset.panel===n)});const Xo=Array.from(document.querySelectorAll("main section[id]")),Xn=new Map(Array.from(document.querySelectorAll(".primary-nav a[href^='#']")).map(e=>[e.getAttribute("href").slice(1),e])),Qo=new IntersectionObserver(e=>{const n=e.filter(t=>t.isIntersecting).sort((t,u)=>u.intersectionRatio-t.intersectionRatio)[0];if(n){for(const t of Xn.values())t.removeAttribute("aria-current");Xn.get(n.target.id)?.setAttribute("aria-current","page")}},{rootMargin:"-20% 0px -60% 0px",threshold:[.1,.4,.7]});for(const e of Xo)Qo.observe(e);const ye=document.querySelector("#docs-nav"),ue=document.querySelector("#docs-content"),Nt=Array.from(document.querySelectorAll("[data-lang-switch]"));let Re="";Ut();jt();for(const e of Nt)e.addEventListener("click",()=>{qt(e.dataset.langSwitch,{scroll:!1}),kn(),P||Kt()});ye&&ue&&(Bt(),window.addEventListener("hashchange",()=>{location.hash.startsWith("#docs")&&_e(Qn(),{scroll:!1})}),_e(Qn(),{scroll:!1}));function Bt(){ye.innerHTML="";for(const e of Fe[z]||Fe.zh){const n=document.createElement("section");n.className="docs-nav-group";const t=document.createElement("h3");t.textContent=e.group,n.appendChild(t);for(const u of e.items){const r=document.createElement("button");r.type="button",r.dataset.docPath=u.path,r.textContent=u.title,r.addEventListener("click",()=>{history.replaceState(null,"",`#docs/${u.path}`),_e(u.path,{scroll:!0})}),n.appendChild(r)}ye.appendChild(n)}}function Qn(){const e=decodeURIComponent(location.hash||"").match(/^#docs\/(.+)$/),n=ts(e?.[1]||se);return n.lang&&n.lang!==z&&qt(n.lang,{reloadDoc:!1}),ie.has(n.path)?n.path:se}async function _e(e,{scroll:n=!1}={}){e=ke(e),ie.has(e)||(e=se),Re=e,zt(e),ue.innerHTML=`<div class="docs-loading">${pe(w("docs.loading"))}</div>`;try{const t=us(e),u=$o.get(t)??await rs(t);ue.innerHTML=as(u,t),es(t),n&&document.querySelector("#docs")?.scrollIntoView({block:"start"})}catch(t){ue.innerHTML=`
      <div class="docs-error">
        <h2>${pe(w("docs.errorTitle"))}</h2>
        <p>${pe(t?.message||String(t))}</p>
      </div>
    `}}function zt(e){ye.querySelectorAll("button[data-doc-path]").forEach(n=>{n.classList.toggle("active",n.dataset.docPath===e)})}function es(e){ue.querySelectorAll("a[href]").forEach(n=>{const t=n.getAttribute("href")||"",u=Vt(t,e);!u||!ie.has(u)||n.addEventListener("click",r=>{r.preventDefault(),history.replaceState(null,"",`#docs/${u}`),_e(u,{scroll:!0})})})}function Gt(e){const n=Fe[e]||Fe.zh;return new Map(n.flatMap(t=>t.items.map(u=>[u.path,u])))}function w(e){return Yn[z]?.[e]||Yn.zh[e]||e}function ns(){const e=decodeURIComponent(location.hash||"").match(/^#docs\/(.+)$/)?.[1]||"",n=qe(e).match(/^(zh|en)\//)?.[1],t=new URLSearchParams(location.search).get("lang"),u=localStorage.getItem(Ot),r=navigator.language?.toLowerCase().startsWith("zh")?"zh":"en";return[n,t,u,r].find(a=>Ht.has(a))||"zh"}function qt(e,{reloadDoc:n=!0,scroll:t=!1}={}){if(Ht.has(e)&&(z=e,localStorage.setItem(Ot,e),document.documentElement.lang=e==="zh"?"zh-CN":"en",ie=Gt(e),Ut(),jt(),ye&&(Bt(),zt(Re)),n&&ue)){const u=ie.has(Re)?Re:se;location.hash.startsWith("#docs")&&history.replaceState(null,"",`#docs/${u}`),_e(u,{scroll:t})}}function Ut(){document.documentElement.lang=z==="zh"?"zh-CN":"en",document.querySelectorAll("[data-i18n]").forEach(e=>{e.textContent=w(e.dataset.i18n)})}function jt(){for(const e of Nt){const n=e.dataset.langSwitch===z;e.classList.toggle("active",n),e.setAttribute("aria-pressed",String(n))}}function ts(e){const n=qe(e),t=n.match(/^(zh|en)\/(.+)$/);return{lang:t?.[1]||"",path:ke(t?.[2]||n||se)}}function us(e){const n=ke(e||se);return z==="en"?`en/${n}`:n}function qe(e){return String(e||"").replace(/^\/?docs\//,"").replace(/^\.\//,"").replace(/\/+/g,"/")}function ke(e){return qe(e).replace(/^(zh|en)\//,"")}function Vt(e,n){if(!e||e.startsWith("#")||/^https?:\/\//i.test(e))return"";const t=e.split("#")[0].split("?")[0];if(!t.endsWith(".md"))return"";if(t.startsWith("/docs/"))return ke(t);const u=n.split("/").slice(0,-1);for(const r of t.split("/"))!r||r==="."||(r===".."?u.pop():u.push(r));return ke(u.join("/"))}async function rs(e){const n=await fetch(`/docs/${e}`);if(!n.ok)throw new Error(`HTTP ${n.status}`);const t=await n.text();if(/^\s*(<!doctype html|<html\b)/i.test(t))throw new Error("Markdown document endpoint returned HTML fallback.");return t}function as(e,n){const t=e.replace(/^---[\s\S]*?---\s*/,"").replace(/\r\n/g,`
`);return`<div class="docs-markdown">${ee.render(t,{currentPath:n})}</div>`}function $t(e,n){if(/^(https?:)?\/\//i.test(e)||e.startsWith("data:"))return e;const t=`/docs/${n}`.split("/").slice(0,-1);for(const r of e.split("/"))!r||r==="."||(r===".."?t.pop():t.push(r));const u=t.join("/");return Ko.get(u)||u}function os(e,n){const t=Vt(e,n);return t&&ie.has(t)?`#docs/${t}`:/^(https?:)?\/\//i.test(e)||e.startsWith("#")||e.startsWith("/")?e:$t(e,n)}function ss(e){return e.toLowerCase().replace(/<[^>]+>/g,"").replace(/[^\p{Letter}\p{Number}]+/gu,"-").replace(/^-+|-+$/g,"")||"section"}function pe(e){return String(e).replace(/[&<>"']/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[n])}const U=document.querySelector("#demo-canvas"),en=document.querySelector("#demo-toggle"),is=document.querySelector("#demo-state"),cs=document.querySelector("#demo-fps"),ls=document.querySelector("#demo-latency"),ds=document.querySelector("#demo-queue"),fs=document.querySelector("#demo-dropped");if(U){const e=U.getContext("2d",{alpha:!1});let n=!0,t=0,u=performance.now(),r=60,a=0,o=0,s=0;const i=()=>{const d=U.getBoundingClientRect(),h=Math.min(window.devicePixelRatio||1,2),p=Math.max(320,Math.round(d.width*h)),f=Math.max(180,Math.round(d.height*h));return(U.width!==p||U.height!==f)&&(U.width=p,U.height=f),e.setTransform(h,0,0,h,0,0),{width:p/h,height:f/h,ratio:h}},c=(d,h,p)=>{e.strokeStyle="rgba(143, 184, 216, .12)",e.lineWidth=1;const f=p/30%48;for(let b=-48+f;b<d+48;b+=48)e.beginPath(),e.moveTo(b,0),e.lineTo(b,h),e.stroke();for(let b=-48+f;b<h+48;b+=48)e.beginPath(),e.moveTo(0,b),e.lineTo(d,b),e.stroke()},l=d=>{s||(s=d),n&&(o+=d-s),s=d;const h=o,{width:p,height:f}=i(),b=h/1400%1,g=e.createLinearGradient(0,0,p,f);g.addColorStop(0,"#07110f"),g.addColorStop(.55,"#111716"),g.addColorStop(1,"#1b1d19"),e.fillStyle=g,e.fillRect(0,0,p,f),c(p,f,h),e.fillStyle="rgba(154, 210, 157, .10)",e.fillRect(0,f*b,p,3);const S=f*.66;e.fillStyle="rgba(244, 245, 242, .08)",e.fillRect(0,S,p,f*.18),e.fillStyle="rgba(228, 198, 122, .55)";for(let _=0;_<12;_+=1){const k=(h/9+_*120)%(p+140)-100;e.fillRect(k,S+f*.08,62,3)}const y=h/16%(p+260)-180;e.fillStyle="#8fb8d8",e.fillRect(y,S-28,92,26),e.fillStyle="#dfe8dd",e.fillRect(y+18,S-42,38,16),e.fillStyle="#050706",e.beginPath(),e.arc(y+22,S,7,0,Math.PI*2),e.arc(y+72,S,7,0,Math.PI*2),e.fill();const m=p*.76+Math.sin(h/700)*32,x=f*.46;if(e.strokeStyle="#e4c67a",e.lineWidth=5,e.beginPath(),e.arc(m,x-18,9,0,Math.PI*2),e.moveTo(m,x-8),e.lineTo(m,x+24),e.moveTo(m-18,x+3),e.lineTo(m+18,x+3),e.moveTo(m,x+24),e.lineTo(m-16,x+52),e.moveTo(m,x+24),e.lineTo(m+16,x+52),e.stroke(),e.strokeStyle="rgba(154, 210, 157, .9)",e.lineWidth=2,e.strokeRect(m-38,x-42,76,112),e.fillStyle="rgba(154, 210, 157, .15)",e.fillRect(m-38,x-42,76,18),e.fillStyle="rgba(5, 7, 6, .78)",e.fillRect(14,14,260,82),e.fillStyle="#f4f5f2",e.font="700 18px system-ui, sans-serif",e.fillText("RTSP Online Demo",28,44),e.font="13px system-ui, sans-serif",e.fillStyle="#b6bbb4",e.fillText(new Date().toLocaleTimeString(z==="zh"?"zh-CN":"en-US",{hour12:!1}),28,70),e.fillText("Simulated low-latency preview",112,70),n){t+=1;const _=d-u;if(_>=500){r=Math.round(t*1e3/_),t=0,u=d;const k=42+Math.round(Math.abs(Math.sin(h/900))*18),v=Math.round(Math.abs(Math.sin(h/1300))*1);Math.sin(h/2800)>.995&&(a+=1),cs.textContent=String(r),ls.textContent=`${k}ms`,ds.textContent=String(v),fs.textContent=String(a)}}requestAnimationFrame(l)};en?.addEventListener("click",()=>{n=!n,en.textContent=n?"Pause":"Play",en.setAttribute("aria-pressed",String(n)),is.textContent=n?"Live Preview":"Paused"}),new ResizeObserver(i).observe(U),requestAnimationFrame(l)}const ps=document.querySelector("#live-demo-form"),hs=document.querySelector("#live-stop"),Ie=document.querySelector("#live-player-mount"),nn=document.querySelector("#live-demo-status"),X=document.querySelector("#live-extension-id"),Le=document.querySelector("#live-rtsp-url");let P=null,fe=0;const ms="giegomfhcmgebjhdiihnjohoinkbcjbh",et="rtsp://9627b0bf2a7b.entrypoint.cloud.wowza.com:1935/app-p5260J38/66abe4b9_stream1",bs=new Set(["rtsp://127.0.0.1:8554/local","rtsp://192.168.28.62:8554/local"]),gs={mac:"/downloads/rtsp-macos-installer.dmg",windows:"/downloads/rtsp-windows-installer.zip",linux:"/downloads/rtsp-linux-installer.tar.gz"},Q=document.querySelector("#install-dialog"),xs=[document.querySelector("#open-install-assistant"),document.querySelector("#hero-install-assistant")].filter(Boolean),ys=Array.from(document.querySelectorAll("[data-install-close]")),_s=document.querySelector("#recheck-install-status"),We=document.querySelector("#install-extension-status"),yn=document.querySelector("#install-native-status"),_n=document.querySelector("#install-origin-status"),tn=document.querySelector("#recommended-installer"),nt=document.querySelector("#installer-recommend-title"),tt=document.querySelector("#installer-recommend-copy"),ut=document.querySelector("#installer-list");let Me=!1,sn=0;function W(e,n="neutral"){nn&&(nn.textContent=e,nn.dataset.tone=n)}function ks(e,n){localStorage.setItem("rtsp-demo-extension-id",e),localStorage.setItem("rtsp-demo-url",n)}function Ss(){if(X&&(X.value=localStorage.getItem("rtsp-demo-extension-id")||ms),Le){const e=(localStorage.getItem("rtsp-demo-url")||"").trim(),n=bs.has(e)?et:e||et;e&&e!==n&&localStorage.setItem("rtsp-demo-url",n),Le.value=n}}function Kt(){Ie&&(Ie.innerHTML=`
    <div class="mount-placeholder">
      <strong>${pe(w("live.placeholderTitle"))}</strong>
      <span>${pe(w("live.placeholderCopy"))}</span>
    </div>
  `)}function ws(){window.clearTimeout(fe),P?.stop&&P.stop(),P=null,Kt(),W(w("live.stopped"),"neutral")}function Cs(){const e=`${navigator.userAgentData?.platform||""} ${navigator.platform||""} ${navigator.userAgent||""}`.toLowerCase();return e.includes("win")?"windows":e.includes("mac")?"mac":e.includes("linux")||e.includes("x11")?"linux":"mac"}function kn(){if(!tn||!nt||!tt)return;const e=Cs(),n={mac:w("installer.mac.label"),windows:w("installer.windows.label"),linux:w("installer.linux.label")},t={mac:w("installer.mac.copy"),windows:w("installer.windows.copy"),linux:w("installer.linux.copy")};tn.href=gs[e],tn.textContent=`${w("installer.download")} ${n[e]}`,nt.textContent=n[e],tt.textContent=t[e],ut&&ut.querySelectorAll("[data-installer-platform]").forEach(u=>{u.hidden=u.dataset.installerPlatform!==e})}function H(e,n,t){e&&(e.textContent=n,e.style.color=t?"var(--green)":"var(--amber)")}function Sn(){kn();const e=Q?.classList.contains("open");Q?.classList.add("open"),Q?.setAttribute("aria-hidden","false"),document.body.style.overflow="hidden",e||wn()}function Zt(){Q?.classList.remove("open"),Q?.setAttribute("aria-hidden","true"),document.body.style.overflow="",sessionStorage.setItem("rtsp-install-assistant-dismissed","1")}function wn(){Me=!1,H(We,w("install.detecting"),!1),window.clearTimeout(sn),sn=window.setTimeout(()=>{Me||(H(We,w("install.notFound"),!1),H(yn,w("install.waitInstall"),!1),H(_n,w("install.waitInstall"),!1))},1200),window.postMessage({type:"RTSP_INSTALL_STATUS_REQUEST",autoAllowOrigin:!0},location.origin)}function vs(e){Me=!0,window.clearTimeout(sn);const n=!!(e.installed&&e.extensionId),t=!!e.nativeOk,u=!!e.originAllowed;H(We,n?`${z==="zh"?"已安装":"Installed"} ${e.extensionId}`:w("install.notFound"),n),H(yn,t?`${w("install.ok")} ${e.nativePort||""}`:e.nativeError||w("install.notFound"),t),H(_n,w(u?"install.allowed":"install.notAllowed"),u),n&&X&&!X.value&&(X.value=e.extensionId,localStorage.setItem("rtsp-demo-extension-id",e.extensionId)),!n||!t||!u?sessionStorage.getItem("rtsp-install-assistant-dismissed")||Sn():Q?.classList.contains("open")&&W(w("live.installReady"),"ok")}for(const e of xs)e.addEventListener("click",Sn);for(const e of ys)e.addEventListener("click",Zt);_s?.addEventListener("click",()=>{wn()});window.addEventListener("keydown",e=>{e.key==="Escape"&&Q?.classList.contains("open")&&Zt()});window.addEventListener("message",e=>{if(e.source!==window||e.origin!==location.origin)return;const n=e.data||{};n.source!=="rtsp-web-player-extension"||n.type!=="RTSP_EXTENSION_STATUS"||vs(n)});Ss();kn();window.setTimeout(()=>{wn(),window.setTimeout(()=>{!Me&&!sessionStorage.getItem("rtsp-install-assistant-dismissed")&&(H(We,w("install.notFound"),!1),H(yn,w("install.waitInstall"),!1),H(_n,w("install.waitInstall"),!1),Sn())},1100)},400);ps?.addEventListener("submit",e=>{e.preventDefault();const n=X?.value.trim()||"",t=Le?.value.trim()||"";if(!n){W(w("live.needExtension"),"error"),X?.focus();return}if(!t||!t.startsWith("rtsp://")){W(w("live.needUrl"),"error"),Le?.focus();return}ks(n,t),er("rtsp-live-player",{extensionId:n}),Ie.innerHTML="",P=document.createElement("rtsp-live-player"),P.setAttribute("extension-id",n),P.setAttribute("url",t),P.setAttribute("autoplay",""),P.setAttribute("controls",""),P.setAttribute("transport","auto"),P.setAttribute("codec","auto"),P.setAttribute("width","100%"),P.setAttribute("height","360"),P.addEventListener("ready",()=>{window.clearTimeout(fe),W(w("live.ready"),"ok")}),P.addEventListener("recovering",u=>{const r=u.detail?.attempt||1,a=u.detail?.maxAttempts||6;W(`${w("live.recovering")} (${r}/${a})...`,"error")}),P.addEventListener("recovered",()=>{W(w("live.recovered"),"ok")}),P.addEventListener("error",u=>{window.clearTimeout(fe);const r=u.detail?.error||"播放器返回错误，请检查 RTSP 地址、鉴权和 H.264 编码。";W(r,"error")}),Ie.appendChild(P),W(w("live.waiting")),window.clearTimeout(fe),fe=window.setTimeout(()=>{W(w("live.timeout"),"error")},5e3)});hs?.addEventListener("click",ws);
