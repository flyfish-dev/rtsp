...
const INSTALLER_FILES = {
  mac: [
    { label: "macOS 图形安装包（DMG）", file: "rtsp-macos-installer.dmg" },
    { label: "macOS 备用安装包（ZIP）", file: "rtsp-macos-installer.zip" },
  ],
  windows: [
    { label: "Windows 安装包（ZIP）", file: "rtsp-windows-installer.zip" },
  ],
  linux: [
    { label: "Linux 安装包（TAR.GZ）", file: "rtsp-linux-installer.tar.gz" },
  ],
};
